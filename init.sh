#!/bin/sh 
DEMO="JBoss Polymita, BRMS Shipping Demo"
AUTHORS="Robbie Wagner, Stephen Walker, Jason Milliron, Eric D. Schabell"
PROJECT="git@github.com:rwwagner90/PolymitaDemo.git"
...
WEB_INF_LIB=./PolymitaDemo/src/main/webapp/WEB-INF/lib/
