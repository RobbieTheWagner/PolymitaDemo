package org.railroad.shipping.web;
...
import org.railroad.shipping.Contact;
import org.railroad.shipping.Container;
import org.railroad.shipping.Item;
import org.railroad.shipping.Shipment;
import org.railroad.shipping.service.ShippingService;
import org.railroad.shipping.web.ui.ContainersView;
import org.railroad.shipping.web.ui.ItemsView;
import org.railroad.shipping.web.ui.ShipmentsView;
...
public class PolymitaDemo extends AbstractCdiApplication implements ClickListener {
	...
	@WebServlet(urlPatterns = "/*", initParams = @WebInitParam(name = "application", value = "org.railroad.shipping.web.PolymitaDemo"))
	...
	public void init() {
		...
		Window mainWindow = new Window("Railroad Polymita Demo");
	...
	public void showView(String viewName) {
		...
		Label header = new Label("Railroad Polymita Demo");
