...
function runAsync_0(callback){
  ...
  $location_0[stackIndex] = 'AsyncLoader2.java:' + '28' , $clinit_259();
  var newCallback;
...
function runCallbackOnFailures_0(e){
  ...
  $location_0[stackIndex] = 'AsyncLoader2.java:' + '72' , $clinit_259();
...
function loadFailed_2(reason){
  ...
  $location_0[stackIndex] = 'AsyncLoader2.java:' + '9' , $clinit_259();
...
function runAsync_1(callback){
  ...
  $location_0[stackIndex] = 'AsyncLoader3.java:' + '28' , $clinit_263();
  var newCallback;
...
function runCallbackOnFailures_1(e){
  ...
  $location_0[stackIndex] = 'AsyncLoader3.java:' + '72' , $clinit_263();
...
function loadFailed_3(reason){
  ...
  $location_0[stackIndex] = 'AsyncLoader3.java:' + '9' , $clinit_263();
...
function runAsync_2(callback){
  ...
  $location_0[stackIndex] = 'AsyncLoader4.java:' + '28' , $clinit_267();
  var newCallback;
...
function runCallbackOnFailures_2(e){
  ...
  $location_0[stackIndex] = 'AsyncLoader4.java:' + '72' , $clinit_267();
...
function loadFailed_4(reason){
  ...
  $location_0[stackIndex] = 'AsyncLoader4.java:' + '9' , $clinit_267();
...
function runAsync_3(callback){
  ...
  $location_0[stackIndex] = 'AsyncLoader5.java:' + '28' , $clinit_271();
  var newCallback;
...
function runCallbackOnFailures_3(e){
  ...
  $location_0[stackIndex] = 'AsyncLoader5.java:' + '72' , $clinit_271();
...
function loadFailed_5(reason){
  ...
  $location_0[stackIndex] = 'AsyncLoader5.java:' + '9' , $clinit_271();
...
function runAsync_4(callback){
  ...
  $location_0[stackIndex] = 'AsyncLoader6.java:' + '28' , $clinit_275();
  var newCallback;
...
function runCallbackOnFailures_4(e){
  ...
  $location_0[stackIndex] = 'AsyncLoader6.java:' + '72' , $clinit_275();
...
function loadFailed_6(reason){
  ...
  $location_0[stackIndex] = 'AsyncLoader6.java:' + '9' , $clinit_275();
...
function runAsync_5(callback){
  ...
  $location_0[stackIndex] = 'AsyncLoader7.java:' + '28' , $clinit_279();
  var newCallback;
...
function runCallbackOnFailures_5(e){
  ...
  $location_0[stackIndex] = 'AsyncLoader7.java:' + '72' , $clinit_279();
...
function loadFailed_7(reason){
  ...
  $location_0[stackIndex] = 'AsyncLoader7.java:' + '9' , $clinit_279();
...
function onLoad_7(){
  ...
  instance_10 = ($location_0[stackIndex] = 'AsyncLoader9.java:' + '5' , $clinit_285() , ($location_0[stackIndex] = 'AsyncLoader9.java:' + '22' , new AsyncLoader9));
...
function $getWidget_5(this$static, index){
  ...
  returnTemp = ($location_0[stackIndex] = 'LayoutPanel.java:' + '490' , $getUnDecoratedWidget(($location_0[stackIndex] = 'ComplexPanel.java:' + '36' , $get_6(($location_0[stackIndex] = 'LayoutComposite.java:' + '89' , dynamicCast(this$static.widget, 182)).children, index))));
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function $add_22(this$static, w, tabText, asHTML){
  ...
  $location_0[stackIndex] = 'TabLayoutPanel.java:' + '211' , $insert_5(this$static, w, tabText, asHTML, ($location_0[stackIndex] = 'LayoutComposite.java:' + '89' , dynamicCast(this$static.deck.widget, 182)).children.size_0);
  $stackDepth_0 = stackIndex - 1;
}
...
function $DecoratedTabLayoutPanel(this$static){
  ...
  $location_0[stackIndex] = 'DecoratedTabLayoutPanel.java:' + '39' , $TabLayoutPanel(this$static, ($location_0[stackIndex] = 'TabLayoutPanel.java:' + '65' , $clinit_719() , TOP), true, false);
  $stackDepth_0 = stackIndex - 1;
  return this$static;
}
...
function $add_27(this$static, w, stackText, asHTML){
  ...
  $location_0[stackIndex] = 'Caption.java:' + '133' , $addDomHandler(caption, this$static.clickHandler, ($location_0[stackIndex] = 'Caption.java:' + '133' , $clinit_126() , ($location_0[stackIndex] = 'ClickEvent.java:' + '27' , $clinit_126()) , TYPE_1));
  ...
  $add_26(layoutPanel, caption, ($location_0[stackIndex] = 'StackLayoutPanel.java:' + '128' , $BoxLayoutData_4(($location_0[stackIndex] = 'StackLayoutPanel.java:' + '128' , new BoxLayoutData), ($location_0[stackIndex] = 'BoxLayoutData.java:' + '30' , $clinit_789() , HORIZONTAL_0))));
  ...
  if (this$static.visibleStack == -1) {
    ...
    $location_0[stackIndex] = 'StackLayoutPanel.java:' + '134' , this$static.visibleStack = ($location_0[stackIndex] = 'LayoutComposite.java:' + '89' , dynamicCast(this$static.widget, 182)).children.size_0 - 2;
...
function $layout_5(this$static){
  ...
  for ($location_0[stackIndex] = 'StackLayoutPanel.java:' + '237' , i = 0 , ($location_0[stackIndex] = 'StackLayoutPanel.java:' + '237' , n = ($location_0[stackIndex] = 'LayoutComposite.java:' + '89' , dynamicCast(this$static.widget, 182)).children.size_0); i < n; $location_0[stackIndex] = 'StackLayoutPanel.java:' + '237' , ++i) {
    $location_0[stackIndex] = 'StackLayoutPanel.java:' + '238' , w = ($location_0[stackIndex] = 'LayoutPanel.java:' + '490' , $getUnDecoratedWidget(($location_0[stackIndex] = 'ComplexPanel.java:' + '36' , $get_6(($location_0[stackIndex] = 'LayoutComposite.java:' + '89' , dynamicCast(this$static.widget, 182)).children, i))));
...
function $setStackVisible(this$static, index, visible){
  ...
  caption = ($location_0[stackIndex] = 'StackLayoutPanel.java:' + '175' , dynamicCast(($location_0[stackIndex] = 'LayoutPanel.java:' + '490' , $getUnDecoratedWidget(($location_0[stackIndex] = 'ComplexPanel.java:' + '36' , $get_6(($location_0[stackIndex] = 'LayoutComposite.java:' + '89' , dynamicCast(this$static.widget, 182)).children, index)))), 193));
  content = ($location_0[stackIndex] = 'StackLayoutPanel.java:' + '176' , dynamicCast(($location_0[stackIndex] = 'LayoutPanel.java:' + '490' , $getUnDecoratedWidget(($location_0[stackIndex] = 'ComplexPanel.java:' + '36' , $get_6(($location_0[stackIndex] = 'LayoutComposite.java:' + '89' , dynamicCast(this$static.widget, 182)).children, index + 1)))), 182));
...
function $showStack(this$static, index){
  ...
  if (index >= ($location_0[stackIndex] = 'LayoutComposite.java:' + '89' , dynamicCast(this$static.widget, 182)).children.size_0 || index < 0 || index == this$static.visibleStack) {
    $stackDepth_0 = stackIndex - 1;
    return;
  }
...
function onClick_7(event_0){
  ...
  if (w != null && ($location_0[stackIndex] = 'Cast.java:' + '76' , canCast(w.typeId$, 193))) {
    $location_0[stackIndex] = 'StackLayoutPanel.java:' + '78' , $showStack(this.this$0, ($location_0[stackIndex] = 'ComplexPanel.java:' + '44' , $indexOf_1(($location_0[stackIndex] = 'LayoutComposite.java:' + '89' , dynamicCast(this.this$0.widget, 182)).children, ($location_0[stackIndex] = 'LayoutPanel.java:' + '500' , $getDecoratorWidget(w)))) >> 1);
...
function $onAnimationComplete(this$static){
  ...
  for ($location_0[stackIndex] = 'StackLayoutPanel.java:' + '91' , i = 0 , ($location_0[stackIndex] = 'StackLayoutPanel.java:' + '91' , n = ($location_0[stackIndex] = 'LayoutComposite.java:' + '89' , dynamicCast(this$static.this$0.widget, 182)).children.size_0); i < n; $location_0[stackIndex] = 'StackLayoutPanel.java:' + '91' , ++i) {
    $location_0[stackIndex] = 'StackLayoutPanel.java:' + '92' , w = ($location_0[stackIndex] = 'LayoutPanel.java:' + '490' , $getUnDecoratedWidget(($location_0[stackIndex] = 'ComplexPanel.java:' + '36' , $get_6(($location_0[stackIndex] = 'LayoutComposite.java:' + '89' , dynamicCast(this$static.this$0.widget, 182)).children, i))));
...
function $setBounds_0(this$static, x, y, width, height){
  ...
  $location_0[stackIndex] = 'Viewport.java:' + '115' , $clinit_425();
...
function $clinit_723(){
  ...
  $location_0[stackIndex] = 'Viewport.java:' + '42' , $clinit_723 = nullMethod;
  $clinit_43();
  $stackDepth_0 = stackIndex - 1;
}
...
function $Viewport$1(this$static, this$0){
  ...
  $location_0[stackIndex] = 'Viewport.java:' + '42' , $clinit_723();
  ...
  if (collapse) {
    if (widget == this$static.west || widget == this$static.east || widget == this$static.north || widget == this$static.south) {
      if (!layoutData.collapsedStateWidget) {
        ...
        if (layoutData.region == ($location_0[stackIndex] = 'BorderLayout.java:' + '199' , $clinit_780() , NORTH_0)) {
          imgBtn = ($location_0[stackIndex] = 'BorderLayout.java:' + '705' , $ImageButton(($location_0[stackIndex] = 'BorderLayout.java:' + '705' , new ImageButton), ($clinit_640() , ($location_0[stackIndex] = 'CaptionImages_generatedBundle.java:' + '29' , $clinit_642()) , toolCollapseDown_SINGLETON)));
          $location_0[stackIndex] = 'UIObject.java:' + '449' , setStyleName(imgBtn.element, 'NorthCollapsedImageButton', true);
          $location_0[stackIndex] = 'BorderLayout.java:' + '707' , $setHorizontalAlignment_0(imgBtn, ($location_0[stackIndex] = 'HasHorizontalAlignment.java:' + '74' , $clinit_380() , ALIGN_RIGHT));
        }
         else if (layoutData.region == EAST_0) {
          imgBtn = ($location_0[stackIndex] = 'BorderLayout.java:' + '709' , $ImageButton(($location_0[stackIndex] = 'BorderLayout.java:' + '709' , new ImageButton), ($clinit_640() , ($location_0[stackIndex] = 'CaptionImages_generatedBundle.java:' + '33' , $clinit_642()) , toolCollapseLeft_SINGLETON)));
          $location_0[stackIndex] = 'UIObject.java:' + '449' , setStyleName(imgBtn.element, 'EastCollapsedImageButton', true);
          $location_0[stackIndex] = 'BorderLayout.java:' + '711' , $setVerticalAlignment_0(imgBtn, ($location_0[stackIndex] = 'HasVerticalAlignment.java:' + '73' , $clinit_385() , ALIGN_TOP));
        }
         else if (layoutData.region == SOUTH_0) {
          imgBtn = ($location_0[stackIndex] = 'BorderLayout.java:' + '713' , $ImageButton(($location_0[stackIndex] = 'BorderLayout.java:' + '713' , new ImageButton), ($clinit_640() , ($location_0[stackIndex] = 'CaptionImages_generatedBundle.java:' + '41' , $clinit_642()) , toolCollapseUp_SINGLETON)));
          $location_0[stackIndex] = 'UIObject.java:' + '449' , setStyleName(imgBtn.element, 'SouthCollapsedImageButton', true);
          $location_0[stackIndex] = 'BorderLayout.java:' + '715' , $setHorizontalAlignment_0(imgBtn, ($location_0[stackIndex] = 'HasHorizontalAlignment.java:' + '74' , $clinit_380() , ALIGN_RIGHT));
        }
         else if (layoutData.region == WEST_0) {
          imgBtn = ($location_0[stackIndex] = 'BorderLayout.java:' + '717' , $ImageButton(($location_0[stackIndex] = 'BorderLayout.java:' + '717' , new ImageButton), ($clinit_640() , ($location_0[stackIndex] = 'CaptionImages_generatedBundle.java:' + '37' , $clinit_642()) , toolCollapseRight_SINGLETON)));
          $location_0[stackIndex] = 'UIObject.java:' + '449' , setStyleName(imgBtn.element, 'WestCollapsedImageButton', true);
          $location_0[stackIndex] = 'BorderLayout.java:' + '719' , $setVerticalAlignment_0(imgBtn, ($location_0[stackIndex] = 'HasVerticalAlignment.java:' + '73' , $clinit_385() , ALIGN_TOP));
        }
        if (!imgBtn) {
          $stackDepth_0 = stackIndex - 1;
          return;
        }
        $location_0[stackIndex] = 'ImageButton.java:' + '58' , $addDomHandler(imgBtn, $BorderLayout$1(($location_0[stackIndex] = 'BorderLayout.java:' + '724' , new BorderLayout$1), layoutPanel, widget), ($location_0[stackIndex] = 'ImageButton.java:' + '58' , $clinit_126() , ($location_0[stackIndex] = 'ClickEvent.java:' + '27' , $clinit_126()) , TYPE_1));
...
function getClass_502(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_502;
  $stackDepth_0 = stackIndex - 1;
...
function getClass_610(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_610;
  $stackDepth_0 = stackIndex - 1;
...
function $WSLaunchButton(this$static, resource, name_0){
  ...
  $LayoutPanel_1(this$static, ($location_0[stackIndex] = 'WSLaunchButton.java:' + '45' , $BoxLayout_1(($location_0[stackIndex] = 'WSLaunchButton.java:' + '45' , new BoxLayout), ($location_0[stackIndex] = 'BoxLayout.java:' + '170' , $clinit_787() , VERTICAL))));
  ...
  $add_26(this$static, html, ($location_0[stackIndex] = 'WSLaunchButton.java:' + '53' , $BoxLayoutData_4(($location_0[stackIndex] = 'WSLaunchButton.java:' + '53' , new BoxLayoutData), ($location_0[stackIndex] = 'BoxLayoutData.java:' + '30' , $clinit_789() , VERTICAL_0))));
...
function getClass_854(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_854;
  $stackDepth_0 = stackIndex - 1;
...
function $createLogPanel(parent_0){
  ...
  collapseBtn = ($location_0[stackIndex] = 'Application.java:' + '319' , $ImageButton(($location_0[stackIndex] = 'Application.java:' + '319' , new ImageButton), ($clinit_640() , ($location_0[stackIndex] = 'CaptionImages_generatedBundle.java:' + '29' , $clinit_642()) , toolCollapseDown_SINGLETON)));
  $location_0[stackIndex] = 'Application.java:' + '320' , $add_17(messagePanel.caption, collapseBtn, ($location_0[stackIndex] = 'Caption.java:' + '61' , $clinit_641() , RIGHT));
  $location_0[stackIndex] = 'ImageButton.java:' + '58' , $addDomHandler(collapseBtn, $Application$6(($location_0[stackIndex] = 'Application.java:' + '322' , new Application$6), parent_0, messagePanel), ($location_0[stackIndex] = 'ImageButton.java:' + '58' , $clinit_126() , ($location_0[stackIndex] = 'ClickEvent.java:' + '27' , $clinit_126()) , TYPE_1));
  $stackDepth_0 = stackIndex - 1;
  return messagePanel;
}
...
function $initializeUI(this$static){
  ...
  $add_26(this$static.mainLayout, this$static.menu, ($location_0[stackIndex] = 'Application.java:' + '203' , $BorderLayoutData_4(($location_0[stackIndex] = 'Application.java:' + '203' , new BorderLayoutData), ($location_0[stackIndex] = 'BorderLayout.java:' + '199' , $clinit_780() , WEST_0), '180 px', false)));
  ...
  $location_0[stackIndex] = 'WorkspaceBuilder.java:' + '40' , $clinit_1239();
  ...
  $location_0[stackIndex] = 'Application.java:' + '220' , $clinit_425();
...
function execute_41(){
  ...
  if (null == initialToolSet) {
    $location_0[stackIndex] = 'Application.java:' + '244' , preferedTool = ($location_0[stackIndex] = 'CookiePreferences.java:' + '39' , getCookie('workspace.default.tool')) != null?($location_0[stackIndex] = 'Application.java:' + '245' , $clinit_1219() , 'ToolSet_' + ($location_0[stackIndex] = 'Workspace.java:' + '266' , $replace_0(($location_0[stackIndex] = 'CookiePreferences.java:' + '39' , getCookie('workspace.default.tool')), ' ', '_'))):null;
    if (preferedTool != null && !!($location_0[stackIndex] = 'Workspace.java:' + '158' , $findToolSet(this.this$0.workspace, preferedTool))) {
      ...
      $location_0[stackIndex] = 'Application.java:' + '254' , toolSets = ($location_0[stackIndex] = 'Workspace.java:' + '61' , $clinit_1219() , toolSets_0);
...
function $Menu(this$static){
  ...
  $LayoutPanel_1(this$static, ($location_0[stackIndex] = 'Menu.java:' + '40' , $BoxLayout_1(($location_0[stackIndex] = 'Menu.java:' + '40' , new BoxLayout), ($location_0[stackIndex] = 'BoxLayout.java:' + '170' , $clinit_787() , VERTICAL))));
  ...
  $add_26(this$static, this$static.stack, ($location_0[stackIndex] = 'Menu.java:' + '46' , $BoxLayoutData_5(($location_0[stackIndex] = 'Menu.java:' + '46' , new BoxLayoutData), ($location_0[stackIndex] = 'BoxLayoutData.java:' + '30' , $clinit_789() , BOTH), true)));
  $stackDepth_0 = stackIndex - 1;
  return this$static;
}
...
function $toggle(this$static, id){
  ...
  $showStack(this$static.stack, dynamicCast(($location_0[stackIndex] = 'Menu.java:' + '66' , $get_7(this$static.toolsetIndex, id)), 82).value_0);
...
_.typeId$ = 594;
_.this$0 = null;
function $clinit_1218(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_1218;
  $location_0[stackIndex] = 'Viewport.java:' + '42' , $clinit_1218 = nullMethod;
  $clinit_43();
  $stackDepth_0 = stackIndex - 1;
}
...
function $Viewport$1$1(this$static, this$1){
  ...
  $location_0[stackIndex] = 'Viewport.java:' + '42' , $clinit_1218();
...
function $Workspace(this$static, menu){
  ...
  $location_0[stackIndex] = 'Workspace.java:' + '76' , $clinit_1219();
  ...
  $location_0[stackIndex] = 'Workspace.java:' + '82' , $clinit_1082();
...
function $addToolSet(this$static, toolSet){
  ...
  $location_0[stackIndex] = 'Workspace.java:' + '153' , deck.index_0 = ($location_0[stackIndex] = 'LayoutComposite.java:' + '89' , dynamicCast(this$static.widget, 182)).children.size_0;
...
function $findToolSet(this$static, id){
  ...
  for ($location_0[stackIndex] = 'Workspace.java:' + '242' , i = 0; i < ($location_0[stackIndex] = 'LayoutComposite.java:' + '89' , dynamicCast(this$static.widget, 182)).children.size_0; $location_0[stackIndex] = 'Workspace.java:' + '242' , ++i) {
    deck = ($location_0[stackIndex] = 'Workspace.java:' + '243' , dynamicCast(($location_0[stackIndex] = 'LayoutPanel.java:' + '490' , $getUnDecoratedWidget(($location_0[stackIndex] = 'ComplexPanel.java:' + '36' , $get_6(($location_0[stackIndex] = 'LayoutComposite.java:' + '89' , dynamicCast(this$static.widget, 182)).children, i)))), 284));
...
function $recordHistory(toolsetId, toolId){
  ...
  $location_0[stackIndex] = 'History.java:' + '171' , $clinit_312();
...
function $showToolSet(this$static, toolSetId, toolId){
  ...
  for ($location_0[stackIndex] = 'Workspace.java:' + '192' , i = 0; i < ($location_0[stackIndex] = 'LayoutComposite.java:' + '89' , dynamicCast(deck.tabLayout.deck.widget, 182)).children.size_0; $location_0[stackIndex] = 'Workspace.java:' + '192' , ++i) {
  ...
  if (!isOpen) {
    ...
    $location_0[stackIndex] = 'Workspace.java:' + '207' , resource = dynamicCast(($location_0[stackIndex] = 'ResourceFactoryImpl.java:' + '27' , $get_7(resourceFactory.mapping, selectedTool.name_0)), 285)?dynamicCast($get_7(resourceFactory.mapping, selectedTool.name_0), 285):($location_0[stackIndex] = 'Workspace.java:' + '208' , $application());
    ...
    $location_0[stackIndex] = 'ScrollTabBar.java:' + '477' , $selectTab(deck.tabLayout.tabBar.tabBar, ($location_0[stackIndex] = 'LayoutComposite.java:' + '89' , dynamicCast(deck.tabLayout.deck.widget, 182)).children.size_0 - 1);
...
function createInstance(menu){
  ...
  $location_0[stackIndex] = 'Workspace.java:' + '65' , $clinit_1219();
...
function splitHistoryToken(tokenString){
  ...
  $location_0[stackIndex] = 'Workspace.java:' + '135' , $clinit_1219();
  var s, token;
...
function callback_13(message){
  ...
  switch (($location_0[stackIndex] = 'LayoutCommands.java:' + '20' , $clinit_1258() , ($location_0[stackIndex] = 'LayoutCommands.java:' + '20' , valueOf_0(enum$map_6, ($location_0[stackIndex] = 'Workspace.java:' + '86' , message.getCommandType())))).ordinal) {
    case 7:
      toolsetId = dynamicCast(($location_0[stackIndex] = 'Workspace.java:' + '88' , message.get_2(Ljava_lang_String_2_classLit, ($location_0[stackIndex] = 'LayoutParts.java:' + '22' , $clinit_1259() , TOOLSET))), 1);
...
_.id_0 = null;
_.name_0 = null;
function $clinit_1239(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_1239;
  $location_0[stackIndex] = 'WorkspaceBuilder.java:' + '40' , $clinit_1239 = nullMethod;
...
function $addTool(group, name_0, component){
  ...
  $location_0[stackIndex] = 'WorkspaceBuilder.java:' + '88' , imgres = dynamicCast(($location_0[stackIndex] = 'ResourceFactoryImpl.java:' + '27' , $get_7(resourceFactory.mapping, name_0)), 285);
  ...
  dynamicCast(($location_0[stackIndex] = 'WorkspaceBuilder.java:' + '76' , $get_7(toBeLoadedGroups, group)), 170).add_0(provider);
  $stackDepth_0 = stackIndex - 1;
}
...
function $build(workspace){
  ...
  if (preferredGroupOrdering.size_0 != 0) {
    for ($location_0[stackIndex] = 'WorkspaceBuilder.java:' + '150' , group$iterator = $AbstractList$IteratorImpl(($location_0[stackIndex] = 'AbstractList.java:' + '278' , new AbstractList$IteratorImpl), preferredGroupOrdering); group$iterator.i < ($location_0[stackIndex] = 'AbstractList.java:' + '38' , group$iterator.this$0.size_1());) {
      ...
      if ($location_0[stackIndex] = 'WorkspaceBuilder.java:' + '162' , $containsKey_0(toBeLoadedGroups, group)) {
        ...
        for (provider$iterator = dynamicCast(($location_0[stackIndex] = 'WorkspaceBuilder.java:' + '166' , $get_7(toBeLoadedGroups, group)), 170).iterator_0(); $location_0[stackIndex] = 'WorkspaceBuilder.java:' + '166' , provider$iterator.hasNext();) {
  ...
  for ($location_0[stackIndex] = 'WorkspaceBuilder.java:' + '201' , group$iterator = (outerIter = ($location_0[stackIndex] = 'AbstractMap.java:' + '107' , ($location_0[stackIndex] = 'WorkspaceBuilder.java:' + '201' , $keySet_1(toBeLoadedGroups)).val$entrySet.iterator_0()) , $AbstractMap$1$1(($location_0[stackIndex] = 'AbstractMap.java:' + '108' , new AbstractMap$1$1), outerIter)); $location_0[stackIndex] = 'AbstractMap.java:' + '110' , group$iterator.val$outerIter.hasNext();) {
    ...
    for (provider$iterator = dynamicCast(($location_0[stackIndex] = 'WorkspaceBuilder.java:' + '205' , $get_7(toBeLoadedGroups, group)), 170).iterator_0(); $location_0[stackIndex] = 'WorkspaceBuilder.java:' + '205' , provider$iterator.hasNext();) {
      provider = dynamicCast(provider$iterator.next_0(), 286);
...
function getAllProvidedTools(){
  ...
  toolArray = ($location_0[stackIndex] = 'WorkspaceBuilder.java:' + '176' , initDim(_3Lorg_jboss_errai_workspaces_client_api_Tool_2_classLit, 719, 120, this.val$toBeRendered.size_0, 0));
...
function getAllProvidedTools_0(){
  ...
  toolArray = ($location_0[stackIndex] = 'WorkspaceBuilder.java:' + '216' , initDim(_3Lorg_jboss_errai_workspaces_client_api_Tool_2_classLit, 719, 120, this.val$toBeRendered.size_0, 0));
...
function $clinit_1259(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_1259;
  $location_0[stackIndex] = 'LayoutParts.java:' + '20' , $clinit_1259 = nullMethod;
...
function $LayoutParts(this$static, enum$name, enum$ordinal){
  ...
  $location_0[stackIndex] = 'LayoutParts.java:' + '20' , $clinit_1259();
...
function getClass_901(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_901;
  $stackDepth_0 = stackIndex - 1;
...
function values_36(){
  ...
  $location_0[stackIndex] = 'LayoutParts.java:' + '20' , $clinit_1259();
  returnTemp = initValues(_3Lorg_jboss_errai_workspaces_client_protocols_LayoutParts_2_classLit, 722, 123, [CommandType_0, ComponentID, InstanceID, Name_1, MultipleInstances, IconURI, Subject_0, DOMID, RespondWithCommand, NestedData, Width, Height, SizeHintsSubject, InitSubject, TOOLSET, TOOL]);
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function $clinit_1261(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_1261;
  $location_0[stackIndex] = 'WorkspaceLogger.java:' + '44' , $clinit_1261 = nullMethod;
  levels = ($location_0[stackIndex] = 'WorkspaceLogger.java:' + '48' , initValues(_3I_classLit, 669, -1, [5000, 10000, 20000, 30000, 40000, 50000, 2147483647]));
  $stackDepth_0 = stackIndex - 1;
}
...
function $WorkspaceLogger(this$static, notification){
  ...
  $location_0[stackIndex] = 'WorkspaceLogger.java:' + '77' , $clinit_1261();
  ...
  $add_26(this$static.logDockPanel, headerPanel, ($location_0[stackIndex] = 'WorkspaceLogger.java:' + '89' , $BorderLayoutData_4(($location_0[stackIndex] = 'WorkspaceLogger.java:' + '89' , new BorderLayoutData), ($location_0[stackIndex] = 'BorderLayout.java:' + '199' , $clinit_780() , NORTH_0), '30 px', false)));
...
function $makeHeader(this$static){
  ...
  this$static.levelButtons = ($location_0[stackIndex] = 'WorkspaceLogger.java:' + '233' , initDim(_3Lcom_google_gwt_user_client_ui_Button_2_classLit, 655, 62, levels.length, 0));
  for ($location_0[stackIndex] = 'WorkspaceLogger.java:' + '234' , i = 0; i < levels.length; $location_0[stackIndex] = 'WorkspaceLogger.java:' + '234' , ++i) {
    ...
    $location_0[stackIndex] = 'FocusWidget.java:' + '91' , $addDomHandler(($location_0[stackIndex] = 'WorkspaceLogger.java:' + '238' , this$static.levelButtons[i]), $WorkspaceLogger$2(new WorkspaceLogger$2, level), ($location_0[stackIndex] = 'FocusWidget.java:' + '91' , $clinit_126() , ($location_0[stackIndex] = 'ClickEvent.java:' + '27' , $clinit_126()) , TYPE_1));
  }
  ...
  $location_0[stackIndex] = 'FocusWidget.java:' + '91' , $addDomHandler(clearButton, ($location_0[stackIndex] = 'WorkspaceLogger.java:' + '249' , new WorkspaceLogger$3), ($location_0[stackIndex] = 'FocusWidget.java:' + '91' , $clinit_126() , ($location_0[stackIndex] = 'ClickEvent.java:' + '27' , $clinit_126()) , TYPE_1));
...
_.timer = null;
var levels;
function $clinit_1262(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_1262;
  $location_0[stackIndex] = 'WorkspaceLogger.java:' + '96' , $clinit_1262 = nullMethod;
  $clinit_43();
  $stackDepth_0 = stackIndex - 1;
}
...
function $WorkspaceLogger$1(this$static, this$0){
  ...
  $location_0[stackIndex] = 'WorkspaceLogger.java:' + '96' , $clinit_1262();
  this$static.this$0 = this$0;
  $stackDepth_0 = stackIndex - 1;
  return this$static;
}
...
function $WSToolSetLauncher(this$static, id, toolSet){
  ...
  $LayoutPanel_1(this$static, ($location_0[stackIndex] = 'WSToolSetLauncher.java:' + '52' , $BoxLayout_1(($location_0[stackIndex] = 'WSToolSetLauncher.java:' + '52' , new BoxLayout), ($location_0[stackIndex] = 'BoxLayout.java:' + '170' , $clinit_787() , VERTICAL))));
...
function $addLink(this$static, name_0, tool){
  ...
  $location_0[stackIndex] = 'WSToolSetLauncher.java:' + '79' , resource = dynamicCast(($location_0[stackIndex] = 'ResourceFactoryImpl.java:' + '27' , $get_7(resourceFactory.mapping, tool.name_0)), 285)?dynamicCast($get_7(resourceFactory.mapping, tool.name_0), 285):($location_0[stackIndex] = 'WSToolSetLauncher.java:' + '80' , $application());
  ...
  $add_26(this$static, button, ($location_0[stackIndex] = 'WSToolSetLauncher.java:' + '100' , $BoxLayoutData_4(($location_0[stackIndex] = 'WSToolSetLauncher.java:' + '100' , new BoxLayoutData), ($location_0[stackIndex] = 'BoxLayoutData.java:' + '30' , $clinit_789() , HORIZONTAL_0))));
  $stackDepth_0 = stackIndex - 1;
}
