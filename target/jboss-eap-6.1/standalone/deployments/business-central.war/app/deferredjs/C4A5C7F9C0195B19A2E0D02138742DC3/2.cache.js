...
function onLoad_0(){
  ...
  instance_3 = ($location_0[stackIndex] = 'AsyncLoader2.java:' + '5' , $clinit_259() , ($location_0[stackIndex] = 'AsyncLoader2.java:' + '22' , new AsyncLoader2));
...
function $provideWidget(this$static, callback){
  ...
  this$static.panel = $MosaicPanel_0(($location_0[stackIndex] = 'PreferencesView.java:' + '65' , new MosaicPanel), ($location_0[stackIndex] = 'PreferencesView.java:' + '65' , $BoxLayout_1(new BoxLayout, ($location_0[stackIndex] = 'BoxLayout.java:' + '170' , $clinit_787() , VERTICAL))));
  ...
  $add_26(this$static.panel, $HeaderLabel(($location_0[stackIndex] = 'PreferencesView.java:' + '68' , new HeaderLabel), 'User Preferences'), ($location_0[stackIndex] = 'PreferencesView.java:' + '68' , $BoxLayoutData_4(new BoxLayoutData, ($location_0[stackIndex] = 'BoxLayoutData.java:' + '30' , $clinit_789() , HORIZONTAL_0))));
  ...
  $location_0[stackIndex] = 'PreferencesView.java:' + '76' , toolsets = ($location_0[stackIndex] = 'PreferencesView.java:' + '77' , $clinit_1219() , ($location_0[stackIndex] = 'Workspace.java:' + '61' , $clinit_1219()) , toolSets_0);
  ...
  $location_0[stackIndex] = 'FocusWidget.java:' + '91' , $addDomHandler(multiBox, $PreferencesView$1(($location_0[stackIndex] = 'PreferencesView.java:' + '93' , new PreferencesView$1), multiBox, toolsets), ($location_0[stackIndex] = 'FocusWidget.java:' + '91' , $clinit_126() , ($location_0[stackIndex] = 'ClickEvent.java:' + '27' , $clinit_126()) , TYPE_1));
