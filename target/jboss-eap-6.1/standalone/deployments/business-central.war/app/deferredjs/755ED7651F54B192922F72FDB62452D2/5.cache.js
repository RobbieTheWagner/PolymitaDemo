...
function onLoad_3(){
  ...
  instance_6 = ($location_0[stackIndex] = 'AsyncLoader5.java:' + '5' , $clinit_274() , ($location_0[stackIndex] = 'AsyncLoader5.java:' + '22' , new AsyncLoader5));
...
function parseReportConfig(json){
  ...
  for ($location_0[stackIndex] = 'JSOParser.java:' + '157' , i = 0; i < rootModel.length; $location_0[stackIndex] = 'JSOParser.java:' + '157' , ++i) {
    ...
    for ($location_0[stackIndex] = 'JSOParser.java:' + '171' , x = 0; x < params.length; $location_0[stackIndex] = 'JSOParser.java:' + '171' , ++x) {
      ...
      pmd = ($location_0[stackIndex] = 'JSOParser.java:' + '178' , $ReportParameter(($location_0[stackIndex] = 'JSOParser.java:' + '178' , new ReportParameter), name_0, ($clinit_1089() , dynamicCast(($location_0[stackIndex] = 'ReportParameter.java:' + '29' , valueOf_0(enum$map_1, type)), 112))));
      $location_0[stackIndex] = 'ReportParameter.java:' + '82' , pmd.dataType = ($location_0[stackIndex] = 'JSOParser.java:' + '179' , $clinit_1088() , dynamicCast(($location_0[stackIndex] = 'ReportParameter.java:' + '30' , valueOf_0(enum$map_0, dataType)), 111));
...
function execute_38(controller, object){
  ...
  builder = ($location_0[stackIndex] = 'RenderReportAction.java:' + '58' , $RequestBuilder(($location_0[stackIndex] = 'RenderReportAction.java:' + '58' , new RequestBuilder), ($location_0[stackIndex] = 'RequestBuilder.java:' + '70' , $clinit_211() , POST), url));
  $location_0[stackIndex] = 'Log.java:' + '101' , $clinit_24();
  $location_0[stackIndex] = 'Log.java:' + '150' , $debug(impl, POST + ': ' + url, null);
  view = ($location_0[stackIndex] = 'RenderReportAction.java:' + '61' , dynamicCast(dynamicCast(($location_0[stackIndex] = 'Controller.java:' + '67' , $get_8(controller.views, ($location_0[stackIndex] = 'ReportLaunchPadView.java:' + '59' , $clinit_1019() , ID_21))), 167), 246));
...
function $ReportLaunchPadView(this$static){
  ...
  $location_0[stackIndex] = 'ListBox.java:' + '104' , $addDomHandler(this$static.dropBox, $ReportLaunchPadView$1(($location_0[stackIndex] = 'ReportLaunchPadView.java:' + '87' , new ReportLaunchPadView$1), this$static), ($location_0[stackIndex] = 'ListBox.java:' + '104' , $clinit_127() , ($location_0[stackIndex] = 'ChangeEvent.java:' + '27' , $clinit_127()) , TYPE_0));
...
function $selectForm(this$static, reportTitle){
  ...
  $location_0[stackIndex] = 'DOMImplTrident.java:' + '260' , ($location_0[stackIndex] = 'Element.java:' + '621' , $clinit_82() , this$static.description.element).innerText = current.description || '';
  $add_25(this$static.inputPanel, dynamicCast(($location_0[stackIndex] = 'ReportLaunchPadView.java:' + '186' , $get_8(this$static.forms, reportTitle)), 2));
...
function fieldValues2PostParams(values){
  ...
  while ($location_0[stackIndex] = 'AbstractMap.java:' + '110' , keys.val$outerIter.hasNext()) {
    ...
    $append_4(($location_0[stackIndex] = 'ReportLaunchPadView.java:' + '221' , $append_4(($location_0[stackIndex] = 'StringBuffer.java:' + '115' , $append_0(sb.data_0, key) , sb), '=')), ($location_0[stackIndex] = 'ReportLaunchPadView.java:' + '221' , dynamicCast(key == null?values.nullSlot:key != null?($location_0[stackIndex] = 'AbstractHashMap.java:' + '382' , values.stringMap[':' + key]):($location_0[stackIndex] = 'AbstractHashMap.java:' + '240' , $getHashValue(values, key, ~~($location_0[stackIndex] = 'String.java:' + '485' , getHashCode_0(key)))), 1)));
    $location_0[stackIndex] = 'StringBuffer.java:' + '115' , $append_0(sb.data_0, ';');
  }
  $location_0[stackIndex] = 'StringBuffer.java:' + '266' , $toString_1(sb.data_0);
  returnTemp = $toString_1(sb.data_0);
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function $onSumbit(this$static, paramValues){
  ...
  if (valid) {
    ...
    $location_0[stackIndex] = 'ReportLaunchPadView.java:' + '141' , $clinit_685();
    $location_0[stackIndex] = 'MessageBox.java:' + '111' , alert_2(($location_0[stackIndex] = 'MessageBox.java:' + '60' , $clinit_694() , ALERT), 'Report Parameters', 'Please provide the required input parameters');
  }
  $stackDepth_0 = stackIndex - 1;
}
...
function $createForm_0(this$static, reportRef, callback){
  ...
  createBtn = ($location_0[stackIndex] = 'ReportParameterForm.java:' + '72' , $Button_1(($location_0[stackIndex] = 'ReportParameterForm.java:' + '72' , new Button), 'Create Report', $ReportParameterForm$1(($location_0[stackIndex] = 'ReportParameterForm.java:' + '73' , new ReportParameterForm$1), this$static, reportRef, callback)));
  ...
  for ($location_0[stackIndex] = 'ReportParameterForm.java:' + '94' , reportParam$iterator = ($location_0[stackIndex] = 'AbstractList.java:' + '291' , $listIterator(reportRef.parameterMetaData, 0)); reportParam$iterator.currentNode != reportParam$iterator.this$0.header;) {
    ...
    prefValue = dynamicCast(($location_0[stackIndex] = 'ReportParameterForm.java:' + '100' , $get_8(preferenceValues, reportParam.name_0)), 1);
  ...
  !hasParameters && ($location_0[stackIndex] = 'ReportParameterForm.java:' + '128' , $add_26(form, $HTML_0(($location_0[stackIndex] = 'ReportParameterForm.java:' + '128' , new HTML), "This report doesn't require any paramters."), ($location_0[stackIndex] = 'ReportParameterForm.java:' + '129' , $GridLayoutData_2(($location_0[stackIndex] = 'ReportParameterForm.java:' + '129' , new GridLayoutData), 2, 1, ($location_0[stackIndex] = 'HasHorizontalAlignment.java:' + '62' , $clinit_388() , ALIGN_CENTER), ($location_0[stackIndex] = 'HasVerticalAlignment.java:' + '73' , $clinit_393() , ALIGN_TOP)))));
  $add_25(form, $HTML_0(($location_0[stackIndex] = 'ReportParameterForm.java:' + '133' , new HTML), ''));
  $add_26(form, createBtn, ($location_0[stackIndex] = 'ReportParameterForm.java:' + '134' , $GridLayoutData_0(($location_0[stackIndex] = 'ReportParameterForm.java:' + '134' , new GridLayoutData), ($location_0[stackIndex] = 'HasHorizontalAlignment.java:' + '74' , $clinit_388() , ALIGN_RIGHT), ($location_0[stackIndex] = 'HasVerticalAlignment.java:' + '61' , $clinit_393() , ALIGN_BOTTOM))));
  $stackDepth_0 = stackIndex - 1;
  return form;
}
...
function $writePrefs(values, reportRef){
  ...
  for ($location_0[stackIndex] = 'ReportParameterForm.java:' + '145' , key$iterator = (outerIter = ($location_0[stackIndex] = 'AbstractMap.java:' + '107' , (entrySet = ($location_0[stackIndex] = 'AbstractMap.java:' + '98' , values.entrySet_0()) , $AbstractMap$1(($location_0[stackIndex] = 'AbstractMap.java:' + '99' , new AbstractMap$1), values, entrySet)).val$entrySet.iterator_0()) , $AbstractMap$1$1(($location_0[stackIndex] = 'AbstractMap.java:' + '108' , new AbstractMap$1$1), outerIter)); $location_0[stackIndex] = 'AbstractMap.java:' + '110' , key$iterator.val$outerIter.hasNext();) {
    ...
    $append_4(($location_0[stackIndex] = 'ReportParameterForm.java:' + '147' , $append_4(($location_0[stackIndex] = 'StringBuffer.java:' + '115' , $append_0(sb.data_0, key) , sb), '=')), ($location_0[stackIndex] = 'ReportParameterForm.java:' + '147' , dynamicCast(key == null?values.nullSlot:key != null?($location_0[stackIndex] = 'AbstractHashMap.java:' + '382' , values.stringMap[':' + key]):($location_0[stackIndex] = 'AbstractHashMap.java:' + '240' , $getHashValue(values, key, ~~($location_0[stackIndex] = 'String.java:' + '485' , getHashCode_0(key)))), 1)));
    i < ($location_0[stackIndex] = 'AbstractMap.java:' + '126' , (entrySet_0 = ($location_0[stackIndex] = 'AbstractMap.java:' + '98' , values.entrySet_0()) , $AbstractMap$1(($location_0[stackIndex] = 'AbstractMap.java:' + '99' , new AbstractMap$1), values, entrySet_0)).val$entrySet.size_1()) && ($location_0[stackIndex] = 'StringBuffer.java:' + '115' , $append_0(sb.data_0, ','));
    $location_0[stackIndex] = 'ReportParameterForm.java:' + '150' , ++i;
  }
  $location_0[stackIndex] = 'ReportParameterForm.java:' + '154' , $set_5(prefKey, ($location_0[stackIndex] = 'StringBuffer.java:' + '266' , $toString_1(sb.data_0)));
  $stackDepth_0 = stackIndex - 1;
}
...
function handleSuccessfulResponse_11(controller, event_0, response){
  ...
  view = ($location_0[stackIndex] = 'UpdateReportConfigAction.java:' + '76' , dynamicCast(dynamicCast(($location_0[stackIndex] = 'Controller.java:' + '67' , $get_8(controller.views, ($location_0[stackIndex] = 'ReportView.java:' + '44' , $clinit_1029() , ID_22))), 167), 250));
...
function handleSuccessfulResponse_12(controller, event_0, response){
  ...
  $location_0[stackIndex] = 'UpdateSearchDefinitionsAction.java:' + '65' , throwClassCastExceptionUnlessNull(dynamicCast(($location_0[stackIndex] = 'Controller.java:' + '67' , $get_8(controller.views, target)), 167));
