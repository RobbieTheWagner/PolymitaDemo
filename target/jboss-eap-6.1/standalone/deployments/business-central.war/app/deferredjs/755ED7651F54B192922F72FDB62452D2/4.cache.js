...
function handlePostError_0(controller, event_0){
  ...
  view = ($location_0[stackIndex] = 'DeleteInstanceAction.java:' + '86' , dynamicCast(dynamicCast(($location_0[stackIndex] = 'Controller.java:' + '67' , $get_8(controller.views, ($location_0[stackIndex] = 'InstanceListView.java:' + '75' , $clinit_979() , ID_10))), 167), 234));
  ...
  if (diagramUrl != null && !($location_0[stackIndex] = 'InstanceDetailView.java:' + '156' , $equals_4(diagramUrl, ''))) {
    ...
    if (selection) {
      if (selection.lifecycle.current == ($location_0[stackIndex] = 'ProcessInstanceRef.java:' + '45' , $clinit_950() , ENDED)) {
        $location_0[stackIndex] = 'InstanceDetailView.java:' + '162' , $clinit_685();
    ...
    $location_0[stackIndex] = 'InstanceDetailView.java:' + '179' , $clinit_685();
    $location_0[stackIndex] = 'MessageBox.java:' + '111' , alert_2(($location_0[stackIndex] = 'MessageBox.java:' + '60' , $clinit_694() , ALERT), 'Incomplete deployment', 'No diagram associated with process');
  }
  $stackDepth_0 = stackIndex - 1;
}
...
function $createSignalWindow(this$static){
  ...
  $location_0[stackIndex] = 'FocusWidget.java:' + '103' , $addDomHandler(this$static.signalRef, $InstanceListView$11(($location_0[stackIndex] = 'InstanceListView.java:' + '669' , new InstanceListView$11), this$static), ($location_0[stackIndex] = 'FocusWidget.java:' + '103' , $clinit_135() , ($location_0[stackIndex] = 'FocusEvent.java:' + '27' , $clinit_135()) , TYPE_3));
...
function onClick_21(clickEvent){
  ...
  if ($location_0[stackIndex] = 'InstanceListView.java:' + '287' , $getSelection(this.this$0)) {
    ...
    $location_0[stackIndex] = 'InstanceListView.java:' + '314' , $clinit_685();
...
function onClick_22(clickEvent){
  ...
  if ($location_0[stackIndex] = 'InstanceListView.java:' + '325' , $getSelection(this.this$0)) {
    ...
    $location_0[stackIndex] = 'InstanceListView.java:' + '358' , $clinit_685();
    $location_0[stackIndex] = 'MessageBox.java:' + '111' , alert_2(($location_0[stackIndex] = 'MessageBox.java:' + '60' , $clinit_694() , ALERT), 'Missing selection', 'Please select an instance');
  }
  $stackDepth_0 = stackIndex - 1;
}
  ...
  if (doIt) {
    try {
      ...
      if (instanceOf($e0, 8)) {
        ...
        $location_0[stackIndex] = 'MessageBox.java:' + '111' , alert_2(($location_0[stackIndex] = 'MessageBox.java:' + '60' , $clinit_694() , ALERT), 'Warning', ($location_0[stackIndex] = 'InstanceListView.java:' + '349' , e.getMessage()));
      }
       else 
        throw $e0;
    }
...
function onClick_23(clickEvent){
  ...
  if ($location_0[stackIndex] = 'InstanceListView.java:' + '369' , $getSelection(this.this$0)) {
    ...
    $location_0[stackIndex] = 'InstanceListView.java:' + '375' , $clinit_685();
    $location_0[stackIndex] = 'MessageBox.java:' + '111' , alert_2(($location_0[stackIndex] = 'MessageBox.java:' + '60' , $clinit_694() , ALERT), 'Missing selection', 'Please select an instance');
  }
  $stackDepth_0 = stackIndex - 1;
}
...
function onClick_24(clickEvent){
  ...
  if (selectedToken != -1 && ($location_0[stackIndex] = 'DOM.java:' + '760' , $getPropertyString(this.this$0.signalRef.element, 'value')).length > 0) {
    $location_0[stackIndex] = 'InstanceListView.java:' + '579' , $clinit_685();
    ...
    $location_0[stackIndex] = 'InstanceListView.java:' + '610' , $clinit_685();
...
function handleSuccessfulResponse_3(controller, event_0, response){
  ...
  if (inst.lifecycle.current == ($location_0[stackIndex] = 'ProcessInstanceRef.java:' + '45' , $clinit_950() , ENDED) || response.val$xmlHttpRequest.responseText.length == 0) {
    $location_0[stackIndex] = 'LoadActivityDiagramAction.java:' + '70' , $clinit_685();
    $location_0[stackIndex] = 'MessageBox.java:' + '111' , alert_2(($location_0[stackIndex] = 'MessageBox.java:' + '60' , $clinit_694() , ALERT), 'Info', 'Process is already completed');
    view = ($location_0[stackIndex] = 'LoadActivityDiagramAction.java:' + '72' , dynamicCast(dynamicCast(($location_0[stackIndex] = 'Controller.java:' + '67' , $get_8(controller.views, ($location_0[stackIndex] = 'InstanceListView.java:' + '75' , $clinit_979() , ID_10))), 167), 234));
    ...
    viewData = ($location_0[stackIndex] = 'LoadActivityDiagramAction.java:' + '78' , dynamicCast(dynamicCast(($location_0[stackIndex] = 'Controller.java:' + '67' , $get_8(controller.views, ($location_0[stackIndex] = 'InstanceDetailView.java:' + '58' , $clinit_973() , ID_9))), 167), 235));
    ...
    view = ($location_0[stackIndex] = 'LoadActivityDiagramAction.java:' + '83' , dynamicCast(dynamicCast(($location_0[stackIndex] = 'Controller.java:' + '67' , $get_8(controller.views, ($location_0[stackIndex] = 'ActivityDiagramView.java:' + '43' , $clinit_956() , ID_2))), 167), 240));
...
function handlePostError_1(controller, event_0){
  ...
  view = ($location_0[stackIndex] = 'StateChangeAction.java:' + '86' , dynamicCast(dynamicCast(($location_0[stackIndex] = 'Controller.java:' + '67' , $get_8(controller.views, ($location_0[stackIndex] = 'InstanceListView.java:' + '75' , $clinit_979() , ID_10))), 167), 234));
...
function handleError_2(url, t){
  ...
  $location_0[stackIndex] = 'ConsoleLog.java:' + '41' , $clinit_24();
  $location_0[stackIndex] = 'Log.java:' + '651' , $warn(impl, 'Server reported following warning: ' + message + ' for url ' + url, null);
  $location_0[stackIndex] = 'UpdateInstanceDataAction.java:' + '81' , $clinit_685();
  $location_0[stackIndex] = 'MessageBox.java:' + '111' , alert_2(($location_0[stackIndex] = 'MessageBox.java:' + '60' , $clinit_694() , ALERT), 'Status information', message);
  $stackDepth_0 = stackIndex - 1;
}
...
function handlePostError_2(controller, event_0){
  ...
  view = ($location_0[stackIndex] = 'UpdateInstanceDataAction.java:' + '87' , dynamicCast(dynamicCast(($location_0[stackIndex] = 'Controller.java:' + '67' , $get_8(controller.views, ($location_0[stackIndex] = 'InstanceListView.java:' + '75' , $clinit_979() , ID_10))), 167), 234));
...
function handleSuccessfulResponse_9(controller, event_0, response){
  ...
  viewData = ($location_0[stackIndex] = 'UpdateInstanceDataAction.java:' + '64' , dynamicCast(dynamicCast(($location_0[stackIndex] = 'Controller.java:' + '67' , $get_8(controller.views, ($location_0[stackIndex] = 'InstanceDetailView.java:' + '58' , $clinit_973() , ID_9))), 167), 235));
  ...
  $location_0[stackIndex] = 'UpdateInstanceDataAction.java:' + '69' , messageDom = ($location_0[stackIndex] = 'UpdateInstanceDataAction.java:' + '69' , $clinit_489() , ($location_0[stackIndex] = 'XMLParser.java:' + '47' , $parse(impl_1, xml)));
  view = ($location_0[stackIndex] = 'UpdateInstanceDataAction.java:' + '70' , dynamicCast(dynamicCast(($location_0[stackIndex] = 'Controller.java:' + '67' , $get_8(controller.views, ($location_0[stackIndex] = 'InstanceDataView.java:' + '48' , $clinit_970() , ID_8))), 167), 243));
