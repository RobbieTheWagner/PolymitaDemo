...
function onLoad_4(){
  ...
  instance_7 = ($location_0[stackIndex] = 'AsyncLoader6.java:' + '5' , $clinit_280() , ($location_0[stackIndex] = 'AsyncLoader6.java:' + '22' , new AsyncLoader6));
  $location_0[stackIndex] = 'AsyncLoader6.java:' + '23' , $fragmentHasLoaded(($location_0[stackIndex] = 'AsyncFragmentLoader.java:' + '335' , $clinit_60() , BROWSER_LOADER), 6);
...
function $AssignedTasksView(this$static){
  ...
  $location_0[stackIndex] = 'AssignedTasksView.java:' + '78' , $clinit_1037();
  this$static.dateFormat = $SimpleDateFormat(($location_0[stackIndex] = 'AssignedTasksView.java:' + '68' , new SimpleDateFormat));
  this$static.controller_0 = dynamicCast(($location_0[stackIndex] = 'AssignedTasksView.java:' + '80' , get_16(Lcom_mvc4g_client_Controller_2_classLit)), 167);
  dynamicCast(($location_0[stackIndex] = 'AssignedTasksView.java:' + '81' , get_16(Lorg_jboss_bpm_console_client_ApplicationContext_2_classLit)), 225);
  $stackDepth_0 = stackIndex - 1;
  return this$static;
}
...
function $provideWidget_5(this$static, callback){
  ...
  $add_26(this$static.panel, this$static.taskList, ($location_0[stackIndex] = 'AssignedTasksView.java:' + '90' , $BorderLayoutData_1(($location_0[stackIndex] = 'AssignedTasksView.java:' + '90' , new BorderLayoutData), ($location_0[stackIndex] = 'BorderLayout.java:' + '199' , $clinit_789() , CENTER_1))));
