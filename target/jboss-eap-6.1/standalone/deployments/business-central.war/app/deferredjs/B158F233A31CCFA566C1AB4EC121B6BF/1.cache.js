...
function onLoad(){
  ...
  instance_2 = ($location_0[stackIndex] = 'AsyncLoader1.java:' + '5' , $clinit_260() , ($location_0[stackIndex] = 'AsyncLoader1.java:' + '22' , new AsyncLoader1));
  $location_0[stackIndex] = 'AsyncLoader1.java:' + '23' , $fragmentHasLoaded(($location_0[stackIndex] = 'AsyncFragmentLoader.java:' + '335' , $clinit_60() , BROWSER_LOADER), 1);
...
function $onSuccess(this$static){
  ...
  $location_0[stackIndex] = 'SecurityService.java:' + '192' , dynamicCast(($location_0[stackIndex] = 'LoginView.java:' + '161' , get_16(Lorg_jboss_errai_bus_client_security_SecurityService_2_classLit)), 226).deferredNotification = false;
  $location_0[stackIndex] = 'AbstractMessageBuilder.java:' + '59' , $sendNowWith($with_0(($location_0[stackIndex] = 'LoginView.java:' + '163' , $with_0(($location_0[stackIndex] = 'LoginView.java:' + '163' , $toSubject_0($start(($location_0[stackIndex] = 'MessageBuilder.java:' + '40' , $AbstractMessageBuilder(($location_0[stackIndex] = 'MessageBuilder.java:' + '40' , new AbstractMessageBuilder), $JSONMessage(($location_0[stackIndex] = 'JSONMessage.java:' + '105' , new JSONMessage))))), 'AuthorizationListener')), ($location_0[stackIndex] = 'SecurityParts.java:' + '26' , $clinit_1156() , Name), this$static.this$3.this$2.this$1.this$0.auth.username)), Roles, roleString.impl.string).val$sendable.this$0.message_0, ($location_0[stackIndex] = 'LoginView.java:' + '169' , $clinit_1091() , ($location_0[stackIndex] = 'ErraiBus.java:' + '30' , $clinit_1091()) , bus_0));
  t = ($location_0[stackIndex] = 'LoginView.java:' + '172' , $clinit_904() , ($location_0[stackIndex] = 'Timer.java:' + '36' , $clinit_43()) , ($location_0[stackIndex] = 'LoginView.java:' + '172' , new LoginView$1$1$1$1$1));
...
function $clinit_904(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_904;
  $location_0[stackIndex] = 'LoginView.java:' + '172' , $clinit_904 = nullMethod;
  $clinit_43();
  $stackDepth_0 = stackIndex - 1;
}
