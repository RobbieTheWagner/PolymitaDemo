...
function onLoad_5(){
  ...
  instance_8 = ($location_0[stackIndex] = 'AsyncLoader7.java:' + '5' , $clinit_283() , ($location_0[stackIndex] = 'AsyncLoader7.java:' + '22' , new AsyncLoader7));
  $location_0[stackIndex] = 'AsyncLoader7.java:' + '23' , $fragmentHasLoaded(($location_0[stackIndex] = 'AsyncFragmentLoader.java:' + '335' , $clinit_61() , BROWSER_LOADER), 7);
...
function $OpenTasksView(this$static){
  ...
  $location_0[stackIndex] = 'OpenTasksView.java:' + '56' , $clinit_1059();
...
function $provideWidget_6(this$static, callback){
  ...
  $add_26(this$static.panel, this$static.taskList, ($location_0[stackIndex] = 'OpenTasksView.java:' + '117' , $BorderLayoutData_1(($location_0[stackIndex] = 'OpenTasksView.java:' + '117' , new BorderLayoutData), ($location_0[stackIndex] = 'BorderLayout.java:' + '199' , $clinit_795() , CENTER_1))));
