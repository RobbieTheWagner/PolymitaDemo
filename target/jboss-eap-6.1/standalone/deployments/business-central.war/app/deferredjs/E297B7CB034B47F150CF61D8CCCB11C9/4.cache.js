...
function handlePostError_0(controller, event_0){
  ...
  view = ($location_0[stackIndex] = 'DeleteInstanceAction.java:' + '86' , dynamicCast(dynamicCast(($location_0[stackIndex] = 'Controller.java:' + '67' , $get_7(controller.views, ($location_0[stackIndex] = 'InstanceListView.java:' + '75' , $clinit_981() , ID_10))), 168), 235));
  $location_0[stackIndex] = 'DeleteInstanceAction.java:' + '87' , def = view.currentDefinition;
  $handleEvent(controller, ($location_0[stackIndex] = 'DeleteInstanceAction.java:' + '90' , $Event(($location_0[stackIndex] = 'DeleteInstanceAction.java:' + '90' , new Event_0), ($location_0[stackIndex] = 'UpdateInstancesAction.java:' + '47' , $clinit_1012() , ID_19), def)));
  $stackDepth_0 = stackIndex - 1;
}
...
function $createDiagramWindow(this$static, inst){
  ...
  if (this$static.isRiftsawInstance) {
    ...
    $add_26(layout, header, ($location_0[stackIndex] = 'InstanceDetailView.java:' + '227' , $BoxLayoutData_4(($location_0[stackIndex] = 'InstanceDetailView.java:' + '227' , new BoxLayoutData), ($location_0[stackIndex] = 'BoxLayoutData.java:' + '30' , $clinit_800() , HORIZONTAL_0))));
    ...
    $handleEvent(this$static.controller, ($location_0[stackIndex] = 'InstanceDetailView.java:' + '266' , $Event(($location_0[stackIndex] = 'InstanceDetailView.java:' + '266' , new Event_0), ($location_0[stackIndex] = 'GetProcessInstanceEventsAction.java:' + '19' , $clinit_971() , ID_7), inst.id_0)));
  }
   else if (this$static.isjBPMInstance) {
    layout = $MosaicPanel_0(($location_0[stackIndex] = 'InstanceDetailView.java:' + '268' , new MosaicPanel), ($location_0[stackIndex] = 'InstanceDetailView.java:' + '268' , $BoxLayout_1(new BoxLayout, ($location_0[stackIndex] = 'BoxLayout.java:' + '170' , $clinit_798() , VERTICAL))));
    $location_0[stackIndex] = 'Element.java:' + '688' , layout.element['className'] = 'bpm-window-layout';
    $location_0[stackIndex] = 'LayoutPanel.java:' + '289' , setStyleAttribute_0(layout.element, 'padding', '5px');
    header = $Label_0(($location_0[stackIndex] = 'InstanceDetailView.java:' + '272' , new Label), 'Instance: ' + inst.id_0);
    $location_0[stackIndex] = 'Element.java:' + '688' , header.element['className'] = 'bpm-label-header';
    $add_26(layout, header, ($location_0[stackIndex] = 'InstanceDetailView.java:' + '274' , $BoxLayoutData_4(($location_0[stackIndex] = 'InstanceDetailView.java:' + '274' , new BoxLayoutData), ($location_0[stackIndex] = 'BoxLayoutData.java:' + '30' , $clinit_800() , HORIZONTAL_0))));
...
function setController_5(controller){
  ...
  $location_0[stackIndex] = 'InstanceDetailView.java:' + '327' , $addView(controller, ($location_0[stackIndex] = 'ActivityDiagramView.java:' + '43' , $clinit_958() , ID_2), this.diagramView);
  $location_0[stackIndex] = 'InstanceDetailView.java:' + '328' , $addView(controller, ($location_0[stackIndex] = 'InstanceDataView.java:' + '48' , $clinit_972() , ID_8), this.instanceDataView);
  $location_0[stackIndex] = 'Controller.java:' + '106' , $put_0(controller.actions, ($location_0[stackIndex] = 'LoadActivityDiagramAction.java:' + '45' , $clinit_998() , ID_11), $LoadActivityDiagramAction(($location_0[stackIndex] = 'InstanceDetailView.java:' + '329' , new LoadActivityDiagramAction)));
  ...
  $location_0[stackIndex] = 'Controller.java:' + '106' , $put_0(controller.actions, ($location_0[stackIndex] = 'UpdateInstanceDataAction.java:' + '44' , $clinit_1010() , ID_17), $UpdateInstanceDataAction(($location_0[stackIndex] = 'InstanceDetailView.java:' + '333' , new UpdateInstanceDataAction)));
  $stackDepth_0 = stackIndex - 1;
}
  ...
  if (diagramUrl != null && !($location_0[stackIndex] = 'InstanceDetailView.java:' + '156' , $equals_4(diagramUrl, ''))) {
    ...
    if (selection) {
      if (selection.lifecycle.current == ($location_0[stackIndex] = 'ProcessInstanceRef.java:' + '45' , $clinit_952() , ENDED)) {
        $location_0[stackIndex] = 'InstanceDetailView.java:' + '162' , $clinit_686();
        ...
        $location_0[stackIndex] = 'InstanceDetailView.java:' + '163' , $handleEvent(this.this$0.controller, ($location_0[stackIndex] = 'InstanceDetailView.java:' + '164' , $Event(($location_0[stackIndex] = 'InstanceDetailView.java:' + '164' , new Event_0), ($location_0[stackIndex] = 'UpdateInstancesAction.java:' + '47' , $clinit_1012() , ID_19), this.this$0.currentDefintion)));
      }
       else {
        $location_0[stackIndex] = 'InstanceDetailView.java:' + '171' , $handleEvent(this.this$0.controller, ($location_0[stackIndex] = 'InstanceDetailView.java:' + '172' , $Event(($location_0[stackIndex] = 'InstanceDetailView.java:' + '172' , new Event_0), ($location_0[stackIndex] = 'LoadActivityDiagramAction.java:' + '45' , $clinit_998() , ID_11), selection)));
      }
    }
  }
   else {
    $location_0[stackIndex] = 'InstanceDetailView.java:' + '179' , $clinit_686();
    $location_0[stackIndex] = 'MessageBox.java:' + '111' , alert_2(($location_0[stackIndex] = 'MessageBox.java:' + '60' , $clinit_695() , ALERT), 'Incomplete deployment', 'No diagram associated with process');
  }
  $stackDepth_0 = stackIndex - 1;
}
...
function onClick_18(clickEvent){
  ...
  !!this.this$0.currentInstance && ($location_0[stackIndex] = 'InstanceDetailView.java:' + '196' , $handleEvent(this.this$0.controller, ($location_0[stackIndex] = 'InstanceDetailView.java:' + '197' , $Event(($location_0[stackIndex] = 'InstanceDetailView.java:' + '197' , new Event_0), ($location_0[stackIndex] = 'UpdateInstanceDataAction.java:' + '44' , $clinit_1010() , ID_17), this.this$0.currentInstance.id_0))));
  $stackDepth_0 = stackIndex - 1;
}
...
function $createSignalWindow(this$static){
  ...
  (new ArrayList).array = ($location_0[stackIndex] = 'ArrayList.java:' + '64' , initDim(_3Ljava_lang_Object_2_classLit, 689, 0, 0, 0));
  layout = $MosaicPanel_0(($location_0[stackIndex] = 'InstanceListView.java:' + '559' , new MosaicPanel), ($location_0[stackIndex] = 'InstanceListView.java:' + '559' , $BoxLayout_1(new BoxLayout, ($location_0[stackIndex] = 'BoxLayout.java:' + '170' , $clinit_798() , VERTICAL))));
  $location_0[stackIndex] = 'Element.java:' + '688' , layout.element['className'] = 'bpm-window-layout';
  $location_0[stackIndex] = 'LayoutPanel.java:' + '289' , setStyleAttribute_0(layout.element, 'padding', '5px');
  ...
  $add_26(toolBox, toolBar, ($location_0[stackIndex] = 'InstanceListView.java:' + '634' , $BoxLayoutData_4(($location_0[stackIndex] = 'InstanceListView.java:' + '634' , new BoxLayoutData), ($location_0[stackIndex] = 'BoxLayoutData.java:' + '30' , $clinit_800() , HORIZONTAL_0))));
  ...
  $location_0[stackIndex] = 'FocusWidget.java:' + '103' , $addDomHandler(this$static.signalRef, $InstanceListView$11(($location_0[stackIndex] = 'InstanceListView.java:' + '669' , new InstanceListView$11), this$static), ($location_0[stackIndex] = 'FocusWidget.java:' + '103' , $clinit_138() , ($location_0[stackIndex] = 'FocusEvent.java:' + '27' , $clinit_138()) , TYPE_3));
...
function $initialize_1(this$static){
  ...
  if (!this$static.isInitialized) {
    ...
    $add_26(toolBox, toolBar, ($location_0[stackIndex] = 'InstanceListView.java:' + '396' , $BoxLayoutData_4(($location_0[stackIndex] = 'InstanceListView.java:' + '396' , new BoxLayoutData), ($location_0[stackIndex] = 'BoxLayoutData.java:' + '30' , $clinit_800() , HORIZONTAL_0))));
    ...
    $add_26(layout, this$static.instanceList, ($location_0[stackIndex] = 'InstanceListView.java:' + '425' , $BorderLayoutData_1(($location_0[stackIndex] = 'InstanceListView.java:' + '425' , new BorderLayoutData), ($location_0[stackIndex] = 'BorderLayout.java:' + '199' , $clinit_791() , CENTER_1))));
    detailsView = $InstanceDetailView(($location_0[stackIndex] = 'InstanceListView.java:' + '428' , new InstanceDetailView));
    $location_0[stackIndex] = 'InstanceListView.java:' + '429' , $addView(this$static.controller, ($location_0[stackIndex] = 'InstanceDetailView.java:' + '58' , $clinit_975() , ID_9), detailsView);
    $location_0[stackIndex] = 'Controller.java:' + '106' , $put_0(this$static.controller.actions, ($location_0[stackIndex] = 'UpdateInstanceDetailAction.java:' + '33' , $clinit_1011() , ID_18), ($location_0[stackIndex] = 'InstanceListView.java:' + '430' , new UpdateInstanceDetailAction));
    $location_0[stackIndex] = 'Controller.java:' + '106' , $put_0(this$static.controller.actions, ($location_0[stackIndex] = 'ClearInstancesAction.java:' + '32' , $clinit_959() , ID_3), ($location_0[stackIndex] = 'InstanceListView.java:' + '431' , new ClearInstancesAction));
    $location_0[stackIndex] = 'Controller.java:' + '106' , $put_0(this$static.controller.actions, ($location_0[stackIndex] = 'SignalExecutionAction.java:' + '42' , $clinit_1005() , ID_13), $SignalExecutionAction(($location_0[stackIndex] = 'InstanceListView.java:' + '432' , new SignalExecutionAction)));
...
function $renderUpdate(this$static){
  ...
  if (this$static.isInitialized) {
    ...
    $location_0[stackIndex] = 'InstanceListView.java:' + '494' , $handleEvent(this$static.controller, ($location_0[stackIndex] = 'InstanceListView.java:' + '495' , $Event(($location_0[stackIndex] = 'InstanceListView.java:' + '495' , new Event_0), ($location_0[stackIndex] = 'UpdateInstanceDetailAction.java:' + '33' , $clinit_1011() , ID_18), $InstanceEvent(($location_0[stackIndex] = 'InstanceListView.java:' + '496' , new InstanceEvent), this$static.currentDefinition, null))));
...
function onClick_21(clickEvent){
  ...
  if ($location_0[stackIndex] = 'InstanceListView.java:' + '287' , $getSelection(this.this$0)) {
    ...
    $location_0[stackIndex] = 'InstanceListView.java:' + '314' , $clinit_686();
...
function onResult_1(doIt){
  ...
  if (doIt) {
    ...
    $location_0[stackIndex] = 'InstanceListView.java:' + '299' , $setState_3(selection, ($location_0[stackIndex] = 'ProcessInstanceRef.java:' + '45' , $clinit_952() , ENDED));
    $location_0[stackIndex] = 'InstanceListView.java:' + '300' , $setEndResult(selection, ($location_0[stackIndex] = 'ProcessInstanceRef.java:' + '50' , $clinit_951() , OBSOLETE));
    $location_0[stackIndex] = 'InstanceListView.java:' + '301' , $handleEvent(this.this$1.this$0.controller, ($location_0[stackIndex] = 'InstanceListView.java:' + '302' , $Event(($location_0[stackIndex] = 'InstanceListView.java:' + '302' , new Event_0), ($location_0[stackIndex] = 'StateChangeAction.java:' + '44' , $clinit_1008() , ID_15), selection)));
  }
  $stackDepth_0 = stackIndex - 1;
}
...
function onClick_22(clickEvent){
  ...
  if ($location_0[stackIndex] = 'InstanceListView.java:' + '325' , $getSelection(this.this$0)) {
    ...
    $location_0[stackIndex] = 'InstanceListView.java:' + '358' , $clinit_686();
    $location_0[stackIndex] = 'MessageBox.java:' + '111' , alert_2(($location_0[stackIndex] = 'MessageBox.java:' + '60' , $clinit_695() , ALERT), 'Missing selection', 'Please select an instance');
  }
  $stackDepth_0 = stackIndex - 1;
}
...
function onResult_2(doIt){
  ...
  if (doIt) {
    try {
      ...
      $location_0[stackIndex] = 'InstanceListView.java:' + '339' , $setState_3(selection, ($location_0[stackIndex] = 'ProcessInstanceRef.java:' + '45' , $clinit_952() , ENDED));
      $location_0[stackIndex] = 'InstanceListView.java:' + '341' , $handleEvent(this.this$1.this$0.controller, ($location_0[stackIndex] = 'InstanceListView.java:' + '342' , $Event(($location_0[stackIndex] = 'InstanceListView.java:' + '342' , new Event_0), ($location_0[stackIndex] = 'DeleteInstanceAction.java:' + '42' , $clinit_970() , ID_6), selection)));
    }
     catch ($e0) {
      ...
      if (instanceOf($e0, 8)) {
        ...
        $location_0[stackIndex] = 'MessageBox.java:' + '111' , alert_2(($location_0[stackIndex] = 'MessageBox.java:' + '60' , $clinit_695() , ALERT), 'Warning', ($location_0[stackIndex] = 'InstanceListView.java:' + '349' , e.getMessage()));
      }
       else 
        throw $e0;
    }
...
function onClick_23(clickEvent){
  ...
  if ($location_0[stackIndex] = 'InstanceListView.java:' + '369' , $getSelection(this.this$0)) {
    ...
    $location_0[stackIndex] = 'InstanceListView.java:' + '375' , $clinit_686();
    $location_0[stackIndex] = 'MessageBox.java:' + '111' , alert_2(($location_0[stackIndex] = 'MessageBox.java:' + '60' , $clinit_695() , ALERT), 'Missing selection', 'Please select an instance');
  }
  $stackDepth_0 = stackIndex - 1;
}
...
function onClick_24(clickEvent){
  ...
  if (selectedToken != -1 && ($location_0[stackIndex] = 'DOM.java:' + '760' , $getPropertyString(this.this$0.signalRef.element, 'value')).length > 0) {
    $location_0[stackIndex] = 'InstanceListView.java:' + '579' , $clinit_686();
    ...
    $location_0[stackIndex] = 'InstanceListView.java:' + '584' , $handleEvent(this.this$0.controller, ($location_0[stackIndex] = 'InstanceListView.java:' + '585' , $Event(($location_0[stackIndex] = 'InstanceListView.java:' + '585' , new Event_0), ($location_0[stackIndex] = 'SignalExecutionAction.java:' + '42' , $clinit_1005() , ID_13), ($location_0[stackIndex] = 'InstanceListView.java:' + '586' , $SignalInstanceEvent(($location_0[stackIndex] = 'InstanceListView.java:' + '586' , new SignalInstanceEvent), this.this$0.currentDefinition, $getSelection(this.this$0), dynamicCast($getItem_0(this.this$0.listBoxTokens, selectedToken), 240), ($location_0[stackIndex] = 'DOM.java:' + '760' , $getPropertyString(this.this$0.eventData.element, 'value')), selectedToken)))));
  }
    ...
    $location_0[stackIndex] = 'InstanceListView.java:' + '605' , $handleEvent(this.this$0.controller, ($location_0[stackIndex] = 'InstanceListView.java:' + '606' , $Event(($location_0[stackIndex] = 'InstanceListView.java:' + '606' , new Event_0), ($location_0[stackIndex] = 'SignalExecutionAction.java:' + '42' , $clinit_1005() , ID_13), ($location_0[stackIndex] = 'InstanceListView.java:' + '607' , $SignalInstanceEvent(($location_0[stackIndex] = 'InstanceListView.java:' + '607' , new SignalInstanceEvent), this.this$0.currentDefinition, $getSelection(this.this$0), token, ($location_0[stackIndex] = 'DOM.java:' + '760' , $getPropertyString(this.this$0.eventData.element, 'value')), foundMatch)))));
  }
   else {
    $location_0[stackIndex] = 'InstanceListView.java:' + '610' , $clinit_686();
...
function onClick_25(clickEvent){
  ...
  $handleEvent(this.this$0.controller, ($location_0[stackIndex] = 'InstanceListView.java:' + '626' , $Event(($location_0[stackIndex] = 'InstanceListView.java:' + '626' , new Event_0), ($location_0[stackIndex] = 'UpdateInstancesAction.java:' + '47' , $clinit_1012() , ID_19), this.this$0.currentDefinition)));
  $stackDepth_0 = stackIndex - 1;
}
...
function $clinit_998(){
  ...
  $location_0[stackIndex] = 'LoadActivityDiagramAction.java:' + '43' , $clinit_998 = nullMethod;
...
function $LoadActivityDiagramAction(this$static){
  ...
  $location_0[stackIndex] = 'LoadActivityDiagramAction.java:' + '43' , $clinit_998();
  dynamicCast(($location_0[stackIndex] = 'AbstractRESTAction.java:' + '44' , get_16(Lorg_jboss_bpm_console_client_ApplicationContext_2_classLit)), 225);
  $stackDepth_0 = stackIndex - 1;
  return this$static;
}
...
function handleSuccessfulResponse_3(controller, event_0, response){
  ...
  if (inst.lifecycle.current == ($location_0[stackIndex] = 'ProcessInstanceRef.java:' + '45' , $clinit_952() , ENDED) || response.val$xmlHttpRequest.responseText.length == 0) {
    $location_0[stackIndex] = 'LoadActivityDiagramAction.java:' + '70' , $clinit_686();
    $location_0[stackIndex] = 'MessageBox.java:' + '111' , alert_2(($location_0[stackIndex] = 'MessageBox.java:' + '60' , $clinit_695() , ALERT), 'Info', 'Process is already completed');
    view = ($location_0[stackIndex] = 'LoadActivityDiagramAction.java:' + '72' , dynamicCast(dynamicCast(($location_0[stackIndex] = 'Controller.java:' + '67' , $get_7(controller.views, ($location_0[stackIndex] = 'InstanceListView.java:' + '75' , $clinit_981() , ID_10))), 168), 235));
    $location_0[stackIndex] = 'LoadActivityDiagramAction.java:' + '73' , def = view.currentDefinition;
    $handleEvent(controller, ($location_0[stackIndex] = 'LoadActivityDiagramAction.java:' + '76' , $Event(($location_0[stackIndex] = 'LoadActivityDiagramAction.java:' + '76' , new Event_0), ($location_0[stackIndex] = 'UpdateInstancesAction.java:' + '47' , $clinit_1012() , ID_19), def)));
  }
   else {
    viewData = ($location_0[stackIndex] = 'LoadActivityDiagramAction.java:' + '78' , dynamicCast(dynamicCast(($location_0[stackIndex] = 'Controller.java:' + '67' , $get_7(controller.views, ($location_0[stackIndex] = 'InstanceDetailView.java:' + '58' , $clinit_975() , ID_9))), 168), 236));
    ...
    view = ($location_0[stackIndex] = 'LoadActivityDiagramAction.java:' + '83' , dynamicCast(dynamicCast(($location_0[stackIndex] = 'Controller.java:' + '67' , $get_7(controller.views, ($location_0[stackIndex] = 'ActivityDiagramView.java:' + '43' , $clinit_958() , ID_2))), 168), 241));
...
function handlePostError_1(controller, event_0){
  ...
  view = ($location_0[stackIndex] = 'StateChangeAction.java:' + '86' , dynamicCast(dynamicCast(($location_0[stackIndex] = 'Controller.java:' + '67' , $get_7(controller.views, ($location_0[stackIndex] = 'InstanceListView.java:' + '75' , $clinit_981() , ID_10))), 168), 235));
  $location_0[stackIndex] = 'StateChangeAction.java:' + '87' , def = view.currentDefinition;
  $handleEvent(controller, ($location_0[stackIndex] = 'StateChangeAction.java:' + '90' , $Event(($location_0[stackIndex] = 'StateChangeAction.java:' + '90' , new Event_0), ($location_0[stackIndex] = 'UpdateInstancesAction.java:' + '47' , $clinit_1012() , ID_19), def)));
  $stackDepth_0 = stackIndex - 1;
}
...
function $clinit_1010(){
  ...
  $location_0[stackIndex] = 'UpdateInstanceDataAction.java:' + '41' , $clinit_1010 = nullMethod;
...
function $UpdateInstanceDataAction(this$static){
  ...
  $location_0[stackIndex] = 'UpdateInstanceDataAction.java:' + '41' , $clinit_1010();
  dynamicCast(($location_0[stackIndex] = 'AbstractRESTAction.java:' + '44' , get_16(Lorg_jboss_bpm_console_client_ApplicationContext_2_classLit)), 225);
  $stackDepth_0 = stackIndex - 1;
  return this$static;
}
...
function handleError_2(url, t){
  ...
  $location_0[stackIndex] = 'ConsoleLog.java:' + '41' , $clinit_24();
  $location_0[stackIndex] = 'Log.java:' + '651' , $warn(impl, 'Server reported following warning: ' + message + ' for url ' + url, null);
  $location_0[stackIndex] = 'UpdateInstanceDataAction.java:' + '81' , $clinit_686();
  $location_0[stackIndex] = 'MessageBox.java:' + '111' , alert_2(($location_0[stackIndex] = 'MessageBox.java:' + '60' , $clinit_695() , ALERT), 'Status information', message);
  $stackDepth_0 = stackIndex - 1;
}
...
function handlePostError_2(controller, event_0){
  ...
  view = ($location_0[stackIndex] = 'UpdateInstanceDataAction.java:' + '87' , dynamicCast(dynamicCast(($location_0[stackIndex] = 'Controller.java:' + '67' , $get_7(controller.views, ($location_0[stackIndex] = 'InstanceListView.java:' + '75' , $clinit_981() , ID_10))), 168), 235));
  $location_0[stackIndex] = 'UpdateInstanceDataAction.java:' + '88' , def = view.currentDefinition;
  $handleEvent(controller, ($location_0[stackIndex] = 'UpdateInstanceDataAction.java:' + '91' , $Event(($location_0[stackIndex] = 'UpdateInstanceDataAction.java:' + '91' , new Event_0), ($location_0[stackIndex] = 'UpdateInstancesAction.java:' + '47' , $clinit_1012() , ID_19), def)));
  $stackDepth_0 = stackIndex - 1;
}
...
function handleSuccessfulResponse_9(controller, event_0, response){
  ...
  viewData = ($location_0[stackIndex] = 'UpdateInstanceDataAction.java:' + '64' , dynamicCast(dynamicCast(($location_0[stackIndex] = 'Controller.java:' + '67' , $get_7(controller.views, ($location_0[stackIndex] = 'InstanceDetailView.java:' + '58' , $clinit_975() , ID_9))), 168), 236));
  ...
  $location_0[stackIndex] = 'UpdateInstanceDataAction.java:' + '69' , messageDom = ($location_0[stackIndex] = 'UpdateInstanceDataAction.java:' + '69' , $clinit_490() , ($location_0[stackIndex] = 'XMLParser.java:' + '47' , $parse(impl_3, xml)));
  view = ($location_0[stackIndex] = 'UpdateInstanceDataAction.java:' + '70' , dynamicCast(dynamicCast(($location_0[stackIndex] = 'Controller.java:' + '67' , $get_7(controller.views, ($location_0[stackIndex] = 'InstanceDataView.java:' + '48' , $clinit_972() , ID_8))), 168), 244));
