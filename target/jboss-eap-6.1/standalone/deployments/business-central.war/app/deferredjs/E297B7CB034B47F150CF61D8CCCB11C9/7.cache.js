...
function onLoad_5(){
  ...
  instance_8 = ($location_0[stackIndex] = 'AsyncLoader7.java:' + '5' , $clinit_285() , ($location_0[stackIndex] = 'AsyncLoader7.java:' + '22' , new AsyncLoader7));
...
function $OpenTasksView(this$static){
  ...
  $location_0[stackIndex] = 'OpenTasksView.java:' + '56' , $clinit_1055();
...
function $provideWidget_6(this$static, callback){
  ...
  $add_26(this$static.panel, this$static.taskList, ($location_0[stackIndex] = 'OpenTasksView.java:' + '117' , $BorderLayoutData_1(($location_0[stackIndex] = 'OpenTasksView.java:' + '117' , new BorderLayoutData), ($location_0[stackIndex] = 'BorderLayout.java:' + '199' , $clinit_791() , CENTER_1))));
