...
function getInnerText(node){
  ...
  while (child) {
    child.nodeType == 1?(text += ($location_0[stackIndex] = 'DOMImpl.java:' + '215' , this.getInnerText(child))):child.nodeValue && ($location_0[stackIndex] = 'DOMImpl.java:' + '217' , text += child.nodeValue);
...
function getInnerText_0(elem){
  var returnTemp, stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getInnerText_0;
  returnTemp = elem.textContent;
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}

_ = DOMImplMozilla.prototype;
_.getInnerText = getInnerText_0;
function $getInnerText_0(this$static, node){
  var text = '', child = node.firstChild, stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $getInnerText_0;
  while (child) {
    child.nodeType == 1?(text += ($location_0[stackIndex] = 'DOMImplMozillaOld.java:' + '59' , this$static.getInnerText(child))):child.nodeValue && ($location_0[stackIndex] = 'DOMImplMozillaOld.java:' + '61' , text += child.nodeValue);
    $location_0[stackIndex] = 'DOMImplMozillaOld.java:' + '63' , child = child.nextSibling;
  }
  $stackDepth_0 = stackIndex - 1;
  return text;
}

function getInnerText_1(node){
  var stackIndex, returnTemp;
  $stack_0[stackIndex = ++$stackDepth_0] = getInnerText_1;
  returnTemp = ($location_0[stackIndex] = 'DOMImplMozillaOld.java:' + '52' , $getInnerText_0(this, node));
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}

_ = DOMImplMozillaOld.prototype;
_.getInnerText = getInnerText_1;
...
function $clinit_130(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_130;
  $location_0[stackIndex] = 'ChangeEvent.java:' + '21' , $clinit_130 = nullMethod;
  TYPE_0 = ($location_0[stackIndex] = 'ChangeEvent.java:' + '27' , $DomEvent$Type(($location_0[stackIndex] = 'ChangeEvent.java:' + '27' , new DomEvent$Type), 'change', ($location_0[stackIndex] = 'ChangeEvent.java:' + '44' , $clinit_130() , ($location_0[stackIndex] = 'ChangeEvent.java:' + '28' , new ChangeEvent))));
  $stackDepth_0 = stackIndex - 1;
}
...
function initDims_0(arrayClasses, typeIdExprs, queryIdExprs, dimExprs, index, count, seedType){
  ...
  $location_0[stackIndex] = 'Array.java:' + '169' , $clinit_250();
...
function $clinit_265(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_265;
  $location_0[stackIndex] = 'AsyncLoader2.java:' + '5' , $clinit_265 = nullMethod;
...
function $clinit_269(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_269;
  $location_0[stackIndex] = 'AsyncLoader3.java:' + '5' , $clinit_269 = nullMethod;
...
function $clinit_273(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_273;
  $location_0[stackIndex] = 'AsyncLoader4.java:' + '5' , $clinit_273 = nullMethod;
...
function $clinit_277(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_277;
  $location_0[stackIndex] = 'AsyncLoader5.java:' + '5' , $clinit_277 = nullMethod;
...
function $clinit_281(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_281;
  $location_0[stackIndex] = 'AsyncLoader6.java:' + '5' , $clinit_281 = nullMethod;
...
function $clinit_285(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_285;
  $location_0[stackIndex] = 'AsyncLoader7.java:' + '5' , $clinit_285 = nullMethod;
...
function $clinit_300(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_300;
  $location_0[stackIndex] = 'AbstractWindowClosingEvent.java:' + '27' , $clinit_300 = nullMethod;
  $clinit_299();
  $stackDepth_0 = stackIndex - 1;
}
...
function $FocusWidget(this$static, elem){
  ...
  $location_0[stackIndex] = 'FocusWidget.java:' + '82' , $clinit_354();
  $location_0[stackIndex] = 'UIObject.java:' + '799' , this$static.element = elem;
...
function addClickHandler(handler){
  ...
  returnTemp = ($location_0[stackIndex] = 'FocusWidget.java:' + '91' , $addDomHandler(this, handler, ($location_0[stackIndex] = 'FocusWidget.java:' + '91' , $clinit_132() , ($location_0[stackIndex] = 'ClickEvent.java:' + '27' , $clinit_132()) , TYPE_1)));
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function $Button_1(this$static, html, listener){
  ...
  $location_0[stackIndex] = 'Button.java:' + '91' , $clinit_356();
...
function getClass_210(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_210;
  $stackDepth_0 = stackIndex - 1;
...
function $TabBar(this$static){
  ...
  $location_0[stackIndex] = 'HorizontalPanel.java:' + '106' , this$static.panel.vertAlign = ($location_0[stackIndex] = 'HasVerticalAlignment.java:' + '61' , $clinit_392() , ALIGN_BOTTOM);
...
function $getTabHTML(this$static, index){
  ...
  if (widget != null && ($location_0[stackIndex] = 'Cast.java:' + '76' , canCast(widget.typeId$, 161))) {
    ...
    returnTemp = ($location_0[stackIndex] = 'Element.java:' + '266' , $getInnerText_0(($location_0[stackIndex] = 'DOMImpl.java:' + '22' , $clinit_81() , impl_0), ($location_0[stackIndex] = 'TabBar.java:' + '315' , dynamicCast(widget, 162)).element));
    $stackDepth_0 = stackIndex - 1;
    return returnTemp;
  }
   else {
...
function $clinit_363(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_363;
  $location_0[stackIndex] = 'DecoratedTabBar.java:' + '52' , $clinit_363 = nullMethod;
...
function addClickHandler_0(handler){
  ...
  returnTemp = ($location_0[stackIndex] = 'Label.java:' + '128' , $addDomHandler(this, handler, ($location_0[stackIndex] = 'Label.java:' + '128' , $clinit_132() , ($location_0[stackIndex] = 'ClickEvent.java:' + '27' , $clinit_132()) , TYPE_1)));
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function getClass_220(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_220;
  $stackDepth_0 = stackIndex - 1;
...
function addClickHandler_1(handler){
  ...
  returnTemp = ($location_0[stackIndex] = 'FocusPanel.java:' + '75' , $addDomHandler(this, handler, ($location_0[stackIndex] = 'FocusPanel.java:' + '75' , $clinit_132() , ($location_0[stackIndex] = 'ClickEvent.java:' + '27' , $clinit_132()) , TYPE_1)));
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function getClass_222(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_222;
  $stackDepth_0 = stackIndex - 1;
...
function addClickHandler_2(handler){
  ...
  returnTemp = ($location_0[stackIndex] = 'HTMLTable.java:' + '694' , $addDomHandler(this, handler, ($location_0[stackIndex] = 'HTMLTable.java:' + '694' , $clinit_132() , ($location_0[stackIndex] = 'ClickEvent.java:' + '27' , $clinit_132()) , TYPE_1)));
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function $Image(this$static){
  ...
  $location_0[stackIndex] = 'Image.java:' + '345' , $clinit_397();
...
function $Image_1(this$static, url){
  ...
  $location_0[stackIndex] = 'Image.java:' + '366' , $clinit_397();
...
function addClickHandler_3(handler){
  ...
  returnTemp = ($location_0[stackIndex] = 'Image.java:' + '406' , $addHandler_1(this, handler, ($location_0[stackIndex] = 'Image.java:' + '406' , $clinit_132() , ($location_0[stackIndex] = 'ClickEvent.java:' + '27' , $clinit_132()) , TYPE_1)));
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function $clinit_407(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_407;
  $location_0[stackIndex] = 'ListBox.java:' + '46' , $clinit_407 = nullMethod;
  $clinit_354();
  $stackDepth_0 = stackIndex - 1;
}
...
function $ListBox_0(this$static, isMultipleSelect){
  ...
  $location_0[stackIndex] = 'ListBox.java:' + '87' , $clinit_407();
...
function add_11(source, listener){
  ...
  $location_0[stackIndex] = 'ListBox.java:' + '104' , $addDomHandler(source, rtn, ($location_0[stackIndex] = 'ListBox.java:' + '104' , $clinit_130() , ($location_0[stackIndex] = 'ChangeEvent.java:' + '27' , $clinit_130()) , TYPE_0));
  $stackDepth_0 = stackIndex - 1;
  return rtn;
}
...
function $init_2(this$static, vertical){
  ...
  outer_0 = ($location_0[stackIndex] = 'MenuBar.java:' + '999' , $createFocusable(($location_0[stackIndex] = 'FocusPanel.java:' + '59' , $clinit_373() , impl_2)));
...
function $itemOver(this$static, item, focus_0){
  ...
  focus_0 && ($location_0[stackIndex] = 'Element.java:' + '134' , ($location_0[stackIndex] = 'MenuBar.java:' + '375' , $clinit_373() , this$static.element).focus() , undefined);
...
function $onBrowserEvent_1(this$static, event_0){
  ...
  switch ($location_0[stackIndex] = 'DOMImpl.java:' + '61' , $eventGetTypeInt(event_0.type)) {
    case 1:
      {
        $location_0[stackIndex] = 'Element.java:' + '134' , ($location_0[stackIndex] = 'MenuBar.java:' + '546' , $clinit_373() , this$static.element).focus();
    ...
    case 128:
      {
        ...
        switch (keyCode) {
          case 37:
            {
              $location_0[stackIndex] = 'MenuBar.java:' + '577' , $clinit_229();
          ...
          case 39:
            {
              $location_0[stackIndex] = 'MenuBar.java:' + '585' , $clinit_229();
...
function $TabBar$ClickDelegatePanel(this$static, child, this$0){
  ...
  this$static.focusablePanel = $SimplePanel_0(($location_0[stackIndex] = 'TabBar.java:' + '93' , new SimplePanel), ($location_0[stackIndex] = 'TabBar.java:' + '93' , $createFocusable(($location_0[stackIndex] = 'FocusPanel.java:' + '59' , $clinit_373() , impl_2))));
...
function addClickHandler_4(handler){
  ...
  returnTemp = ($location_0[stackIndex] = 'TabBar.java:' + '107' , $addHandler_1(this, handler, ($location_0[stackIndex] = 'TabBar.java:' + '107' , $clinit_132() , ($location_0[stackIndex] = 'ClickEvent.java:' + '27' , $clinit_132()) , TYPE_1)));
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function $init_3(this$static, images, useLeafImages){
  ...
  this$static.focusable = ($location_0[stackIndex] = 'Tree.java:' + '947' , $createFocusable(($location_0[stackIndex] = 'FocusPanel.java:' + '59' , $clinit_373() , impl_2)));
...
function $moveFocus(this$static){
  ...
  $location_0[stackIndex] = 'Tree.java:' + '1084' , left = $getAbsoluteLeftImpl(($location_0[stackIndex] = 'DOMImplMozillaOld.java:' + '41' , $getViewportElement(selectedElem.ownerDocument)), selectedElem) - containerLeft;
  $location_0[stackIndex] = 'Tree.java:' + '1085' , top_0 = $getAbsoluteTopImpl(($location_0[stackIndex] = 'DOMImplMozillaOld.java:' + '47' , $getViewportElement(selectedElem.ownerDocument)), selectedElem) - containerTop;
  ...
  $location_0[stackIndex] = 'Element.java:' + '134' , ($location_0[stackIndex] = 'Tree.java:' + '664' , $clinit_373() , this$static.focusable).focus();
  $stackDepth_0 = stackIndex - 1;
}
...
function $setImages(this$static, images, useLeafImages){
  ...
  if (!useLeafImages) {
    ...
    $location_0[stackIndex] = 'Tree.java:' + '1204' , $clinit_432();
...
function $showLeafImage(this$static, treeItem){
  ...
  if (this$static.useLeafImages || !!treeItem.imageHolder) {
    ...
    $location_0[stackIndex] = 'Tree.java:' + '841' , $clinit_229();
...
function addMouseDownHandler_3(handler){
  ...
  returnTemp = ($location_0[stackIndex] = 'Tree.java:' + '374' , $addHandler_1(this, handler, ($location_0[stackIndex] = 'Tree.java:' + '374' , $clinit_171() , ($location_0[stackIndex] = 'MouseDownEvent.java:' + '27' , $clinit_171()) , TYPE_7)));
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function addMouseMoveHandler_3(handler){
  ...
  returnTemp = ($location_0[stackIndex] = 'Tree.java:' + '388' , $addDomHandler(this, handler, ($location_0[stackIndex] = 'Tree.java:' + '388' , $clinit_173() , ($location_0[stackIndex] = 'MouseMoveEvent.java:' + '27' , $clinit_173()) , TYPE_8)));
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function addMouseOutHandler_3(handler){
  ...
  returnTemp = ($location_0[stackIndex] = 'Tree.java:' + '392' , $addDomHandler(this, handler, ($location_0[stackIndex] = 'Tree.java:' + '392' , $clinit_175() , ($location_0[stackIndex] = 'MouseOutEvent.java:' + '29' , $clinit_175()) , TYPE_9)));
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function addMouseUpHandler_3(handler){
  ...
  returnTemp = ($location_0[stackIndex] = 'Tree.java:' + '400' , $addDomHandler(this, handler, ($location_0[stackIndex] = 'Tree.java:' + '400' , $clinit_179() , ($location_0[stackIndex] = 'MouseUpEvent.java:' + '27' , $clinit_179()) , TYPE_11)));
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function doAttachChildren_3(){
  ...
  try {
    $location_0[stackIndex] = 'Tree.java:' + '718' , tryCommand(this, ($location_0[stackIndex] = 'AttachDetachException.java:' + '30' , $clinit_350() , attachCommand));
  }
   catch (e) {
...
function doDetachChildren_3(){
  ...
  try {
    $location_0[stackIndex] = 'Tree.java:' + '728' , tryCommand(this, ($location_0[stackIndex] = 'AttachDetachException.java:' + '39' , $clinit_350() , detachCommand));
  }
   catch (e) {
    ...
    case 1:
      {
        ...
        ($location_0[stackIndex] = 'Tree.java:' + '524' , shouldTreeDelegateFocusToElement(e)) || !!this.curSelection && ($location_0[stackIndex] = 'Element.java:' + '134' , ($location_0[stackIndex] = 'Tree.java:' + '664' , $clinit_373() , this.focusable).focus() , undefined);
        break;
      }
...
function standardizeKeycode(code){
  ...
  $location_0[stackIndex] = 'Tree.java:' + '206' , $clinit_229();
  $stackDepth_0 = stackIndex - 1;
  return code;
}
...
function $clinit_454(){
  ...
  $location_0[stackIndex] = 'TreeItem.java:' + '39' , $clinit_454 = nullMethod;
  itemAnimation = ($location_0[stackIndex] = 'TreeItem.java:' + '233' , new TreeItem$TreeItemAnimation);
  $location_0[stackIndex] = 'TreeItem.java:' + '239' , $clinit_454();
...
function $TreeItem(this$static){
  ...
  $location_0[stackIndex] = 'TreeItem.java:' + '262' , $clinit_454();
...
function $TreeItem_0(this$static, html){
  ...
  $location_0[stackIndex] = 'TreeItem.java:' + '274' , $clinit_454();
...
function addItem(item){
  ...
  $location_0[stackIndex] = 'TreeItem.java:' + '321' , $clinit_229();
...
function $clinit_455(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_455;
  $location_0[stackIndex] = 'Tree.java:' + '965' , $clinit_455 = nullMethod;
  $clinit_454();
  $stackDepth_0 = stackIndex - 1;
}
...
function $Tree$1(this$static, this$0){
  ...
  $location_0[stackIndex] = 'Tree.java:' + '965' , $clinit_455();
...
function $addItem_3(this$static, item){
  ...
  $location_0[stackIndex] = 'Tree.java:' + '981' , $clinit_229();
...
function $convertToFullNode(item){
  ...
  if (!item.imageHolder) {
    $location_0[stackIndex] = 'TreeItem.java:' + '51' , itemTable = ($location_0[stackIndex] = 'Node.java:' + '94' , ($location_0[stackIndex] = 'TreeItem.java:' + '239' , $clinit_454() , BASE_INTERNAL_ELEM).cloneNode(true));
...
function $adjust(img, url, left, top_0, width, height){
  ...
  $location_0[stackIndex] = 'Style.java:' + '1449' , img.style['width'] = width + ($location_0[stackIndex] = 'Style.java:' + '1369' , $clinit_112() , 'px');
...
function hexDigit(c, s){
  var val = ($location_0[stackIndex] = 'Long.java:' + '273' , ($location_0[stackIndex] = 'Long.java:' + '35' , $clinit_539() , hexLookup)[c]), stackIndex;
...
function $clinit_539(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_539;
  $location_0[stackIndex] = 'Long.java:' + '31' , $clinit_539 = nullMethod;
  var c;
...
function $Date_0(this$static, year, month, date, hrs, min, sec){
  ...
  $location_0[stackIndex] = 'Date.java:' + '127' , $clinit_554();
...
function sort(target, c){
  ...
  $location_0[stackIndex] = 'Collections.java:' + '843' , $clinit_572();
  var x;
  ...
  $location_0[stackIndex] = 'Arrays.java:' + '997' , mergeSort(x, 0, x.length, c?c:($location_0[stackIndex] = 'Arrays.java:' + '997' , $clinit_583() , ($location_0[stackIndex] = 'Comparators.java:' + '32' , $clinit_583()) , NATURAL));
...
function $clinit_583(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_583;
  $location_0[stackIndex] = 'Comparators.java:' + '18' , $clinit_583 = nullMethod;
...
function $clinit_607(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_607;
  $location_0[stackIndex] = 'TreeMap.java:' + '29' , $clinit_607 = nullMethod;
...
function $TreeMap(this$static){
  ...
  $location_0[stackIndex] = 'TreeMap.java:' + '602' , $clinit_607();
...
function $TreeMap_0(this$static, c){
  ...
  $location_0[stackIndex] = 'TreeMap.java:' + '607' , $clinit_607();
...
function $TreeMap$EntryIterator(this$static, this$0){
  ...
  $location_0[stackIndex] = 'TreeMap.java:' + '51' , $TreeMap$EntryIterator_0(this$static, ($location_0[stackIndex] = 'TreeMap.java:' + '500' , $clinit_613() , All), null, null, this$0);
  $stackDepth_0 = stackIndex - 1;
  return this$static;
}
...
function $clinit_613(){
  ...
  $location_0[stackIndex] = 'TreeMap.java:' + '499' , $clinit_613 = nullMethod;
...
function $TreeMap$SubMapType(this$static, enum$name, enum$ordinal){
  ...
  $location_0[stackIndex] = 'TreeMap.java:' + '499' , $clinit_613();
...
function $clinit_614(){
  ...
  $location_0[stackIndex] = 'TreeMap.java:' + '502' , $clinit_614 = nullMethod;
  $clinit_613();
  $stackDepth_0 = stackIndex - 1;
}
...
function $TreeMap$SubMapType$1(this$static, enum$name, enum$ordinal){
  ...
  $location_0[stackIndex] = 'TreeMap.java:' + '502' , $clinit_614();
  $location_0[stackIndex] = 'Enum.java:' + '76' , this$static.name_0 = enum$name;
  $location_0[stackIndex] = 'Enum.java:' + '77' , this$static.ordinal = enum$ordinal;
  $stackDepth_0 = stackIndex - 1;
  return this$static;
...
function $clinit_615(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_615;
  $location_0[stackIndex] = 'TreeMap.java:' + '509' , $clinit_615 = nullMethod;
  $clinit_613();
  $stackDepth_0 = stackIndex - 1;
}
...
function $TreeMap$SubMapType$2(this$static, enum$name, enum$ordinal){
  ...
  $location_0[stackIndex] = 'TreeMap.java:' + '509' , $clinit_615();
  $location_0[stackIndex] = 'Enum.java:' + '76' , this$static.name_0 = enum$name;
  $location_0[stackIndex] = 'Enum.java:' + '77' , this$static.ordinal = enum$ordinal;
  $stackDepth_0 = stackIndex - 1;
  return this$static;
...
function $clinit_616(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_616;
  $location_0[stackIndex] = 'TreeMap.java:' + '521' , $clinit_616 = nullMethod;
  $clinit_613();
  $stackDepth_0 = stackIndex - 1;
}
...
function $TreeMap$SubMapType$3(this$static, enum$name, enum$ordinal){
  ...
  $location_0[stackIndex] = 'TreeMap.java:' + '521' , $clinit_616();
  $location_0[stackIndex] = 'Enum.java:' + '76' , this$static.name_0 = enum$name;
  $location_0[stackIndex] = 'Enum.java:' + '77' , this$static.ordinal = enum$ordinal;
  $stackDepth_0 = stackIndex - 1;
  return this$static;
...
function add_22(o){
  ...
  returnTemp = ($location_0[stackIndex] = 'TreeSet.java:' + '69' , $put_1(this.map, o, ($location_0[stackIndex] = 'Boolean.java:' + '29' , $clinit_517() , FALSE_0))) == null;
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function $clinit_634(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_634;
  $location_0[stackIndex] = 'DelayedRunnable.java:' + '42' , $clinit_634 = nullMethod;
  $clinit_43();
  $stackDepth_0 = stackIndex - 1;
}
...
function $DelayedRunnable$1(this$static, this$0){
  ...
  $location_0[stackIndex] = 'DelayedRunnable.java:' + '42' , $clinit_634();
  this$static.this$0 = this$0;
  $stackDepth_0 = stackIndex - 1;
  return this$static;
}
...
function addClickHandler_5(handler){
  ...
  returnTemp = ($location_0[stackIndex] = 'Caption.java:' + '133' , $addDomHandler(this, handler, ($location_0[stackIndex] = 'Caption.java:' + '133' , $clinit_132() , ($location_0[stackIndex] = 'ClickEvent.java:' + '27' , $clinit_132()) , TYPE_1)));
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function getClass_396(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_396;
  $stackDepth_0 = stackIndex - 1;
...
function $TabLayoutPanel(this$static, region, decorate, decorateBody){
  ...
  decorate?region == ($location_0[stackIndex] = 'TabLayoutPanel.java:' + '65' , $clinit_729() , TOP)?(this$static.tabBar = $ScrollTabBar_0(($location_0[stackIndex] = 'TabLayoutPanel.java:' + '143' , new ScrollTabBar), true, false)):(this$static.tabBar = $ScrollTabBar_0(($location_0[stackIndex] = 'TabLayoutPanel.java:' + '145' , new ScrollTabBar), true, true)):(this$static.tabBar = $ScrollTabBar(($location_0[stackIndex] = 'TabLayoutPanel.java:' + '148' , new ScrollTabBar)));
  ...
  region == ($location_0[stackIndex] = 'TabLayoutPanel.java:' + '65' , $clinit_729() , TOP)?$add_26(layoutPanel, this$static.tabBar, ($location_0[stackIndex] = 'TabLayoutPanel.java:' + '160' , $BorderLayoutData_1(($location_0[stackIndex] = 'TabLayoutPanel.java:' + '160' , new BorderLayoutData), ($location_0[stackIndex] = 'BorderLayout.java:' + '199' , $clinit_791() , NORTH_0)))):$add_26(layoutPanel, this$static.tabBar, ($location_0[stackIndex] = 'TabLayoutPanel.java:' + '162' , $BorderLayoutData_1(($location_0[stackIndex] = 'TabLayoutPanel.java:' + '162' , new BorderLayoutData), ($location_0[stackIndex] = 'BorderLayout.java:' + '199' , $clinit_791() , SOUTH_0))));
...
function getClass_399(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_399;
  $stackDepth_0 = stackIndex - 1;
...
function getClass_400(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_400;
  $stackDepth_0 = stackIndex - 1;
...
function addClickHandler_6(handler){
  ...
  returnTemp = ($location_0[stackIndex] = 'ImageButton.java:' + '58' , $addDomHandler(this, handler, ($location_0[stackIndex] = 'ImageButton.java:' + '58' , $clinit_132() , ($location_0[stackIndex] = 'ClickEvent.java:' + '27' , $clinit_132()) , TYPE_1)));
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function getClass_417(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_417;
  $stackDepth_0 = stackIndex - 1;
...
function $clinit_681(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_681;
  $location_0[stackIndex] = 'ListBox.java:' + '66' , $clinit_681 = nullMethod;
  $location_0[stackIndex] = 'ListBox.java:' + '92' , impl_5 = ($location_0[stackIndex] = 'ListBox.java:' + '92' , $clinit_470() , ($location_0[stackIndex] = 'FocusImpl.java:' + '28' , $clinit_470()) , implPanel);
  $stackDepth_0 = stackIndex - 1;
}
...
function $ListBox_1(this$static, columns){
  ...
  $location_0[stackIndex] = 'ListBox.java:' + '134' , $clinit_681();
  $initWidget(this$static, ($location_0[stackIndex] = 'LayoutComposite.java:' + '56' , $LayoutComposite$1(($location_0[stackIndex] = 'LayoutComposite.java:' + '56' , new LayoutComposite$1), ($location_0[stackIndex] = 'ListBox.java:' + '135' , $createFocusable(impl_5)))));
  ...
  $location_0[stackIndex] = 'ListBox.java:' + '140' , $setResizePolicy(this$static.scrollTable, ($location_0[stackIndex] = 'AbstractScrollTable.java:' + '844' , $clinit_837() , FILL_WIDTH));
  ...
  $location_0[stackIndex] = 'ListBox.java:' + '854' , $setSelectionPolicy_0(this$static.dataTable, ($location_0[stackIndex] = 'SelectionGrid.java:' + '127' , $clinit_868() , ONE_ROW));
...
function add_27(windowPanel, listener){
  ...
  $location_0[stackIndex] = 'WindowPanel.java:' + '433' , $addHandler_1(windowPanel, handler, ($location_0[stackIndex] = 'WindowPanel.java:' + '433' , $clinit_300() , ($location_0[stackIndex] = 'Window.java:' + '55' , $clinit_299()) , TYPE_18));
...
function $WindowPanel(this$static){
  ...
  $location_0[stackIndex] = 'WindowPanel.java:' + '271' , $clinit_685();
  $location_0[stackIndex] = 'WindowPanel.java:' + '302' , $WindowPanel_2(this$static, ($location_0[stackIndex] = 'WindowPanel.java:' + '302' , $clinit_432() , ($location_0[stackIndex] = 'RootPanel.java:' + '151' , get_1(null))), null, true, false);
  $stackDepth_0 = stackIndex - 1;
  return this$static;
}
...
function $clinit_697(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_697;
  $location_0[stackIndex] = 'PopupMenu.java:' + '35' , $clinit_697 = nullMethod;
  $clinit_345();
  $stackDepth_0 = stackIndex - 1;
}
...
function $PopupMenu(this$static){
  ...
  $location_0[stackIndex] = 'PopupMenu.java:' + '40' , $clinit_697();
  $location_0[stackIndex] = 'PopupMenu.java:' + '41' , $AbstractDecoratedPopupPanel(this$static, true, false, 'menuPopup', ($location_0[stackIndex] = 'AbstractDecoratedPopupPanel.java:' + '37' , $clinit_346() , ONE_WAY_CORNER));
...
function $PopupMenu$1(this$static, $anonymous0){
  ...
  $location_0[stackIndex] = 'MenuBar.java:' + '233' , $init_2(this$static, $anonymous0, ($location_0[stackIndex] = 'MenuBar.java:' + '234' , create_1((!menuBarSubMenuIcon && (menuBarSubMenuIcon = ($location_0[stackIndex] = 'com_google_gwt_user_client_ui_MenuBar_Resources_default_InlineClientBundleGenerator.java:' + '9' , $ImageResourcePrototype(($location_0[stackIndex] = 'com_google_gwt_user_client_ui_MenuBar_Resources_default_InlineClientBundleGenerator.java:' + '9' , new ImageResourcePrototype), ($location_0[stackIndex] = 'com_google_gwt_user_client_ui_MenuBar_Resources_default_InlineClientBundleGenerator.java:' + '11' , $clinit_229() , 'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAUAAAAJCAYAAAD6reaeAAAAI0lEQVR42mNgYGD4z4AF/Mcm8R+bxH9sEv+xSRBUSdh2FAAAXN8Y6EbBLKwAAAAASUVORK5CYII='), 0, 0, 5, 9))) , menuBarSubMenuIcon))));
  $stackDepth_0 = stackIndex - 1;
  return this$static;
}
...
function $ScrollTabBar_0(this$static, decorated, atBottom){
  ...
  this$static.scrollLeftBtn = ($location_0[stackIndex] = 'ScrollTabBar.java:' + '255' , $Button_2(($location_0[stackIndex] = 'ScrollTabBar.java:' + '255' , new Button), ($location_0[stackIndex] = 'ScrollTabBar.java:' + '255' , $getHTML_0(($clinit_650() , ($location_0[stackIndex] = 'CaptionImages_generatedBundle.java:' + '17' , $clinit_652()) , toolArrowLeft_SINGLETON))), $ScrollTabBar$7(($location_0[stackIndex] = 'ScrollTabBar.java:' + '256' , new ScrollTabBar$7), this$static)));
  $location_0[stackIndex] = 'FocusWidget.java:' + '136' , $addDomHandler(this$static.scrollLeftBtn, $ScrollTabBar$8(($location_0[stackIndex] = 'ScrollTabBar.java:' + '263' , new ScrollTabBar$8), this$static), ($location_0[stackIndex] = 'FocusWidget.java:' + '136' , $clinit_171() , ($location_0[stackIndex] = 'MouseDownEvent.java:' + '27' , $clinit_171()) , TYPE_7));
  $location_0[stackIndex] = 'FocusWidget.java:' + '162' , $addDomHandler(this$static.scrollLeftBtn, $ScrollTabBar$9(($location_0[stackIndex] = 'ScrollTabBar.java:' + '269' , new ScrollTabBar$9), this$static), ($location_0[stackIndex] = 'FocusWidget.java:' + '162' , $clinit_179() , ($location_0[stackIndex] = 'MouseUpEvent.java:' + '27' , $clinit_179()) , TYPE_11));
  ...
  $add_26(layoutPanel, this$static.tabBarWrapper, ($location_0[stackIndex] = 'ScrollTabBar.java:' + '336' , $BoxLayoutData_4(($location_0[stackIndex] = 'ScrollTabBar.java:' + '336' , new BoxLayoutData), ($location_0[stackIndex] = 'BoxLayoutData.java:' + '30' , $clinit_800() , HORIZONTAL_0))));
...
function $clinit_701(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_701;
  $location_0[stackIndex] = 'ScrollTabBar.java:' + '151' , $clinit_701 = nullMethod;
  $clinit_43();
  $stackDepth_0 = stackIndex - 1;
}
...
function $ScrollTabBar$1(this$static, this$0){
  ...
  $location_0[stackIndex] = 'ScrollTabBar.java:' + '151' , $clinit_701();
  this$static.this$0 = this$0;
  $stackDepth_0 = stackIndex - 1;
  return this$static;
}
...
function $clinit_713(){
  ...
  $location_0[stackIndex] = 'ScrollTabBar.java:' + '164' , $clinit_713 = nullMethod;
  $clinit_43();
  $stackDepth_0 = stackIndex - 1;
}
...
function $ScrollTabBar$2(this$static, this$0){
  ...
  $location_0[stackIndex] = 'ScrollTabBar.java:' + '164' , $clinit_713();
  this$static.this$0 = this$0;
  $stackDepth_0 = stackIndex - 1;
  return this$static;
}
...
function $clinit_714(){
  ...
  $location_0[stackIndex] = 'ScrollTabBar.java:' + '47' , $clinit_714 = nullMethod;
...
function $clinit_715(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_715;
  $location_0[stackIndex] = 'ScrollTabBar.java:' + '194' , $clinit_715 = nullMethod;
  $clinit_714();
  $stackDepth_0 = stackIndex - 1;
}
...
function $ScrollTabBar$3(this$static, this$0){
  ...
  $location_0[stackIndex] = 'ScrollTabBar.java:' + '194' , $clinit_715();
  this$static.this$0 = this$0;
...
function $clinit_716(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_716;
  $location_0[stackIndex] = 'ScrollTabBar.java:' + '208' , $clinit_716 = nullMethod;
  $clinit_363();
  $stackDepth_0 = stackIndex - 1;
}
...
function $ScrollTabBar$4(this$static, this$0){
  ...
  $location_0[stackIndex] = 'ScrollTabBar.java:' + '208' , $clinit_716();
  this$static.this$0 = this$0;
...
function $clinit_723(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_723;
  $location_0[stackIndex] = 'ScrollTabBar.java:' + '62' , $clinit_723 = nullMethod;
  $clinit_348();
  $stackDepth_0 = stackIndex - 1;
}
...
function $ScrollTabBar$DecoratedBottomTabBar$1(this$static, $anonymous0, $anonymous1){
  ...
  $location_0[stackIndex] = 'ScrollTabBar.java:' + '62' , $clinit_723();
...
function $clinit_729(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_729;
  $location_0[stackIndex] = 'TabLayoutPanel.java:' + '64' , $clinit_729 = nullMethod;
...
function $TabLayoutPanel$TabBarPosition(this$static, enum$name, enum$ordinal){
  ...
  $location_0[stackIndex] = 'TabLayoutPanel.java:' + '64' , $clinit_729();
  $location_0[stackIndex] = 'Enum.java:' + '76' , this$static.name_0 = enum$name;
  $location_0[stackIndex] = 'Enum.java:' + '77' , this$static.ordinal = enum$ordinal;
  $stackDepth_0 = stackIndex - 1;
  return this$static;
...
function $add_28(this$static, w){
  ...
  if (boxLayoutMgr.orientation == ($location_0[stackIndex] = 'BoxLayout.java:' + '170' , $clinit_798() , HORIZONTAL)) {
    ...
    $add_26(layoutPanel, w, ($location_0[stackIndex] = 'ToolBar.java:' + '100' , $BoxLayoutData_6(($location_0[stackIndex] = 'ToolBar.java:' + '100' , new BoxLayoutData), ($location_0[stackIndex] = 'BoxLayoutData.java:' + '30' , $clinit_800() , VERTICAL_0), width, null)));
  }
   else {
    ...
    $add_26(($location_0[stackIndex] = 'LayoutComposite.java:' + '89' , dynamicCast(this$static.widget, 183)), w, ($location_0[stackIndex] = 'ToolBar.java:' + '103' , $BoxLayoutData_6(($location_0[stackIndex] = 'ToolBar.java:' + '103' , new BoxLayoutData), ($location_0[stackIndex] = 'BoxLayoutData.java:' + '30' , $clinit_800() , BOTH), null, height)));
  }
  $stackDepth_0 = stackIndex - 1;
}

function getClass_466(){
  var stackIndex;
...
function addClickHandler_7(handler){
  ...
  returnTemp = ($location_0[stackIndex] = 'WindowPanel.java:' + '154' , $addDomHandler(this, handler, ($location_0[stackIndex] = 'WindowPanel.java:' + '154' , $clinit_132() , ($location_0[stackIndex] = 'ClickEvent.java:' + '27' , $clinit_132()) , TYPE_1)));
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function $clinit_767(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_767;
  $location_0[stackIndex] = 'InfoPanel.java:' + '40' , $clinit_767 = nullMethod;
  $clinit_344();
  $stackDepth_0 = stackIndex - 1;
}
...
function $InfoPanel(this$static){
  ...
  $location_0[stackIndex] = 'InfoPanel.java:' + '70' , $clinit_767();
...
function $InfoPanel_0(this$static, caption, description, autoHide){
  ...
  $location_0[stackIndex] = 'InfoPanel.java:' + '82' , $clinit_767();
...
function $clinit_768(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_768;
  $location_0[stackIndex] = 'InfoPanel.java:' + '62' , $clinit_768 = nullMethod;
  $clinit_43();
  $stackDepth_0 = stackIndex - 1;
}
...
function $InfoPanel$1(this$static, this$0){
  ...
  $location_0[stackIndex] = 'InfoPanel.java:' + '62' , $clinit_768();
  this$static.this$0 = this$0;
  $stackDepth_0 = stackIndex - 1;
  return this$static;
}

function getClass_492(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_492;
  $stackDepth_0 = stackIndex - 1;
...
function getClass_493(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_493;
  $stackDepth_0 = stackIndex - 1;
...
_.getClass$ = getClass_493;
_.typeId$ = 0;
_.this$0 = null;
function $BorderLayoutData_0(this$static, decorate){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $BorderLayoutData_0;
  $location_0[stackIndex] = 'BorderLayoutData.java:' + '68' , $BorderLayoutData_2(this$static, ($location_0[stackIndex] = 'BorderLayout.java:' + '199' , $clinit_791() , CENTER_1), decorate);
  $stackDepth_0 = stackIndex - 1;
  return this$static;
}
...
function $BorderLayoutData_6(this$static, region, preferredSize, minSize, maxSize, decorate){
  ...
  if (region == ($location_0[stackIndex] = 'BorderLayout.java:' + '199' , $clinit_791() , NORTH_0) || region == SOUTH_0) {
  ...
  this$static.minSize = (0 > minSize?0:minSize) + ($location_0[stackIndex] = 'BorderLayoutData.java:' + '397' , $clinit_112() , 'px');
...
function $BoxLayout_0(this$static, alignment){
  ...
  $location_0[stackIndex] = 'BoxLayout.java:' + '187' , $BoxLayout_2(this$static, ($location_0[stackIndex] = 'BoxLayout.java:' + '170' , $clinit_798() , HORIZONTAL), alignment);
  $stackDepth_0 = stackIndex - 1;
  return this$static;
}
...
function $clinit_808(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_808;
  $location_0[stackIndex] = 'GridLayout.java:' + '61' , $clinit_808 = nullMethod;
...
function $GridLayout(this$static, columns, rows){
  ...
  $location_0[stackIndex] = 'GridLayout.java:' + '98' , $clinit_808();
...
function $buildWidgetMatrix(this$static, layoutPanel){
  ...
  for ($location_0[stackIndex] = 'GridLayout.java:' + '343' , iter = $LayoutPanel$3(($location_0[stackIndex] = 'LayoutPanel.java:' + '553' , new LayoutPanel$3), layoutPanel); $location_0[stackIndex] = 'LayoutPanel.java:' + '557' , $hasNext_1(iter.iter);) {
    ...
    $location_0[stackIndex] = 'GridLayout.java:' + '348' , $clinit_625();
...
function $fireIntervalAdded(this$static, source, index0, index1){
  ...
  event_0 = ($location_0[stackIndex] = 'AbstractListModel.java:' + '64' , $ListDataEvent(($location_0[stackIndex] = 'AbstractListModel.java:' + '64' , new ListDataEvent), source, ($location_0[stackIndex] = 'ListDataEvent.java:' + '33' , $clinit_825() , INTERVAL_ADDED), index0, index1));
...
function $fireIntervalRemoved(this$static, source, index0, index1){
  ...
  event_0 = ($location_0[stackIndex] = 'AbstractListModel.java:' + '78' , $ListDataEvent(($location_0[stackIndex] = 'AbstractListModel.java:' + '78' , new ListDataEvent), source, ($location_0[stackIndex] = 'ListDataEvent.java:' + '35' , $clinit_825() , INTERVAL_REMOVED), index0, index1));
...
function $clinit_825(){
  ...
  $location_0[stackIndex] = 'ListDataEvent.java:' + '29' , $clinit_825 = nullMethod;
...
function $ListDataEvent$Type(this$static, enum$name, enum$ordinal){
  ...
  $location_0[stackIndex] = 'ListDataEvent.java:' + '29' , $clinit_825();
  $location_0[stackIndex] = 'Enum.java:' + '76' , this$static.name_0 = enum$name;
  $location_0[stackIndex] = 'Enum.java:' + '77' , this$static.ordinal = enum$ordinal;
  $stackDepth_0 = stackIndex - 1;
  return this$static;
...
function $AbstractScrollTable(this$static, dataTable, headerTable, resources){
  ...
  this$static.children = $WidgetCollection(($location_0[stackIndex] = 'ComplexPanel.java:' + '28' , new WidgetCollection), this$static);
  $location_0[stackIndex] = 'AbstractScrollTable.java:' + '903' , this$static.columnResizePolicy = ($location_0[stackIndex] = 'AbstractScrollTable.java:' + '823' , $clinit_832() , MULTI_CELL);
  $location_0[stackIndex] = 'AbstractScrollTable.java:' + '981' , this$static.resizePolicy = ($location_0[stackIndex] = 'AbstractScrollTable.java:' + '844' , $clinit_837() , FLOW);
  ...
  $location_0[stackIndex] = 'AbstractScrollTable.java:' + '991' , this$static.scrollPolicy = ($location_0[stackIndex] = 'AbstractScrollTable.java:' + '874' , $clinit_838() , BOTH_0);
  $location_0[stackIndex] = 'AbstractScrollTable.java:' + '996' , this$static.sortPolicy = ($location_0[stackIndex] = 'AbstractScrollTable.java:' + '887' , $clinit_842() , SINGLE_CELL_0);
...
function $applyTableWrapperSizes(this$static, sizes){
  ...
  $location_0[stackIndex] = 'Style.java:' + '1449' , this$static.headerWrapper.style['height'] = sizes.headerTableHeight + ($location_0[stackIndex] = 'Style.java:' + '1369' , $clinit_112() , 'px');
...
function $createWrapper_0(cssName){
  ...
  $location_0[stackIndex] = 'Style.java:' + '1449' , wrapper.style['padding'] = 0 + ($location_0[stackIndex] = 'Style.java:' + '1369' , $clinit_112() , 'px');
...
function $getAvailableWidth(this$static){
  ...
  if (this$static.scrollPolicy == ($location_0[stackIndex] = 'AbstractScrollTable.java:' + '874' , $clinit_838() , BOTH_0)) {
...
function $getTableWrapperSizes(this$static){
  ...
  if (this$static.scrollPolicy == ($location_0[stackIndex] = 'AbstractScrollTable.java:' + '874' , $clinit_838() , DISABLED_0) || this$static.scrollPolicy == HORIZONTAL_1) {
    $stackDepth_0 = stackIndex - 1;
    return null;
  }
...
function $maybeRecalculateIdealColumnWidths(this$static){
  ...
  headerTable.idealColumnWidthInfo = ($location_0[stackIndex] = 'FixedWidthFlexTable.java:' + '624' , $recalculateIdealColumnWidthsSetup_0((!impl_6 && (impl_6 = ($location_0[stackIndex] = 'FixedWidthTableImpl.java:' + '65' , new FixedWidthTableImpl$Impl)) , headerTable), headerTable.maxRawColumnCount, 0));
  dataTable.idealWidths = ($location_0[stackIndex] = 'FixedWidthGrid.java:' + '480' , $recalculateIdealColumnWidths_2((!impl_6 && (impl_6 = ($location_0[stackIndex] = 'FixedWidthTableImpl.java:' + '65' , new FixedWidthTableImpl$Impl)) , dataTable.idealColumnWidthInfo)));
  headerTable.idealWidths = ($location_0[stackIndex] = 'FixedWidthFlexTable.java:' + '616' , $recalculateIdealColumnWidths_2((!impl_6 && (impl_6 = ($location_0[stackIndex] = 'FixedWidthTableImpl.java:' + '65' , new FixedWidthTableImpl$Impl)) , headerTable.idealColumnWidthInfo)));
  $location_0[stackIndex] = 'FixedWidthGrid.java:' + '500' , $recalculateIdealColumnWidthsTeardown((!impl_6 && (impl_6 = ($location_0[stackIndex] = 'FixedWidthTableImpl.java:' + '65' , new FixedWidthTableImpl$Impl)) , dataTable.idealColumnWidthInfo));
  $location_0[stackIndex] = 'FixedWidthGrid.java:' + '502' , dataTable.idealColumnWidthInfo = null;
  $location_0[stackIndex] = 'FixedWidthFlexTable.java:' + '632' , $recalculateIdealColumnWidthsTeardown((!impl_6 && (impl_6 = ($location_0[stackIndex] = 'FixedWidthTableImpl.java:' + '65' , new FixedWidthTableImpl$Impl)) , headerTable.idealColumnWidthInfo));
...
function $resizeTablesVertically(this$static){
  ...
  if (this$static.scrollPolicy == ($location_0[stackIndex] = 'AbstractScrollTable.java:' + '874' , $clinit_838() , DISABLED_0)) {
...
function $updateFillWidthImage(this$static){
  ...
  this$static.columnResizePolicy == ($location_0[stackIndex] = 'AbstractScrollTable.java:' + '823' , $clinit_832() , DISABLED) || this$static.resizePolicy.isFixedWidth?($location_0[stackIndex] = 'UIObject.java:' + '214' , this$static.fillWidthImage.element.style.display = 'none' , undefined):(this$static.fillWidthImage.element.style.display = '' , undefined);
  $stackDepth_0 = stackIndex - 1;
}
  ...
  switch ($location_0[stackIndex] = 'DOMImpl.java:' + '61' , $eventGetTypeInt(event_0.type)) {
    ...
    case 8:
      ...
      if (this.resizeWorker.resizing) {
        ...
        if (cellElem) {
          if (this.sortPolicy == ($location_0[stackIndex] = 'AbstractScrollTable.java:' + '887' , $clinit_842() , DISABLED_1)) {
            $stackDepth_0 = stackIndex - 1;
            return;
          }
...
function $clinit_830(){
  ...
  $location_0[stackIndex] = 'AbstractScrollTable.java:' + '1101' , $clinit_830 = nullMethod;
  $clinit_397();
  $stackDepth_0 = stackIndex - 1;
}
...
function $AbstractScrollTable$1(this$static, this$0){
  ...
  $location_0[stackIndex] = 'AbstractScrollTable.java:' + '1101' , $clinit_830();
  this$static.this$0 = this$0;
  $Image(this$static);
  $stackDepth_0 = stackIndex - 1;
  return this$static;
...
function $clinit_832(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_832;
  $location_0[stackIndex] = 'AbstractScrollTable.java:' + '822' , $clinit_832 = nullMethod;
...
function $AbstractScrollTable$ColumnResizePolicy(this$static, enum$name, enum$ordinal){
  ...
  $location_0[stackIndex] = 'AbstractScrollTable.java:' + '822' , $clinit_832();
  $location_0[stackIndex] = 'Enum.java:' + '76' , this$static.name_0 = enum$name;
  $location_0[stackIndex] = 'Enum.java:' + '77' , this$static.ordinal = enum$ordinal;
  $stackDepth_0 = stackIndex - 1;
  return this$static;
...
function $repositionSpacer(scrollTable, force){
  ...
  if (!force && scrollTable.scrollPolicy != ($location_0[stackIndex] = 'AbstractScrollTable.java:' + '874' , $clinit_838() , BOTH_0)) {
    $stackDepth_0 = stackIndex - 1;
    return;
  }
...
function $resizeSpacer(table, spacerWidth){
  ...
  $location_0[stackIndex] = 'Style.java:' + '1449' , table.element.style['paddingRight'] = spacerWidth + ($location_0[stackIndex] = 'Style.java:' + '1369' , $clinit_112() , 'px');
  $stackDepth_0 = stackIndex - 1;
}
...
function $resizeColumn_0(this$static){
  ...
  if (this$static.mouseXLast != this$static.mouseXCurrent) {
    ...
    $location_0[stackIndex] = 'AbstractScrollTable.java:' + '588' , $clinit_229();
...
function $setCurrentCell(this$static, event_0){
  ...
  if (this$static.table.columnResizePolicy == ($location_0[stackIndex] = 'AbstractScrollTable.java:' + '823' , $clinit_832() , MULTI_CELL)) {
  ...
  if (cell) {
    $location_0[stackIndex] = 'AbstractScrollTable.java:' + '446' , absLeft = $getAbsoluteLeftImpl(($location_0[stackIndex] = 'DOMImplMozillaOld.java:' + '41' , $getViewportElement(cell.ownerDocument)), cell) - ($location_0[stackIndex] = 'Document.java:' + '1259' , $getScrollLeft_0($doc));
    $location_0[stackIndex] = 'AbstractScrollTable.java:' + '447' , $clinit_229();
...
function $clinit_836(){
  ...
  $location_0[stackIndex] = 'AbstractScrollTable.java:' + '373' , $clinit_836 = nullMethod;
  $clinit_43();
  $stackDepth_0 = stackIndex - 1;
}
...
function $AbstractScrollTable$MouseResizeWorker$1(this$static, this$1){
  ...
  $location_0[stackIndex] = 'AbstractScrollTable.java:' + '373' , $clinit_836();
...
function $clinit_837(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_837;
  $location_0[stackIndex] = 'AbstractScrollTable.java:' + '843' , $clinit_837 = nullMethod;
...
function $AbstractScrollTable$ResizePolicy(this$static, enum$name, enum$ordinal, isFixedWidth, isSacrificial){
  ...
  $location_0[stackIndex] = 'AbstractScrollTable.java:' + '850' , $clinit_837();
  $location_0[stackIndex] = 'Enum.java:' + '76' , this$static.name_0 = enum$name;
  $location_0[stackIndex] = 'Enum.java:' + '77' , this$static.ordinal = enum$ordinal;
...
function values_18(){
  ...
  $location_0[stackIndex] = 'AbstractScrollTable.java:' + '843' , $clinit_837();
...
function $clinit_838(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_838;
  $location_0[stackIndex] = 'AbstractScrollTable.java:' + '873' , $clinit_838 = nullMethod;
...
function $AbstractScrollTable$ScrollPolicy(this$static, enum$name, enum$ordinal){
  ...
  $location_0[stackIndex] = 'AbstractScrollTable.java:' + '873' , $clinit_838();
  $location_0[stackIndex] = 'Enum.java:' + '76' , this$static.name_0 = enum$name;
  $location_0[stackIndex] = 'Enum.java:' + '77' , this$static.ordinal = enum$ordinal;
  $stackDepth_0 = stackIndex - 1;
  return this$static;
...
function $clinit_842(){
  ...
  $location_0[stackIndex] = 'AbstractScrollTable.java:' + '886' , $clinit_842 = nullMethod;
...
function $AbstractScrollTable$SortPolicy(this$static, enum$name, enum$ordinal){
  ...
  $location_0[stackIndex] = 'AbstractScrollTable.java:' + '886' , $clinit_842();
  $location_0[stackIndex] = 'Enum.java:' + '76' , this$static.name_0 = enum$name;
  $location_0[stackIndex] = 'Enum.java:' + '77' , this$static.ordinal = enum$ordinal;
  $stackDepth_0 = stackIndex - 1;
  return this$static;
...
function $getSelectedRowsSet(this$static){
  ...
  for ($location_0[stackIndex] = 'SelectionGrid.java:' + '696' , rowIndex$iterator = (outerIter = ($location_0[stackIndex] = 'AbstractMap.java:' + '107' , ($location_0[stackIndex] = 'SelectionGrid.java:' + '696' , $keySet_1(this$static.selectedRows)).val$entrySet.iterator_0()) , $AbstractMap$1$1(($location_0[stackIndex] = 'AbstractMap.java:' + '108' , new AbstractMap$1$1), outerIter)); $location_0[stackIndex] = 'AbstractMap.java:' + '110' , rowIndex$iterator.val$outerIter.hasNext();) {
    ...
    ($location_0[stackIndex] = 'TreeSet.java:' + '69' , $put_1(rowSet.map, $TableEvent$Row(($location_0[stackIndex] = 'SelectionGrid.java:' + '697' , new TableEvent$Row), rowIndex.value_0), ($location_0[stackIndex] = 'Boolean.java:' + '29' , $clinit_517() , FALSE_0))) == null;
  }
  $stackDepth_0 = stackIndex - 1;
  return rowSet;
}
...
function $onMouseClick(this$static, event_0){
  ...
  if (this$static.selectionPolicy == ($location_0[stackIndex] = 'SelectionGrid.java:' + '127' , $clinit_868() , MULTI_ROW)) {
...
function $getGhostCellElement(this$static, column){
  ...
  returnTemp = ($location_0[stackIndex] = 'DOM.java:' + '705' , $getChild((!impl_6 && (impl_6 = ($location_0[stackIndex] = 'FixedWidthTableImpl.java:' + '65' , new FixedWidthTableImpl$Impl)) , this$static.ghostRow), column));
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function $recalculateIdealColumnWidths_0(this$static){
  ...
  this$static.idealWidths = ($location_0[stackIndex] = 'FixedWidthGrid.java:' + '480' , $recalculateIdealColumnWidths_2((!impl_6 && (impl_6 = ($location_0[stackIndex] = 'FixedWidthTableImpl.java:' + '65' , new FixedWidthTableImpl$Impl)) , this$static.idealColumnWidthInfo)));
  $location_0[stackIndex] = 'FixedWidthGrid.java:' + '500' , $recalculateIdealColumnWidthsTeardown((!impl_6 && (impl_6 = ($location_0[stackIndex] = 'FixedWidthTableImpl.java:' + '65' , new FixedWidthTableImpl$Impl)) , this$static.idealColumnWidthInfo));
...
function $recalculateIdealColumnWidthsSetup(this$static){
  ...
  this$static.idealColumnWidthInfo = ($location_0[stackIndex] = 'FixedWidthGrid.java:' + '492' , $recalculateIdealColumnWidthsSetup_0((!impl_6 && (impl_6 = ($location_0[stackIndex] = 'FixedWidthTableImpl.java:' + '65' , new FixedWidthTableImpl$Impl)) , this$static), this$static.numColumns, offset));
  $stackDepth_0 = stackIndex - 1;
}
...
function $setColumnWidthImpl(this$static, column, width){
  ...
  $location_0[stackIndex] = 'FixedWidthGrid.java:' + '538' , $setColumnWidth_1((!impl_6 && (impl_6 = ($location_0[stackIndex] = 'FixedWidthTableImpl.java:' + '65' , new FixedWidthTableImpl$Impl)) , this$static.ghostRow), column, width);
  $stackDepth_0 = stackIndex - 1;
}
...
function $setSelectionPolicy_0(this$static, selectionPolicy){
  ...
  if (selectionPolicy.inputHtml != null && this$static.selectionPolicy.inputHtml == null) {
    ...
    td = ($location_0[stackIndex] = 'FixedWidthGrid.java:' + '297' , $createGhostCell((!impl_6 && (impl_6 = ($location_0[stackIndex] = 'FixedWidthTableImpl.java:' + '65' , new FixedWidthTableImpl$Impl)) , null)));
...
function $updateGhostRow(this$static){
  ...
  if (this$static.numColumns > numGhosts) {
    for ($location_0[stackIndex] = 'FixedWidthGrid.java:' + '434' , i = numGhosts; i < this$static.numColumns; $location_0[stackIndex] = 'FixedWidthGrid.java:' + '434' , ++i) {
      td = ($location_0[stackIndex] = 'FixedWidthGrid.java:' + '435' , $createGhostCell((!impl_6 && (impl_6 = ($location_0[stackIndex] = 'FixedWidthTableImpl.java:' + '65' , new FixedWidthTableImpl$Impl)) , null)));
...
function $DataTable(this$static){
  ...
  $location_0[stackIndex] = 'SelectionGrid.java:' + '200' , this$static.selectionPolicy = ($location_0[stackIndex] = 'SelectionGrid.java:' + '127' , $clinit_868() , MULTI_ROW);
  ...
  this$static.ghostRow = ($location_0[stackIndex] = 'FixedWidthGrid.java:' + '140' , $createGhostRow((!impl_6 && (impl_6 = ($location_0[stackIndex] = 'FixedWidthTableImpl.java:' + '65' , new FixedWidthTableImpl$Impl)) , impl_6)));
...
function $FixedWidthFlexTable(this$static){
  ...
  this$static.ghostRow = ($location_0[stackIndex] = 'FixedWidthFlexTable.java:' + '247' , $createGhostRow((!impl_6 && (impl_6 = ($location_0[stackIndex] = 'FixedWidthTableImpl.java:' + '65' , new FixedWidthTableImpl$Impl)) , impl_6)));
  $location_0[stackIndex] = 'DOM.java:' + '929' , $insertChild(this$static.bodyElem, this$static.ghostRow, 0);
  $stackDepth_0 = stackIndex - 1;
  return this$static;
}
...
function $recalculateIdealColumnWidths_1(this$static){
  ...
  this$static.idealColumnWidthInfo = ($location_0[stackIndex] = 'FixedWidthFlexTable.java:' + '624' , $recalculateIdealColumnWidthsSetup_0((!impl_6 && (impl_6 = ($location_0[stackIndex] = 'FixedWidthTableImpl.java:' + '65' , new FixedWidthTableImpl$Impl)) , this$static), this$static.maxRawColumnCount, 0));
  this$static.idealWidths = ($location_0[stackIndex] = 'FixedWidthFlexTable.java:' + '616' , $recalculateIdealColumnWidths_2((!impl_6 && (impl_6 = ($location_0[stackIndex] = 'FixedWidthTableImpl.java:' + '65' , new FixedWidthTableImpl$Impl)) , this$static.idealColumnWidthInfo)));
  $location_0[stackIndex] = 'FixedWidthFlexTable.java:' + '632' , $recalculateIdealColumnWidthsTeardown((!impl_6 && (impl_6 = ($location_0[stackIndex] = 'FixedWidthTableImpl.java:' + '65' , new FixedWidthTableImpl$Impl)) , this$static.idealColumnWidthInfo));
...
function $setColumnWidth_0(this$static, column, width){
  ...
  $location_0[stackIndex] = 'FixedWidthFlexTable.java:' + '479' , $setColumnWidth_1((!impl_6 && (impl_6 = ($location_0[stackIndex] = 'FixedWidthTableImpl.java:' + '65' , new FixedWidthTableImpl$Impl)) , this$static.ghostRow), column, width);
  $stackDepth_0 = stackIndex - 1;
}
...
function $updateGhostRow_0(this$static){
  ...
  if (this$static.maxRawColumnCount > curNumGhosts) {
    ...
    for ($location_0[stackIndex] = 'FixedWidthFlexTable.java:' + '730' , i = curNumGhosts; i < this$static.maxRawColumnCount; $location_0[stackIndex] = 'FixedWidthFlexTable.java:' + '730' , ++i) {
      $location_0[stackIndex] = 'FixedWidthFlexTable.java:' + '731' , td = ($location_0[stackIndex] = 'DOM.java:' + '705' , $getChild((!impl_6 && (impl_6 = ($location_0[stackIndex] = 'FixedWidthTableImpl.java:' + '65' , new FixedWidthTableImpl$Impl)) , this$static.ghostRow), i));
      $location_0[stackIndex] = 'FixedWidthFlexTable.java:' + '732' , $createGhostCell((!impl_6 && (impl_6 = ($location_0[stackIndex] = 'FixedWidthTableImpl.java:' + '65' , new FixedWidthTableImpl$Impl)) , td));
    ...
    for ($location_0[stackIndex] = 'FixedWidthFlexTable.java:' + '738' , i = 0; i < cellsToRemove; $location_0[stackIndex] = 'FixedWidthFlexTable.java:' + '738' , ++i) {
      $location_0[stackIndex] = 'Node.java:' + '285' , this$static.ghostRow.removeChild(($location_0[stackIndex] = 'DOM.java:' + '705' , $getChild((!impl_6 && (impl_6 = ($location_0[stackIndex] = 'FixedWidthTableImpl.java:' + '65' , new FixedWidthTableImpl$Impl)) , this$static.ghostRow), this$static.maxRawColumnCount)));
    }
  }
  $stackDepth_0 = stackIndex - 1;
}
...
function $createGhostCell(td){
  ...
  $location_0[stackIndex] = 'Style.java:' + '1449' , td.style['height'] = 0 + ($location_0[stackIndex] = 'Style.java:' + '1369' , $clinit_112() , 'px');
...
function $createGhostRow(){
  ...
  $location_0[stackIndex] = 'Style.java:' + '1449' , ghostRow.style['margin'] = 0 + ($location_0[stackIndex] = 'Style.java:' + '1369' , $clinit_112() , 'px');
...
function $setColumnWidth_1(ghostRow, column, width){
  ...
  $location_0[stackIndex] = 'Style.java:' + '1449' , ($location_0[stackIndex] = 'DOM.java:' + '705' , $getChild(ghostRow, column)).style['width'] = width + ($location_0[stackIndex] = 'Style.java:' + '1369' , $clinit_112() , 'px');
  $stackDepth_0 = stackIndex - 1;
}
...
function $isColumnSortable(this$static, column){
  ...
  returnTemp = this$static.sortPolicy != ($location_0[stackIndex] = 'AbstractScrollTable.java:' + '887' , $clinit_842() , DISABLED_1) && !($location_0[stackIndex] = 'HashSet.java:' + '83' , $containsKey_0(this$static.unsortableColumns.map, ($location_0[stackIndex] = 'ScrollTable.java:' + '116' , valueOf_4(column))));
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function isColumnSortable(column){
  var stackIndex, returnTemp;
  $stack_0[stackIndex = ++$stackDepth_0] = isColumnSortable;
  returnTemp = this.sortPolicy != ($location_0[stackIndex] = 'AbstractScrollTable.java:' + '887' , $clinit_842() , DISABLED_1) && !($location_0[stackIndex] = 'HashSet.java:' + '83' , $containsKey_0(this.unsortableColumns.map, ($location_0[stackIndex] = 'ScrollTable.java:' + '116' , valueOf_4(column))));
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function $clinit_868(){
  ...
  $location_0[stackIndex] = 'SelectionGrid.java:' + '126' , $clinit_868 = nullMethod;
...
function $SelectionGrid$SelectionPolicy(this$static, enum$name, enum$ordinal, inputHtml){
  ...
  $location_0[stackIndex] = 'SelectionGrid.java:' + '132' , $clinit_868();
  $location_0[stackIndex] = 'Enum.java:' + '76' , this$static.name_0 = enum$name;
  $location_0[stackIndex] = 'Enum.java:' + '77' , this$static.ordinal = enum$ordinal;
...
function values_21(){
  ...
  $location_0[stackIndex] = 'SelectionGrid.java:' + '126' , $clinit_868();
...
function getClass_587(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_587;
  $stackDepth_0 = stackIndex - 1;
...
function createButtonLabel(image, text, type){
  ...
  if (type == ($location_0[stackIndex] = 'ButtonHelper.java:' + '34' , $clinit_879() , TEXT_ONLY)) {
    $stackDepth_0 = stackIndex - 1;
    return text;
  }
    ...
    $location_0[stackIndex] = 'ButtonHelper.java:' + '69' , $setCellVerticalAlignment(hpanel, html, ($location_0[stackIndex] = 'HasVerticalAlignment.java:' + '67' , $clinit_392() , ALIGN_MIDDLE));
    ...
    $location_0[stackIndex] = 'ButtonHelper.java:' + '81' , $setCellHorizontalAlignment(vpanel, html, ($location_0[stackIndex] = 'HasHorizontalAlignment.java:' + '62' , $clinit_387() , ALIGN_CENTER));
...
function $clinit_879(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_879;
  $location_0[stackIndex] = 'ButtonHelper.java:' + '33' , $clinit_879 = nullMethod;
...
function $ButtonHelper$ButtonLabelType(this$static, enum$name, enum$ordinal){
  ...
  $location_0[stackIndex] = 'ButtonHelper.java:' + '33' , $clinit_879();
  $location_0[stackIndex] = 'Enum.java:' + '76' , this$static.name_0 = enum$name;
  $location_0[stackIndex] = 'Enum.java:' + '77' , this$static.ordinal = enum$ordinal;
  $stackDepth_0 = stackIndex - 1;
  return this$static;
...
function getClass_588(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_588;
  $stackDepth_0 = stackIndex - 1;
...
function $createWindow(this$static){
  ...
  layout = $ScrollLayoutPanel_0(($location_0[stackIndex] = 'IFrameWindowPanel.java:' + '78' , new ScrollLayoutPanel), ($location_0[stackIndex] = 'IFrameWindowPanel.java:' + '78' , $BoxLayout_1(new BoxLayout, ($location_0[stackIndex] = 'BoxLayout.java:' + '170' , $clinit_798() , VERTICAL))));
  ...
  $add_26(layout, header, ($location_0[stackIndex] = 'IFrameWindowPanel.java:' + '84' , $BoxLayoutData_4(($location_0[stackIndex] = 'IFrameWindowPanel.java:' + '84' , new BoxLayoutData), ($location_0[stackIndex] = 'BoxLayoutData.java:' + '30' , $clinit_800() , HORIZONTAL_0))));
  ...
  $location_0[stackIndex] = 'IFrameWindowPanel.java:' + '154' , addMaximizeButton(this$static.windowPanel, ($location_0[stackIndex] = 'Caption.java:' + '61' , $clinit_651() , RIGHT));
...
function $clinit_929(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_929;
  $location_0[stackIndex] = 'ModelCommands.java:' + '24' , $clinit_929 = nullMethod;
...
function $ModelCommands(this$static, enum$name, enum$ordinal){
  ...
  $location_0[stackIndex] = 'ModelCommands.java:' + '24' , $clinit_929();
  $location_0[stackIndex] = 'Enum.java:' + '76' , this$static.name_0 = enum$name;
  $location_0[stackIndex] = 'Enum.java:' + '77' , this$static.ordinal = enum$ordinal;
  $stackDepth_0 = stackIndex - 1;
  return this$static;
...
function $clinit_930(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_930;
  $location_0[stackIndex] = 'ModelParts.java:' + '24' , $clinit_930 = nullMethod;
...
function $ModelParts(this$static, enum$name, enum$ordinal){
  ...
  $location_0[stackIndex] = 'ModelParts.java:' + '24' , $clinit_930();
  $location_0[stackIndex] = 'Enum.java:' + '76' , this$static.name_0 = enum$name;
  $location_0[stackIndex] = 'Enum.java:' + '77' , this$static.ordinal = enum$ordinal;
  $stackDepth_0 = stackIndex - 1;
  return this$static;
...
function $PagingPanel(this$static, callback){
  ...
  $MosaicPanel_0(this$static, ($location_0[stackIndex] = 'PagingPanel.java:' + '55' , $BoxLayout_1(($location_0[stackIndex] = 'PagingPanel.java:' + '55' , new BoxLayout), ($location_0[stackIndex] = 'BoxLayout.java:' + '170' , $clinit_798() , HORIZONTAL))));
  ...
  this$static.revBtn = ($location_0[stackIndex] = 'PagingPanel.java:' + '69' , $Button_2(($location_0[stackIndex] = 'PagingPanel.java:' + '69' , new Button), ($location_0[stackIndex] = 'ButtonHelper.java:' + '39' , createButtonLabel(($location_0[stackIndex] = 'PagingPanel.java:' + '71' , $clinit_650() , ($location_0[stackIndex] = 'CaptionImages_generatedBundle.java:' + '33' , $clinit_652()) , toolCollapseLeft_SINGLETON), '', ($location_0[stackIndex] = 'ButtonHelper.java:' + '34' , $clinit_879() , NO_TEXT))), clickHandler));
...
function parseProcessDefinition(rootModel){
  ...
  $location_0[stackIndex] = 'ProcessDefinitionRef.java:' + '141' , def.suspended = ($location_0[stackIndex] = 'JSOModel.java:' + '112' , $clinit_517() , ($location_0[stackIndex] = 'Boolean.java:' + '35' , $equalsIgnoreCase('true', '' + ($location_0[stackIndex] = 'JSOModel.java:' + '96' , rootModel['suspended']))));
...
function $initOrUpdateState(this$static){
  ...
  this$static.assignee == null || ($location_0[stackIndex] = 'TaskRef.java:' + '170' , $equals_4(this$static.assignee, ''))?($location_0[stackIndex] = 'TaskRef.java:' + '172' , this$static.currentState = ($location_0[stackIndex] = 'TaskRef.java:' + '47' , $clinit_956() , OPEN)):($location_0[stackIndex] = 'TaskRef.java:' + '176' , this$static.currentState = ($location_0[stackIndex] = 'TaskRef.java:' + '47' , $clinit_956() , ASSIGNED));
  $stackDepth_0 = stackIndex - 1;
}
...
function $clinit_956(){
  ...
  $location_0[stackIndex] = 'TaskRef.java:' + '47' , $clinit_956 = nullMethod;
...
function $TaskRef$STATE(this$static, enum$name, enum$ordinal){
  ...
  $location_0[stackIndex] = 'TaskRef.java:' + '47' , $clinit_956();
  $location_0[stackIndex] = 'Enum.java:' + '76' , this$static.name_0 = enum$name;
  $location_0[stackIndex] = 'Enum.java:' + '77' , this$static.ordinal = enum$ordinal;
  $stackDepth_0 = stackIndex - 1;
  return this$static;
...
_.listBox = null;
_.taskList = null;
function $clinit_1036(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_1036;
  $location_0[stackIndex] = 'AssignTaskAction.java:' + '35' , $clinit_1036 = nullMethod;
...
function $AssignTaskAction(this$static){
  ...
  $location_0[stackIndex] = 'AssignTaskAction.java:' + '35' , $clinit_1036();
...
function handleSuccessfulResponse_13(controller, event_0, response){
  ...
  $location_0[stackIndex] = 'AssignTaskAction.java:' + '60' , $handleEvent(controller, ($location_0[stackIndex] = 'AssignTaskAction.java:' + '61' , $Event(($location_0[stackIndex] = 'AssignTaskAction.java:' + '61' , new Event_0), ($location_0[stackIndex] = 'ReloadAllTaskListsAction.java:' + '38' , $clinit_1068() , ID_32), null)));
  $stackDepth_0 = stackIndex - 1;
}
...
function $clinit_1039(){
  ...
  $location_0[stackIndex] = 'AssignedTasksView.java:' + '57' , $clinit_1039 = nullMethod;
...
function $initialize_3(this$static){
  ...
  if (!this$static.isInitialized) {
    ...
    this$static.taskList = $MosaicPanel_0(($location_0[stackIndex] = 'AssignedTasksView.java:' + '105' , new MosaicPanel), ($location_0[stackIndex] = 'AssignedTasksView.java:' + '105' , $BoxLayout_1(new BoxLayout, ($location_0[stackIndex] = 'BoxLayout.java:' + '170' , $clinit_798() , VERTICAL))));
    ...
    $add_26(toolBox, toolBar, ($location_0[stackIndex] = 'AssignedTasksView.java:' + '272' , $BoxLayoutData_4(($location_0[stackIndex] = 'AssignedTasksView.java:' + '272' , new BoxLayoutData), ($location_0[stackIndex] = 'BoxLayoutData.java:' + '30' , $clinit_800() , HORIZONTAL_0))));
    ...
    $location_0[stackIndex] = 'AssignedTasksView.java:' + '306' , $clinit_1093();
...
function $renderUpdate_0(this$static){
  ...
  $location_0[stackIndex] = 'AssignedTasksView.java:' + '353' , $handleEvent(this$static.controller_0, $Event(($location_0[stackIndex] = 'AssignedTasksView.java:' + '354' , new Event_0), ($location_0[stackIndex] = 'UpdateDetailsAction.java:' + '35' , $clinit_1072() , ID_34), $DetailViewEvent(($location_0[stackIndex] = 'AssignedTasksView.java:' + '354' , new DetailViewEvent), 'AssignedDetailView', null)));
  ...
  for (task$iterator = ($location_0[stackIndex] = 'AssignedTasksView.java:' + '383' , trimmed.iterator_0()); $location_0[stackIndex] = 'AssignedTasksView.java:' + '383' , task$iterator.hasNext();) {
    ...
    ($location_0[stackIndex] = 'TaskRef.java:' + '47' , $clinit_956() , ASSIGNED) == task.currentState && ($location_0[stackIndex] = 'DefaultListModel.java:' + '45' , $add_6(model.list, task));
  }
  $stackDepth_0 = stackIndex - 1;
}
...
function onRowSelection_1(rowSelectionEvent){
  ...
  if (task) {
    ...
    $location_0[stackIndex] = 'AssignedTasksView.java:' + '153' , $handleEvent(this.this$0.controller_0, $Event(($location_0[stackIndex] = 'AssignedTasksView.java:' + '154' , new Event_0), ($location_0[stackIndex] = 'UpdateDetailsAction.java:' + '35' , $clinit_1072() , ID_34), $DetailViewEvent(($location_0[stackIndex] = 'AssignedTasksView.java:' + '154' , new DetailViewEvent), 'AssignedDetailView', task)));
  }
  $stackDepth_0 = stackIndex - 1;
}
...
function onClick_27(clickEvent){
  ...
  $location_0[stackIndex] = 'AssignedTasksView.java:' + '340' , $handleEvent(this.this$0.controller_0, ($location_0[stackIndex] = 'AssignedTasksView.java:' + '341' , $Event(($location_0[stackIndex] = 'AssignedTasksView.java:' + '341' , new Event_0), ($location_0[stackIndex] = 'LoadTasksAction.java:' + '45' , $clinit_1051() , ID_28), dynamicCast(($location_0[stackIndex] = 'ErraiApplication.java:' + '129' , get_16(Lorg_jboss_bpm_console_client_Authentication_2_classLit)), 230).username)));
  $stackDepth_0 = stackIndex - 1;
}
...
function onClick_28(clickEvent){
  ...
  if (selection) {
    if (selection.url != null && !($location_0[stackIndex] = 'AssignedTasksView.java:' + '190' , $equals_4(selection.url, ''))) {
      ...
      $location_0[stackIndex] = 'AssignedTasksView.java:' + '210' , $clinit_686();
      $location_0[stackIndex] = 'MessageBox.java:' + '111' , alert_2(($location_0[stackIndex] = 'MessageBox.java:' + '60' , $clinit_695() , ALERT), 'Invalid operation', "The task doesn't provide a UI");
    }
  }
   else {
    $location_0[stackIndex] = 'AssignedTasksView.java:' + '215' , $clinit_686();
    $location_0[stackIndex] = 'MessageBox.java:' + '111' , alert_2(($location_0[stackIndex] = 'MessageBox.java:' + '60' , $clinit_695() , ALERT), 'Missing selection', 'Please select a task');
  }
  $stackDepth_0 = stackIndex - 1;
}
...
function onWindowClosed_0(){
  ...
  $location_0[stackIndex] = 'AssignedTasksView.java:' + '340' , $handleEvent(this.this$1.this$0.controller_0, ($location_0[stackIndex] = 'AssignedTasksView.java:' + '341' , $Event(($location_0[stackIndex] = 'AssignedTasksView.java:' + '341' , new Event_0), ($location_0[stackIndex] = 'LoadTasksAction.java:' + '45' , $clinit_1051() , ID_28), dynamicCast(($location_0[stackIndex] = 'ErraiApplication.java:' + '129' , get_16(Lorg_jboss_bpm_console_client_Authentication_2_classLit)), 230).username)));
  $stackDepth_0 = stackIndex - 1;
}
...
function onClick_29(clickEvent){
  ...
  if (selection) {
    ...
    $location_0[stackIndex] = 'AssignedTasksView.java:' + '234' , $handleEvent(this.this$0.controller_0, ($location_0[stackIndex] = 'AssignedTasksView.java:' + '235' , $Event(($location_0[stackIndex] = 'AssignedTasksView.java:' + '235' , new Event_0), ($location_0[stackIndex] = 'ReleaseTaskAction.java:' + '37' , $clinit_1067() , ID_31), payload)));
  }
   else {
    $location_0[stackIndex] = 'AssignedTasksView.java:' + '240' , $clinit_686();
    $location_0[stackIndex] = 'MessageBox.java:' + '111' , alert_2(($location_0[stackIndex] = 'MessageBox.java:' + '60' , $clinit_695() , ALERT), 'Missing selection', 'Please select a task');
  }
  $stackDepth_0 = stackIndex - 1;
}
...
function onClick_30(clickEvent){
  ...
  if (!!selection && !selection.isBlocking) {
    $location_0[stackIndex] = 'AssignedTasksView.java:' + '254' , $handleEvent(this.this$0.controller_0, ($location_0[stackIndex] = 'AssignedTasksView.java:' + '255' , $Event(($location_0[stackIndex] = 'AssignedTasksView.java:' + '255' , new Event_0), ($location_0[stackIndex] = 'SkipTaskAction.java:' + '14' , $clinit_1069() , ID_33), ($location_0[stackIndex] = 'AssignedTasksView.java:' + '257' , $TaskIdentityEvent(($location_0[stackIndex] = 'AssignedTasksView.java:' + '257' , new TaskIdentityEvent), dynamicCast(($location_0[stackIndex] = 'ErraiApplication.java:' + '129' , get_16(Lorg_jboss_bpm_console_client_Authentication_2_classLit)), 230).username, selection)))));
  }
   else {
    $location_0[stackIndex] = 'AssignedTasksView.java:' + '263' , $clinit_686();
    $location_0[stackIndex] = 'MessageBox.java:' + '111' , alert_2(($location_0[stackIndex] = 'MessageBox.java:' + '60' , $clinit_695() , ALERT), 'Missing selection', 'Please select a task');
  }
  $stackDepth_0 = stackIndex - 1;
}
...
function callback_2(message){
  ...
  ($location_0[stackIndex] = 'ModelCommands.java:' + '24' , $clinit_929() , ($location_0[stackIndex] = 'ModelCommands.java:' + '24' , valueOf_0(enum$map, ($location_0[stackIndex] = 'AssignedTasksView.java:' + '311' , message.getCommandType())))).ordinal == 1 && $equals_4(dynamicCast(($location_0[stackIndex] = 'AssignedTasksView.java:' + '314' , message.get_2(Ljava_lang_String_2_classLit, ($location_0[stackIndex] = 'ModelParts.java:' + '27' , $clinit_930() , CLASS))), 1), 'processModel') && ($location_0[stackIndex] = 'AssignedTasksView.java:' + '340' , $handleEvent(this.this$0.controller_0, ($location_0[stackIndex] = 'AssignedTasksView.java:' + '341' , $Event(($location_0[stackIndex] = 'AssignedTasksView.java:' + '341' , new Event_0), ($location_0[stackIndex] = 'LoadTasksAction.java:' + '45' , $clinit_1051() , ID_28), dynamicCast(($location_0[stackIndex] = 'ErraiApplication.java:' + '129' , get_16(Lorg_jboss_bpm_console_client_Authentication_2_classLit)), 230).username))));
  $stackDepth_0 = stackIndex - 1;
}
...
function $clinit_1049(){
  ...
  $location_0[stackIndex] = 'AssignedTasksView.java:' + '321' , $clinit_1049 = nullMethod;
  $clinit_43();
  $stackDepth_0 = stackIndex - 1;
}
...
function $AssignedTasksView$9(this$static, this$0){
  ...
  $location_0[stackIndex] = 'AssignedTasksView.java:' + '321' , $clinit_1049();
  this$static.this$0 = this$0;
  $stackDepth_0 = stackIndex - 1;
  return this$static;
}
...
function $clinit_1050(){
  ...
  $location_0[stackIndex] = 'ClaimTaskAction.java:' + '35' , $clinit_1050 = nullMethod;
...
function $ClaimTaskAction(this$static){
  ...
  $location_0[stackIndex] = 'ClaimTaskAction.java:' + '35' , $clinit_1050();
  dynamicCast(($location_0[stackIndex] = 'AbstractRESTAction.java:' + '44' , get_16(Lorg_jboss_bpm_console_client_ApplicationContext_2_classLit)), 225);
  $stackDepth_0 = stackIndex - 1;
  return this$static;
}
...
function handleSuccessfulResponse_14(controller, event_0, response){
  ...
  $location_0[stackIndex] = 'ClaimTaskAction.java:' + '60' , $handleEvent(controller, ($location_0[stackIndex] = 'ClaimTaskAction.java:' + '61' , $Event(($location_0[stackIndex] = 'ClaimTaskAction.java:' + '61' , new Event_0), ($location_0[stackIndex] = 'ReloadAllTaskListsAction.java:' + '38' , $clinit_1068() , ID_32), null)));
  $stackDepth_0 = stackIndex - 1;
}
...
function $clinit_1051(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_1051;
  $location_0[stackIndex] = 'LoadTasksAction.java:' + '43' , $clinit_1051 = nullMethod;
...
function $LoadTasksAction(this$static){
  ...
  $location_0[stackIndex] = 'LoadTasksAction.java:' + '43' , $clinit_1051();
  dynamicCast(($location_0[stackIndex] = 'AbstractRESTAction.java:' + '44' , get_16(Lorg_jboss_bpm_console_client_ApplicationContext_2_classLit)), 225);
  $stackDepth_0 = stackIndex - 1;
  return this$static;
}
...
function getDataDriven_2(controller){
  ...
  returnTemp = ($location_0[stackIndex] = 'LoadTasksAction.java:' + '66' , dynamicCast(dynamicCast(($location_0[stackIndex] = 'Controller.java:' + '67' , $get_7(controller.views, ($location_0[stackIndex] = 'AssignedTasksView.java:' + '60' , $clinit_1039() , ID_26))), 168), 255));
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function handleSuccessfulResponse_15(controller, event_0, response){
  ...
  view = ($location_0[stackIndex] = 'LoadTasksAction.java:' + '75' , dynamicCast(dynamicCast(($location_0[stackIndex] = 'Controller.java:' + '67' , $get_7(controller.views, ($location_0[stackIndex] = 'AssignedTasksView.java:' + '60' , $clinit_1039() , ID_26))), 168), 255));
...
function $clinit_1052(){
  ...
  $location_0[stackIndex] = 'LoadTasksParticipationAction.java:' + '43' , $clinit_1052 = nullMethod;
...
function $LoadTasksParticipationAction(this$static){
  ...
  $location_0[stackIndex] = 'LoadTasksParticipationAction.java:' + '43' , $clinit_1052();
  dynamicCast(($location_0[stackIndex] = 'AbstractRESTAction.java:' + '44' , get_16(Lorg_jboss_bpm_console_client_ApplicationContext_2_classLit)), 225);
  $stackDepth_0 = stackIndex - 1;
  return this$static;
}
...
function getDataDriven_3(controller){
  ...
  returnTemp = ($location_0[stackIndex] = 'LoadTasksParticipationAction.java:' + '66' , dynamicCast(dynamicCast(($location_0[stackIndex] = 'Controller.java:' + '67' , $get_7(controller.views, ($location_0[stackIndex] = 'OpenTasksView.java:' + '59' , $clinit_1055() , ID_30))), 168), 256));
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function handleSuccessfulResponse_16(controller, event_0, response){
  ...
  view = ($location_0[stackIndex] = 'LoadTasksParticipationAction.java:' + '75' , dynamicCast(dynamicCast(($location_0[stackIndex] = 'Controller.java:' + '67' , $get_7(controller.views, ($location_0[stackIndex] = 'OpenTasksView.java:' + '59' , $clinit_1055() , ID_30))), 168), 256));
  $location_0[stackIndex] = 'Log.java:' + '354' , $clinit_24();
  $location_0[stackIndex] = 'Log.java:' + '403' , $info(impl, 'Loaded ' + tasks.size_0 + ' tasks', null);
...
function $clinit_1055(){
  ...
  $location_0[stackIndex] = 'OpenTasksView.java:' + '56' , $clinit_1055 = nullMethod;
...
function $initialize_4(this$static){
  ...
  if (!this$static.isInitialized) {
    this$static.taskList = $MosaicPanel_0(($location_0[stackIndex] = 'OpenTasksView.java:' + '127' , new MosaicPanel), ($location_0[stackIndex] = 'OpenTasksView.java:' + '127' , $BoxLayout_1(new BoxLayout, ($location_0[stackIndex] = 'BoxLayout.java:' + '170' , $clinit_798() , VERTICAL))));
    $location_0[stackIndex] = 'LayoutPanel.java:' + '289' , setStyleAttribute_0(this$static.taskList.element, 'padding', '0px');
    $location_0[stackIndex] = 'LayoutPanel.java:' + '297' , this$static.taskList.widgetSpacing = 0;
    ...
    $add_26(toolBox, toolBar, ($location_0[stackIndex] = 'OpenTasksView.java:' + '251' , $BoxLayoutData_4(($location_0[stackIndex] = 'OpenTasksView.java:' + '251' , new BoxLayoutData), ($location_0[stackIndex] = 'BoxLayoutData.java:' + '30' , $clinit_800() , HORIZONTAL_0))));
    ...
    $location_0[stackIndex] = 'OpenTasksView.java:' + '284' , $clinit_1093();
...
function $renderUpdate_1(this$static){
  ...
  $location_0[stackIndex] = 'DefaultListModel.java:' + '61' , $clear_5(model_0.list);
  $location_0[stackIndex] = 'OpenTasksView.java:' + '332' , $handleEvent(this$static.controller, $Event(($location_0[stackIndex] = 'OpenTasksView.java:' + '333' , new Event_0), ($location_0[stackIndex] = 'UpdateDetailsAction.java:' + '35' , $clinit_1072() , ID_34), $DetailViewEvent(($location_0[stackIndex] = 'OpenTasksView.java:' + '333' , new DetailViewEvent), 'OpenDetailView', null)));
  ...
  for (task$iterator = ($location_0[stackIndex] = 'OpenTasksView.java:' + '362' , trimmed.iterator_0()); $location_0[stackIndex] = 'OpenTasksView.java:' + '362' , task$iterator.hasNext();) {
    task = dynamicCast(task$iterator.next_0(), 252);
    ($location_0[stackIndex] = 'TaskRef.java:' + '47' , $clinit_956() , OPEN) == task.currentState && ($location_0[stackIndex] = 'DefaultListModel.java:' + '45' , $add_6(model.list, task));
  }
  $stackDepth_0 = stackIndex - 1;
}
...
function registerCommonActions(controller){
  ...
  $location_0[stackIndex] = 'OpenTasksView.java:' + '77' , $clinit_1055();
  if (!actionSetup) {
    $location_0[stackIndex] = 'Controller.java:' + '106' , $put_0(controller.actions, ($location_0[stackIndex] = 'LoadTasksAction.java:' + '45' , $clinit_1051() , ID_28), $LoadTasksAction(($location_0[stackIndex] = 'OpenTasksView.java:' + '82' , new LoadTasksAction)));
    $location_0[stackIndex] = 'Controller.java:' + '106' , $put_0(controller.actions, ($location_0[stackIndex] = 'LoadTasksParticipationAction.java:' + '45' , $clinit_1052() , ID_29), $LoadTasksParticipationAction(($location_0[stackIndex] = 'OpenTasksView.java:' + '83' , new LoadTasksParticipationAction)));
    $location_0[stackIndex] = 'Controller.java:' + '106' , $put_0(controller.actions, ($location_0[stackIndex] = 'ClaimTaskAction.java:' + '37' , $clinit_1050() , ID_27), $ClaimTaskAction(($location_0[stackIndex] = 'OpenTasksView.java:' + '84' , new ClaimTaskAction)));
    $location_0[stackIndex] = 'Controller.java:' + '106' , $put_0(controller.actions, ($location_0[stackIndex] = 'ReleaseTaskAction.java:' + '37' , $clinit_1067() , ID_31), $ReleaseTaskAction(($location_0[stackIndex] = 'OpenTasksView.java:' + '85' , new ReleaseTaskAction)));
    $location_0[stackIndex] = 'Controller.java:' + '106' , $put_0(controller.actions, ($location_0[stackIndex] = 'UpdateDetailsAction.java:' + '35' , $clinit_1072() , ID_34), ($location_0[stackIndex] = 'OpenTasksView.java:' + '86' , new UpdateDetailsAction));
    $location_0[stackIndex] = 'Controller.java:' + '106' , $put_0(controller.actions, ($location_0[stackIndex] = 'AssignTaskAction.java:' + '38' , $clinit_1036() , ID_25), $AssignTaskAction(($location_0[stackIndex] = 'OpenTasksView.java:' + '87' , new AssignTaskAction)));
    $location_0[stackIndex] = 'Controller.java:' + '106' , $put_0(controller.actions, ($location_0[stackIndex] = 'ReloadAllTaskListsAction.java:' + '38' , $clinit_1068() , ID_32), $ReloadAllTaskListsAction(($location_0[stackIndex] = 'OpenTasksView.java:' + '88' , new ReloadAllTaskListsAction)));
    $location_0[stackIndex] = 'Controller.java:' + '106' , $put_0(controller.actions, ($location_0[stackIndex] = 'SkipTaskAction.java:' + '14' , $clinit_1069() , ID_33), $SkipTaskAction(($location_0[stackIndex] = 'OpenTasksView.java:' + '89' , new SkipTaskAction)));
...
function onRowSelection_2(rowSelectionEvent){
  ...
  if (task) {
    task.isBlocking?($location_0[stackIndex] = 'Element.java:' + '638' , this.this$0.skipBtn.element['disabled'] = !false , undefined):(this.this$0.skipBtn.element['disabled'] = !true , undefined);
    $location_0[stackIndex] = 'OpenTasksView.java:' + '178' , $handleEvent(this.this$0.controller, $Event(($location_0[stackIndex] = 'OpenTasksView.java:' + '179' , new Event_0), ($location_0[stackIndex] = 'UpdateDetailsAction.java:' + '35' , $clinit_1072() , ID_34), $DetailViewEvent(($location_0[stackIndex] = 'OpenTasksView.java:' + '179' , new DetailViewEvent), 'OpenDetailView', task)));
  }
  $stackDepth_0 = stackIndex - 1;
}
...
function onClick_32(clickEvent){
  ...
  if (selection) {
    $location_0[stackIndex] = 'OpenTasksView.java:' + '212' , $handleEvent(this.this$0.controller, ($location_0[stackIndex] = 'OpenTasksView.java:' + '213' , $Event(($location_0[stackIndex] = 'OpenTasksView.java:' + '213' , new Event_0), ($location_0[stackIndex] = 'ClaimTaskAction.java:' + '37' , $clinit_1050() , ID_27), ($location_0[stackIndex] = 'OpenTasksView.java:' + '215' , $TaskIdentityEvent(($location_0[stackIndex] = 'OpenTasksView.java:' + '215' , new TaskIdentityEvent), dynamicCast(($location_0[stackIndex] = 'ErraiApplication.java:' + '129' , get_16(Lorg_jboss_bpm_console_client_Authentication_2_classLit)), 230).username, selection)))));
  }
   else {
    $location_0[stackIndex] = 'OpenTasksView.java:' + '221' , $clinit_686();
    $location_0[stackIndex] = 'MessageBox.java:' + '111' , alert_2(($location_0[stackIndex] = 'MessageBox.java:' + '60' , $clinit_695() , ALERT), 'Missing selection', 'Please select a task');
  }
  $stackDepth_0 = stackIndex - 1;
}
...
function onClick_33(clickEvent){
  ...
  if (!!selection && !selection.isBlocking) {
    $location_0[stackIndex] = 'OpenTasksView.java:' + '235' , $handleEvent(this.this$0.controller, ($location_0[stackIndex] = 'OpenTasksView.java:' + '236' , $Event(($location_0[stackIndex] = 'OpenTasksView.java:' + '236' , new Event_0), ($location_0[stackIndex] = 'SkipTaskAction.java:' + '14' , $clinit_1069() , ID_33), ($location_0[stackIndex] = 'OpenTasksView.java:' + '238' , $TaskIdentityEvent(($location_0[stackIndex] = 'OpenTasksView.java:' + '238' , new TaskIdentityEvent), dynamicCast(($location_0[stackIndex] = 'ErraiApplication.java:' + '129' , get_16(Lorg_jboss_bpm_console_client_Authentication_2_classLit)), 230).username, selection)))));
  }
   else {
    $location_0[stackIndex] = 'OpenTasksView.java:' + '243' , $clinit_686();
    $location_0[stackIndex] = 'MessageBox.java:' + '111' , alert_2(($location_0[stackIndex] = 'MessageBox.java:' + '60' , $clinit_695() , ALERT), 'Missing selection', 'Please select a task');
  }
  $stackDepth_0 = stackIndex - 1;
}
...
function callback_3(message){
  ...
  ($location_0[stackIndex] = 'ModelCommands.java:' + '24' , $clinit_929() , ($location_0[stackIndex] = 'ModelCommands.java:' + '24' , valueOf_0(enum$map, ($location_0[stackIndex] = 'OpenTasksView.java:' + '289' , message.getCommandType())))).ordinal == 1 && $equals_4(dynamicCast(($location_0[stackIndex] = 'OpenTasksView.java:' + '292' , message.get_2(Ljava_lang_String_2_classLit, ($location_0[stackIndex] = 'ModelParts.java:' + '27' , $clinit_930() , CLASS))), 1), 'processModel') && ($location_0[stackIndex] = 'OpenTasksView.java:' + '318' , $handleEvent(this.this$0.controller, ($location_0[stackIndex] = 'OpenTasksView.java:' + '319' , $Event(($location_0[stackIndex] = 'OpenTasksView.java:' + '319' , new Event_0), ($location_0[stackIndex] = 'LoadTasksParticipationAction.java:' + '45' , $clinit_1052() , ID_29), dynamicCast(($location_0[stackIndex] = 'AbstractTaskList.java:' + '75' , get_16(Lorg_jboss_bpm_console_client_Authentication_2_classLit)), 230).username))));
  $stackDepth_0 = stackIndex - 1;
}
...
_.typeId$ = 509;
_.this$0 = null;
function $clinit_1063(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_1063;
  $location_0[stackIndex] = 'OpenTasksView.java:' + '299' , $clinit_1063 = nullMethod;
  $clinit_43();
  $stackDepth_0 = stackIndex - 1;
}
...
function $OpenTasksView$8(this$static, this$0){
  ...
  $location_0[stackIndex] = 'OpenTasksView.java:' + '299' , $clinit_1063();
  this$static.this$0 = this$0;
  $stackDepth_0 = stackIndex - 1;
  return this$static;
}
...
function $ParticipantPanel(this$static){
  ...
  $MosaicPanel_0(this$static, ($location_0[stackIndex] = 'ParticipantPanel.java:' + '58' , $BoxLayout_1(($location_0[stackIndex] = 'ParticipantPanel.java:' + '58' , new BoxLayout), ($location_0[stackIndex] = 'BoxLayout.java:' + '170' , $clinit_798() , HORIZONTAL))));
  ...
  $add_26(this$static, treePanel, ($location_0[stackIndex] = 'ParticipantPanel.java:' + '68' , $BoxLayoutData_4(($location_0[stackIndex] = 'ParticipantPanel.java:' + '68' , new BoxLayoutData), ($location_0[stackIndex] = 'BoxLayoutData.java:' + '30' , $clinit_800() , BOTH))));
...
function onClick_34(widget){
  ...
  this.this$0.selection != null && ($location_0[stackIndex] = 'ParticipantPanel.java:' + '108' , $handleEvent(this.this$0.controller, $Event(($location_0[stackIndex] = 'ParticipantPanel.java:' + '109' , new Event_0), ($location_0[stackIndex] = 'AssignTaskAction.java:' + '38' , $clinit_1036() , ID_25), $AssignEvent(($location_0[stackIndex] = 'ParticipantPanel.java:' + '109' , new AssignEvent), this.this$0.selection, this.this$0.currentTask))));
  $stackDepth_0 = stackIndex - 1;
}
...
function $clinit_1067(){
  ...
  $location_0[stackIndex] = 'ReleaseTaskAction.java:' + '35' , $clinit_1067 = nullMethod;
...
function $ReleaseTaskAction(this$static){
  ...
  $location_0[stackIndex] = 'ReleaseTaskAction.java:' + '35' , $clinit_1067();
  dynamicCast(($location_0[stackIndex] = 'AbstractRESTAction.java:' + '44' , get_16(Lorg_jboss_bpm_console_client_ApplicationContext_2_classLit)), 225);
  $stackDepth_0 = stackIndex - 1;
  return this$static;
}
...
function handleSuccessfulResponse_17(controller, event_0, response){
  ...
  $location_0[stackIndex] = 'ReleaseTaskAction.java:' + '59' , $handleEvent(controller, ($location_0[stackIndex] = 'ReleaseTaskAction.java:' + '60' , $Event(($location_0[stackIndex] = 'ReleaseTaskAction.java:' + '60' , new Event_0), ($location_0[stackIndex] = 'LoadTasksAction.java:' + '45' , $clinit_1051() , ID_28), currentUser)));
  $stackDepth_0 = stackIndex - 1;
}
...
_.typeId$ = 514;
var ID_31;
function $clinit_1068(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_1068;
  $location_0[stackIndex] = 'ReloadAllTaskListsAction.java:' + '35' , $clinit_1068 = nullMethod;
...
function $ReloadAllTaskListsAction(this$static){
  ...
  $location_0[stackIndex] = 'ReloadAllTaskListsAction.java:' + '42' , $clinit_1068();
...
function execute_38(controller, object){
  ...
  $location_0[stackIndex] = 'ReloadAllTaskListsAction.java:' + '51' , $handleEvent(controller, ($location_0[stackIndex] = 'ReloadAllTaskListsAction.java:' + '52' , $Event(($location_0[stackIndex] = 'ReloadAllTaskListsAction.java:' + '52' , new Event_0), ($location_0[stackIndex] = 'LoadTasksAction.java:' + '45' , $clinit_1051() , ID_28), currentUser)));
  $location_0[stackIndex] = 'ReloadAllTaskListsAction.java:' + '56' , $handleEvent(controller, ($location_0[stackIndex] = 'ReloadAllTaskListsAction.java:' + '57' , $Event(($location_0[stackIndex] = 'ReloadAllTaskListsAction.java:' + '57' , new Event_0), ($location_0[stackIndex] = 'LoadTasksParticipationAction.java:' + '45' , $clinit_1052() , ID_29), currentUser)));
  $stackDepth_0 = stackIndex - 1;
}
...
_.typeId$ = 515;
var ID_32;
function $clinit_1069(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_1069;
  $location_0[stackIndex] = 'SkipTaskAction.java:' + '12' , $clinit_1069 = nullMethod;
...
function $SkipTaskAction(this$static){
  ...
  $location_0[stackIndex] = 'SkipTaskAction.java:' + '12' , $clinit_1069();
  dynamicCast(($location_0[stackIndex] = 'AbstractRESTAction.java:' + '44' , get_16(Lorg_jboss_bpm_console_client_ApplicationContext_2_classLit)), 225);
  $stackDepth_0 = stackIndex - 1;
  return this$static;
}
...
function handleSuccessfulResponse_18(controller, event_0, response){
  ...
  $location_0[stackIndex] = 'SkipTaskAction.java:' + '37' , $handleEvent(controller, ($location_0[stackIndex] = 'SkipTaskAction.java:' + '38' , $Event(($location_0[stackIndex] = 'SkipTaskAction.java:' + '38' , new Event_0), ($location_0[stackIndex] = 'ReloadAllTaskListsAction.java:' + '38' , $clinit_1068() , ID_32), null)));
  $stackDepth_0 = stackIndex - 1;
}
...
function $initialize_5(this$static){
  ...
  if (!this$static.initialzed) {
    ...
    if (this$static.openView) {
      ...
      $location_0[stackIndex] = 'TaskDetailView.java:' + '106' , $add_17(this$static.caption, dropBox, ($location_0[stackIndex] = 'Caption.java:' + '61' , $clinit_651() , RIGHT));
      $location_0[stackIndex] = 'CaptionLayoutPanel.java:' + '91' , $add_26(this$static.body_0, deck, ($location_0[stackIndex] = 'TaskDetailView.java:' + '107' , $BoxLayoutData_4(($location_0[stackIndex] = 'TaskDetailView.java:' + '107' , new BoxLayoutData), ($location_0[stackIndex] = 'BoxLayoutData.java:' + '30' , $clinit_800() , BOTH))));
...
function $clinit_1072(){
  ...
  $location_0[stackIndex] = 'UpdateDetailsAction.java:' + '32' , $clinit_1072 = nullMethod;
...
_.identity = null;
_.task = null;
function $clinit_1077(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_1077;
  $location_0[stackIndex] = 'DateLocale.java:' + '27' , $clinit_1077 = nullMethod;
...
function $DateLocale(this$static){
  ...
  $location_0[stackIndex] = 'DateLocale.java:' + '27' , $clinit_1077();
...
function $format_2(this$static, date){
  ...
  if (this$static.format != null && this$static.format.length > 0) {
    ...
    for ($location_0[stackIndex] = 'SimpleDateFormat.java:' + '59' , i = 0; i < this$static.format.length; $location_0[stackIndex] = 'SimpleDateFormat.java:' + '59' , ++i) {
      ...
      $location_0[stackIndex] = 'SimpleDateFormat.java:' + '61' , currentTokenType = ($location_0[stackIndex] = 'Arrays.java:' + '48' , $indexOf(($location_0[stackIndex] = 'DateLocale.java:' + '52' , $clinit_1077() , SUPPORTED_DF_TOKENS), thisChar)) != -1?thisChar:'';
...
function $handleToken(this$static, token, date){
  ...
  if ($location_0[stackIndex] = 'SimpleDateFormat.java:' + '96' , $equals_4('E', tc)) {
    ...
    hour > 11?(response = ($location_0[stackIndex] = 'SimpleDateFormat.java:' + '154' , $clinit_1077() , 'PM')):(response = ($location_0[stackIndex] = 'SimpleDateFormat.java:' + '156' , $clinit_1077() , 'AM'));
  }
  $stackDepth_0 = stackIndex - 1;
  return response;
}
...
function $clinit_1081(){
  ...
  $location_0[stackIndex] = 'SimpleDateParser.java:' + '34' , $clinit_1081 = nullMethod;
...
function $SimpleDateParser(this$static, format){
  ...
  $location_0[stackIndex] = 'SimpleDateParser.java:' + '137' , $clinit_1081();
...
function parse_0(input, pattern){
  var stackIndex, returnTemp;
  $stack_0[stackIndex = ++$stackDepth_0] = parse_0;
  $location_0[stackIndex] = 'SimpleDateParser.java:' + '158' , $clinit_1081();
...
function addMaximizeButton(windowPanel, captionRegion){
  ...
  maximizeBtn = ($location_0[stackIndex] = 'WindowUtil.java:' + '42' , $ImageButton(($location_0[stackIndex] = 'WindowUtil.java:' + '42' , new ImageButton), ($location_0[stackIndex] = 'WindowUtil.java:' + '43' , $clinit_650() , ($location_0[stackIndex] = 'CaptionImages_generatedBundle.java:' + '65' , $clinit_652()) , windowMaximize_SINGLETON)));
...
function addMinimizeButton(windowPanel, captionRegion){
  ...
  minimizeBtn = ($location_0[stackIndex] = 'WindowUtil.java:' + '74' , $ImageButton(($location_0[stackIndex] = 'WindowUtil.java:' + '74' , new ImageButton), ($location_0[stackIndex] = 'WindowUtil.java:' + '75' , $clinit_650() , ($location_0[stackIndex] = 'CaptionImages_generatedBundle.java:' + '69' , $clinit_652()) , windowMinimize_SINGLETON)));
...
function onClick_35(sender){
  ...
  this.val$windowPanel.windowState == ($location_0[stackIndex] = 'WindowPanel.java:' + '118' , $clinit_747() , MAXIMIZED)?($location_0[stackIndex] = 'WindowUtil.java:' + '47' , $setWindowState(this.val$windowPanel, NORMAL)):($location_0[stackIndex] = 'WindowUtil.java:' + '49' , $setWindowState(this.val$windowPanel, MAXIMIZED));
  $stackDepth_0 = stackIndex - 1;
}
...
function onWindowStateChange_0(sender, windowState, windowState1){
  ...
  sender.windowState == ($location_0[stackIndex] = 'WindowPanel.java:' + '118' , $clinit_747() , MAXIMIZED)?$setImage(this.val$maximizeBtn, ($location_0[stackIndex] = 'WindowUtil.java:' + '58' , $createImage(($location_0[stackIndex] = 'WindowUtil.java:' + '58' , $clinit_650() , ($location_0[stackIndex] = 'CaptionImages_generatedBundle.java:' + '73' , $clinit_652()) , windowRestore_SINGLETON)))):$setImage(this.val$maximizeBtn, ($location_0[stackIndex] = 'WindowUtil.java:' + '60' , $createImage(($location_0[stackIndex] = 'WindowUtil.java:' + '60' , $clinit_650() , ($location_0[stackIndex] = 'CaptionImages_generatedBundle.java:' + '65' , $clinit_652()) , windowMaximize_SINGLETON))));
  $stackDepth_0 = stackIndex - 1;
}
...
function getClass_778(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_778;
  $stackDepth_0 = stackIndex - 1;
...
function onClick_36(sender){
  ...
  $location_0[stackIndex] = 'WindowUtil.java:' + '78' , $setWindowState(this.val$windowPanel, ($location_0[stackIndex] = 'WindowPanel.java:' + '118' , $clinit_747() , NORMAL));
  $stackDepth_0 = stackIndex - 1;
}
...
function getClass_779(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_779;
  $stackDepth_0 = stackIndex - 1;
...
_.getClass$ = getClass_779;
_.toString$ = toString_59;
_.typeId$ = 0;
_.regExp = null;
function $clinit_1230(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_1230;
  $location_0[stackIndex] = 'Workspace.java:' + '57' , $clinit_1230 = nullMethod;
