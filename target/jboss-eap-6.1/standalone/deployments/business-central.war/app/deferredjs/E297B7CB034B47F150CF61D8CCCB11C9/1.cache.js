...
function onLoad(){
  ...
  instance_2 = ($location_0[stackIndex] = 'AsyncLoader1.java:' + '5' , $clinit_261() , ($location_0[stackIndex] = 'AsyncLoader1.java:' + '22' , new AsyncLoader1));
...
function $clinit_906(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_906;
  $location_0[stackIndex] = 'LoginView.java:' + '172' , $clinit_906 = nullMethod;
  $clinit_43();
  $stackDepth_0 = stackIndex - 1;
}
