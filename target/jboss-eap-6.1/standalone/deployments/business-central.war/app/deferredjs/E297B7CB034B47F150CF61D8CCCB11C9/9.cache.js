...
function runAsync_0(callback){
  ...
  $location_0[stackIndex] = 'AsyncLoader2.java:' + '28' , $clinit_265();
  var newCallback;
  ...
  if (!loading_1) {
    ...
    $location_0[stackIndex] = 'AsyncLoader2.java:' + '44' , $inject(($location_0[stackIndex] = 'AsyncFragmentLoader.java:' + '335' , $clinit_60() , BROWSER_LOADER), 2, ($location_0[stackIndex] = 'AsyncLoader2.java:' + '45' , new AsyncLoader2$1));
  }
  $stackDepth_0 = stackIndex - 1;
}
...
function runCallbackOnFailures_0(e){
  ...
  $location_0[stackIndex] = 'AsyncLoader2.java:' + '72' , $clinit_265();
...
function loadFailed_2(reason){
  ...
  $location_0[stackIndex] = 'AsyncLoader2.java:' + '9' , $clinit_265();
...
function runAsync_1(callback){
  ...
  $location_0[stackIndex] = 'AsyncLoader3.java:' + '28' , $clinit_269();
  var newCallback;
  ...
  if (!loading_2) {
    ...
    $location_0[stackIndex] = 'AsyncLoader3.java:' + '44' , $inject(($location_0[stackIndex] = 'AsyncFragmentLoader.java:' + '335' , $clinit_60() , BROWSER_LOADER), 3, ($location_0[stackIndex] = 'AsyncLoader3.java:' + '45' , new AsyncLoader3$1));
  }
  $stackDepth_0 = stackIndex - 1;
}
...
function runCallbackOnFailures_1(e){
  ...
  $location_0[stackIndex] = 'AsyncLoader3.java:' + '72' , $clinit_269();
...
function loadFailed_3(reason){
  ...
  $location_0[stackIndex] = 'AsyncLoader3.java:' + '9' , $clinit_269();
...
function runAsync_2(callback){
  ...
  $location_0[stackIndex] = 'AsyncLoader4.java:' + '28' , $clinit_273();
  var newCallback;
  ...
  if (!loading_3) {
    ...
    $location_0[stackIndex] = 'AsyncLoader4.java:' + '44' , $inject(($location_0[stackIndex] = 'AsyncFragmentLoader.java:' + '335' , $clinit_60() , BROWSER_LOADER), 4, ($location_0[stackIndex] = 'AsyncLoader4.java:' + '45' , new AsyncLoader4$1));
  }
  $stackDepth_0 = stackIndex - 1;
}
...
function runCallbackOnFailures_2(e){
  ...
  $location_0[stackIndex] = 'AsyncLoader4.java:' + '72' , $clinit_273();
...
function loadFailed_4(reason){
  ...
  $location_0[stackIndex] = 'AsyncLoader4.java:' + '9' , $clinit_273();
...
function runAsync_3(callback){
  ...
  $location_0[stackIndex] = 'AsyncLoader5.java:' + '28' , $clinit_277();
  var newCallback;
  ...
  if (!loading_4) {
    ...
    $location_0[stackIndex] = 'AsyncLoader5.java:' + '44' , $inject(($location_0[stackIndex] = 'AsyncFragmentLoader.java:' + '335' , $clinit_60() , BROWSER_LOADER), 5, ($location_0[stackIndex] = 'AsyncLoader5.java:' + '45' , new AsyncLoader5$1));
  }
  $stackDepth_0 = stackIndex - 1;
}
...
function runCallbackOnFailures_3(e){
  ...
  $location_0[stackIndex] = 'AsyncLoader5.java:' + '72' , $clinit_277();
...
function loadFailed_5(reason){
  ...
  $location_0[stackIndex] = 'AsyncLoader5.java:' + '9' , $clinit_277();
...
function runAsync_4(callback){
  ...
  $location_0[stackIndex] = 'AsyncLoader6.java:' + '28' , $clinit_281();
  var newCallback;
  ...
  if (!loading_5) {
    ...
    $location_0[stackIndex] = 'AsyncLoader6.java:' + '44' , $inject(($location_0[stackIndex] = 'AsyncFragmentLoader.java:' + '335' , $clinit_60() , BROWSER_LOADER), 6, ($location_0[stackIndex] = 'AsyncLoader6.java:' + '45' , new AsyncLoader6$1));
  }
  $stackDepth_0 = stackIndex - 1;
}
...
function runCallbackOnFailures_4(e){
  ...
  $location_0[stackIndex] = 'AsyncLoader6.java:' + '72' , $clinit_281();
...
function loadFailed_6(reason){
  ...
  $location_0[stackIndex] = 'AsyncLoader6.java:' + '9' , $clinit_281();
...
function runAsync_5(callback){
  ...
  $location_0[stackIndex] = 'AsyncLoader7.java:' + '28' , $clinit_285();
  var newCallback;
  ...
  if (!loading_6) {
    ...
    $location_0[stackIndex] = 'AsyncLoader7.java:' + '44' , $inject(($location_0[stackIndex] = 'AsyncFragmentLoader.java:' + '335' , $clinit_60() , BROWSER_LOADER), 7, ($location_0[stackIndex] = 'AsyncLoader7.java:' + '45' , new AsyncLoader7$1));
  }
  $stackDepth_0 = stackIndex - 1;
}
...
function runCallbackOnFailures_5(e){
  ...
  $location_0[stackIndex] = 'AsyncLoader7.java:' + '72' , $clinit_285();
...
function loadFailed_7(reason){
  ...
  $location_0[stackIndex] = 'AsyncLoader7.java:' + '9' , $clinit_285();
...
function onLoad_7(){
  ...
  instance_10 = ($location_0[stackIndex] = 'AsyncLoader9.java:' + '5' , $clinit_291() , ($location_0[stackIndex] = 'AsyncLoader9.java:' + '22' , new AsyncLoader9));
  $location_0[stackIndex] = 'AsyncLoader9.java:' + '23' , $fragmentHasLoaded(($location_0[stackIndex] = 'AsyncFragmentLoader.java:' + '335' , $clinit_60() , BROWSER_LOADER), 9);
...
function $newItem(this$static, historyToken, issueEvent){
  ...
  if (!($location_0[stackIndex] = 'HistoryImpl.java:' + '114' , $equals_4(historyToken, $wnd.__gwt_historyToken || ''))) {
    ...
    $location_0[stackIndex] = 'HistoryImpl.java:' + '116' , $nativeUpdate(this$static, historyToken);
...
function $nativeUpdate(this$static, historyToken){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $nativeUpdate;
  if (historyToken.length == 0) {
    var s = $wnd.location.href;
    var i = ($location_0[stackIndex] = 'HistoryImplMozilla.java:' + '44' , s.indexOf('#'));
    i != -1 && (s = ($location_0[stackIndex] = 'HistoryImplMozilla.java:' + '46' , s.substring(0, i)));
    $location_0[stackIndex] = 'HistoryImplMozilla.java:' + '48' , $wnd.location = s + '#';
  }
   else {
    $wnd.location.hash = ($location_0[stackIndex] = 'HistoryImplMozilla.java:' + '50' , this$static.encodeFragment(historyToken));
  }
  $stackDepth_0 = stackIndex - 1;
}
...
function $Label_1(this$static, text, wordWrap){
  ...
  $location_0[stackIndex] = 'Element.java:' + '621' , $setInnerText_0(this$static.element, text);
...
function $getWidget_5(this$static, index){
  ...
  returnTemp = ($location_0[stackIndex] = 'LayoutPanel.java:' + '490' , $getUnDecoratedWidget(($location_0[stackIndex] = 'ComplexPanel.java:' + '36' , $get_6(($location_0[stackIndex] = 'LayoutComposite.java:' + '89' , dynamicCast(this$static.widget, 183)).children, index))));
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function $add_22(this$static, w, tabText, asHTML){
  ...
  $location_0[stackIndex] = 'TabLayoutPanel.java:' + '211' , $insert_5(this$static, w, tabText, asHTML, ($location_0[stackIndex] = 'LayoutComposite.java:' + '89' , dynamicCast(this$static.deck.widget, 183)).children.size_0);
  $stackDepth_0 = stackIndex - 1;
}
...
function $DecoratedTabLayoutPanel(this$static){
  ...
  $location_0[stackIndex] = 'DecoratedTabLayoutPanel.java:' + '39' , $TabLayoutPanel(this$static, ($location_0[stackIndex] = 'TabLayoutPanel.java:' + '65' , $clinit_729() , TOP), true, false);
  $stackDepth_0 = stackIndex - 1;
  return this$static;
}
...
function $setHorizontalAlignment_0(this$static, align){
  ...
  $setHorizontalAlignment_1(($location_0[stackIndex] = 'ImageButton.java:' + '84' , dynamicCast(this$static.widget, 190)), align);
  $stackDepth_0 = stackIndex - 1;
}
...
function $setVerticalAlignment_0(this$static, align){
  ...
  $setVerticalAlignment_1(($location_0[stackIndex] = 'ImageButton.java:' + '92' , dynamicCast(this$static.widget, 190)), align);
  $stackDepth_0 = stackIndex - 1;
}
...
function $isCollapsed(this$static, widget){
  ...
  if ($location_0[stackIndex] = 'LayoutPanel.java:' + '738' , instanceOf(this$static.layout, 215)) {
    returnTemp = ($location_0[stackIndex] = 'BorderLayout.java:' + '688' , dynamicCast(($location_0[stackIndex] = 'LayoutPanel.java:' + '739' , dynamicCast(this$static.layout, 215) , widget).layoutData, 204)).collapsed;
    $stackDepth_0 = stackIndex - 1;
    return returnTemp;
  }
  $stackDepth_0 = stackIndex - 1;
...
function $setCollapsed_0(this$static, widget, collapse){
  ...
  if ($location_0[stackIndex] = 'LayoutPanel.java:' + '745' , instanceOf(this$static.layout, 215)) {
    if (collapse != ($location_0[stackIndex] = 'LayoutPanel.java:' + '746' , $isCollapsed(this$static, widget))) {
      $setCollapsed_2(($location_0[stackIndex] = 'LayoutPanel.java:' + '747' , dynamicCast(this$static.layout, 215)), this$static, widget, collapse);
...
function $StackLayoutPanel(this$static){
  ...
  $location_0[stackIndex] = 'StackLayoutPanel.java:' + '87' , layoutPanel = ($location_0[stackIndex] = 'LayoutComposite.java:' + '89' , dynamicCast(this$static.widget, 183));
...
function $add_27(this$static, w, stackText, asHTML){
  ...
  $location_0[stackIndex] = 'StackLayoutPanel.java:' + '122' , layoutPanel = ($location_0[stackIndex] = 'LayoutComposite.java:' + '89' , dynamicCast(this$static.widget, 183));
  $location_0[stackIndex] = 'UIObject.java:' + '449' , setStyleName(caption.element, 'mosaic-StackLayoutPanelItem', true);
  $location_0[stackIndex] = 'Caption.java:' + '133' , $addDomHandler(caption, this$static.clickHandler, ($location_0[stackIndex] = 'Caption.java:' + '133' , $clinit_132() , ($location_0[stackIndex] = 'ClickEvent.java:' + '27' , $clinit_132()) , TYPE_1));
  $location_0[stackIndex] = 'UIObject.java:' + '449' , setStyleName(content.element, 'mosaic-StackLayoutPanelContent', true);
  $location_0[stackIndex] = 'LayoutPanel.java:' + '391' , $insert_0(content, w, content.children.size_0);
  $location_0[stackIndex] = 'StackLayoutPanel.java:' + '127' , $put_0(this$static.panels, w, content);
  $add_26(layoutPanel, caption, ($location_0[stackIndex] = 'StackLayoutPanel.java:' + '128' , $BoxLayoutData_4(($location_0[stackIndex] = 'StackLayoutPanel.java:' + '128' , new BoxLayoutData), ($location_0[stackIndex] = 'BoxLayoutData.java:' + '30' , $clinit_800() , HORIZONTAL_0))));
  ...
  if (this$static.visibleStack == -1) {
    ...
    $location_0[stackIndex] = 'StackLayoutPanel.java:' + '134' , this$static.visibleStack = ($location_0[stackIndex] = 'LayoutComposite.java:' + '89' , dynamicCast(this$static.widget, 183)).children.size_0 - 2;
...
function $layout_5(this$static){
  ...
  for ($location_0[stackIndex] = 'StackLayoutPanel.java:' + '237' , i = 0 , ($location_0[stackIndex] = 'StackLayoutPanel.java:' + '237' , n = ($location_0[stackIndex] = 'LayoutComposite.java:' + '89' , dynamicCast(this$static.widget, 183)).children.size_0); i < n; $location_0[stackIndex] = 'StackLayoutPanel.java:' + '237' , ++i) {
    $location_0[stackIndex] = 'StackLayoutPanel.java:' + '238' , w = ($location_0[stackIndex] = 'LayoutPanel.java:' + '490' , $getUnDecoratedWidget(($location_0[stackIndex] = 'ComplexPanel.java:' + '36' , $get_6(($location_0[stackIndex] = 'LayoutComposite.java:' + '89' , dynamicCast(this$static.widget, 183)).children, i))));
    w != null && ($location_0[stackIndex] = 'Cast.java:' + '76' , canCast(w.typeId$, 194)) && ($location_0[stackIndex] = 'Style.java:' + '1449' , w.element.style['zIndex'] = '1' , undefined);
  }
...
function $setStackVisible(this$static, index, visible){
  ...
  caption = ($location_0[stackIndex] = 'StackLayoutPanel.java:' + '175' , dynamicCast(($location_0[stackIndex] = 'LayoutPanel.java:' + '490' , $getUnDecoratedWidget(($location_0[stackIndex] = 'ComplexPanel.java:' + '36' , $get_6(($location_0[stackIndex] = 'LayoutComposite.java:' + '89' , dynamicCast(this$static.widget, 183)).children, index)))), 194));
  content = ($location_0[stackIndex] = 'StackLayoutPanel.java:' + '176' , dynamicCast(($location_0[stackIndex] = 'LayoutPanel.java:' + '490' , $getUnDecoratedWidget(($location_0[stackIndex] = 'ComplexPanel.java:' + '36' , $get_6(($location_0[stackIndex] = 'LayoutComposite.java:' + '89' , dynamicCast(this$static.widget, 183)).children, index + 1)))), 183));
  ...
  if (visible && oldIndex >= 0) {
    ...
    if (layoutDataObject != null && ($location_0[stackIndex] = 'Cast.java:' + '76' , canCast(layoutDataObject.typeId$, 195))) {
      layoutData = ($location_0[stackIndex] = 'StackLayoutPanel.java:' + '190' , dynamicCast(layoutDataObject, 195));
...
function $showStack(this$static, index){
  ...
  if (index >= ($location_0[stackIndex] = 'LayoutComposite.java:' + '89' , dynamicCast(this$static.widget, 183)).children.size_0 || index < 0 || index == this$static.visibleStack) {
    $stackDepth_0 = stackIndex - 1;
    return;
  }
...
function onClick_7(event_0){
  ...
  if (w != null && ($location_0[stackIndex] = 'Cast.java:' + '76' , canCast(w.typeId$, 194))) {
    $location_0[stackIndex] = 'StackLayoutPanel.java:' + '78' , $showStack(this.this$0, ($location_0[stackIndex] = 'ComplexPanel.java:' + '44' , $indexOf_1(($location_0[stackIndex] = 'LayoutComposite.java:' + '89' , dynamicCast(this.this$0.widget, 183)).children, ($location_0[stackIndex] = 'LayoutPanel.java:' + '500' , $getDecoratorWidget(w)))) >> 1);
...
function $onAnimationComplete(this$static){
  ...
  for ($location_0[stackIndex] = 'StackLayoutPanel.java:' + '91' , i = 0 , ($location_0[stackIndex] = 'StackLayoutPanel.java:' + '91' , n = ($location_0[stackIndex] = 'LayoutComposite.java:' + '89' , dynamicCast(this$static.this$0.widget, 183)).children.size_0); i < n; $location_0[stackIndex] = 'StackLayoutPanel.java:' + '91' , ++i) {
    $location_0[stackIndex] = 'StackLayoutPanel.java:' + '92' , w = ($location_0[stackIndex] = 'LayoutPanel.java:' + '490' , $getUnDecoratedWidget(($location_0[stackIndex] = 'ComplexPanel.java:' + '36' , $get_6(($location_0[stackIndex] = 'LayoutComposite.java:' + '89' , dynamicCast(this$static.this$0.widget, 183)).children, i))));
    w != null && ($location_0[stackIndex] = 'Cast.java:' + '76' , canCast(w.typeId$, 194)) && ($location_0[stackIndex] = 'Style.java:' + '1449' , w.element.style['zIndex'] = '0' , undefined);
  }
  $stackDepth_0 = stackIndex - 1;
}
...
function $setBounds_0(this$static, x, y, width, height){
  ...
  $location_0[stackIndex] = 'Viewport.java:' + '115' , $clinit_432();
...
function getClass_468(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_468;
  $stackDepth_0 = stackIndex - 1;
...
function getLayoutPanel_0(){
  ...
  returnTemp = ($location_0[stackIndex] = 'LayoutComposite.java:' + '89' , dynamicCast(this.widget, 183));
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function $clinit_733(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_733;
  $location_0[stackIndex] = 'Viewport.java:' + '42' , $clinit_733 = nullMethod;
  $clinit_43();
  $stackDepth_0 = stackIndex - 1;
}
...
function $Viewport$1(this$static, this$0){
  ...
  $location_0[stackIndex] = 'Viewport.java:' + '42' , $clinit_733();
  this$static.this$0 = this$0;
  $stackDepth_0 = stackIndex - 1;
  return this$static;
}

function getClass_469(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_469;
  $stackDepth_0 = stackIndex - 1;
...
function run_8(){
  ...
  $location_0[stackIndex] = 'LayoutComposite.java:' + '125' , ($location_0[stackIndex] = 'LayoutComposite.java:' + '89' , dynamicCast(this.this$0.widget, 183)).layout_0();
  $stackDepth_0 = stackIndex - 1;
}
...
function getClass_470(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_470;
  $stackDepth_0 = stackIndex - 1;
...
function $setHorizontalAlignment_1(this$static, align){
  ...
  $location_0[stackIndex] = 'WidgetWrapper.java:' + '76' , $setAlignment_0(this$static, ($location_0[stackIndex] = 'WidgetWrapper.java:' + '67' , dynamicCast(this$static.widget, 191)));
  $stackDepth_0 = stackIndex - 1;
}
...
function $setVerticalAlignment_1(this$static, align){
  ...
  $location_0[stackIndex] = 'WidgetWrapper.java:' + '85' , $setAlignment_0(this$static, ($location_0[stackIndex] = 'WidgetWrapper.java:' + '67' , dynamicCast(this$static.widget, 191)));
  $stackDepth_0 = stackIndex - 1;
}
...
function $setCollapsed_2(this$static, layoutPanel, widget, collapse){
  ...
  layoutData = ($location_0[stackIndex] = 'BorderLayout.java:' + '697' , dynamicCast(widget.layoutData, 204));
  if (collapse) {
    if (widget == this$static.west || widget == this$static.east || widget == this$static.north || widget == this$static.south) {
      if (!layoutData.collapsedStateWidget) {
        ...
        if (layoutData.region == ($location_0[stackIndex] = 'BorderLayout.java:' + '199' , $clinit_791() , NORTH_0)) {
          imgBtn = ($location_0[stackIndex] = 'BorderLayout.java:' + '705' , $ImageButton(($location_0[stackIndex] = 'BorderLayout.java:' + '705' , new ImageButton), ($clinit_650() , ($location_0[stackIndex] = 'CaptionImages_generatedBundle.java:' + '29' , $clinit_652()) , toolCollapseDown_SINGLETON)));
          $location_0[stackIndex] = 'UIObject.java:' + '449' , setStyleName(imgBtn.element, 'NorthCollapsedImageButton', true);
          $location_0[stackIndex] = 'BorderLayout.java:' + '707' , $setHorizontalAlignment_0(imgBtn, ($location_0[stackIndex] = 'HasHorizontalAlignment.java:' + '74' , $clinit_387() , ALIGN_RIGHT));
        }
         else if (layoutData.region == EAST_0) {
          imgBtn = ($location_0[stackIndex] = 'BorderLayout.java:' + '709' , $ImageButton(($location_0[stackIndex] = 'BorderLayout.java:' + '709' , new ImageButton), ($clinit_650() , ($location_0[stackIndex] = 'CaptionImages_generatedBundle.java:' + '33' , $clinit_652()) , toolCollapseLeft_SINGLETON)));
          $location_0[stackIndex] = 'UIObject.java:' + '449' , setStyleName(imgBtn.element, 'EastCollapsedImageButton', true);
          $location_0[stackIndex] = 'BorderLayout.java:' + '711' , $setVerticalAlignment_0(imgBtn, ($location_0[stackIndex] = 'HasVerticalAlignment.java:' + '73' , $clinit_392() , ALIGN_TOP));
        }
         else if (layoutData.region == SOUTH_0) {
          imgBtn = ($location_0[stackIndex] = 'BorderLayout.java:' + '713' , $ImageButton(($location_0[stackIndex] = 'BorderLayout.java:' + '713' , new ImageButton), ($clinit_650() , ($location_0[stackIndex] = 'CaptionImages_generatedBundle.java:' + '41' , $clinit_652()) , toolCollapseUp_SINGLETON)));
          $location_0[stackIndex] = 'UIObject.java:' + '449' , setStyleName(imgBtn.element, 'SouthCollapsedImageButton', true);
          $location_0[stackIndex] = 'BorderLayout.java:' + '715' , $setHorizontalAlignment_0(imgBtn, ($location_0[stackIndex] = 'HasHorizontalAlignment.java:' + '74' , $clinit_387() , ALIGN_RIGHT));
        }
         else if (layoutData.region == WEST_0) {
          imgBtn = ($location_0[stackIndex] = 'BorderLayout.java:' + '717' , $ImageButton(($location_0[stackIndex] = 'BorderLayout.java:' + '717' , new ImageButton), ($clinit_650() , ($location_0[stackIndex] = 'CaptionImages_generatedBundle.java:' + '37' , $clinit_652()) , toolCollapseRight_SINGLETON)));
          $location_0[stackIndex] = 'UIObject.java:' + '449' , setStyleName(imgBtn.element, 'WestCollapsedImageButton', true);
          $location_0[stackIndex] = 'BorderLayout.java:' + '719' , $setVerticalAlignment_0(imgBtn, ($location_0[stackIndex] = 'HasVerticalAlignment.java:' + '73' , $clinit_392() , ALIGN_TOP));
        }
        if (!imgBtn) {
          $stackDepth_0 = stackIndex - 1;
          return;
        }
        $location_0[stackIndex] = 'ImageButton.java:' + '58' , $addDomHandler(imgBtn, $BorderLayout$1(($location_0[stackIndex] = 'BorderLayout.java:' + '724' , new BorderLayout$1), layoutPanel, widget), ($location_0[stackIndex] = 'ImageButton.java:' + '58' , $clinit_132() , ($location_0[stackIndex] = 'ClickEvent.java:' + '27' , $clinit_132()) , TYPE_1));
...
function getClass_512(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_512;
  $stackDepth_0 = stackIndex - 1;
...
function $WSLaunchButton(this$static, resource, name_0){
  ...
  $LayoutPanel_1(this$static, ($location_0[stackIndex] = 'WSLaunchButton.java:' + '45' , $BoxLayout_1(($location_0[stackIndex] = 'WSLaunchButton.java:' + '45' , new BoxLayout), ($location_0[stackIndex] = 'BoxLayout.java:' + '170' , $clinit_798() , VERTICAL))));
  $location_0[stackIndex] = 'WSLaunchButton.java:' + '48' , this$static.name_0 = name_0;
  $location_0[stackIndex] = 'WSLaunchButton.java:' + '50' , $sinkEvents_0(this$static, 124);
  html = $HTML_0(($location_0[stackIndex] = 'WSLaunchButton.java:' + '52' , new HTML), '&nbsp;&nbsp;' + ($location_0[stackIndex] = 'WSLaunchButton.java:' + '52' , $getHTML_0($ClippedImagePrototype(($location_0[stackIndex] = 'AbstractImagePrototype.java:' + '73' , new ClippedImagePrototype), resource.url, resource.left, resource.top_0, resource.width_0, resource.height_0))) + '&nbsp;<span class="WSLaunchButton-contents"> ' + this$static.name_0 + '<\/span>');
  $add_26(this$static, html, ($location_0[stackIndex] = 'WSLaunchButton.java:' + '53' , $BoxLayoutData_4(($location_0[stackIndex] = 'WSLaunchButton.java:' + '53' , new BoxLayoutData), ($location_0[stackIndex] = 'BoxLayoutData.java:' + '30' , $clinit_800() , VERTICAL_0))));
...
function $createLogPanel(parent_0){
  ...
  collapseBtn = ($location_0[stackIndex] = 'Application.java:' + '319' , $ImageButton(($location_0[stackIndex] = 'Application.java:' + '319' , new ImageButton), ($clinit_650() , ($location_0[stackIndex] = 'CaptionImages_generatedBundle.java:' + '29' , $clinit_652()) , toolCollapseDown_SINGLETON)));
  $location_0[stackIndex] = 'Application.java:' + '320' , $add_17(messagePanel.caption, collapseBtn, ($location_0[stackIndex] = 'Caption.java:' + '61' , $clinit_651() , RIGHT));
  $location_0[stackIndex] = 'ImageButton.java:' + '58' , $addDomHandler(collapseBtn, $Application$6(($location_0[stackIndex] = 'Application.java:' + '322' , new Application$6), parent_0, messagePanel), ($location_0[stackIndex] = 'ImageButton.java:' + '58' , $clinit_132() , ($location_0[stackIndex] = 'ClickEvent.java:' + '27' , $clinit_132()) , TYPE_1));
  $stackDepth_0 = stackIndex - 1;
  return messagePanel;
}
...
function $initializeUI(this$static){
  ...
  $add_26(this$static.mainLayout, this$static.menu, ($location_0[stackIndex] = 'Application.java:' + '203' , $BorderLayoutData_4(($location_0[stackIndex] = 'Application.java:' + '203' , new BorderLayoutData), ($location_0[stackIndex] = 'BorderLayout.java:' + '199' , $clinit_791() , WEST_0), '180 px', false)));
  ...
  $location_0[stackIndex] = 'WorkspaceBuilder.java:' + '40' , $clinit_1250();
...
function execute_42(){
  ...
  $stack_0[stackIndex = ++$stackDepth_0] = execute_42;
  ...
  if (null == initialToolSet) {
    $location_0[stackIndex] = 'Application.java:' + '244' , preferedTool = ($location_0[stackIndex] = 'CookiePreferences.java:' + '39' , getCookie('workspace.default.tool')) != null?($location_0[stackIndex] = 'Application.java:' + '245' , $clinit_1230() , 'ToolSet_' + ($location_0[stackIndex] = 'Workspace.java:' + '266' , $replace_0(($location_0[stackIndex] = 'CookiePreferences.java:' + '39' , getCookie('workspace.default.tool')), ' ', '_'))):null;
    if (preferedTool != null && !!($location_0[stackIndex] = 'Workspace.java:' + '158' , $findToolSet(this.this$0.workspace, preferedTool))) {
      ...
      $location_0[stackIndex] = 'Application.java:' + '254' , toolSets = ($location_0[stackIndex] = 'Workspace.java:' + '61' , $clinit_1230() , toolSets_0);
      toolSets.size_0 > 0 && ($location_0[stackIndex] = 'Application.java:' + '257' , initialToolSet = 'ToolSet_' + ($location_0[stackIndex] = 'Workspace.java:' + '266' , $replace_0(($location_0[stackIndex] = 'Application.java:' + '257' , dynamicCast(($location_0[stackIndex] = 'ArrayList.java:' + '157' , checkIndex(0, toolSets.size_0) , ($location_0[stackIndex] = 'ArrayList.java:' + '158' , toolSets.array[0])), 228)).getToolSetName(), ' ', '_')));
    }
  }
  initialToolSet != null && ($location_0[stackIndex] = 'AbstractMessageBuilder.java:' + '59' , $sendNowWith($with_0(($location_0[stackIndex] = 'Application.java:' + '265' , $with_0(($location_0[stackIndex] = 'Application.java:' + '265' , $command_0(($location_0[stackIndex] = 'Application.java:' + '265' , $toSubject_0($start(($location_0[stackIndex] = 'MessageBuilder.java:' + '40' , $AbstractMessageBuilder(($location_0[stackIndex] = 'MessageBuilder.java:' + '40' , new AbstractMessageBuilder), $JSONMessage(($location_0[stackIndex] = 'JSONMessage.java:' + '105' , new JSONMessage))))), 'Workspace')), ($location_0[stackIndex] = 'LayoutCommands.java:' + '28' , $clinit_1269() , ActivateTool))), ($location_0[stackIndex] = 'LayoutParts.java:' + '22' , $clinit_1270() , TOOLSET), initialToolSet)), TOOL, initialTool).val$sendable.this$0.message_0, ($location_0[stackIndex] = 'Application.java:' + '271' , $clinit_1093() , ($location_0[stackIndex] = 'ErraiBus.java:' + '30' , $clinit_1093()) , bus_0)) , undefined);
  $location_0[stackIndex] = 'Application.java:' + '339' , ($location_0[stackIndex] = 'LayoutComposite.java:' + '89' , dynamicCast(this.this$0.viewport.widget, 183)).layout_0();
  $stackDepth_0 = stackIndex - 1;
}
...
function $Menu(this$static){
  ...
  $LayoutPanel_1(this$static, ($location_0[stackIndex] = 'Menu.java:' + '40' , $BoxLayout_1(($location_0[stackIndex] = 'Menu.java:' + '40' , new BoxLayout), ($location_0[stackIndex] = 'BoxLayout.java:' + '170' , $clinit_798() , VERTICAL))));
  ...
  $location_0[stackIndex] = 'LayoutPanel.java:' + '216' , dynamicCast(this$static.stack.widget, 183).animationEnabled = false;
  $add_26(this$static, this$static.stack, ($location_0[stackIndex] = 'Menu.java:' + '46' , $BoxLayoutData_5(($location_0[stackIndex] = 'Menu.java:' + '46' , new BoxLayoutData), ($location_0[stackIndex] = 'BoxLayoutData.java:' + '30' , $clinit_800() , BOTH), true)));
  $stackDepth_0 = stackIndex - 1;
  return this$static;
}
...
function $toggle(this$static, id){
  ...
  $showStack(this$static.stack, dynamicCast(($location_0[stackIndex] = 'Menu.java:' + '66' , $get_7(this$static.toolsetIndex, id)), 83).value_0);
  $location_0[stackIndex] = 'LayoutComposite.java:' + '116' , $invalidate_1(($location_0[stackIndex] = 'LayoutComposite.java:' + '89' , dynamicCast(this$static.stack.widget, 183)), null);
...
_.typeId$ = 601;
_.this$0 = null;
function $clinit_1229(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_1229;
  $location_0[stackIndex] = 'Viewport.java:' + '42' , $clinit_1229 = nullMethod;
  $clinit_43();
  $stackDepth_0 = stackIndex - 1;
}
...
function $Viewport$1$1(this$static, this$1){
  ...
  $location_0[stackIndex] = 'Viewport.java:' + '42' , $clinit_1229();
...
function run_29(){
  ...
  $location_0[stackIndex] = 'Viewport.java:' + '45' , layoutHints(($location_0[stackIndex] = 'LayoutComposite.java:' + '89' , dynamicCast(this.this$1.this$0.widget, 183)));
  $stackDepth_0 = stackIndex - 1;
}
...
function $Workspace(this$static, menu){
  ...
  $location_0[stackIndex] = 'Workspace.java:' + '76' , $clinit_1230();
  ...
  $location_0[stackIndex] = 'LayoutPanel.java:' + '289' , setStyleAttribute_0(($location_0[stackIndex] = 'LayoutComposite.java:' + '89' , dynamicCast(this$static.widget, 183)).element, 'padding', '5px');
  $location_0[stackIndex] = 'Workspace.java:' + '82' , $clinit_1093();
...
function $addToolSet(this$static, toolSet){
  ...
  $location_0[stackIndex] = 'Workspace.java:' + '153' , deck.index_0 = ($location_0[stackIndex] = 'LayoutComposite.java:' + '89' , dynamicCast(this$static.widget, 183)).children.size_0;
  $location_0[stackIndex] = 'UIObject.java:' + '214' , deck.element.style.display = 'none';
  $location_0[stackIndex] = 'DeckLayoutPanel.java:' + '58' , $add_25(($location_0[stackIndex] = 'LayoutComposite.java:' + '89' , dynamicCast(this$static.widget, 183)), deck);
  $stackDepth_0 = stackIndex - 1;
}
...
function $findToolSet(this$static, id){
  ...
  for ($location_0[stackIndex] = 'Workspace.java:' + '242' , i = 0; i < ($location_0[stackIndex] = 'LayoutComposite.java:' + '89' , dynamicCast(this$static.widget, 183)).children.size_0; $location_0[stackIndex] = 'Workspace.java:' + '242' , ++i) {
    deck = ($location_0[stackIndex] = 'Workspace.java:' + '243' , dynamicCast(($location_0[stackIndex] = 'LayoutPanel.java:' + '490' , $getUnDecoratedWidget(($location_0[stackIndex] = 'ComplexPanel.java:' + '36' , $get_6(($location_0[stackIndex] = 'LayoutComposite.java:' + '89' , dynamicCast(this$static.widget, 183)).children, i)))), 285));
...
function $recordHistory(toolsetId, toolId){
  ...
  $location_0[stackIndex] = 'History.java:' + '171' , $clinit_318();
  !!impl_1 && ($location_0[stackIndex] = 'History.java:' + '173' , $newItem(impl_1, historyToken, false));
  $stackDepth_0 = stackIndex - 1;
}
...
function $showToolSet(this$static, toolSetId, toolId){
  ...
  for ($location_0[stackIndex] = 'Workspace.java:' + '192' , i = 0; i < ($location_0[stackIndex] = 'LayoutComposite.java:' + '89' , dynamicCast(deck.tabLayout.deck.widget, 183)).children.size_0; $location_0[stackIndex] = 'Workspace.java:' + '192' , ++i) {
    toolTab = ($location_0[stackIndex] = 'Workspace.java:' + '193' , dynamicCast(($location_0[stackIndex] = 'TabLayoutPanel.java:' + '300' , $getWidget_5(deck.tabLayout.deck, i)), 284));
  ...
  if (!isOpen) {
    ...
    $location_0[stackIndex] = 'Workspace.java:' + '207' , resource = dynamicCast(($location_0[stackIndex] = 'ResourceFactoryImpl.java:' + '27' , $get_7(resourceFactory.mapping, selectedTool.name_0)), 286)?dynamicCast($get_7(resourceFactory.mapping, selectedTool.name_0), 286):($location_0[stackIndex] = 'Workspace.java:' + '208' , $application());
    ...
    $location_0[stackIndex] = 'ScrollTabBar.java:' + '477' , $selectTab(deck.tabLayout.tabBar.tabBar, ($location_0[stackIndex] = 'LayoutComposite.java:' + '89' , dynamicCast(deck.tabLayout.deck.widget, 183)).children.size_0 - 1);
...
function createInstance(menu){
  ...
  $location_0[stackIndex] = 'Workspace.java:' + '65' , $clinit_1230();
...
function splitHistoryToken(tokenString){
  ...
  $location_0[stackIndex] = 'Workspace.java:' + '135' , $clinit_1230();
  var s, token;
...
function callback_13(message){
  ...
  switch (($location_0[stackIndex] = 'LayoutCommands.java:' + '20' , $clinit_1269() , ($location_0[stackIndex] = 'LayoutCommands.java:' + '20' , valueOf_0(enum$map_6, ($location_0[stackIndex] = 'Workspace.java:' + '86' , message.getCommandType())))).ordinal) {
    case 7:
      toolsetId = dynamicCast(($location_0[stackIndex] = 'Workspace.java:' + '88' , message.get_2(Ljava_lang_String_2_classLit, ($location_0[stackIndex] = 'LayoutParts.java:' + '22' , $clinit_1270() , TOOLSET))), 1);
...
function getClass_885(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_885;
  $stackDepth_0 = stackIndex - 1;
...
function onSelection_4(selectionEvent){
  ...
  toolTab = ($location_0[stackIndex] = 'Workspace.java:' + '288' , dynamicCast(($location_0[stackIndex] = 'TabLayoutPanel.java:' + '300' , $getWidget_5(this.this$1.tabLayout.deck, ($location_0[stackIndex] = 'Workspace.java:' + '288' , dynamicCast(selectionEvent.selectedItem, 83)).value_0)), 284));
...
function getClass_891(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_891;
  $stackDepth_0 = stackIndex - 1;
...
function getClass_892(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_892;
  $stackDepth_0 = stackIndex - 1;
...
function getClass_893(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_893;
  $stackDepth_0 = stackIndex - 1;
...
function getClass_895(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_895;
  $stackDepth_0 = stackIndex - 1;
...
_.getClass$ = getClass_895;
_.provideWidget = provideWidget_13;
_.typeId$ = 611;
_.component = null;
_.id_0 = null;
_.name_0 = null;
function $clinit_1250(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_1250;
  $location_0[stackIndex] = 'WorkspaceBuilder.java:' + '40' , $clinit_1250 = nullMethod;
...
function $addTool(group, name_0, component){
  ...
  $location_0[stackIndex] = 'WorkspaceBuilder.java:' + '88' , imgres = dynamicCast(($location_0[stackIndex] = 'ResourceFactoryImpl.java:' + '27' , $get_7(resourceFactory.mapping, name_0)), 286);
  ...
  dynamicCast(($location_0[stackIndex] = 'WorkspaceBuilder.java:' + '76' , $get_7(toBeLoadedGroups, group)), 171).add_0(provider);
  $stackDepth_0 = stackIndex - 1;
}
...
function $build(workspace){
  ...
  if (preferredGroupOrdering.size_0 != 0) {
    for ($location_0[stackIndex] = 'WorkspaceBuilder.java:' + '150' , group$iterator = $AbstractList$IteratorImpl(($location_0[stackIndex] = 'AbstractList.java:' + '278' , new AbstractList$IteratorImpl), preferredGroupOrdering); group$iterator.i < ($location_0[stackIndex] = 'AbstractList.java:' + '38' , group$iterator.this$0.size_1());) {
      ...
      for ($location_0[stackIndex] = 'WorkspaceBuilder.java:' + '153' , ts$iterator = $AbstractList$IteratorImpl(($location_0[stackIndex] = 'AbstractList.java:' + '278' , new AbstractList$IteratorImpl), toBeLoaded); ts$iterator.i < ($location_0[stackIndex] = 'AbstractList.java:' + '38' , ts$iterator.this$0.size_1());) {
        ts = dynamicCast(($location_0[stackIndex] = 'WorkspaceBuilder.java:' + '153' , $next_6(ts$iterator)), 228);
      ...
      if ($location_0[stackIndex] = 'WorkspaceBuilder.java:' + '162' , $containsKey_0(toBeLoadedGroups, group)) {
        ...
        for (provider$iterator = dynamicCast(($location_0[stackIndex] = 'WorkspaceBuilder.java:' + '166' , $get_7(toBeLoadedGroups, group)), 171).iterator_0(); $location_0[stackIndex] = 'WorkspaceBuilder.java:' + '166' , provider$iterator.hasNext();) {
          provider = dynamicCast(provider$iterator.next_0(), 287);
  ...
  for ($location_0[stackIndex] = 'WorkspaceBuilder.java:' + '196' , ts$iterator = $AbstractList$IteratorImpl(($location_0[stackIndex] = 'AbstractList.java:' + '278' , new AbstractList$IteratorImpl), toBeLoaded); ts$iterator.i < ($location_0[stackIndex] = 'AbstractList.java:' + '38' , ts$iterator.this$0.size_1());) {
    ts = dynamicCast(($location_0[stackIndex] = 'WorkspaceBuilder.java:' + '196' , $next_6(ts$iterator)), 228);
  ...
  for ($location_0[stackIndex] = 'WorkspaceBuilder.java:' + '201' , group$iterator = (outerIter = ($location_0[stackIndex] = 'AbstractMap.java:' + '107' , ($location_0[stackIndex] = 'WorkspaceBuilder.java:' + '201' , $keySet_1(toBeLoadedGroups)).val$entrySet.iterator_0()) , $AbstractMap$1$1(($location_0[stackIndex] = 'AbstractMap.java:' + '108' , new AbstractMap$1$1), outerIter)); $location_0[stackIndex] = 'AbstractMap.java:' + '110' , group$iterator.val$outerIter.hasNext();) {
    group = ($location_0[stackIndex] = 'WorkspaceBuilder.java:' + '201' , dynamicCast((entry = dynamicCast(($location_0[stackIndex] = 'AbstractMap.java:' + '114' , group$iterator.val$outerIter.next_0()), 88) , ($location_0[stackIndex] = 'AbstractMap.java:' + '115' , entry.getKey())), 1));
    if ($location_0[stackIndex] = 'HashSet.java:' + '83' , $containsKey_0(loaded.map, group))
      continue;
    toBeRendered = $ArrayList(($location_0[stackIndex] = 'WorkspaceBuilder.java:' + '204' , new ArrayList));
    for (provider$iterator = dynamicCast(($location_0[stackIndex] = 'WorkspaceBuilder.java:' + '205' , $get_7(toBeLoadedGroups, group)), 171).iterator_0(); $location_0[stackIndex] = 'WorkspaceBuilder.java:' + '205' , provider$iterator.hasNext();) {
      provider = dynamicCast(provider$iterator.next_0(), 287);
...
function getClass_896(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_896;
  $stackDepth_0 = stackIndex - 1;
...
function getAllProvidedTools(){
  ...
  toolArray = ($location_0[stackIndex] = 'WorkspaceBuilder.java:' + '176' , initDim(_3Lorg_jboss_errai_workspaces_client_api_Tool_2_classLit, 727, 121, this.val$toBeRendered.size_0, 0));
  $location_0[stackIndex] = 'WorkspaceBuilder.java:' + '177' , $toArray_1(this.val$toBeRendered, toolArray);
  $stackDepth_0 = stackIndex - 1;
  return toolArray;
}

function getClass_897(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_897;
  $stackDepth_0 = stackIndex - 1;
...
function getAllProvidedTools_0(){
  ...
  toolArray = ($location_0[stackIndex] = 'WorkspaceBuilder.java:' + '216' , initDim(_3Lorg_jboss_errai_workspaces_client_api_Tool_2_classLit, 727, 121, this.val$toBeRendered.size_0, 0));
  $location_0[stackIndex] = 'WorkspaceBuilder.java:' + '217' , $toArray_1(this.val$toBeRendered, toolArray);
  $stackDepth_0 = stackIndex - 1;
  return toolArray;
}

function getClass_898(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_898;
  $stackDepth_0 = stackIndex - 1;
...
function getClass_899(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_899;
  $stackDepth_0 = stackIndex - 1;
...
_.getClass$ = getClass_899;
_.onResize_0 = onResize_16;
_.typeId$ = 615;
function $clinit_1270(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_1270;
  $location_0[stackIndex] = 'LayoutParts.java:' + '20' , $clinit_1270 = nullMethod;
...
function $LayoutParts(this$static, enum$name, enum$ordinal){
  ...
  $location_0[stackIndex] = 'LayoutParts.java:' + '20' , $clinit_1270();
...
function getClass_911(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_911;
  $stackDepth_0 = stackIndex - 1;
...
function values_37(){
  var stackIndex, returnTemp;
  $stack_0[stackIndex = ++$stackDepth_0] = values_37;
  $location_0[stackIndex] = 'LayoutParts.java:' + '20' , $clinit_1270();
  returnTemp = initValues(_3Lorg_jboss_errai_workspaces_client_protocols_LayoutParts_2_classLit, 730, 124, [CommandType_0, ComponentID, InstanceID, Name_1, MultipleInstances, IconURI, Subject_0, DOMID, RespondWithCommand, NestedData, Width, Height, SizeHintsSubject, InitSubject, TOOLSET, TOOL]);
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function layoutHints(widgets){
  ...
  for (w$iterator = ($location_0[stackIndex] = 'LayoutUtil.java:' + '24' , widgets.iterator_0()); $location_0[stackIndex] = 'LayoutUtil.java:' + '24' , w$iterator.hasNext();) {
    ...
    w != null && ($location_0[stackIndex] = 'Cast.java:' + '76' , canCast(w.typeId$, 159)) && ($location_0[stackIndex] = 'LayoutUtil.java:' + '26' , dynamicCast(w, 159)).onResize_0();
  }
  $stackDepth_0 = stackIndex - 1;
}

function $clinit_1272(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_1272;
  $location_0[stackIndex] = 'WorkspaceLogger.java:' + '44' , $clinit_1272 = nullMethod;
  levels = ($location_0[stackIndex] = 'WorkspaceLogger.java:' + '48' , initValues(_3I_classLit, 677, -1, [5000, 10000, 20000, 30000, 40000, 50000, 2147483647]));
  $stackDepth_0 = stackIndex - 1;
}
...
function $WorkspaceLogger(this$static, notification){
  ...
  $location_0[stackIndex] = 'WorkspaceLogger.java:' + '77' , $clinit_1272();
  ...
  $add_26(this$static.logDockPanel, headerPanel, ($location_0[stackIndex] = 'WorkspaceLogger.java:' + '89' , $BorderLayoutData_4(($location_0[stackIndex] = 'WorkspaceLogger.java:' + '89' , new BorderLayoutData), ($location_0[stackIndex] = 'BorderLayout.java:' + '199' , $clinit_791() , NORTH_0), '30 px', false)));
...
function $makeHeader(this$static){
  ...
  this$static.levelButtons = ($location_0[stackIndex] = 'WorkspaceLogger.java:' + '233' , initDim(_3Lcom_google_gwt_user_client_ui_Button_2_classLit, 663, 63, levels.length, 0));
  for ($location_0[stackIndex] = 'WorkspaceLogger.java:' + '234' , i = 0; i < levels.length; $location_0[stackIndex] = 'WorkspaceLogger.java:' + '234' , ++i) {
    ...
    this$static.levelButtons[i] = $Button_0(($location_0[stackIndex] = 'WorkspaceLogger.java:' + '236' , new Button), levelToString(level));
    $add_5(buttonPanel, ($location_0[stackIndex] = 'WorkspaceLogger.java:' + '237' , this$static.levelButtons[i]));
    $location_0[stackIndex] = 'FocusWidget.java:' + '91' , $addDomHandler(($location_0[stackIndex] = 'WorkspaceLogger.java:' + '238' , this$static.levelButtons[i]), $WorkspaceLogger$2(new WorkspaceLogger$2, level), ($location_0[stackIndex] = 'FocusWidget.java:' + '91' , $clinit_132() , ($location_0[stackIndex] = 'ClickEvent.java:' + '27' , $clinit_132()) , TYPE_1));
  }
  clearButton = $Button_0(($location_0[stackIndex] = 'WorkspaceLogger.java:' + '246' , new Button), 'Clear');
  ...
  $location_0[stackIndex] = 'FocusWidget.java:' + '91' , $addDomHandler(clearButton, ($location_0[stackIndex] = 'WorkspaceLogger.java:' + '249' , new WorkspaceLogger$3), ($location_0[stackIndex] = 'FocusWidget.java:' + '91' , $clinit_132() , ($location_0[stackIndex] = 'ClickEvent.java:' + '27' , $clinit_132()) , TYPE_1));
...
function getClass_912(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_912;
  $stackDepth_0 = stackIndex - 1;
...
_.timer = null;
var levels;
function $clinit_1273(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_1273;
  $location_0[stackIndex] = 'WorkspaceLogger.java:' + '96' , $clinit_1273 = nullMethod;
  $clinit_43();
  $stackDepth_0 = stackIndex - 1;
}
...
function $WorkspaceLogger$1(this$static, this$0){
  ...
  $location_0[stackIndex] = 'WorkspaceLogger.java:' + '96' , $clinit_1273();
  this$static.this$0 = this$0;
  $stackDepth_0 = stackIndex - 1;
  return this$static;
}

function getClass_913(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_913;
  $stackDepth_0 = stackIndex - 1;
...
function run_31(){
  ...
  $location_0[stackIndex] = 'WorkspaceLogger.java:' + '100' , $setHTML(this.this$0.logTextArea, ($location_0[stackIndex] = 'Element.java:' + '259' , $clinit_81() , this.this$0.logTextArea.element).innerHTML + this.this$0.logText);
...
function execute_48(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = execute_48;
  $location_0[stackIndex] = 'Element.java:' + '658' , this.this$1.this$0.scrollPanel.element['scrollTop'] = 107374182;
  $stackDepth_0 = stackIndex - 1;
}

function getClass_914(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_914;
  $stackDepth_0 = stackIndex - 1;
...
_.execute = execute_48;
_.getClass$ = getClass_914;
_.typeId$ = 628;
_.this$1 = null;
...
function getClass_915(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_915;
  $stackDepth_0 = stackIndex - 1;
...
function onClick_44(event_0){
  ...
  $setFocus(($location_0[stackIndex] = 'WorkspaceLogger.java:' + '240' , dynamicCast(event_0.source_0, 63)), false);
...
_.getClass$ = getClass_915;
_.onClick = onClick_44;
_.typeId$ = 629;
_.val$level = 0;
function getClass_916(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_916;
  $stackDepth_0 = stackIndex - 1;
...
function onClick_45(event_0){
  ...
  $setFocus(($location_0[stackIndex] = 'WorkspaceLogger.java:' + '251' , dynamicCast(event_0.source_0, 63)), false);
...
function $WSToolSetLauncher(this$static, id, toolSet){
  ...
  $LayoutPanel_1(this$static, ($location_0[stackIndex] = 'WSToolSetLauncher.java:' + '52' , $BoxLayout_1(($location_0[stackIndex] = 'WSToolSetLauncher.java:' + '52' , new BoxLayout), ($location_0[stackIndex] = 'BoxLayout.java:' + '170' , $clinit_798() , VERTICAL))));
...
function $addLink(this$static, name_0, tool){
  ...
  $location_0[stackIndex] = 'WSToolSetLauncher.java:' + '79' , resource = dynamicCast(($location_0[stackIndex] = 'ResourceFactoryImpl.java:' + '27' , $get_7(resourceFactory.mapping, tool.name_0)), 286)?dynamicCast($get_7(resourceFactory.mapping, tool.name_0), 286):($location_0[stackIndex] = 'WSToolSetLauncher.java:' + '80' , $application());
  ...
  $add_26(this$static, button, ($location_0[stackIndex] = 'WSToolSetLauncher.java:' + '100' , $BoxLayoutData_4(($location_0[stackIndex] = 'WSToolSetLauncher.java:' + '100' , new BoxLayoutData), ($location_0[stackIndex] = 'BoxLayoutData.java:' + '30' , $clinit_800() , HORIZONTAL_0))));
  $stackDepth_0 = stackIndex - 1;
}

function getClass_917(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_917;
  $stackDepth_0 = stackIndex - 1;
...
function getClass_918(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_918;
  $stackDepth_0 = stackIndex - 1;
