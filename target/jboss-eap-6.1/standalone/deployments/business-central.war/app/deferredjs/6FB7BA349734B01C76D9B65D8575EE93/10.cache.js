...
function compareTo(p0){
  ...
  returnTemp = this.ordinal - ($location_0[stackIndex] = 'com.google.gwt.dev.jjs.impl.GenerateJavaAST:' + '0' , dynamicCast(p0, 82)).ordinal;
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function $clinit_129(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_129;
  $location_0[stackIndex] = 'ChangeEvent.java:' + '21' , $clinit_129 = nullMethod;
  TYPE_0 = ($location_0[stackIndex] = 'ChangeEvent.java:' + '27' , $DomEvent$Type(($location_0[stackIndex] = 'ChangeEvent.java:' + '27' , new DomEvent$Type), 'change', ($location_0[stackIndex] = 'ChangeEvent.java:' + '44' , $clinit_129() , ($location_0[stackIndex] = 'ChangeEvent.java:' + '28' , new ChangeEvent))));
  $stackDepth_0 = stackIndex - 1;
}
...
function initDims_0(arrayClasses, typeIdExprs, queryIdExprs, dimExprs, index, count, seedType){
  ...
  $location_0[stackIndex] = 'Array.java:' + '169' , $clinit_249();
...
function $clinit_264(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_264;
  $location_0[stackIndex] = 'AsyncLoader2.java:' + '5' , $clinit_264 = nullMethod;
...
function $clinit_268(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_268;
  $location_0[stackIndex] = 'AsyncLoader3.java:' + '5' , $clinit_268 = nullMethod;
...
function $clinit_272(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_272;
  $location_0[stackIndex] = 'AsyncLoader4.java:' + '5' , $clinit_272 = nullMethod;
...
function $clinit_276(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_276;
  $location_0[stackIndex] = 'AsyncLoader5.java:' + '5' , $clinit_276 = nullMethod;
...
function $clinit_280(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_280;
  $location_0[stackIndex] = 'AsyncLoader6.java:' + '5' , $clinit_280 = nullMethod;
...
function $clinit_284(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_284;
  $location_0[stackIndex] = 'AsyncLoader7.java:' + '5' , $clinit_284 = nullMethod;
...
function $eventGetToElement(evt){
  ...
  if ($location_0[stackIndex] = 'DOMImplStandard.java:' + '60' , $equals_4(evt.type, 'mouseout')) {
    returnTemp = ($location_0[stackIndex] = 'NativeEvent.java:' + '161' , $eventGetRelatedTarget(evt));
    $stackDepth_0 = stackIndex - 1;
    return returnTemp;
  }
  $stackDepth_0 = stackIndex - 1;
...
function $FocusWidget(this$static, elem){
  ...
  $location_0[stackIndex] = 'FocusWidget.java:' + '82' , $clinit_353();
  $location_0[stackIndex] = 'UIObject.java:' + '799' , this$static.element = elem;
...
function addClickHandler(handler){
  ...
  returnTemp = ($location_0[stackIndex] = 'FocusWidget.java:' + '91' , $addDomHandler(this, handler, ($location_0[stackIndex] = 'FocusWidget.java:' + '91' , $clinit_131() , ($location_0[stackIndex] = 'ClickEvent.java:' + '27' , $clinit_131()) , TYPE_1)));
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function $Button_1(this$static, html, listener){
  var rtn, stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $Button_1;
  $location_0[stackIndex] = 'Button.java:' + '91' , $clinit_355();
  $location_0[stackIndex] = 'Button.java:' + '92' , $Button_0(this$static, html);
...
function getClass_209(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_209;
  $stackDepth_0 = stackIndex - 1;
...
function $TabBar(this$static){
  ...
  $location_0[stackIndex] = 'TabBar.java:' + '189' , $sinkEvents_0(this$static, 1);
  ...
  $location_0[stackIndex] = 'HorizontalPanel.java:' + '106' , this$static.panel.vertAlign = ($location_0[stackIndex] = 'HasVerticalAlignment.java:' + '61' , $clinit_391() , ALIGN_BOTTOM);
...
function $getTabHTML(this$static, index){
  ...
  delPanel = ($location_0[stackIndex] = 'TabBar.java:' + '309' , dynamicCast(($location_0[stackIndex] = 'ComplexPanel.java:' + '36' , $get_6(this$static.panel.children, index + 1)), 160));
  ...
  if (widget != null && ($location_0[stackIndex] = 'Cast.java:' + '76' , canCast(widget.typeId$, 161))) {
    returnTemp = ($location_0[stackIndex] = 'Element.java:' + '259' , $clinit_81() , ($location_0[stackIndex] = 'TabBar.java:' + '313' , dynamicCast(widget, 161)).element).innerHTML;
    $stackDepth_0 = stackIndex - 1;
    return returnTemp;
  }
   else if (widget != null && ($location_0[stackIndex] = 'Cast.java:' + '76' , canCast(widget.typeId$, 162))) {
    returnTemp = ($location_0[stackIndex] = 'Element.java:' + '266' , $clinit_81() , ($location_0[stackIndex] = 'TabBar.java:' + '315' , dynamicCast(widget, 162)).element).textContent;
    $stackDepth_0 = stackIndex - 1;
    return returnTemp;
  }
   else {
...
function getClass_211(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_211;
  $stackDepth_0 = stackIndex - 1;
...
function $clinit_362(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_362;
  $location_0[stackIndex] = 'DecoratedTabBar.java:' + '52' , $clinit_362 = nullMethod;
  TAB_ROW_STYLES = ($location_0[stackIndex] = 'DecoratedTabBar.java:' + '53' , initValues(_3Ljava_lang_String_2_classLit, 692, 1, ['tabTop', 'tabMiddle']));
  $stackDepth_0 = stackIndex - 1;
}
...
function getClass_212(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_212;
  $stackDepth_0 = stackIndex - 1;
...
function addClickHandler_0(handler){
  ...
  returnTemp = ($location_0[stackIndex] = 'Label.java:' + '128' , $addDomHandler(this, handler, ($location_0[stackIndex] = 'Label.java:' + '128' , $clinit_131() , ($location_0[stackIndex] = 'ClickEvent.java:' + '27' , $clinit_131()) , TYPE_1)));
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function getClass_219(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_219;
  $stackDepth_0 = stackIndex - 1;
...
function addClickHandler_1(handler){
  ...
  returnTemp = ($location_0[stackIndex] = 'FocusPanel.java:' + '75' , $addDomHandler(this, handler, ($location_0[stackIndex] = 'FocusPanel.java:' + '75' , $clinit_131() , ($location_0[stackIndex] = 'ClickEvent.java:' + '27' , $clinit_131()) , TYPE_1)));
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function getClass_221(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_221;
  $stackDepth_0 = stackIndex - 1;
...
function addClickHandler_2(handler){
  ...
  returnTemp = ($location_0[stackIndex] = 'HTMLTable.java:' + '694' , $addDomHandler(this, handler, ($location_0[stackIndex] = 'HTMLTable.java:' + '694' , $clinit_131() , ($location_0[stackIndex] = 'ClickEvent.java:' + '27' , $clinit_131()) , TYPE_1)));
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function $Image(this$static){
  ...
  $location_0[stackIndex] = 'Image.java:' + '345' , $clinit_396();
...
function $Image_1(this$static, url){
  ...
  $location_0[stackIndex] = 'Image.java:' + '366' , $clinit_396();
...
function addClickHandler_3(handler){
  ...
  returnTemp = ($location_0[stackIndex] = 'Image.java:' + '406' , $addHandler_1(this, handler, ($location_0[stackIndex] = 'Image.java:' + '406' , $clinit_131() , ($location_0[stackIndex] = 'ClickEvent.java:' + '27' , $clinit_131()) , TYPE_1)));
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function $Image$UnclippedState(this$static, image){
  ...
  $location_0[stackIndex] = 'DOM.java:' + '1220' , $sinkEvents(image.element, 32768);
  $location_0[stackIndex] = 'Image.java:' + '240' , $sinkEvents_0(image, 229501);
  $stackDepth_0 = stackIndex - 1;
  return this$static;
}
...
function $clinit_406(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_406;
  $location_0[stackIndex] = 'ListBox.java:' + '46' , $clinit_406 = nullMethod;
  $clinit_353();
  $stackDepth_0 = stackIndex - 1;
}
...
function $ListBox_0(this$static, isMultipleSelect){
  ...
  $location_0[stackIndex] = 'ListBox.java:' + '87' , $clinit_406();
...
function add_11(source, listener){
  ...
  $location_0[stackIndex] = 'ListBox.java:' + '104' , $addDomHandler(source, rtn, ($location_0[stackIndex] = 'ListBox.java:' + '104' , $clinit_129() , ($location_0[stackIndex] = 'ChangeEvent.java:' + '27' , $clinit_129()) , TYPE_0));
  $stackDepth_0 = stackIndex - 1;
  return rtn;
}
...
function onChange(event_0){
  ...
  $location_0[stackIndex] = 'ListenerWrapper.java:' + '196' , $onChange(($location_0[stackIndex] = 'ListenerWrapper.java:' + '196' , dynamicCast(this.listener, 151)), ($location_0[stackIndex] = 'BaseListenerWrapper.java:' + '238' , dynamicCast(event_0.source_0, 2)));
  $stackDepth_0 = stackIndex - 1;
}
...
function onClick_0(event_0){
  ...
  $location_0[stackIndex] = 'ListenerWrapper.java:' + '245' , ($location_0[stackIndex] = 'ListenerWrapper.java:' + '245' , dynamicCast(this.listener, 152)).onClick_0(($location_0[stackIndex] = 'BaseListenerWrapper.java:' + '238' , dynamicCast(event_0.source_0, 2)));
  $stackDepth_0 = stackIndex - 1;
}
...
function getClass_243(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_243;
  $stackDepth_0 = stackIndex - 1;
...
function onBeforeSelection(event_0){
  ...
  !($location_0[stackIndex] = 'ListenerWrapper.java:' + '747' , ($location_0[stackIndex] = 'ListenerWrapper.java:' + '747' , dynamicCast(this.listener, 153)).onBeforeTabSelected(($location_0[stackIndex] = 'ListenerWrapper.java:' + '748' , dynamicCast(event_0.source_0, 154)), dynamicCast(event_0.item_0, 83).value_0)) && ($location_0[stackIndex] = 'BeforeSelectionEvent.java:' + '83' , event_0.canceled = true);
  $stackDepth_0 = stackIndex - 1;
}
...
function onSelection(event_0){
  ...
  $location_0[stackIndex] = 'ListenerWrapper.java:' + '754' , ($location_0[stackIndex] = 'ListenerWrapper.java:' + '754' , dynamicCast(this.listener, 153)).onTabSelected(dynamicCast(event_0.source_0, 154), ($location_0[stackIndex] = 'ListenerWrapper.java:' + '755' , dynamicCast(event_0.selectedItem, 83)).value_0);
  $stackDepth_0 = stackIndex - 1;
}
...
function onClose_0(event_0){
  ...
  $location_0[stackIndex] = 'ListenerWrapper.java:' + '783' , dynamicCast(this.listener, 155);
  dynamicCast(event_0.target_0, 156);
  $stackDepth_0 = stackIndex - 1;
}
...
function onOpen(event_0){
  ...
  $location_0[stackIndex] = 'ListenerWrapper.java:' + '787' , dynamicCast(this.listener, 155);
  dynamicCast(event_0.target_0, 156);
  $stackDepth_0 = stackIndex - 1;
}
...
function onSelection_0(event_0){
  ...
  $onTreeItemSelected(($location_0[stackIndex] = 'ListenerWrapper.java:' + '791' , dynamicCast(this.listener, 155)), dynamicCast(event_0.selectedItem, 156));
  $stackDepth_0 = stackIndex - 1;
}
...
function $findItem(this$static, hItem){
  ...
  for ($location_0[stackIndex] = 'MenuBar.java:' + '969' , item$iterator = $AbstractList$IteratorImpl(($location_0[stackIndex] = 'AbstractList.java:' + '278' , new AbstractList$IteratorImpl), this$static.items); item$iterator.i < ($location_0[stackIndex] = 'AbstractList.java:' + '38' , item$iterator.this$0.size_1());) {
    item = dynamicCast(($location_0[stackIndex] = 'MenuBar.java:' + '969' , $next_6(item$iterator)), 157);
    if ($isOrHasChild_0(($location_0[stackIndex] = 'Node.java:' + '274' , $clinit_81() , item.element), hItem)) {
      $stackDepth_0 = stackIndex - 1;
      return item;
    }
  }
...
function $init_2(this$static, vertical){
  var outer_0, table, tr, stackIndex;
  ...
  outer_0 = ($location_0[stackIndex] = 'MenuBar.java:' + '999' , $createFocusable(($location_0[stackIndex] = 'FocusPanel.java:' + '59' , $clinit_372() , impl_1)));
  $location_0[stackIndex] = 'Node.java:' + '72' , outer_0.appendChild(table);
  $location_0[stackIndex] = 'UIObject.java:' + '799' , this$static.element = outer_0;
  $location_0[stackIndex] = 'Element.java:' + '576' , this$static.element.setAttribute('role', 'menubar');
  $location_0[stackIndex] = 'MenuBar.java:' + '1005' , $sinkEvents_0(this$static, 2225);
...
function $insertItem_0(this$static, item, beforeIndex){
  ...
  for ($location_0[stackIndex] = 'MenuBar.java:' + '426' , i = 0; i < beforeIndex; $location_0[stackIndex] = 'MenuBar.java:' + '426' , ++i) {
    instanceOf(($location_0[stackIndex] = 'MenuBar.java:' + '427' , $get_5(this$static.allItems, i)), 157) && ($location_0[stackIndex] = 'MenuBar.java:' + '428' , ++itemsIndex);
  }
...
function $itemOver(this$static, item, focus_0){
  ...
  focus_0 && ($location_0[stackIndex] = 'Element.java:' + '134' , ($location_0[stackIndex] = 'MenuBar.java:' + '375' , $clinit_372() , this$static.element).focus() , undefined);
...
function $onBrowserEvent_1(this$static, event_0){
  ...
  switch ($location_0[stackIndex] = 'DOMImpl.java:' + '61' , $eventGetTypeInt(event_0.type)) {
    case 1:
      {
        $location_0[stackIndex] = 'Element.java:' + '134' , ($location_0[stackIndex] = 'MenuBar.java:' + '546' , $clinit_372() , this$static.element).focus();
    ...
    case 128:
      {
        ...
        switch (keyCode) {
          case 37:
            {
              $location_0[stackIndex] = 'MenuBar.java:' + '577' , $clinit_228();
          ...
          case 39:
            {
              $location_0[stackIndex] = 'MenuBar.java:' + '585' , $clinit_228();
...
function $selectFirstItemIfNoneSelected(this$static){
  ...
  if (!this$static.selectedItem) {
    if (this$static.items.size_0 > 0) {
      nextItem = dynamicCast(($location_0[stackIndex] = 'MenuBar.java:' + '1199' , $get_5(this$static.items, 0)), 157);
...
function $selectNextItem(this$static){
  ...
  index < this$static.items.size_0 - 1?(itemToBeSelected = dynamicCast(($location_0[stackIndex] = 'MenuBar.java:' + '1221' , $get_5(this$static.items, index + 1)), 157)):(itemToBeSelected = dynamicCast(($location_0[stackIndex] = 'MenuBar.java:' + '1223' , $get_5(this$static.items, 0)), 157));
...
function $selectPrevItem(this$static){
  ...
  index > 0?(itemToBeSelected = dynamicCast(($location_0[stackIndex] = 'MenuBar.java:' + '1245' , $get_5(this$static.items, index - 1)), 157)):(itemToBeSelected = dynamicCast(($location_0[stackIndex] = 'MenuBar.java:' + '1248' , $get_5(this$static.items, this$static.items.size_0 - 1)), 157));
...
function $MenuItem(this$static, text, asHTML, cmd){
  ...
  asHTML?($location_0[stackIndex] = 'Element.java:' + '614' , this$static.element.innerHTML = text || '' , undefined):($location_0[stackIndex] = 'DOMImplMozilla.java:' + '115' , this$static.element.textContent = text || '' , undefined);
...
function $TabBar$ClickDelegatePanel(this$static, child, this$0){
  ...
  this$static.focusablePanel = $SimplePanel_0(($location_0[stackIndex] = 'TabBar.java:' + '93' , new SimplePanel), ($location_0[stackIndex] = 'TabBar.java:' + '93' , $createFocusable(($location_0[stackIndex] = 'FocusPanel.java:' + '59' , $clinit_372() , impl_1))));
  ...
  $location_0[stackIndex] = 'TabBar.java:' + '103' , $sinkEvents_0(this$static, 129);
  $stackDepth_0 = stackIndex - 1;
  return this$static;
}
...
function addClickHandler_4(handler){
  ...
  returnTemp = ($location_0[stackIndex] = 'TabBar.java:' + '107' , $addHandler_1(this, handler, ($location_0[stackIndex] = 'TabBar.java:' + '107' , $clinit_131() , ($location_0[stackIndex] = 'ClickEvent.java:' + '27' , $clinit_131()) , TYPE_1)));
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function $elementClicked(this$static, hElem){
  ...
  if (!!item && item != this$static.root) {
    if (($location_0[stackIndex] = 'Tree.java:' + '876' , $getChildCount_0(item)) > 0 && ($location_0[stackIndex] = 'Tree.java:' + '877' , isOrHasChild(($location_0[stackIndex] = 'Element.java:' + '241' , $getFirstChildElement_0(($location_0[stackIndex] = 'Element.java:' + '241' , $clinit_81() , !item.imageHolder && ($location_0[stackIndex] = 'TreeItem.java:' + '801' , $convertToFullNode(item)) , item.imageHolder))), hElem))) {
     ...
     else if ($isOrHasChild_0(($location_0[stackIndex] = 'Node.java:' + '274' , $clinit_81() , item.element), hElem)) {
...
function $init_3(this$static, images, useLeafImages){
  ...
  this$static.focusable = ($location_0[stackIndex] = 'Tree.java:' + '947' , $createFocusable(($location_0[stackIndex] = 'FocusPanel.java:' + '59' , $clinit_372() , impl_1)));
  ...
  $location_0[stackIndex] = 'Tree.java:' + '960' , $sinkEvents_0(this$static, 901);
  $location_0[stackIndex] = 'DOM.java:' + '1220' , $sinkEvents(this$static.focusable, 6144);
...
function $moveFocus(this$static){
  ...
  $location_0[stackIndex] = 'Tree.java:' + '1084' , left = $getAbsoluteLeftImpl(($location_0[stackIndex] = 'DOMImplMozilla.java:' + '55' , $getViewportElement(selectedElem.ownerDocument)), selectedElem) - containerLeft;
  $location_0[stackIndex] = 'Tree.java:' + '1085' , top_0 = $getAbsoluteTopImpl(($location_0[stackIndex] = 'DOMImplMozilla.java:' + '61' , $getViewportElement(selectedElem.ownerDocument)), selectedElem) - containerTop;
  ...
  $location_0[stackIndex] = 'Element.java:' + '134' , ($location_0[stackIndex] = 'Tree.java:' + '664' , $clinit_372() , this$static.focusable).focus();
  $stackDepth_0 = stackIndex - 1;
}
...
function $remove_9(this$static, w){
  ...
  item = dynamicCast(($location_0[stackIndex] = 'Tree.java:' + '590' , $get_7(this$static.childWidgets, w)), 156);
  if (!item) {
    $stackDepth_0 = stackIndex - 1;
    return false;
  }
...
function $setImages(this$static, images, useLeafImages){
  ...
  if (!useLeafImages) {
    ...
    $location_0[stackIndex] = 'Tree.java:' + '1204' , $clinit_431();
...
function $showImage(treeItem, proto){
  ...
  !child?($location_0[stackIndex] = 'Node.java:' + '72' , holder.appendChild(($location_0[stackIndex] = 'ClippedImagePrototype.java:' + '58' , $createStructure(proto.url, proto.left_0, proto.top_0, proto.width_0, proto.height_0)))):($location_0[stackIndex] = 'ClippedImagePrototype.java:' + '53' , $adjust(child, proto.url, proto.left_0, proto.top_0, proto.width_0, proto.height_0));
  $stackDepth_0 = stackIndex - 1;
}
...
function $showLeafImage(this$static, treeItem){
  ...
  if (this$static.useLeafImages || !!treeItem.imageHolder) {
    ...
    $location_0[stackIndex] = 'Tree.java:' + '841' , $clinit_228();
...
function addMouseDownHandler_3(handler){
  ...
  returnTemp = ($location_0[stackIndex] = 'Tree.java:' + '374' , $addHandler_1(this, handler, ($location_0[stackIndex] = 'Tree.java:' + '374' , $clinit_170() , ($location_0[stackIndex] = 'MouseDownEvent.java:' + '27' , $clinit_170()) , TYPE_7)));
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function addMouseMoveHandler_3(handler){
  ...
  returnTemp = ($location_0[stackIndex] = 'Tree.java:' + '388' , $addDomHandler(this, handler, ($location_0[stackIndex] = 'Tree.java:' + '388' , $clinit_172() , ($location_0[stackIndex] = 'MouseMoveEvent.java:' + '27' , $clinit_172()) , TYPE_8)));
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function addMouseOutHandler_3(handler){
  ...
  returnTemp = ($location_0[stackIndex] = 'Tree.java:' + '392' , $addDomHandler(this, handler, ($location_0[stackIndex] = 'Tree.java:' + '392' , $clinit_174() , ($location_0[stackIndex] = 'MouseOutEvent.java:' + '29' , $clinit_174()) , TYPE_9)));
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function addMouseUpHandler_3(handler){
  ...
  returnTemp = ($location_0[stackIndex] = 'Tree.java:' + '400' , $addDomHandler(this, handler, ($location_0[stackIndex] = 'Tree.java:' + '400' , $clinit_178() , ($location_0[stackIndex] = 'MouseUpEvent.java:' + '27' , $clinit_178()) , TYPE_11)));
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function doAttachChildren_3(){
  ...
  try {
    $location_0[stackIndex] = 'Tree.java:' + '718' , tryCommand(this, ($location_0[stackIndex] = 'AttachDetachException.java:' + '30' , $clinit_349() , attachCommand));
  }
   catch (e) {
...
function doDetachChildren_3(){
  ...
  try {
    $location_0[stackIndex] = 'Tree.java:' + '728' , tryCommand(this, ($location_0[stackIndex] = 'AttachDetachException.java:' + '39' , $clinit_349() , detachCommand));
  }
   catch (e) {
...
function iterator_6(){
  ...
  widgets = ($location_0[stackIndex] = 'Tree.java:' + '488' , initDim(_3Lcom_google_gwt_user_client_ui_Widget_2_classLit, 675, 2, this.childWidgets.size_0, 0));
    ...
    case 1:
      {
        ...
        ($location_0[stackIndex] = 'Tree.java:' + '524' , shouldTreeDelegateFocusToElement(e)) || !!this.curSelection && ($location_0[stackIndex] = 'Element.java:' + '134' , ($location_0[stackIndex] = 'Tree.java:' + '664' , $clinit_372() , this.focusable).focus() , undefined);
        break;
      }
...
function standardizeKeycode(code){
  ...
  $location_0[stackIndex] = 'Tree.java:' + '206' , $clinit_228();
  $stackDepth_0 = stackIndex - 1;
  return code;
}
...
function $clinit_453(){
  ...
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_453;
  $location_0[stackIndex] = 'TreeItem.java:' + '39' , $clinit_453 = nullMethod;
  itemAnimation = ($location_0[stackIndex] = 'TreeItem.java:' + '233' , new TreeItem$TreeItemAnimation);
  $location_0[stackIndex] = 'TreeItem.java:' + '239' , $clinit_453();
...
function $TreeItem(this$static){
  ...
  $location_0[stackIndex] = 'TreeItem.java:' + '262' , $clinit_453();
...
function $TreeItem_0(this$static, html){
  ...
  $location_0[stackIndex] = 'TreeItem.java:' + '274' , $clinit_453();
...
function $getChild_0(this$static, index){
  ...
  returnTemp = dynamicCast(($location_0[stackIndex] = 'TreeItem.java:' + '361' , $get_5(this$static.children, index)), 156);
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function $setTree(this$static, newTree){
  ...
  for ($location_0[stackIndex] = 'TreeItem.java:' + '743' , i = 0 , n = $getChildCount_0(this$static); i < n; $location_0[stackIndex] = 'TreeItem.java:' + '743' , ++i) {
    $setTree(dynamicCast(($location_0[stackIndex] = 'TreeItem.java:' + '744' , $get_5(this$static.children, i)), 156), newTree);
  }
...
function $updateStateRecursiveHelper(this$static){
  ...
  for ($location_0[stackIndex] = 'TreeItem.java:' + '806' , i = 0 , n = $getChildCount_0(this$static); i < n; $location_0[stackIndex] = 'TreeItem.java:' + '806' , ++i) {
    $updateStateRecursiveHelper(dynamicCast(($location_0[stackIndex] = 'TreeItem.java:' + '807' , $get_5(this$static.children, i)), 156));
  }
  $stackDepth_0 = stackIndex - 1;
}
...
function addItem(item){
  ...
  $location_0[stackIndex] = 'TreeItem.java:' + '321' , $clinit_228();
...
function $clinit_454(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_454;
  $location_0[stackIndex] = 'Tree.java:' + '965' , $clinit_454 = nullMethod;
  $clinit_453();
  $stackDepth_0 = stackIndex - 1;
}
...
function $Tree$1(this$static, this$0){
  ...
  $location_0[stackIndex] = 'Tree.java:' + '965' , $clinit_454();
...
function $addItem_3(this$static, item){
  ...
  $location_0[stackIndex] = 'Tree.java:' + '981' , $clinit_228();
...
function $convertToFullNode(item){
  ...
  if (!item.imageHolder) {
    $location_0[stackIndex] = 'TreeItem.java:' + '51' , itemTable = ($location_0[stackIndex] = 'Node.java:' + '94' , ($location_0[stackIndex] = 'TreeItem.java:' + '239' , $clinit_453() , BASE_INTERNAL_ELEM).cloneNode(true));
...
function copyWidgetArray(widgets){
  ...
  clone = ($location_0[stackIndex] = 'WidgetIterators.java:' + '29' , initDim(_3Lcom_google_gwt_user_client_ui_Widget_2_classLit, 675, 2, widgets.length, 0));
...
function $adjust(img, url, left, top_0, width, height){
  ...
  $location_0[stackIndex] = 'Style.java:' + '1449' , img.style['width'] = width + ($location_0[stackIndex] = 'Style.java:' + '1369' , $clinit_111() , 'px');
...
function $getHTML_0(this$static){
  ...
  returnTemp = ($location_0[stackIndex] = 'ClippedImagePrototype.java:' + '68' , $getHTML(this$static.url, this$static.left_0, this$static.top_0, this$static.width_0, this$static.height_0));
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function compareTo_0(p0){
  ...
  returnTemp = this.value_0 == ($location_0[stackIndex] = 'com.google.gwt.dev.jjs.impl.GenerateJavaAST:' + '0' , dynamicCast(p0, 76)).value_0?0:this.value_0?1:-1;
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function compareTo_1(p0){
  var stackIndex, returnTemp;
  $stack_0[stackIndex = ++$stackDepth_0] = compareTo_1;
  returnTemp = $compareTo_1(this, ($location_0[stackIndex] = 'com.google.gwt.dev.jjs.impl.GenerateJavaAST:' + '0' , dynamicCast(p0, 77)));
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function compareTo_2(p0){
  ...
  returnTemp = this.value_0 - ($location_0[stackIndex] = 'com.google.gwt.dev.jjs.impl.GenerateJavaAST:' + '0' , dynamicCast(p0, 79)).value_0;
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function compareTo_3(p0){
  var stackIndex, returnTemp;
  $stack_0[stackIndex = ++$stackDepth_0] = compareTo_3;
  returnTemp = $compareTo_3(this, ($location_0[stackIndex] = 'com.google.gwt.dev.jjs.impl.GenerateJavaAST:' + '0' , dynamicCast(p0, 81)));
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function compareTo_4(p0){
  var stackIndex, returnTemp;
  $stack_0[stackIndex = ++$stackDepth_0] = compareTo_4;
  returnTemp = $compareTo_4(this, ($location_0[stackIndex] = 'com.google.gwt.dev.jjs.impl.GenerateJavaAST:' + '0' , dynamicCast(p0, 170)));
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function compareTo_5(p0){
  var stackIndex, returnTemp;
  $stack_0[stackIndex = ++$stackDepth_0] = compareTo_5;
  returnTemp = $compareTo_5(this, ($location_0[stackIndex] = 'com.google.gwt.dev.jjs.impl.GenerateJavaAST:' + '0' , dynamicCast(p0, 83)));
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function compareTo_6(p0){
  var stackIndex, returnTemp;
  $stack_0[stackIndex = ++$stackDepth_0] = compareTo_6;
  returnTemp = $compareTo_6(this, ($location_0[stackIndex] = 'com.google.gwt.dev.jjs.impl.GenerateJavaAST:' + '0' , dynamicCast(p0, 84)));
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}

function hexDigit(c, s){
  var val = ($location_0[stackIndex] = 'Long.java:' + '273' , ($location_0[stackIndex] = 'Long.java:' + '35' , $clinit_537() , hexLookup)[c]), stackIndex;
...
function $clinit_537(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_537;
  $location_0[stackIndex] = 'Long.java:' + '31' , $clinit_537 = nullMethod;
  var c;
  hexLookup = ($location_0[stackIndex] = 'Long.java:' + '35' , initDim(_3I_classLit, 677, -1, 0, 1));
...
function compareTo_7(p0){
  var stackIndex, returnTemp;
  $stack_0[stackIndex = ++$stackDepth_0] = compareTo_7;
  returnTemp = $compareTo_7(this, ($location_0[stackIndex] = 'com.google.gwt.dev.jjs.impl.GenerateJavaAST:' + '0' , dynamicCast(p0, 86)));
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function $Date_0(this$static, year, month, date, hrs, min, sec){
  ...
  $location_0[stackIndex] = 'Date.java:' + '127' , $clinit_552();
...
function compareTo_10(p0){
  ...
  returnTemp = $compareTo_8(this, ($location_0[stackIndex] = 'com.google.gwt.dev.jjs.impl.GenerateJavaAST:' + '0' , dynamicCast(p0, 176)));
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function sort(target, c){
  ...
  $location_0[stackIndex] = 'Collections.java:' + '843' , $clinit_570();
  var x;
  ...
  $location_0[stackIndex] = 'Arrays.java:' + '997' , mergeSort(x, 0, x.length, c?c:($location_0[stackIndex] = 'Arrays.java:' + '997' , $clinit_581() , ($location_0[stackIndex] = 'Comparators.java:' + '32' , $clinit_581()) , NATURAL));
...
function $clinit_581(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_581;
  $location_0[stackIndex] = 'Comparators.java:' + '18' , $clinit_581 = nullMethod;
...
function compare_1(o1, o2){
  ...
  returnTemp = ($location_0[stackIndex] = 'Comparators.java:' + '34' , dynamicCast(o1, 80)).compareTo$(o2);
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function getClass_347(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_347;
  $stackDepth_0 = stackIndex - 1;
...
function $clinit_605(){
  ...
  $location_0[stackIndex] = 'TreeMap.java:' + '29' , $clinit_605 = nullMethod;
...
function $TreeMap(this$static){
  ...
  $location_0[stackIndex] = 'TreeMap.java:' + '602' , $clinit_605();
...
function $TreeMap_0(this$static, c){
  ...
  $location_0[stackIndex] = 'TreeMap.java:' + '607' , $clinit_605();
...
function $compare_0(p0, p1){
  ...
  returnTemp = $compare(($location_0[stackIndex] = 'com.google.gwt.dev.jjs.impl.GenerateJavaAST:' + '0' , dynamicCast(p0, 80)), dynamicCast(p1, 80));
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function $TreeMap$EntryIterator(this$static, this$0){
  ...
  $location_0[stackIndex] = 'TreeMap.java:' + '51' , $TreeMap$EntryIterator_0(this$static, ($location_0[stackIndex] = 'TreeMap.java:' + '500' , $clinit_611() , All), null, null, this$0);
  $stackDepth_0 = stackIndex - 1;
  return this$static;
}
...
function $inRange(type, key, fromKey, toKey){
  ...
  if ($location_0[stackIndex] = 'TreeMap.java:' + '96' , type.toKeyValid()) {
    if ($compare(($location_0[stackIndex] = 'com.google.gwt.dev.jjs.impl.GenerateJavaAST:' + '0' , dynamicCast(key, 80)), dynamicCast(toKey, 80)) >= 0) {
      $stackDepth_0 = stackIndex - 1;
      return false;
    }
  }
  if ($location_0[stackIndex] = 'TreeMap.java:' + '101' , type.fromKeyValid()) {
    if ($compare(($location_0[stackIndex] = 'com.google.gwt.dev.jjs.impl.GenerateJavaAST:' + '0' , dynamicCast(key, 80)), dynamicCast(fromKey, 80)) < 0) {
      $stackDepth_0 = stackIndex - 1;
      return false;
    }
  }
...
function next_12(){
  ...
  returnTemp = this.last = dynamicCast(($location_0[stackIndex] = 'TreeMap.java:' + '71' , $next_6(this.iter)), 88);
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function contains_7(o){
  ...
  entry = ($location_0[stackIndex] = 'TreeMap.java:' + '122' , dynamicCast(o, 88));
...
function $TreeMap$Node(this$static, key, value){
  ...
  this$static.child = ($location_0[stackIndex] = 'TreeMap.java:' + '198' , initDim(_3Ljava_util_TreeMap$Node_2_classLit, 695, 89, 2, 0));
...
function equals_26(o){
  ...
  if (!(o != null && ($location_0[stackIndex] = 'Cast.java:' + '76' , canCast(o.typeId$, 89)))) {
    $stackDepth_0 = stackIndex - 1;
    return false;
  }
  other = ($location_0[stackIndex] = 'TreeMap.java:' + '209' , dynamicCast(o, 89));
...
function getClass_363(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_363;
  $stackDepth_0 = stackIndex - 1;
...
function $clinit_611(){
  ...
  $location_0[stackIndex] = 'TreeMap.java:' + '499' , $clinit_611 = nullMethod;
...
function $TreeMap$SubMapType(this$static, enum$name, enum$ordinal){
  ...
  $location_0[stackIndex] = 'TreeMap.java:' + '499' , $clinit_611();
...
function values_6(){
  ...
  $location_0[stackIndex] = 'TreeMap.java:' + '499' , $clinit_611();
  returnTemp = initValues(_3Ljava_util_TreeMap$SubMapType_2_classLit, 696, 90, [All, Head, Range, Tail]);
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function $clinit_612(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_612;
  $location_0[stackIndex] = 'TreeMap.java:' + '502' , $clinit_612 = nullMethod;
  $clinit_611();
  $stackDepth_0 = stackIndex - 1;
}
...
function $TreeMap$SubMapType$1(this$static, enum$name, enum$ordinal){
  ...
  $location_0[stackIndex] = 'TreeMap.java:' + '502' , $clinit_612();
  $location_0[stackIndex] = 'Enum.java:' + '76' , this$static.name_0 = enum$name;
  $location_0[stackIndex] = 'Enum.java:' + '77' , this$static.ordinal = enum$ordinal;
  $stackDepth_0 = stackIndex - 1;
  return this$static;
...
function getClass_365(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_365;
  $stackDepth_0 = stackIndex - 1;
...
function $clinit_613(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_613;
  $location_0[stackIndex] = 'TreeMap.java:' + '509' , $clinit_613 = nullMethod;
  $clinit_611();
  $stackDepth_0 = stackIndex - 1;
}
...
function $TreeMap$SubMapType$2(this$static, enum$name, enum$ordinal){
  ...
  $location_0[stackIndex] = 'TreeMap.java:' + '509' , $clinit_613();
  $location_0[stackIndex] = 'Enum.java:' + '76' , this$static.name_0 = enum$name;
  $location_0[stackIndex] = 'Enum.java:' + '77' , this$static.ordinal = enum$ordinal;
  $stackDepth_0 = stackIndex - 1;
  return this$static;
...
function getClass_366(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_366;
  $stackDepth_0 = stackIndex - 1;
...
function $clinit_614(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_614;
  $location_0[stackIndex] = 'TreeMap.java:' + '521' , $clinit_614 = nullMethod;
  $clinit_611();
  $stackDepth_0 = stackIndex - 1;
}
...
function $TreeMap$SubMapType$3(this$static, enum$name, enum$ordinal){
  ...
  $location_0[stackIndex] = 'TreeMap.java:' + '521' , $clinit_614();
  $location_0[stackIndex] = 'Enum.java:' + '76' , this$static.name_0 = enum$name;
  $location_0[stackIndex] = 'Enum.java:' + '77' , this$static.ordinal = enum$ordinal;
  $stackDepth_0 = stackIndex - 1;
  return this$static;
...
function getClass_367(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_367;
  $stackDepth_0 = stackIndex - 1;
...
function add_22(o){
  ...
  returnTemp = ($location_0[stackIndex] = 'TreeSet.java:' + '69' , $put_1(this.map, o, ($location_0[stackIndex] = 'Boolean.java:' + '29' , $clinit_515() , FALSE_0))) == null;
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function getClass_368(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_368;
  $stackDepth_0 = stackIndex - 1;
...
function $clear_5(this$static){
  ...
  if (dup.size_0 != 0) {
    for ($location_0[stackIndex] = 'ObservableCollections.java:' + '326' , listener$iterator = $AbstractList$IteratorImpl(($location_0[stackIndex] = 'AbstractList.java:' + '278' , new AbstractList$IteratorImpl), this$static.listeners); listener$iterator.i < ($location_0[stackIndex] = 'AbstractList.java:' + '38' , listener$iterator.this$0.size_1());) {
      listener = dynamicCast(($location_0[stackIndex] = 'ObservableCollections.java:' + '326' , $next_6(listener$iterator)), 177);
...
function add_25(index, element){
  ...
  for ($location_0[stackIndex] = 'ObservableCollections.java:' + '292' , listener$iterator = $AbstractList$IteratorImpl(($location_0[stackIndex] = 'AbstractList.java:' + '278' , new AbstractList$IteratorImpl), this.listeners); listener$iterator.i < ($location_0[stackIndex] = 'AbstractList.java:' + '38' , listener$iterator.this$0.size_1());) {
    listener = dynamicCast(($location_0[stackIndex] = 'ObservableCollections.java:' + '292' , $next_6(listener$iterator)), 177);
...
function $clinit_632(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_632;
  $location_0[stackIndex] = 'DelayedRunnable.java:' + '42' , $clinit_632 = nullMethod;
  $clinit_43();
  $stackDepth_0 = stackIndex - 1;
}
...
function $DelayedRunnable$1(this$static, this$0){
  ...
  $location_0[stackIndex] = 'DelayedRunnable.java:' + '42' , $clinit_632();
  this$static.this$0 = this$0;
  $stackDepth_0 = stackIndex - 1;
  return this$static;
}
...
function $HTMLTable_0(this$static){
  ...
  $location_0[stackIndex] = 'HTMLTable.java:' + '818' , $sinkEvents_0(this$static, 1);
  $stackDepth_0 = stackIndex - 1;
  return this$static;
}
...
function $setText_3(this$static, row, column, text){
  ...
  text != null && ($location_0[stackIndex] = 'DOMImplMozilla.java:' + '115' , ($location_0[stackIndex] = 'Element.java:' + '621' , $clinit_81() , td).textContent = text || '' , undefined);
  $stackDepth_0 = stackIndex - 1;
}
...
function $getRawColumnIndex(this$static, row, column){
  ...
  $location_0[stackIndex] = 'FlexTable.java:' + '308' , formatter = ($location_0[stackIndex] = 'FlexTable.java:' + '177' , dynamicCast(this$static.cellFormatter, 182));
...
function getClass_383(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_383;
  $stackDepth_0 = stackIndex - 1;
...
function getClass_384(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_384;
  $stackDepth_0 = stackIndex - 1;
...
function getClass_385(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_385;
  $stackDepth_0 = stackIndex - 1;
...
function getClass_387(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_387;
  $stackDepth_0 = stackIndex - 1;
...
function addClickHandler_5(handler){
  ...
  returnTemp = ($location_0[stackIndex] = 'Caption.java:' + '133' , $addDomHandler(this, handler, ($location_0[stackIndex] = 'Caption.java:' + '133' , $clinit_131() , ($location_0[stackIndex] = 'ClickEvent.java:' + '27' , $clinit_131()) , TYPE_1)));
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function $add_20(this$static, w){
  ...
  $location_0[stackIndex] = 'DeckLayoutPanel.java:' + '58' , $add_25(($location_0[stackIndex] = 'LayoutComposite.java:' + '89' , dynamicCast(this$static.widget, 183)), w);
  $stackDepth_0 = stackIndex - 1;
}
...
function $insert_4(this$static, w, beforeIndex){
  ...
  $location_0[stackIndex] = 'DeckLayoutPanel.java:' + '126' , layoutPanel = ($location_0[stackIndex] = 'LayoutComposite.java:' + '89' , dynamicCast(this$static.widget, 183));
...
function $remove_23(this$static, w){
  var stackIndex, returnTemp;
  $stack_0[stackIndex = ++$stackDepth_0] = $remove_23;
  returnTemp = ($location_0[stackIndex] = 'DeckLayoutPanel.java:' + '157' , $remove_26(($location_0[stackIndex] = 'LayoutComposite.java:' + '89' , dynamicCast(this$static.widget, 183)), w));
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function $showWidget(this$static, index){
  ...
  $location_0[stackIndex] = 'DeckLayoutPanel.java:' + '177' , this$static.visibleWidget = ($location_0[stackIndex] = 'LayoutPanel.java:' + '490' , $getUnDecoratedWidget(($location_0[stackIndex] = 'ComplexPanel.java:' + '36' , $get_6(($location_0[stackIndex] = 'LayoutComposite.java:' + '89' , dynamicCast(this$static.widget, 183)).children, index))));
  if (oldWidget != this$static.visibleWidget) {
    ...
    $location_0[stackIndex] = 'LayoutComposite.java:' + '116' , $invalidate_1(($location_0[stackIndex] = 'LayoutComposite.java:' + '89' , dynamicCast(this$static.widget, 183)), null);
  }
  $stackDepth_0 = stackIndex - 1;
}
...
function getClass_394(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_394;
  $stackDepth_0 = stackIndex - 1;
...
function iterator_20(){
  ...
  returnTemp = ($location_0[stackIndex] = 'LayoutPanel.java:' + '553' , $LayoutPanel$3(($location_0[stackIndex] = 'LayoutPanel.java:' + '553' , new LayoutPanel$3), ($location_0[stackIndex] = 'LayoutComposite.java:' + '89' , dynamicCast(this.widget, 183))));
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function remove_29(w){
  ...
  returnTemp = ($location_0[stackIndex] = 'DeckLayoutPanel.java:' + '157' , $remove_26(($location_0[stackIndex] = 'LayoutComposite.java:' + '89' , dynamicCast(this.widget, 183)), w));
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function $TabLayoutPanel(this$static, region, decorate, decorateBody){
  ...
  $location_0[stackIndex] = 'TabLayoutPanel.java:' + '136' , layoutPanel = ($location_0[stackIndex] = 'LayoutComposite.java:' + '89' , dynamicCast(this$static.widget, 183));
  ...
  decorate?region == ($location_0[stackIndex] = 'TabLayoutPanel.java:' + '65' , $clinit_727() , TOP)?(this$static.tabBar = $ScrollTabBar_0(($location_0[stackIndex] = 'TabLayoutPanel.java:' + '143' , new ScrollTabBar), true, false)):(this$static.tabBar = $ScrollTabBar_0(($location_0[stackIndex] = 'TabLayoutPanel.java:' + '145' , new ScrollTabBar), true, true)):(this$static.tabBar = $ScrollTabBar(($location_0[stackIndex] = 'TabLayoutPanel.java:' + '148' , new ScrollTabBar)));
  ...
  region == ($location_0[stackIndex] = 'TabLayoutPanel.java:' + '65' , $clinit_727() , TOP)?$add_26(layoutPanel, this$static.tabBar, ($location_0[stackIndex] = 'TabLayoutPanel.java:' + '160' , $BorderLayoutData_1(($location_0[stackIndex] = 'TabLayoutPanel.java:' + '160' , new BorderLayoutData), ($location_0[stackIndex] = 'BorderLayout.java:' + '199' , $clinit_789() , NORTH_0)))):$add_26(layoutPanel, this$static.tabBar, ($location_0[stackIndex] = 'TabLayoutPanel.java:' + '162' , $BorderLayoutData_1(($location_0[stackIndex] = 'TabLayoutPanel.java:' + '162' , new BorderLayoutData), ($location_0[stackIndex] = 'BorderLayout.java:' + '199' , $clinit_789() , SOUTH_0))));
...
function getClass_397(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_397;
  $stackDepth_0 = stackIndex - 1;
...
function onTabSelected(sender, tabIndex){
  ...
  lm?($location_0[stackIndex] = 'TabLayoutPanel.java:' + '442' , lm.layout_0()):($location_0[stackIndex] = 'LayoutComposite.java:' + '125' , ($location_0[stackIndex] = 'LayoutComposite.java:' + '89' , dynamicCast(this.widget, 183)).layout_0());
...
function getClass_398(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_398;
  $stackDepth_0 = stackIndex - 1;
...
function $setImage(this$static, image){
  ...
  $location_0[stackIndex] = 'ImageButton.java:' + '76' , $setWidget_2(($location_0[stackIndex] = 'WidgetWrapper.java:' + '67' , dynamicCast(($location_0[stackIndex] = 'ImageButton.java:' + '76' , dynamicCast(this$static.widget, 190)).widget, 191)), 0, 0, image);
  $stackDepth_0 = stackIndex - 1;
}
...
function addClickHandler_6(handler){
  ...
  returnTemp = ($location_0[stackIndex] = 'ImageButton.java:' + '58' , $addDomHandler(this, handler, ($location_0[stackIndex] = 'ImageButton.java:' + '58' , $clinit_131() , ($location_0[stackIndex] = 'ClickEvent.java:' + '27' , $clinit_131()) , TYPE_1)));
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function $LayoutPanel_0(this$static, elem, layout){
  ...
  this$static.children = $WidgetCollection(($location_0[stackIndex] = 'ComplexPanel.java:' + '28' , new WidgetCollection), this$static);
  $location_0[stackIndex] = 'UIObject.java:' + '799' , this$static.element = elem;
  $location_0[stackIndex] = 'LayoutPanel.java:' + '124' , $$init_57(this$static);
...
function getClass_415(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_415;
  $stackDepth_0 = stackIndex - 1;
...
function $clinit_679(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_679;
  $location_0[stackIndex] = 'ListBox.java:' + '66' , $clinit_679 = nullMethod;
  $location_0[stackIndex] = 'ListBox.java:' + '92' , impl_4 = ($location_0[stackIndex] = 'ListBox.java:' + '92' , $clinit_469() , ($location_0[stackIndex] = 'FocusImpl.java:' + '28' , $clinit_469()) , implPanel);
  $stackDepth_0 = stackIndex - 1;
}
...
function $ListBox_1(this$static, columns){
  ...
  $location_0[stackIndex] = 'ListBox.java:' + '134' , $clinit_679();
  $initWidget(this$static, ($location_0[stackIndex] = 'LayoutComposite.java:' + '56' , $LayoutComposite$1(($location_0[stackIndex] = 'LayoutComposite.java:' + '56' , new LayoutComposite$1), ($location_0[stackIndex] = 'ListBox.java:' + '135' , $createFocusable(impl_4)))));
  ...
  $location_0[stackIndex] = 'ListBox.java:' + '140' , $setResizePolicy(this$static.scrollTable, ($location_0[stackIndex] = 'AbstractScrollTable.java:' + '844' , $clinit_835() , FILL_WIDTH));
  ...
  $location_0[stackIndex] = 'ListBox.java:' + '854' , $setSelectionPolicy_0(this$static.dataTable, ($location_0[stackIndex] = 'SelectionGrid.java:' + '127' , $clinit_866() , ONE_ROW));
  $location_0[stackIndex] = 'ListBox.java:' + '146' , $resize(this$static.dataTable, 0, this$static.dataTable.numColumns);
  $location_0[stackIndex] = 'ListBox.java:' + '148' , $add_25(($location_0[stackIndex] = 'LayoutComposite.java:' + '89' , dynamicCast(this$static.widget, 183)), this$static.scrollTable);
  $location_0[stackIndex] = 'ListBox.java:' + '152' , $sinkEvents_0(this$static, 2225);
...
function $selectNextItem_0(this$static){
  ...
  $location_0[stackIndex] = 'Element.java:' + '565' , $scrollIntoView_0(($location_0[stackIndex] = 'Element.java:' + '565' , $clinit_81() , ($location_0[stackIndex] = 'ListBox.java:' + '685' , $getElement_0(this$static.dataTable.rowFormatter, ($location_0[stackIndex] = 'ListBox.java:' + '686' , $getSelectedIndex_0(this$static)))).firstChild));
  $stackDepth_0 = stackIndex - 1;
}
...
function $selectPrevItem_0(this$static){
  ...
  $location_0[stackIndex] = 'Element.java:' + '565' , $scrollIntoView_0(($location_0[stackIndex] = 'Element.java:' + '565' , $clinit_81() , ($location_0[stackIndex] = 'ListBox.java:' + '702' , $getElement_0(this$static.dataTable.rowFormatter, ($location_0[stackIndex] = 'ListBox.java:' + '703' , $getSelectedIndex_0(this$static)))).firstChild));
  $stackDepth_0 = stackIndex - 1;
}
...
function $setHeader_0(this$static, listHeader){
  ...
  if (listHeader.size_0 > 0) {
    for ($location_0[stackIndex] = 'ListBox.java:' + '227' , column = 0 , size = listHeader.size_0; column < size; $location_0[stackIndex] = 'ListBox.java:' + '227' , ++column) {
      $setHTML_2(this$static.headerTable, 0, column, ($location_0[stackIndex] = 'ListBox.java:' + '228' , dynamicCast(($location_0[stackIndex] = 'ArrayList.java:' + '157' , checkIndex(column, listHeader.size_0) , ($location_0[stackIndex] = 'ArrayList.java:' + '158' , listHeader.array[column])), 192)).name_0);
    }
...
function $setModel(this$static, dataModel){
  ...
  $location_0[stackIndex] = 'LayoutComposite.java:' + '125' , ($location_0[stackIndex] = 'LayoutComposite.java:' + '89' , dynamicCast(this$static.widget, 183)).layout_0();
  $stackDepth_0 = stackIndex - 1;
}
...
function getClass_418(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_418;
  $stackDepth_0 = stackIndex - 1;
...
function onClose_4(event_0){
  ...
  $onWindowClosed(($location_0[stackIndex] = 'ListenerWrapper.java:' + '95' , dynamicCast(this.listener, 193)));
  $stackDepth_0 = stackIndex - 1;
}
...
function onWindowClosing(event_0){
  ...
  $location_0[stackIndex] = 'ListenerWrapper.java:' + '99' , dynamicCast(this.listener, 193);
  $stackDepth_0 = stackIndex - 1;
}
...
function $WindowPanel(this$static){
  ...
  $location_0[stackIndex] = 'WindowPanel.java:' + '271' , $clinit_683();
  $location_0[stackIndex] = 'WindowPanel.java:' + '302' , $WindowPanel_2(this$static, ($location_0[stackIndex] = 'WindowPanel.java:' + '302' , $clinit_431() , ($location_0[stackIndex] = 'RootPanel.java:' + '151' , get_1(null))), null, true, false);
  $stackDepth_0 = stackIndex - 1;
  return this$static;
}
...
function $clinit_695(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_695;
  $location_0[stackIndex] = 'PopupMenu.java:' + '35' , $clinit_695 = nullMethod;
  $clinit_344();
  $stackDepth_0 = stackIndex - 1;
}
...
function $PopupMenu(this$static){
  ...
  $location_0[stackIndex] = 'PopupMenu.java:' + '40' , $clinit_695();
  $location_0[stackIndex] = 'PopupMenu.java:' + '41' , $AbstractDecoratedPopupPanel(this$static, true, false, 'menuPopup', ($location_0[stackIndex] = 'AbstractDecoratedPopupPanel.java:' + '37' , $clinit_345() , ONE_WAY_CORNER));
  ...
  $location_0[stackIndex] = 'PopupMenu.java:' + '75' , $sinkEvents_0(this$static, 1);
...
function $PopupMenu$1(this$static, $anonymous0){
  ...
  $location_0[stackIndex] = 'MenuBar.java:' + '233' , $init_2(this$static, $anonymous0, ($location_0[stackIndex] = 'MenuBar.java:' + '234' , create_1((!menuBarSubMenuIcon && (menuBarSubMenuIcon = ($location_0[stackIndex] = 'com_google_gwt_user_client_ui_MenuBar_Resources_default_InlineClientBundleGenerator.java:' + '9' , $ImageResourcePrototype(($location_0[stackIndex] = 'com_google_gwt_user_client_ui_MenuBar_Resources_default_InlineClientBundleGenerator.java:' + '9' , new ImageResourcePrototype), ($location_0[stackIndex] = 'com_google_gwt_user_client_ui_MenuBar_Resources_default_InlineClientBundleGenerator.java:' + '11' , $clinit_228() , 'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAUAAAAJCAYAAAD6reaeAAAAI0lEQVR42mNgYGD4z4AF/Mcm8R+bxH9sEv+xSRBUSdh2FAAAXN8Y6EbBLKwAAAAASUVORK5CYII='), 0, 0, 5, 9))) , menuBarSubMenuIcon))));
  $stackDepth_0 = stackIndex - 1;
  return this$static;
}
...
function $ScrollTabBar_0(this$static, decorated, atBottom){
  ...
  $location_0[stackIndex] = 'ScrollTabBar.java:' + '188' , layoutPanel = ($location_0[stackIndex] = 'LayoutComposite.java:' + '89' , dynamicCast(this$static.widget, 183));
  ...
  this$static.scrollLeftBtn = ($location_0[stackIndex] = 'ScrollTabBar.java:' + '255' , $Button_2(($location_0[stackIndex] = 'ScrollTabBar.java:' + '255' , new Button), ($location_0[stackIndex] = 'ScrollTabBar.java:' + '255' , $getHTML_0(($clinit_648() , ($location_0[stackIndex] = 'CaptionImages_generatedBundle.java:' + '17' , $clinit_650()) , toolArrowLeft_SINGLETON))), $ScrollTabBar$7(($location_0[stackIndex] = 'ScrollTabBar.java:' + '256' , new ScrollTabBar$7), this$static)));
  $location_0[stackIndex] = 'FocusWidget.java:' + '136' , $addDomHandler(this$static.scrollLeftBtn, $ScrollTabBar$8(($location_0[stackIndex] = 'ScrollTabBar.java:' + '263' , new ScrollTabBar$8), this$static), ($location_0[stackIndex] = 'FocusWidget.java:' + '136' , $clinit_170() , ($location_0[stackIndex] = 'MouseDownEvent.java:' + '27' , $clinit_170()) , TYPE_7));
  $location_0[stackIndex] = 'FocusWidget.java:' + '162' , $addDomHandler(this$static.scrollLeftBtn, $ScrollTabBar$9(($location_0[stackIndex] = 'ScrollTabBar.java:' + '269' , new ScrollTabBar$9), this$static), ($location_0[stackIndex] = 'FocusWidget.java:' + '162' , $clinit_178() , ($location_0[stackIndex] = 'MouseUpEvent.java:' + '27' , $clinit_178()) , TYPE_11));
  $location_0[stackIndex] = 'ScrollTabBar.java:' + '275' , $add_5(this$static.navBar, this$static.scrollLeftBtn);
  this$static.scrollRightBtn = ($location_0[stackIndex] = 'ScrollTabBar.java:' + '277' , $Button_2(($location_0[stackIndex] = 'ScrollTabBar.java:' + '277' , new Button), $getHTML_0(toolArrowRight_SINGLETON), $ScrollTabBar$10(($location_0[stackIndex] = 'ScrollTabBar.java:' + '278' , new ScrollTabBar$10), this$static)));
  ...
  this$static.tabBarMenuBtn = ($location_0[stackIndex] = 'ScrollTabBar.java:' + '299' , $Button_2(($location_0[stackIndex] = 'ScrollTabBar.java:' + '299' , new Button), $getHTML_0(toolArrowDown_SINGLETON), $ScrollTabBar$13(($location_0[stackIndex] = 'ScrollTabBar.java:' + '300' , new ScrollTabBar$13), this$static)));
  $location_0[stackIndex] = 'ScrollTabBar.java:' + '334' , $add_5(this$static.navBar, this$static.tabBarMenuBtn);
  $add_26(layoutPanel, this$static.tabBarWrapper, ($location_0[stackIndex] = 'ScrollTabBar.java:' + '336' , $BoxLayoutData_4(($location_0[stackIndex] = 'ScrollTabBar.java:' + '336' , new BoxLayoutData), ($location_0[stackIndex] = 'BoxLayoutData.java:' + '30' , $clinit_798() , HORIZONTAL_0))));
...
function $updateNavBarState(this$static){
  ...
  $location_0[stackIndex] = 'ScrollTabBar.java:' + '485' , scrollLeft = $getScrollLeft_2(($location_0[stackIndex] = 'Element.java:' + '398' , $clinit_81() , this$static.tabBarWrapper.element));
...
function layout_7(){
  ...
  $location_0[stackIndex] = 'LayoutComposite.java:' + '125' , ($location_0[stackIndex] = 'LayoutComposite.java:' + '89' , dynamicCast(this.widget, 183)).layout_0();
...
function $clinit_699(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_699;
  $location_0[stackIndex] = 'ScrollTabBar.java:' + '151' , $clinit_699 = nullMethod;
  $clinit_43();
  $stackDepth_0 = stackIndex - 1;
}
...
function $ScrollTabBar$1(this$static, this$0){
  ...
  $location_0[stackIndex] = 'ScrollTabBar.java:' + '151' , $clinit_699();
  this$static.this$0 = this$0;
  $stackDepth_0 = stackIndex - 1;
  return this$static;
}
...
function run_6(){
  ...
  !($location_0[stackIndex] = 'Element.java:' + '329' , this.this$0.scrollLeftBtn.element['disabled']) && this.this$0.scrollLeftBtnDown?($buttonClick(($location_0[stackIndex] = 'ButtonElement.java:' + '44' , $clinit_81() , this.this$0.scrollLeftBtn.element)) , undefined):($location_0[stackIndex] = 'ScrollTabBar.java:' + '157' , $cancel_0(this));
  $stackDepth_0 = stackIndex - 1;
}
...
function execute_19(){
  ...
  if ((parseInt(($location_0[stackIndex] = 'Element.java:' + '349' , this.this$0.tabBar.element['offsetWidth'])) || 0) > (parseInt(this.this$0.tabBarWrapper.element['offsetWidth']) || 0) + (parseInt(this.this$0.navBar.element['offsetWidth']) || 0)) {
    if (this.this$0.navBar.element.style.display != 'none') {
      $location_0[stackIndex] = 'ScrollTabBar.java:' + '432' , scrollLeft = $getScrollLeft_2(($location_0[stackIndex] = 'Element.java:' + '398' , $clinit_81() , this.this$0.tabBarWrapper.element));
    ...
    $setScrollLeft_1(($location_0[stackIndex] = 'Element.java:' + '695' , $clinit_81() , this.this$0.tabBarWrapper.element), 0);
...
function execute_20(){
  ...
  $location_0[stackIndex] = 'LayoutComposite.java:' + '116' , $invalidate_1(($location_0[stackIndex] = 'LayoutComposite.java:' + '89' , dynamicCast(this.this$0.widget, 183)), null);
...
function execute_21(){
  ...
  $location_0[stackIndex] = 'Element.java:' + '565' , $scrollIntoView_0(($location_0[stackIndex] = 'Element.java:' + '565' , $clinit_81() , dynamicCast($get_5(this.this$0.tabs, ($location_0[stackIndex] = 'ScrollTabBar.java:' + '471' , $getSelectedTab(this.this$0.tabBar))), 2).element));
  $stackDepth_0 = stackIndex - 1;
}
...
function $clinit_711(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_711;
  $location_0[stackIndex] = 'ScrollTabBar.java:' + '164' , $clinit_711 = nullMethod;
  $clinit_43();
  $stackDepth_0 = stackIndex - 1;
}
...
function $ScrollTabBar$2(this$static, this$0){
  ...
  $location_0[stackIndex] = 'ScrollTabBar.java:' + '164' , $clinit_711();
  this$static.this$0 = this$0;
  $stackDepth_0 = stackIndex - 1;
  return this$static;
}
...
function run_7(){
  ...
  !($location_0[stackIndex] = 'Element.java:' + '329' , this.this$0.scrollRightBtn.element['disabled']) && this.this$0.scrollRightBtnDown?($buttonClick(($location_0[stackIndex] = 'ButtonElement.java:' + '44' , $clinit_81() , this.this$0.scrollRightBtn.element)) , undefined):($location_0[stackIndex] = 'ScrollTabBar.java:' + '170' , $cancel_0(this));
  $stackDepth_0 = stackIndex - 1;
}
...
function $clinit_712(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_712;
  $location_0[stackIndex] = 'ScrollTabBar.java:' + '47' , $clinit_712 = nullMethod;
  TAB_ROW_STYLES_0 = ($location_0[stackIndex] = 'ScrollTabBar.java:' + '48' , initValues(_3Ljava_lang_String_2_classLit, 692, 1, ['tabTop', 'tabMiddle', 'tabBottom']));
  $stackDepth_0 = stackIndex - 1;
}
...
function $clinit_713(){
  ...
  $location_0[stackIndex] = 'ScrollTabBar.java:' + '194' , $clinit_713 = nullMethod;
  $clinit_712();
  $stackDepth_0 = stackIndex - 1;
}
...
function $ScrollTabBar$3(this$static, this$0){
  ...
  $location_0[stackIndex] = 'ScrollTabBar.java:' + '194' , $clinit_713();
  this$static.this$0 = this$0;
...
function $clinit_714(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_714;
  $location_0[stackIndex] = 'ScrollTabBar.java:' + '208' , $clinit_714 = nullMethod;
  $clinit_362();
  $stackDepth_0 = stackIndex - 1;
}
...
function $ScrollTabBar$4(this$static, this$0){
  ...
  $location_0[stackIndex] = 'ScrollTabBar.java:' + '208' , $clinit_714();
  this$static.this$0 = this$0;
...
function execute_22(){
  ...
  $location_0[stackIndex] = 'LayoutComposite.java:' + '116' , $invalidate_1(($location_0[stackIndex] = 'LayoutComposite.java:' + '89' , dynamicCast(this.this$1.this$0.widget, 183)), null);
  addCommand($ScrollTabBar$17(($location_0[stackIndex] = 'ScrollTabBar.java:' + '469' , new ScrollTabBar$17), this.this$1.this$0));
  $stackDepth_0 = stackIndex - 1;
}

function getClass_453(){
  var stackIndex;
...
function $clinit_721(){
  ...
  $location_0[stackIndex] = 'ScrollTabBar.java:' + '62' , $clinit_721 = nullMethod;
  $clinit_347();
  $stackDepth_0 = stackIndex - 1;
}
...
function $ScrollTabBar$DecoratedBottomTabBar$1(this$static, $anonymous0, $anonymous1){
  ...
  $location_0[stackIndex] = 'ScrollTabBar.java:' + '62' , $clinit_721();
...
function $onUpdate_1(this$static, progress){
  ...
  $location_0[stackIndex] = 'ScrollTabBar.java:' + '96' , scrollLeft = $getScrollLeft_2(($location_0[stackIndex] = 'Element.java:' + '398' , $clinit_81() , this$static.scrollTabBar.tabBarWrapper.element));
...
function $TabLayoutPanel$1(this$static, this$0){
  ...
  $location_0[stackIndex] = 'TabLayoutPanel.java:' + '406' , this$static.iter = ($location_0[stackIndex] = 'LayoutPanel.java:' + '553' , $LayoutPanel$3(($location_0[stackIndex] = 'LayoutPanel.java:' + '553' , new LayoutPanel$3), ($location_0[stackIndex] = 'LayoutComposite.java:' + '89' , dynamicCast(this$static.this$0.deck.widget, 183))));
  $stackDepth_0 = stackIndex - 1;
  return this$static;
}

function getClass_462(){
  var stackIndex;
...
function $clinit_727(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_727;
  $location_0[stackIndex] = 'TabLayoutPanel.java:' + '64' , $clinit_727 = nullMethod;
...
function $TabLayoutPanel$TabBarPosition(this$static, enum$name, enum$ordinal){
  ...
  $location_0[stackIndex] = 'TabLayoutPanel.java:' + '64' , $clinit_727();
  $location_0[stackIndex] = 'Enum.java:' + '76' , this$static.name_0 = enum$name;
  $location_0[stackIndex] = 'Enum.java:' + '77' , this$static.ordinal = enum$ordinal;
  $stackDepth_0 = stackIndex - 1;
  return this$static;
...
function values_9(){
  ...
  $location_0[stackIndex] = 'TabLayoutPanel.java:' + '64' , $clinit_727();
  returnTemp = initValues(_3Lorg_gwt_mosaic_ui_client_TabLayoutPanel$TabBarPosition_2_classLit, 699, 93, [TOP, BOTTOM]);
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function $add_28(this$static, w){
  ...
  $location_0[stackIndex] = 'ToolBar.java:' + '94' , layoutPanel = ($location_0[stackIndex] = 'LayoutComposite.java:' + '89' , dynamicCast(this$static.widget, 183));
  boxLayoutMgr = ($location_0[stackIndex] = 'ToolBar.java:' + '95' , dynamicCast(layoutPanel.layout, 196));
  if (boxLayoutMgr.orientation == ($location_0[stackIndex] = 'BoxLayout.java:' + '170' , $clinit_796() , HORIZONTAL)) {
    ...
    $add_26(layoutPanel, w, ($location_0[stackIndex] = 'ToolBar.java:' + '100' , $BoxLayoutData_6(($location_0[stackIndex] = 'ToolBar.java:' + '100' , new BoxLayoutData), ($location_0[stackIndex] = 'BoxLayoutData.java:' + '30' , $clinit_798() , VERTICAL_0), width, null)));
  }
   else {
    ...
    $add_26(($location_0[stackIndex] = 'LayoutComposite.java:' + '89' , dynamicCast(this$static.widget, 183)), w, ($location_0[stackIndex] = 'ToolBar.java:' + '103' , $BoxLayoutData_6(($location_0[stackIndex] = 'ToolBar.java:' + '103' , new BoxLayoutData), ($location_0[stackIndex] = 'BoxLayoutData.java:' + '30' , $clinit_798() , BOTH), null, height)));
  }
  $stackDepth_0 = stackIndex - 1;
}

function getClass_464(){
  var stackIndex;
...
function remove_33(w){
  ...
  returnTemp = ($location_0[stackIndex] = 'ToolBar.java:' + '231' , $remove_26(($location_0[stackIndex] = 'LayoutComposite.java:' + '89' , dynamicCast(this.widget, 183)), w));
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function addClickHandler_7(handler){
  ...
  returnTemp = ($location_0[stackIndex] = 'WindowPanel.java:' + '154' , $addDomHandler(this, handler, ($location_0[stackIndex] = 'WindowPanel.java:' + '154' , $clinit_131() , ($location_0[stackIndex] = 'ClickEvent.java:' + '27' , $clinit_131()) , TYPE_1)));
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function dispatch_22(p0){
  ...
  $location_0[stackIndex] = 'ColumnSortEvent.java:' + '105' , $onColumnSorted(($location_0[stackIndex] = 'com.google.gwt.dev.jjs.impl.GenerateJavaAST:' + '0' , dynamicCast(p0, 198)), this);
  $stackDepth_0 = stackIndex - 1;
}
...
function getClass_484(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_484;
  $stackDepth_0 = stackIndex - 1;
...
function dispatch_24(p0){
  ...
  $location_0[stackIndex] = 'RowSelectionEvent.java:' + '127' , ($location_0[stackIndex] = 'com.google.gwt.dev.jjs.impl.GenerateJavaAST:' + '0' , dynamicCast(p0, 199)).onRowSelection(this);
  $stackDepth_0 = stackIndex - 1;
}
...
function compareTo_11(p0){
  ...
  returnTemp = $compareTo_9(this, ($location_0[stackIndex] = 'com.google.gwt.dev.jjs.impl.GenerateJavaAST:' + '0' , dynamicCast(p0, 200)));
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function equals_31(obj){
  ...
  other = ($location_0[stackIndex] = 'TableEvent.java:' + '138' , dynamicCast(obj, 200));
...
function getClass_488(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_488;
  $stackDepth_0 = stackIndex - 1;
...
_.equals$ = equals_31;
_.getClass$ = getClass_488;
_.hashCode$ = hashCode_32;
_.typeId$ = 332;
_.rowIndex = 0;
function $clinit_765(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_765;
  $location_0[stackIndex] = 'InfoPanel.java:' + '40' , $clinit_765 = nullMethod;
  $clinit_343();
  $stackDepth_0 = stackIndex - 1;
}
...
function $InfoPanel(this$static){
  ...
  $location_0[stackIndex] = 'InfoPanel.java:' + '70' , $clinit_765();
...
function $InfoPanel_0(this$static, caption, description, autoHide){
  ...
  $location_0[stackIndex] = 'InfoPanel.java:' + '82' , $clinit_765();
...
function getClass_489(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_489;
  $stackDepth_0 = stackIndex - 1;
...
function $clinit_766(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_766;
  $location_0[stackIndex] = 'InfoPanel.java:' + '62' , $clinit_766 = nullMethod;
  $clinit_43();
  $stackDepth_0 = stackIndex - 1;
}
...
function $InfoPanel$1(this$static, this$0){
  ...
  $location_0[stackIndex] = 'InfoPanel.java:' + '62' , $clinit_766();
  this$static.this$0 = this$0;
  $stackDepth_0 = stackIndex - 1;
  return this$static;
}

function getClass_490(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_490;
  $stackDepth_0 = stackIndex - 1;
...
function getClass_491(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_491;
  $stackDepth_0 = stackIndex - 1;
...
_.getClass$ = getClass_491;
_.typeId$ = 0;
_.this$0 = null;
function $BorderLayoutData_0(this$static, decorate){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $BorderLayoutData_0;
  $location_0[stackIndex] = 'BorderLayoutData.java:' + '68' , $BorderLayoutData_2(this$static, ($location_0[stackIndex] = 'BorderLayout.java:' + '199' , $clinit_789() , CENTER_1), decorate);
  $stackDepth_0 = stackIndex - 1;
  return this$static;
}
...
function $BorderLayoutData_6(this$static, region, preferredSize, minSize, maxSize, decorate){
  ...
  this$static.minSize = (0 > minSize?0:minSize) + ($location_0[stackIndex] = 'BorderLayoutData.java:' + '397' , $clinit_111() , 'px');
...
function $BoxLayout_0(this$static, alignment){
  ...
  $location_0[stackIndex] = 'BoxLayout.java:' + '187' , $BoxLayout_2(this$static, ($location_0[stackIndex] = 'BoxLayout.java:' + '170' , $clinit_796() , HORIZONTAL), alignment);
  $stackDepth_0 = stackIndex - 1;
  return this$static;
}
...
function $clinit_806(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_806;
  $location_0[stackIndex] = 'GridLayout.java:' + '61' , $clinit_806 = nullMethod;
...
function $GridLayout(this$static, columns, rows){
  ...
  $location_0[stackIndex] = 'GridLayout.java:' + '98' , $clinit_806();
...
function $buildWidgetMatrix(this$static, layoutPanel){
  ...
  $location_0[stackIndex] = 'GridLayout.java:' + '341' , this$static.widgetMatrix = ($location_0[stackIndex] = 'Array.java:' + '153' , initDims_0([_3_3Lcom_google_gwt_user_client_ui_Widget_2_classLit, _3Lcom_google_gwt_user_client_ui_Widget_2_classLit], [734, 675], [128, 2], [this$static.cols, this$static.rows_0], 0, 2, 0));
  for ($location_0[stackIndex] = 'GridLayout.java:' + '343' , iter = $LayoutPanel$3(($location_0[stackIndex] = 'LayoutPanel.java:' + '553' , new LayoutPanel$3), layoutPanel); $location_0[stackIndex] = 'LayoutPanel.java:' + '557' , $hasNext_1(iter.iter);) {
    ...
    $location_0[stackIndex] = 'GridLayout.java:' + '348' , $clinit_623();
...
function $getLayoutData_3(widget){
  ...
  if (layoutDataObject == null || !(layoutDataObject != null && ($location_0[stackIndex] = 'Cast.java:' + '76' , canCast(layoutDataObject.typeId$, 209)))) {
  ...
  returnTemp = ($location_0[stackIndex] = 'GridLayout.java:' + '128' , dynamicCast(layoutDataObject, 209));
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function getClass_527(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_527;
  $stackDepth_0 = stackIndex - 1;
  ...
  try {
    ...
    for ($location_0[stackIndex] = 'GridLayout.java:' + '262' , r = 0; r < this.rows_0; $location_0[stackIndex] = 'GridLayout.java:' + '262' , ++r) {
      ...
      for ($location_0[stackIndex] = 'GridLayout.java:' + '265' , c = 0; c < this.cols; $location_0[stackIndex] = 'GridLayout.java:' + '265' , ++c) {
        ...
        widget != null && ($location_0[stackIndex] = 'Cast.java:' + '76' , canCast(widget.typeId$, 202)) && (widget = ($location_0[stackIndex] = 'GridLayout.java:' + '271' , dynamicCast(widget, 202)).widget_0);
        layoutData = ($location_0[stackIndex] = 'GridLayout.java:' + '274' , dynamicCast(widget.layoutData, 209));
  ...
  try {
    ...
    for ($location_0[stackIndex] = 'GridLayout.java:' + '425' , r = 0; r < this.rows_0; $location_0[stackIndex] = 'GridLayout.java:' + '425' , ++r) {
      for ($location_0[stackIndex] = 'GridLayout.java:' + '426' , c = 0; c < this.cols; $location_0[stackIndex] = 'GridLayout.java:' + '426' , ++c) {
        ...
        widget != null && ($location_0[stackIndex] = 'Cast.java:' + '76' , canCast(widget.typeId$, 202)) && (widget = ($location_0[stackIndex] = 'GridLayout.java:' + '432' , dynamicCast(widget, 202)).widget_0);
        layoutData = ($location_0[stackIndex] = 'GridLayout.java:' + '438' , dynamicCast(widget.layoutData, 209));
        ...
        if (parent_0 != null && ($location_0[stackIndex] = 'Cast.java:' + '76' , canCast(parent_0.typeId$, 202))) {
          decPanel = ($location_0[stackIndex] = 'GridLayout.java:' + '441' , dynamicCast(parent_0, 202));
...
function getClass_528(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_528;
  $stackDepth_0 = stackIndex - 1;
...
function $fireIntervalAdded(this$static, source, index0, index1){
  ...
  event_0 = ($location_0[stackIndex] = 'AbstractListModel.java:' + '64' , $ListDataEvent(($location_0[stackIndex] = 'AbstractListModel.java:' + '64' , new ListDataEvent), source, ($location_0[stackIndex] = 'ListDataEvent.java:' + '33' , $clinit_823() , INTERVAL_ADDED), index0, index1));
  for ($location_0[stackIndex] = 'AbstractListModel.java:' + '66' , listener$iterator = $AbstractList$IteratorImpl(($location_0[stackIndex] = 'AbstractList.java:' + '278' , new AbstractList$IteratorImpl), this$static.listenerList); listener$iterator.i < ($location_0[stackIndex] = 'AbstractList.java:' + '38' , listener$iterator.this$0.size_1());) {
    listener = dynamicCast(($location_0[stackIndex] = 'AbstractListModel.java:' + '66' , $next_6(listener$iterator)), 216);
...
function $fireIntervalRemoved(this$static, source, index0, index1){
  ...
  event_0 = ($location_0[stackIndex] = 'AbstractListModel.java:' + '78' , $ListDataEvent(($location_0[stackIndex] = 'AbstractListModel.java:' + '78' , new ListDataEvent), source, ($location_0[stackIndex] = 'ListDataEvent.java:' + '35' , $clinit_823() , INTERVAL_REMOVED), index0, index1));
  for ($location_0[stackIndex] = 'AbstractListModel.java:' + '80' , listener$iterator = $AbstractList$IteratorImpl(($location_0[stackIndex] = 'AbstractList.java:' + '278' , new AbstractList$IteratorImpl), this$static.listenerList); listener$iterator.i < ($location_0[stackIndex] = 'AbstractList.java:' + '38' , listener$iterator.this$0.size_1());) {
    listener = dynamicCast(($location_0[stackIndex] = 'AbstractListModel.java:' + '80' , $next_6(listener$iterator)), 216);
...
function $clinit_823(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_823;
  $location_0[stackIndex] = 'ListDataEvent.java:' + '29' , $clinit_823 = nullMethod;
...
function $ListDataEvent$Type(this$static, enum$name, enum$ordinal){
  ...
  $location_0[stackIndex] = 'ListDataEvent.java:' + '29' , $clinit_823();
  $location_0[stackIndex] = 'Enum.java:' + '76' , this$static.name_0 = enum$name;
  $location_0[stackIndex] = 'Enum.java:' + '77' , this$static.ordinal = enum$ordinal;
  $stackDepth_0 = stackIndex - 1;
  return this$static;
...
function values_16(){
  ...
  $location_0[stackIndex] = 'ListDataEvent.java:' + '29' , $clinit_823();
  returnTemp = initValues(_3Lorg_gwt_mosaic_ui_client_list_ListDataEvent$Type_2_classLit, 706, 100, [CONTENTS_CHANGED, INTERVAL_ADDED, INTERVAL_REMOVED]);
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function $ListHeader(this$static, names){
  ...
  this$static.array = ($location_0[stackIndex] = 'ArrayList.java:' + '64' , initDim(_3Ljava_lang_Object_2_classLit, 689, 0, 0, 0));
  if (names != null) {
...
function $AbstractScrollTable(this$static, dataTable, headerTable, resources){
  ...
  this$static.children = $WidgetCollection(($location_0[stackIndex] = 'ComplexPanel.java:' + '28' , new WidgetCollection), this$static);
  $location_0[stackIndex] = 'AbstractScrollTable.java:' + '903' , this$static.columnResizePolicy = ($location_0[stackIndex] = 'AbstractScrollTable.java:' + '823' , $clinit_830() , MULTI_CELL);
  $location_0[stackIndex] = 'AbstractScrollTable.java:' + '981' , this$static.resizePolicy = ($location_0[stackIndex] = 'AbstractScrollTable.java:' + '844' , $clinit_835() , FLOW);
  ...
  $location_0[stackIndex] = 'AbstractScrollTable.java:' + '991' , this$static.scrollPolicy = ($location_0[stackIndex] = 'AbstractScrollTable.java:' + '874' , $clinit_836() , BOTH_0);
  $location_0[stackIndex] = 'AbstractScrollTable.java:' + '996' , this$static.sortPolicy = ($location_0[stackIndex] = 'AbstractScrollTable.java:' + '887' , $clinit_840() , SINGLE_CELL_0);
  ...
  $location_0[stackIndex] = 'AbstractScrollTable.java:' + '1131' , $sinkEvents_0(this$static, 32);
  $location_0[stackIndex] = 'DOMImpl.java:' + '122' , this$static.dataWrapper.__listener = this$static;
  $location_0[stackIndex] = 'DOM.java:' + '1220' , $sinkEvents(this$static.dataWrapper, 16384);
  $location_0[stackIndex] = 'DOMImpl.java:' + '122' , this$static.headerWrapper.__listener = this$static;
  $location_0[stackIndex] = 'DOM.java:' + '1220' , $sinkEvents(this$static.headerWrapper, 77);
...
function $applyNewColumnWidths(this$static, startIndex, infos, forced){
  ...
  for ($location_0[stackIndex] = 'AbstractScrollTable.java:' + '1930' , i = 0; i < numColumns; $location_0[stackIndex] = 'AbstractScrollTable.java:' + '1930' , ++i) {
    info = ($location_0[stackIndex] = 'AbstractScrollTable.java:' + '1931' , dynamicCast(($location_0[stackIndex] = 'ArrayList.java:' + '157' , checkIndex(i, infos.size_0) , ($location_0[stackIndex] = 'ArrayList.java:' + '158' , infos.array[i])), 217));
...
function $applyTableWrapperSizes(this$static, sizes){
  ...
  $location_0[stackIndex] = 'Style.java:' + '1449' , this$static.headerWrapper.style['height'] = sizes.headerTableHeight + ($location_0[stackIndex] = 'Style.java:' + '1369' , $clinit_111() , 'px');
...
function $createWrapper_0(cssName){
  ...
  $location_0[stackIndex] = 'Style.java:' + '1449' , wrapper.style['padding'] = 0 + ($location_0[stackIndex] = 'Style.java:' + '1369' , $clinit_111() , 'px');
...
function $getAvailableWidth(this$static){
  ...
  if (this$static.scrollPolicy == ($location_0[stackIndex] = 'AbstractScrollTable.java:' + '874' , $clinit_836() , BOTH_0)) {
...
function $getBoundedColumnWidths(this$static, boundsOnly){
  ...
  if (!boundsOnly) {
    for ($location_0[stackIndex] = 'AbstractScrollTable.java:' + '1999' , info$iterator = $AbstractList$IteratorImpl(($location_0[stackIndex] = 'AbstractList.java:' + '278' , new AbstractList$IteratorImpl), colWidthInfos); info$iterator.i < ($location_0[stackIndex] = 'AbstractList.java:' + '38' , info$iterator.this$0.size_1());) {
      info = dynamicCast(($location_0[stackIndex] = 'AbstractScrollTable.java:' + '1999' , $next_6(info$iterator)), 217);
...
function $getTableWrapperSizes(this$static){
  ...
  if (this$static.scrollPolicy == ($location_0[stackIndex] = 'AbstractScrollTable.java:' + '874' , $clinit_836() , DISABLED_0) || this$static.scrollPolicy == HORIZONTAL_1) {
    $stackDepth_0 = stackIndex - 1;
    return null;
  }
...
function $maybeRecalculateIdealColumnWidths(this$static){
  ...
  headerTable.idealColumnWidthInfo = ($location_0[stackIndex] = 'FixedWidthFlexTable.java:' + '624' , $recalculateIdealColumnWidthsSetup_0((!impl_5 && (impl_5 = ($location_0[stackIndex] = 'FixedWidthTableImpl.java:' + '65' , new FixedWidthTableImpl$Impl)) , headerTable), headerTable.maxRawColumnCount, 0));
  dataTable.idealWidths = ($location_0[stackIndex] = 'FixedWidthGrid.java:' + '480' , $recalculateIdealColumnWidths_2((!impl_5 && (impl_5 = ($location_0[stackIndex] = 'FixedWidthTableImpl.java:' + '65' , new FixedWidthTableImpl$Impl)) , dataTable.idealColumnWidthInfo)));
  headerTable.idealWidths = ($location_0[stackIndex] = 'FixedWidthFlexTable.java:' + '616' , $recalculateIdealColumnWidths_2((!impl_5 && (impl_5 = ($location_0[stackIndex] = 'FixedWidthTableImpl.java:' + '65' , new FixedWidthTableImpl$Impl)) , headerTable.idealColumnWidthInfo)));
  $location_0[stackIndex] = 'FixedWidthGrid.java:' + '500' , $recalculateIdealColumnWidthsTeardown((!impl_5 && (impl_5 = ($location_0[stackIndex] = 'FixedWidthTableImpl.java:' + '65' , new FixedWidthTableImpl$Impl)) , dataTable.idealColumnWidthInfo));
  $location_0[stackIndex] = 'FixedWidthGrid.java:' + '502' , dataTable.idealColumnWidthInfo = null;
  $location_0[stackIndex] = 'FixedWidthFlexTable.java:' + '632' , $recalculateIdealColumnWidthsTeardown((!impl_5 && (impl_5 = ($location_0[stackIndex] = 'FixedWidthTableImpl.java:' + '65' , new FixedWidthTableImpl$Impl)) , headerTable.idealColumnWidthInfo));
...
function $resizeTablesVertically(this$static){
  ...
  if (this$static.scrollPolicy == ($location_0[stackIndex] = 'AbstractScrollTable.java:' + '874' , $clinit_836() , DISABLED_0)) {
...
function $scrollTables(this$static, baseHeader){
  ...
  if (this$static.lastScrollLeft >= 0) {
    $setScrollLeft_1(($location_0[stackIndex] = 'Element.java:' + '695' , $clinit_81() , this$static.headerWrapper), this$static.lastScrollLeft);
...
function $updateFillWidthImage(this$static){
  ...
  this$static.columnResizePolicy == ($location_0[stackIndex] = 'AbstractScrollTable.java:' + '823' , $clinit_830() , DISABLED) || this$static.resizePolicy.isFixedWidth?($location_0[stackIndex] = 'UIObject.java:' + '214' , this$static.fillWidthImage.element.style.display = 'none' , undefined):(this$static.fillWidthImage.element.style.display = '' , undefined);
  $stackDepth_0 = stackIndex - 1;
}
  ...
  switch ($location_0[stackIndex] = 'DOMImpl.java:' + '61' , $eventGetTypeInt(event_0.type)) {
    ...
    case 8:
      ...
      if (this.resizeWorker.resizing) {
        ...
        if (cellElem) {
          if (this.sortPolicy == ($location_0[stackIndex] = 'AbstractScrollTable.java:' + '887' , $clinit_840() , DISABLED_1)) {
            $stackDepth_0 = stackIndex - 1;
            return;
          }
...
function $clinit_828(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_828;
  $location_0[stackIndex] = 'AbstractScrollTable.java:' + '1101' , $clinit_828 = nullMethod;
  $clinit_396();
  $stackDepth_0 = stackIndex - 1;
}
...
function $AbstractScrollTable$1(this$static, this$0){
  ...
  $location_0[stackIndex] = 'AbstractScrollTable.java:' + '1101' , $clinit_828();
  this$static.this$0 = this$0;
  $Image(this$static);
  $stackDepth_0 = stackIndex - 1;
  return this$static;
...
function $clinit_830(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_830;
  $location_0[stackIndex] = 'AbstractScrollTable.java:' + '822' , $clinit_830 = nullMethod;
...
function $AbstractScrollTable$ColumnResizePolicy(this$static, enum$name, enum$ordinal){
  ...
  $location_0[stackIndex] = 'AbstractScrollTable.java:' + '822' , $clinit_830();
  $location_0[stackIndex] = 'Enum.java:' + '76' , this$static.name_0 = enum$name;
  $location_0[stackIndex] = 'Enum.java:' + '77' , this$static.ordinal = enum$ordinal;
  $stackDepth_0 = stackIndex - 1;
  return this$static;
...
function values_17(){
  ...
  $location_0[stackIndex] = 'AbstractScrollTable.java:' + '822' , $clinit_830();
  returnTemp = initValues(_3Lorg_gwt_mosaic_ui_client_table_AbstractScrollTable$ColumnResizePolicy_2_classLit, 707, 101, [DISABLED, SINGLE_CELL, MULTI_CELL]);
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function $repositionSpacer(scrollTable, force){
  ...
  if (!force && scrollTable.scrollPolicy != ($location_0[stackIndex] = 'AbstractScrollTable.java:' + '874' , $clinit_836() , BOTH_0)) {
    $stackDepth_0 = stackIndex - 1;
    return;
  }
...
function $resizeSpacer(table, spacerWidth){
  ...
  $location_0[stackIndex] = 'Style.java:' + '1449' , table.element.style['paddingRight'] = spacerWidth + ($location_0[stackIndex] = 'Style.java:' + '1369' , $clinit_111() , 'px');
  $stackDepth_0 = stackIndex - 1;
}
...
function $resizeColumn_0(this$static){
  ...
  if (this$static.mouseXLast != this$static.mouseXCurrent) {
    ...
    $location_0[stackIndex] = 'AbstractScrollTable.java:' + '588' , $clinit_228();
...
function $setCurrentCell(this$static, event_0){
  ...
  if (this$static.table.columnResizePolicy == ($location_0[stackIndex] = 'AbstractScrollTable.java:' + '823' , $clinit_830() , MULTI_CELL)) {
  ...
  if (cell) {
    $location_0[stackIndex] = 'AbstractScrollTable.java:' + '446' , absLeft = $getAbsoluteLeftImpl(($location_0[stackIndex] = 'DOMImplMozilla.java:' + '55' , $getViewportElement(cell.ownerDocument)), cell) - ($location_0[stackIndex] = 'Document.java:' + '1259' , $getScrollLeft_0($doc));
    $location_0[stackIndex] = 'AbstractScrollTable.java:' + '447' , $clinit_228();
  ...
  if (cell != this$static.curCell) {
    ...
    if (this$static.curCell) {
      ...
      for ($location_0[stackIndex] = 'AbstractScrollTable.java:' + '480' , info$iterator = $AbstractList$IteratorImpl(($location_0[stackIndex] = 'AbstractList.java:' + '278' , new AbstractList$IteratorImpl), this$static.curCells); info$iterator.i < ($location_0[stackIndex] = 'AbstractList.java:' + '38' , info$iterator.this$0.size_1());) {
        info = dynamicCast(($location_0[stackIndex] = 'AbstractScrollTable.java:' + '480' , $next_6(info$iterator)), 217);
...
function $clinit_834(){
  ...
  $location_0[stackIndex] = 'AbstractScrollTable.java:' + '373' , $clinit_834 = nullMethod;
  $clinit_43();
  $stackDepth_0 = stackIndex - 1;
}
...
function $AbstractScrollTable$MouseResizeWorker$1(this$static, this$1){
  ...
  $location_0[stackIndex] = 'AbstractScrollTable.java:' + '373' , $clinit_834();
...
function $clinit_835(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_835;
  $location_0[stackIndex] = 'AbstractScrollTable.java:' + '843' , $clinit_835 = nullMethod;
...
function $AbstractScrollTable$ResizePolicy(this$static, enum$name, enum$ordinal, isFixedWidth, isSacrificial){
  ...
  $location_0[stackIndex] = 'AbstractScrollTable.java:' + '850' , $clinit_835();
  $location_0[stackIndex] = 'Enum.java:' + '76' , this$static.name_0 = enum$name;
  $location_0[stackIndex] = 'Enum.java:' + '77' , this$static.ordinal = enum$ordinal;
...
function values_18(){
  ...
  $location_0[stackIndex] = 'AbstractScrollTable.java:' + '843' , $clinit_835();
  returnTemp = initValues(_3Lorg_gwt_mosaic_ui_client_table_AbstractScrollTable$ResizePolicy_2_classLit, 708, 102, [UNCONSTRAINED, FLOW, FIXED_WIDTH, FILL_WIDTH]);
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function $clinit_836(){
  ...
  $location_0[stackIndex] = 'AbstractScrollTable.java:' + '873' , $clinit_836 = nullMethod;
...
function $AbstractScrollTable$ScrollPolicy(this$static, enum$name, enum$ordinal){
  ...
  $location_0[stackIndex] = 'AbstractScrollTable.java:' + '873' , $clinit_836();
  $location_0[stackIndex] = 'Enum.java:' + '76' , this$static.name_0 = enum$name;
  $location_0[stackIndex] = 'Enum.java:' + '77' , this$static.ordinal = enum$ordinal;
  $stackDepth_0 = stackIndex - 1;
  return this$static;
...
function values_19(){
  ...
  $location_0[stackIndex] = 'AbstractScrollTable.java:' + '873' , $clinit_836();
  returnTemp = initValues(_3Lorg_gwt_mosaic_ui_client_table_AbstractScrollTable$ScrollPolicy_2_classLit, 709, 103, [HORIZONTAL_1, BOTH_0, DISABLED_0]);
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function $clinit_840(){
  ...
  $location_0[stackIndex] = 'AbstractScrollTable.java:' + '886' , $clinit_840 = nullMethod;
...
function $AbstractScrollTable$SortPolicy(this$static, enum$name, enum$ordinal){
  ...
  $location_0[stackIndex] = 'AbstractScrollTable.java:' + '886' , $clinit_840();
  $location_0[stackIndex] = 'Enum.java:' + '76' , this$static.name_0 = enum$name;
  $location_0[stackIndex] = 'Enum.java:' + '77' , this$static.ordinal = enum$ordinal;
  $stackDepth_0 = stackIndex - 1;
  return this$static;
...
function values_20(){
  ...
  $location_0[stackIndex] = 'AbstractScrollTable.java:' + '886' , $clinit_840();
  returnTemp = initValues(_3Lorg_gwt_mosaic_ui_client_table_AbstractScrollTable$SortPolicy_2_classLit, 710, 104, [DISABLED_1, SINGLE_CELL_0, MULTI_CELL_0]);
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function $distributeWidth(columns, width){
  ...
  for ($location_0[stackIndex] = 'ColumnResizer.java:' + '197' , info$iterator = $AbstractList$IteratorImpl(($location_0[stackIndex] = 'AbstractList.java:' + '278' , new AbstractList$IteratorImpl), columns); info$iterator.i < ($location_0[stackIndex] = 'AbstractList.java:' + '38' , info$iterator.this$0.size_1());) {
    info = dynamicCast(($location_0[stackIndex] = 'ColumnResizer.java:' + '197' , $next_6(info$iterator)), 217);
...
function $distributeWidthImpl(columns, width){
  ...
  while (columns.size_0 > 0 && width != 0) {
    ...
    for ($location_0[stackIndex] = 'ColumnResizer.java:' + '267' , curIndex = 0; curIndex < syncedColumns; $location_0[stackIndex] = 'ColumnResizer.java:' + '267' , ++curIndex) {
      curInfo = ($location_0[stackIndex] = 'ColumnResizer.java:' + '269' , dynamicCast(($location_0[stackIndex] = 'ArrayList.java:' + '157' , checkIndex(curIndex, columns.size_0) , ($location_0[stackIndex] = 'ArrayList.java:' + '158' , columns.array[curIndex])), 217));
    ...
    for ($location_0[stackIndex] = 'ColumnResizer.java:' + '296' , curIndex = 0; curIndex < syncedColumns; $location_0[stackIndex] = 'ColumnResizer.java:' + '296' , ++curIndex) {
      curInfo = ($location_0[stackIndex] = 'ColumnResizer.java:' + '298' , dynamicCast(($location_0[stackIndex] = 'ArrayList.java:' + '157' , checkIndex(curIndex, columns.size_0) , ($location_0[stackIndex] = 'ArrayList.java:' + '158' , columns.array[curIndex])), 217));
...
function $getTargetDiff(columns, syncedColumns, width){
  ...
  if (syncedColumns < columns.size_0) {
    returnTemp = $getPercentageDifference(($location_0[stackIndex] = 'ColumnResizer.java:' + '358' , dynamicCast(($location_0[stackIndex] = 'ArrayList.java:' + '157' , checkIndex(syncedColumns, columns.size_0) , ($location_0[stackIndex] = 'ArrayList.java:' + '158' , columns.array[syncedColumns])), 217)));
    $stackDepth_0 = stackIndex - 1;
    return returnTemp;
  }
   else {
    ...
    for ($location_0[stackIndex] = 'ColumnResizer.java:' + '363' , info$iterator = $AbstractList$IteratorImpl(($location_0[stackIndex] = 'AbstractList.java:' + '278' , new AbstractList$IteratorImpl), columns); info$iterator.i < ($location_0[stackIndex] = 'AbstractList.java:' + '38' , info$iterator.this$0.size_1());) {
      info = dynamicCast(($location_0[stackIndex] = 'ColumnResizer.java:' + '363' , $next_6(info$iterator)), 217);
...
function compare_3(p0, p1){
  ...
  returnTemp = $compare_1(($location_0[stackIndex] = 'com.google.gwt.dev.jjs.impl.GenerateJavaAST:' + '0' , dynamicCast(p0, 217)), dynamicCast(p1, 217));
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function compare_4(p0, p1){
  ...
  returnTemp = $compare_2(($location_0[stackIndex] = 'com.google.gwt.dev.jjs.impl.GenerateJavaAST:' + '0' , dynamicCast(p0, 217)), dynamicCast(p1, 217));
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function $getSelectedRowsSet(this$static){
  ...
  for ($location_0[stackIndex] = 'SelectionGrid.java:' + '696' , rowIndex$iterator = (outerIter = ($location_0[stackIndex] = 'AbstractMap.java:' + '107' , ($location_0[stackIndex] = 'SelectionGrid.java:' + '696' , $keySet_1(this$static.selectedRows)).val$entrySet.iterator_0()) , $AbstractMap$1$1(($location_0[stackIndex] = 'AbstractMap.java:' + '108' , new AbstractMap$1$1), outerIter)); $location_0[stackIndex] = 'AbstractMap.java:' + '110' , rowIndex$iterator.val$outerIter.hasNext();) {
    rowIndex = ($location_0[stackIndex] = 'SelectionGrid.java:' + '696' , dynamicCast((entry = dynamicCast(($location_0[stackIndex] = 'AbstractMap.java:' + '114' , rowIndex$iterator.val$outerIter.next_0()), 88) , ($location_0[stackIndex] = 'AbstractMap.java:' + '115' , entry.getKey())), 83));
    ($location_0[stackIndex] = 'TreeSet.java:' + '69' , $put_1(rowSet.map, $TableEvent$Row(($location_0[stackIndex] = 'SelectionGrid.java:' + '697' , new TableEvent$Row), rowIndex.value_0), ($location_0[stackIndex] = 'Boolean.java:' + '29' , $clinit_515() , FALSE_0))) == null;
  }
  $stackDepth_0 = stackIndex - 1;
  return rowSet;
}
...
function $onMouseClick(this$static, event_0){
  ...
  if (this$static.selectionPolicy == ($location_0[stackIndex] = 'SelectionGrid.java:' + '127' , $clinit_866() , MULTI_ROW)) {
...
function $selectRow_0(this$static, row, ctrlKey, shiftKey){
  ...
  if (shiftKey && this$static.lastSelectedRowIndex > -1) {
    $location_0[stackIndex] = 'SelectionGrid.java:' + '470' , formatter = ($location_0[stackIndex] = 'SelectionGrid.java:' + '294' , dynamicCast(this$static.rowFormatter, 219));
    ...
    $location_0[stackIndex] = 'SelectionGrid.java:' + '492' , formatter = ($location_0[stackIndex] = 'SelectionGrid.java:' + '294' , dynamicCast(this$static.rowFormatter, 219));
...
function $setSelectionEnabled(this$static, enabled){
  ...
  if (this$static.selectionPolicy.inputHtml != null) {
    $location_0[stackIndex] = 'SelectionGrid.java:' + '509' , formatter = ($location_0[stackIndex] = 'SelectionGrid.java:' + '283' , dynamicCast(this$static.cellFormatter, 220));
...
function $sortColumn_0(this$static, column, ascending){
  ...
  selectedRows = dynamicCast(($location_0[stackIndex] = 'SortableGrid.java:' + '347' , $toArray(($location_0[stackIndex] = 'SortableGrid.java:' + '347' , $values(this$static.selectedRows)), ($location_0[stackIndex] = 'SortableGrid.java:' + '348' , initDim(_3Lcom_google_gwt_core_client_JavaScriptObject_2_classLit, 636, -1, 0, 0)))), 221);
  $location_0[stackIndex] = 'SelectionGrid.java:' + '255' , $deselectAllRows(this$static, true);
...
function $getColumnWidth(this$static, column){
  ...
  colWidth = dynamicCast($get_7(this$static.colWidths, ($location_0[stackIndex] = 'FixedWidthGrid.java:' + '173' , valueOf_4(column))), 83);
  if (!colWidth) {
    $stackDepth_0 = stackIndex - 1;
    return 80;
  }
...
function $getGhostCellElement(this$static, column){
  ...
  returnTemp = ($location_0[stackIndex] = 'DOM.java:' + '705' , $getChild((!impl_5 && (impl_5 = ($location_0[stackIndex] = 'FixedWidthTableImpl.java:' + '65' , new FixedWidthTableImpl$Impl)) , this$static.ghostRow), column));
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function $recalculateIdealColumnWidths_0(this$static){
  ...
  if (!this$static.attached || this$static.numRows == 0 || columnCount < 1) {
    this$static.idealWidths = ($location_0[stackIndex] = 'FixedWidthGrid.java:' + '408' , initDim(_3I_classLit, 677, -1, 0, 1));
    $stackDepth_0 = stackIndex - 1;
    return;
  }
  $location_0[stackIndex] = 'FixedWidthGrid.java:' + '412' , $recalculateIdealColumnWidthsSetup(this$static);
  this$static.idealWidths = ($location_0[stackIndex] = 'FixedWidthGrid.java:' + '480' , $recalculateIdealColumnWidths_2((!impl_5 && (impl_5 = ($location_0[stackIndex] = 'FixedWidthTableImpl.java:' + '65' , new FixedWidthTableImpl$Impl)) , this$static.idealColumnWidthInfo)));
  $location_0[stackIndex] = 'FixedWidthGrid.java:' + '500' , $recalculateIdealColumnWidthsTeardown((!impl_5 && (impl_5 = ($location_0[stackIndex] = 'FixedWidthTableImpl.java:' + '65' , new FixedWidthTableImpl$Impl)) , this$static.idealColumnWidthInfo));
...
function $recalculateIdealColumnWidthsSetup(this$static){
  ...
  this$static.idealColumnWidthInfo = ($location_0[stackIndex] = 'FixedWidthGrid.java:' + '492' , $recalculateIdealColumnWidthsSetup_0((!impl_5 && (impl_5 = ($location_0[stackIndex] = 'FixedWidthTableImpl.java:' + '65' , new FixedWidthTableImpl$Impl)) , this$static), this$static.numColumns, offset));
  $stackDepth_0 = stackIndex - 1;
}
...
function $setCellPadding_0(this$static, padding){
  ...
  for ($location_0[stackIndex] = 'FixedWidthGrid.java:' + '236' , entry$iterator = ($location_0[stackIndex] = 'AbstractHashMap.java:' + '64' , $AbstractHashMap$EntrySetIterator(($location_0[stackIndex] = 'AbstractHashMap.java:' + '64' , new AbstractHashMap$EntrySetIterator), $AbstractHashMap$EntrySet(($location_0[stackIndex] = 'AbstractHashMap.java:' + '235' , new AbstractHashMap$EntrySet), this$static.colWidths).this$0)); $location_0[stackIndex] = 'AbstractHashMap.java:' + '104' , $hasNext_4(entry$iterator.iter);) {
    $location_0[stackIndex] = 'FixedWidthGrid.java:' + '236' , entry = entry$iterator.last = dynamicCast(($location_0[stackIndex] = 'AbstractHashMap.java:' + '108' , $next_6(entry$iterator.iter)), 88);
    $setColumnWidth(this$static, dynamicCast(($location_0[stackIndex] = 'FixedWidthGrid.java:' + '237' , entry.getKey()), 83).value_0, dynamicCast(entry.getValue(), 83).value_0);
  }
...
function $setCellSpacing_0(this$static, spacing){
  ...
  for ($location_0[stackIndex] = 'FixedWidthGrid.java:' + '249' , entry$iterator = ($location_0[stackIndex] = 'AbstractHashMap.java:' + '64' , $AbstractHashMap$EntrySetIterator(($location_0[stackIndex] = 'AbstractHashMap.java:' + '64' , new AbstractHashMap$EntrySetIterator), $AbstractHashMap$EntrySet(($location_0[stackIndex] = 'AbstractHashMap.java:' + '235' , new AbstractHashMap$EntrySet), this$static.colWidths).this$0)); $location_0[stackIndex] = 'AbstractHashMap.java:' + '104' , $hasNext_4(entry$iterator.iter);) {
    $location_0[stackIndex] = 'FixedWidthGrid.java:' + '249' , entry = entry$iterator.last = dynamicCast(($location_0[stackIndex] = 'AbstractHashMap.java:' + '108' , $next_6(entry$iterator.iter)), 88);
    $setColumnWidth(this$static, dynamicCast(($location_0[stackIndex] = 'FixedWidthGrid.java:' + '250' , entry.getKey()), 83).value_0, dynamicCast(entry.getValue(), 83).value_0);
  }
...
function $setColumnWidthImpl(this$static, column, width){
  ...
  $location_0[stackIndex] = 'FixedWidthGrid.java:' + '538' , $setColumnWidth_1((!impl_5 && (impl_5 = ($location_0[stackIndex] = 'FixedWidthTableImpl.java:' + '65' , new FixedWidthTableImpl$Impl)) , this$static.ghostRow), column, width);
  $stackDepth_0 = stackIndex - 1;
}
...
function $setSelectionPolicy_0(this$static, selectionPolicy){
  ...
  if (selectionPolicy.inputHtml != null && this$static.selectionPolicy.inputHtml == null) {
    ...
    td = ($location_0[stackIndex] = 'FixedWidthGrid.java:' + '297' , $createGhostCell((!impl_5 && (impl_5 = ($location_0[stackIndex] = 'FixedWidthTableImpl.java:' + '65' , new FixedWidthTableImpl$Impl)) , null)));
...
function $updateGhostRow(this$static){
  ...
  if (this$static.numColumns > numGhosts) {
    for ($location_0[stackIndex] = 'FixedWidthGrid.java:' + '434' , i = numGhosts; i < this$static.numColumns; $location_0[stackIndex] = 'FixedWidthGrid.java:' + '434' , ++i) {
      td = ($location_0[stackIndex] = 'FixedWidthGrid.java:' + '435' , $createGhostCell((!impl_5 && (impl_5 = ($location_0[stackIndex] = 'FixedWidthTableImpl.java:' + '65' , new FixedWidthTableImpl$Impl)) , null)));
...
function $DataTable(this$static){
  ...
  $location_0[stackIndex] = 'SelectionGrid.java:' + '200' , this$static.selectionPolicy = ($location_0[stackIndex] = 'SelectionGrid.java:' + '127' , $clinit_866() , MULTI_ROW);
  ...
  $location_0[stackIndex] = 'SelectionGrid.java:' + '212' , $sinkEvents_0(this$static, 53);
  ...
  this$static.ghostRow = ($location_0[stackIndex] = 'FixedWidthGrid.java:' + '140' , $createGhostRow((!impl_5 && (impl_5 = ($location_0[stackIndex] = 'FixedWidthTableImpl.java:' + '65' , new FixedWidthTableImpl$Impl)) , impl_5)));
  $location_0[stackIndex] = 'DOM.java:' + '929' , $insertChild(this$static.bodyElem, this$static.ghostRow, 0);
  $location_0[stackIndex] = 'FixedWidthGrid.java:' + '144' , $sinkEvents_0(this$static, 21);
  $location_0[stackIndex] = 'DataTable.java:' + '60' , $sinkEvents_0(this$static, 262146);
  $stackDepth_0 = stackIndex - 1;
  return this$static;
}
...
function $FixedWidthFlexTable(this$static){
  ...
  this$static.ghostRow = ($location_0[stackIndex] = 'FixedWidthFlexTable.java:' + '247' , $createGhostRow((!impl_5 && (impl_5 = ($location_0[stackIndex] = 'FixedWidthTableImpl.java:' + '65' , new FixedWidthTableImpl$Impl)) , impl_5)));
  $location_0[stackIndex] = 'DOM.java:' + '929' , $insertChild(this$static.bodyElem, this$static.ghostRow, 0);
  $stackDepth_0 = stackIndex - 1;
  return this$static;
}
...
function $getColumnWidth_0(this$static, column){
  ...
  if (colWidth == null) {
    ...
    returnTemp = ($location_0[stackIndex] = 'FixedWidthFlexTable.java:' + '276' , dynamicCast(colWidth, 83)).value_0;
    $stackDepth_0 = stackIndex - 1;
    return returnTemp;
  }
  $stackDepth_0 = stackIndex - 1;
...
function $getNumColumnsPerRow(this$static, row){
  ...
  if (this$static.columnsPerRow.size_0 <= row) {
    ...
    returnTemp = dynamicCast(($location_0[stackIndex] = 'FixedWidthFlexTable.java:' + '646' , $get_5(this$static.columnsPerRow, row)), 83).value_0;
    $stackDepth_0 = stackIndex - 1;
    return returnTemp;
  }
  $stackDepth_0 = stackIndex - 1;
...
function $recalculateIdealColumnWidths_1(this$static){
  ...
  if (!this$static.attached || this$static.bodyElem.rows.length - 1 == 0 || columnCount < 1) {
    this$static.idealWidths = ($location_0[stackIndex] = 'FixedWidthFlexTable.java:' + '588' , initDim(_3I_classLit, 677, -1, 0, 1));
    $stackDepth_0 = stackIndex - 1;
    return;
  }
  this$static.idealColumnWidthInfo = ($location_0[stackIndex] = 'FixedWidthFlexTable.java:' + '624' , $recalculateIdealColumnWidthsSetup_0((!impl_5 && (impl_5 = ($location_0[stackIndex] = 'FixedWidthTableImpl.java:' + '65' , new FixedWidthTableImpl$Impl)) , this$static), this$static.maxRawColumnCount, 0));
  this$static.idealWidths = ($location_0[stackIndex] = 'FixedWidthFlexTable.java:' + '616' , $recalculateIdealColumnWidths_2((!impl_5 && (impl_5 = ($location_0[stackIndex] = 'FixedWidthTableImpl.java:' + '65' , new FixedWidthTableImpl$Impl)) , this$static.idealColumnWidthInfo)));
  $location_0[stackIndex] = 'FixedWidthFlexTable.java:' + '632' , $recalculateIdealColumnWidthsTeardown((!impl_5 && (impl_5 = ($location_0[stackIndex] = 'FixedWidthTableImpl.java:' + '65' , new FixedWidthTableImpl$Impl)) , this$static.idealColumnWidthInfo));
...
function $removeRow_3(this$static, row){
  ...
  $location_0[stackIndex] = 'FixedWidthFlexTable.java:' + '397' , formatter = ($location_0[stackIndex] = 'FlexTable.java:' + '177' , dynamicCast(this$static.cellFormatter, 182));
...
function $setCellPadding_1(this$static, padding){
  ...
  for ($location_0[stackIndex] = 'FixedWidthFlexTable.java:' + '439' , entry$iterator = ($location_0[stackIndex] = 'AbstractHashMap.java:' + '64' , $AbstractHashMap$EntrySetIterator(($location_0[stackIndex] = 'AbstractHashMap.java:' + '64' , new AbstractHashMap$EntrySetIterator), $AbstractHashMap$EntrySet(($location_0[stackIndex] = 'AbstractHashMap.java:' + '235' , new AbstractHashMap$EntrySet), this$static.colWidths).this$0)); $location_0[stackIndex] = 'AbstractHashMap.java:' + '104' , $hasNext_4(entry$iterator.iter);) {
    $location_0[stackIndex] = 'FixedWidthFlexTable.java:' + '439' , entry = entry$iterator.last = dynamicCast(($location_0[stackIndex] = 'AbstractHashMap.java:' + '108' , $next_6(entry$iterator.iter)), 88);
    $setColumnWidth_0(this$static, dynamicCast(($location_0[stackIndex] = 'FixedWidthFlexTable.java:' + '440' , entry.getKey()), 83).value_0, dynamicCast(entry.getValue(), 83).value_0);
  }
  $stackDepth_0 = stackIndex - 1;
}
...
function $setCellSpacing_1(this$static, spacing){
  ...
  for ($location_0[stackIndex] = 'FixedWidthFlexTable.java:' + '449' , entry$iterator = ($location_0[stackIndex] = 'AbstractHashMap.java:' + '64' , $AbstractHashMap$EntrySetIterator(($location_0[stackIndex] = 'AbstractHashMap.java:' + '64' , new AbstractHashMap$EntrySetIterator), $AbstractHashMap$EntrySet(($location_0[stackIndex] = 'AbstractHashMap.java:' + '235' , new AbstractHashMap$EntrySet), this$static.colWidths).this$0)); $location_0[stackIndex] = 'AbstractHashMap.java:' + '104' , $hasNext_4(entry$iterator.iter);) {
    $location_0[stackIndex] = 'FixedWidthFlexTable.java:' + '449' , entry = entry$iterator.last = dynamicCast(($location_0[stackIndex] = 'AbstractHashMap.java:' + '108' , $next_6(entry$iterator.iter)), 88);
    $setColumnWidth_0(this$static, dynamicCast(($location_0[stackIndex] = 'FixedWidthFlexTable.java:' + '450' , entry.getKey()), 83).value_0, dynamicCast(entry.getValue(), 83).value_0);
  }
  $stackDepth_0 = stackIndex - 1;
}
...
function $setColumnWidth_0(this$static, column, width){
  ...
  $location_0[stackIndex] = 'FixedWidthFlexTable.java:' + '479' , $setColumnWidth_1((!impl_5 && (impl_5 = ($location_0[stackIndex] = 'FixedWidthTableImpl.java:' + '65' , new FixedWidthTableImpl$Impl)) , this$static.ghostRow), column, width);
  $stackDepth_0 = stackIndex - 1;
}
...
function $setNumColumnsPerRow(this$static, row, numColumns){
  ...
  if ($location_0[stackIndex] = 'FixedWidthFlexTable.java:' + '685' , $containsKey_0(this$static.columnCountMap, oldNumColumnsI)) {
    numRows = dynamicCast(($location_0[stackIndex] = 'FixedWidthFlexTable.java:' + '686' , $get_7(this$static.columnCountMap, oldNumColumnsI)), 83).value_0;
    if (numRows == 1) {
  ...
  if (numColumns > 0) {
    if ($location_0[stackIndex] = 'FixedWidthFlexTable.java:' + '697' , $containsKey_0(this$static.columnCountMap, numColumnsI)) {
      numRows = dynamicCast(($location_0[stackIndex] = 'FixedWidthFlexTable.java:' + '698' , $get_7(this$static.columnCountMap, numColumnsI)), 83).value_0;
  ...
  if (numColumns > this$static.maxRawColumnCount) {
    ...
    for ($location_0[stackIndex] = 'FixedWidthFlexTable.java:' + '712' , curNumColumns$iterator = (outerIter = ($location_0[stackIndex] = 'AbstractMap.java:' + '107' , ($location_0[stackIndex] = 'FixedWidthFlexTable.java:' + '712' , $keySet_1(this$static.columnCountMap)).val$entrySet.iterator_0()) , $AbstractMap$1$1(($location_0[stackIndex] = 'AbstractMap.java:' + '108' , new AbstractMap$1$1), outerIter)); $location_0[stackIndex] = 'AbstractMap.java:' + '110' , curNumColumns$iterator.val$outerIter.hasNext();) {
      curNumColumns = ($location_0[stackIndex] = 'FixedWidthFlexTable.java:' + '712' , dynamicCast((entry = dynamicCast(($location_0[stackIndex] = 'AbstractMap.java:' + '114' , curNumColumns$iterator.val$outerIter.next_0()), 88) , ($location_0[stackIndex] = 'AbstractMap.java:' + '115' , entry.getKey())), 83));
...
function $updateGhostRow_0(this$static){
  ...
  if (this$static.maxRawColumnCount > curNumGhosts) {
    ...
    for ($location_0[stackIndex] = 'FixedWidthFlexTable.java:' + '730' , i = curNumGhosts; i < this$static.maxRawColumnCount; $location_0[stackIndex] = 'FixedWidthFlexTable.java:' + '730' , ++i) {
      $location_0[stackIndex] = 'FixedWidthFlexTable.java:' + '731' , td = ($location_0[stackIndex] = 'DOM.java:' + '705' , $getChild((!impl_5 && (impl_5 = ($location_0[stackIndex] = 'FixedWidthTableImpl.java:' + '65' , new FixedWidthTableImpl$Impl)) , this$static.ghostRow), i));
      $location_0[stackIndex] = 'FixedWidthFlexTable.java:' + '732' , $createGhostCell((!impl_5 && (impl_5 = ($location_0[stackIndex] = 'FixedWidthTableImpl.java:' + '65' , new FixedWidthTableImpl$Impl)) , td));
    ...
    for ($location_0[stackIndex] = 'FixedWidthFlexTable.java:' + '738' , i = 0; i < cellsToRemove; $location_0[stackIndex] = 'FixedWidthFlexTable.java:' + '738' , ++i) {
      $location_0[stackIndex] = 'Node.java:' + '285' , this$static.ghostRow.removeChild(($location_0[stackIndex] = 'DOM.java:' + '705' , $getChild((!impl_5 && (impl_5 = ($location_0[stackIndex] = 'FixedWidthTableImpl.java:' + '65' , new FixedWidthTableImpl$Impl)) , this$static.ghostRow), this$static.maxRawColumnCount)));
    }
  }
  $stackDepth_0 = stackIndex - 1;
}
...
function insertRow_0(beforeRow){
  ...
  $location_0[stackIndex] = 'FixedWidthFlexTable.java:' + '321' , formatter = ($location_0[stackIndex] = 'FlexTable.java:' + '177' , dynamicCast(this.cellFormatter, 182));
...
function $createGhostCell(td){
  ...
  $location_0[stackIndex] = 'Style.java:' + '1449' , td.style['height'] = 0 + ($location_0[stackIndex] = 'Style.java:' + '1369' , $clinit_111() , 'px');
...
function $createGhostRow(){
  ...
  $location_0[stackIndex] = 'Style.java:' + '1449' , ghostRow.style['margin'] = 0 + ($location_0[stackIndex] = 'Style.java:' + '1369' , $clinit_111() , 'px');
...
function $recalculateIdealColumnWidths_2(info){
  ...
  if (!info) {
    returnTemp = ($location_0[stackIndex] = 'FixedWidthTableImpl.java:' + '148' , initDim(_3I_classLit, 677, -1, 0, 1));
    $stackDepth_0 = stackIndex - 1;
    return returnTemp;
  }
  ...
  if (!table.attached || ($location_0[stackIndex] = 'FixedWidthTableImpl.java:' + '154' , table.getRowCount()) == 0 || columnCount < 1) {
    returnTemp = ($location_0[stackIndex] = 'FixedWidthTableImpl.java:' + '155' , initDim(_3I_classLit, 677, -1, 0, 1));
    $stackDepth_0 = stackIndex - 1;
    return returnTemp;
  }
  idealWidths = ($location_0[stackIndex] = 'FixedWidthTableImpl.java:' + '159' , initDim(_3I_classLit, 677, -1, columnCount, 1));
...
function $setColumnWidth_1(ghostRow, column, width){
  ...
  $location_0[stackIndex] = 'Style.java:' + '1449' , ($location_0[stackIndex] = 'DOM.java:' + '705' , $getChild(ghostRow, column)).style['width'] = width + ($location_0[stackIndex] = 'Style.java:' + '1369' , $clinit_111() , 'px');
  $stackDepth_0 = stackIndex - 1;
}
...
function $getColumnWidthInfo_1(this$static, column){
  ...
  info = dynamicCast($get_7(this$static.columnWidthInfos, ($location_0[stackIndex] = 'ScrollTable.java:' + '239' , valueOf_4(column))), 217);
  if (!info) {
...
function $isColumnSortable(this$static, column){
  ...
  returnTemp = this$static.sortPolicy != ($location_0[stackIndex] = 'AbstractScrollTable.java:' + '887' , $clinit_840() , DISABLED_1) && !($location_0[stackIndex] = 'HashSet.java:' + '83' , $containsKey_0(this$static.unsortableColumns.map, ($location_0[stackIndex] = 'ScrollTable.java:' + '116' , valueOf_4(column))));
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function isColumnSortable(column){
  var stackIndex, returnTemp;
  $stack_0[stackIndex = ++$stackDepth_0] = isColumnSortable;
  returnTemp = this.sortPolicy != ($location_0[stackIndex] = 'AbstractScrollTable.java:' + '887' , $clinit_840() , DISABLED_1) && !($location_0[stackIndex] = 'HashSet.java:' + '83' , $containsKey_0(this.unsortableColumns.map, ($location_0[stackIndex] = 'ScrollTable.java:' + '116' , valueOf_4(column))));
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function $clinit_866(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_866;
  $location_0[stackIndex] = 'SelectionGrid.java:' + '126' , $clinit_866 = nullMethod;
...
function $SelectionGrid$SelectionPolicy(this$static, enum$name, enum$ordinal, inputHtml){
  ...
  $location_0[stackIndex] = 'SelectionGrid.java:' + '132' , $clinit_866();
  $location_0[stackIndex] = 'Enum.java:' + '76' , this$static.name_0 = enum$name;
  $location_0[stackIndex] = 'Enum.java:' + '77' , this$static.ordinal = enum$ordinal;
...
function values_21(){
  ...
  $location_0[stackIndex] = 'SelectionGrid.java:' + '126' , $clinit_866();
  returnTemp = initValues(_3Lorg_gwt_mosaic_ui_client_table_SelectionGrid$SelectionPolicy_2_classLit, 711, 105, [ONE_ROW, MULTI_ROW, CHECKBOX, RADIO]);
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function $onSortColumn(grid, sortList, callback){
  ...
  $location_0[stackIndex] = 'SortableGrid.java:' + '90' , formatter = ($location_0[stackIndex] = 'SelectionGrid.java:' + '283' , dynamicCast(grid.cellFormatter, 220));
  ...
  trElems = ($location_0[stackIndex] = 'SortableGrid.java:' + '113' , initDim(_3Lcom_google_gwt_core_client_JavaScriptObject_2_classLit, 636, -1, rowCount, 0));
...
function compare_5(p0, p1){
  ...
  returnTemp = ($location_0[stackIndex] = 'String.java:' + '435' , compareTo_8(($location_0[stackIndex] = 'Element.java:' + '266' , $clinit_81() , ($location_0[stackIndex] = 'com.google.gwt.dev.jjs.impl.GenerateJavaAST:' + '0' , dynamicCastJso(p0))).textContent, dynamicCastJso(p1).textContent));
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function $compare_4(o1, o2){
  var stackIndex, returnTemp;
  $stack_0[stackIndex = ++$stackDepth_0] = $compare_4;
  returnTemp = ($location_0[stackIndex] = 'String.java:' + '435' , compareTo_8(($location_0[stackIndex] = 'Element.java:' + '266' , $clinit_81() , o2).textContent, o1.textContent));
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function equals_32(obj){
  ...
  if (obj != null && ($location_0[stackIndex] = 'Cast.java:' + '76' , canCast(obj.typeId$, 222))) {
    returnTemp = $equals_7(this, ($location_0[stackIndex] = 'TableModelHelper.java:' + '93' , dynamicCast(obj, 222)));
    $stackDepth_0 = stackIndex - 1;
    return returnTemp;
  }
  $stackDepth_0 = stackIndex - 1;
...
function $add_30(this$static, index, sortInfo){
  ...
  for ($location_0[stackIndex] = 'TableModelHelper.java:' + '188' , i = 0; i < this$static.infos.size_0; $location_0[stackIndex] = 'TableModelHelper.java:' + '188' , ++i) {
    curInfo = dynamicCast(($location_0[stackIndex] = 'TableModelHelper.java:' + '189' , $get_5(this$static.infos, i)), 222);
...
function $equals_8(this$static, csl){
  ...
  for ($location_0[stackIndex] = 'TableModelHelper.java:' + '237' , i = 0; i < size; $location_0[stackIndex] = 'TableModelHelper.java:' + '237' , ++i) {
    if (!$equals_7(dynamicCast(($location_0[stackIndex] = 'TableModelHelper.java:' + '238' , $get_5(this$static.infos, i)), 222), dynamicCast($get_5(csl.infos, i), 222))) {
      $stackDepth_0 = stackIndex - 1;
      return false;
    }
  }
...
function $getPrimaryColumnSortInfo(this$static){
  ...
  if (this$static.infos.size_0 > 0) {
    returnTemp = dynamicCast(($location_0[stackIndex] = 'TableModelHelper.java:' + '267' , $get_5(this$static.infos, 0)), 222);
    $stackDepth_0 = stackIndex - 1;
    return returnTemp;
  }
  $stackDepth_0 = stackIndex - 1;
...
function equals_33(obj){
  ...
  if (obj != null && ($location_0[stackIndex] = 'Cast.java:' + '76' , canCast(obj.typeId$, 223))) {
    returnTemp = $equals_8(this, ($location_0[stackIndex] = 'TableModelHelper.java:' + '213' , dynamicCast(obj, 223)));
    $stackDepth_0 = stackIndex - 1;
    return returnTemp;
  }
  $stackDepth_0 = stackIndex - 1;
...
function getClass_583(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_583;
  $stackDepth_0 = stackIndex - 1;
...
function getClass_584(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_584;
  $stackDepth_0 = stackIndex - 1;
...
function getClass_585(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_585;
  $stackDepth_0 = stackIndex - 1;
...
function createButtonLabel(image, text, type){
  ...
  if (type == ($location_0[stackIndex] = 'ButtonHelper.java:' + '34' , $clinit_877() , TEXT_ONLY)) {
    $stackDepth_0 = stackIndex - 1;
    return text;
  }
   else if (type == NO_TEXT) {
    returnTemp = ($location_0[stackIndex] = 'ClippedImagePrototype.java:' + '68' , $getHTML(image.url, image.left_0, image.top_0, image.width_0, image.height_0));
    $stackDepth_0 = stackIndex - 1;
    return returnTemp;
  }
    ...
    $location_0[stackIndex] = 'ButtonHelper.java:' + '69' , $setCellVerticalAlignment(hpanel, html, ($location_0[stackIndex] = 'HasVerticalAlignment.java:' + '67' , $clinit_391() , ALIGN_MIDDLE));
    $location_0[stackIndex] = 'ButtonHelper.java:' + '70' , $setCellVerticalAlignment(hpanel, img, ALIGN_MIDDLE);
    returnTemp = $toString_1(($location_0[stackIndex] = 'Element.java:' + '424' , $clinit_81() , hpanel.element));
    $stackDepth_0 = stackIndex - 1;
    return returnTemp;
  }
   else {
    ...
    $location_0[stackIndex] = 'ButtonHelper.java:' + '81' , $setCellHorizontalAlignment(vpanel, html, ($location_0[stackIndex] = 'HasHorizontalAlignment.java:' + '62' , $clinit_386() , ALIGN_CENTER));
    $location_0[stackIndex] = 'ButtonHelper.java:' + '83' , $setCellHorizontalAlignment(vpanel, img, ALIGN_CENTER);
    returnTemp = $toString_1(($location_0[stackIndex] = 'Element.java:' + '424' , $clinit_81() , vpanel.element));
    $stackDepth_0 = stackIndex - 1;
    return returnTemp;
  }
  $stackDepth_0 = stackIndex - 1;
...
function $clinit_877(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_877;
  $location_0[stackIndex] = 'ButtonHelper.java:' + '33' , $clinit_877 = nullMethod;
...
function $ButtonHelper$ButtonLabelType(this$static, enum$name, enum$ordinal){
  ...
  $location_0[stackIndex] = 'ButtonHelper.java:' + '33' , $clinit_877();
  $location_0[stackIndex] = 'Enum.java:' + '76' , this$static.name_0 = enum$name;
  $location_0[stackIndex] = 'Enum.java:' + '77' , this$static.ordinal = enum$ordinal;
  $stackDepth_0 = stackIndex - 1;
  return this$static;
...
function getClass_586(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_586;
  $stackDepth_0 = stackIndex - 1;
...
function values_22(){
  ...
  $location_0[stackIndex] = 'ButtonHelper.java:' + '33' , $clinit_877();
  returnTemp = initValues(_3Lorg_gwt_mosaic_ui_client_util_ButtonHelper$ButtonLabelType_2_classLit, 712, 106, [TEXT_ON_TOP, TEXT_ON_RIGHT, TEXT_ON_BOTTOM, TEXT_ON_LEFT, TEXT_ONLY, NO_TEXT]);
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function has(type){
  ...
  if (status_1) {
    for ($location_0[stackIndex] = 'ServerPlugins.java:' + '50' , p$iterator = $AbstractList$IteratorImpl(($location_0[stackIndex] = 'AbstractList.java:' + '278' , new AbstractList$IteratorImpl), status_1.plugins); p$iterator.i < ($location_0[stackIndex] = 'AbstractList.java:' + '38' , p$iterator.this$0.size_1());) {
      p = dynamicCast(($location_0[stackIndex] = 'ServerPlugins.java:' + '50' , $next_6(p$iterator)), 229);
...
function $createWindow(this$static){
  ...
  layout = $ScrollLayoutPanel_0(($location_0[stackIndex] = 'IFrameWindowPanel.java:' + '78' , new ScrollLayoutPanel), ($location_0[stackIndex] = 'IFrameWindowPanel.java:' + '78' , $BoxLayout_1(new BoxLayout, ($location_0[stackIndex] = 'BoxLayout.java:' + '170' , $clinit_796() , VERTICAL))));
  ...
  $add_26(layout, header, ($location_0[stackIndex] = 'IFrameWindowPanel.java:' + '84' , $BoxLayoutData_4(($location_0[stackIndex] = 'IFrameWindowPanel.java:' + '84' , new BoxLayoutData), ($location_0[stackIndex] = 'BoxLayoutData.java:' + '30' , $clinit_798() , HORIZONTAL_0))));
  ...
  $location_0[stackIndex] = 'IFrameWindowPanel.java:' + '154' , addMaximizeButton(this$static.windowPanel, ($location_0[stackIndex] = 'Caption.java:' + '61' , $clinit_649() , RIGHT));
...
function $clinit_927(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_927;
  $location_0[stackIndex] = 'ModelCommands.java:' + '24' , $clinit_927 = nullMethod;
...
function $ModelCommands(this$static, enum$name, enum$ordinal){
  ...
  $location_0[stackIndex] = 'ModelCommands.java:' + '24' , $clinit_927();
  $location_0[stackIndex] = 'Enum.java:' + '76' , this$static.name_0 = enum$name;
  $location_0[stackIndex] = 'Enum.java:' + '77' , this$static.ordinal = enum$ordinal;
  $stackDepth_0 = stackIndex - 1;
  return this$static;
...
function values_23(){
  ...
  $location_0[stackIndex] = 'ModelCommands.java:' + '24' , $clinit_927();
  returnTemp = initValues(_3Lorg_jboss_bpm_console_client_common_ModelCommands_2_classLit, 713, 107, [HAS_BECOME_STALE, HAS_BEEN_UPDATED]);
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function $clinit_928(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_928;
  $location_0[stackIndex] = 'ModelParts.java:' + '24' , $clinit_928 = nullMethod;
...
function $ModelParts(this$static, enum$name, enum$ordinal){
  ...
  $location_0[stackIndex] = 'ModelParts.java:' + '24' , $clinit_928();
  $location_0[stackIndex] = 'Enum.java:' + '76' , this$static.name_0 = enum$name;
  $location_0[stackIndex] = 'Enum.java:' + '77' , this$static.ordinal = enum$ordinal;
  $stackDepth_0 = stackIndex - 1;
  return this$static;
...
function values_24(){
  ...
  $location_0[stackIndex] = 'ModelParts.java:' + '24' , $clinit_928();
  returnTemp = initValues(_3Lorg_jboss_bpm_console_client_common_ModelParts_2_classLit, 714, 108, [CLASS]);
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function $PagingPanel(this$static, callback){
  ...
  $MosaicPanel_0(this$static, ($location_0[stackIndex] = 'PagingPanel.java:' + '55' , $BoxLayout_1(($location_0[stackIndex] = 'PagingPanel.java:' + '55' , new BoxLayout), ($location_0[stackIndex] = 'BoxLayout.java:' + '170' , $clinit_796() , HORIZONTAL))));
  ...
  this$static.revBtn = ($location_0[stackIndex] = 'PagingPanel.java:' + '69' , $Button_2(($location_0[stackIndex] = 'PagingPanel.java:' + '69' , new Button), ($location_0[stackIndex] = 'ButtonHelper.java:' + '39' , createButtonLabel(($location_0[stackIndex] = 'PagingPanel.java:' + '71' , $clinit_648() , ($location_0[stackIndex] = 'CaptionImages_generatedBundle.java:' + '33' , $clinit_650()) , toolCollapseLeft_SINGLETON), '', ($location_0[stackIndex] = 'ButtonHelper.java:' + '34' , $clinit_877() , NO_TEXT))), clickHandler));
  ...
  this$static.ffwBtn = ($location_0[stackIndex] = 'PagingPanel.java:' + '88' , $Button_2(($location_0[stackIndex] = 'PagingPanel.java:' + '88' , new Button), ($location_0[stackIndex] = 'ButtonHelper.java:' + '39' , createButtonLabel(toolCollapseRight_SINGLETON, '', NO_TEXT)), clickHandler2));
...
function parseProcessDefinition(rootModel){
  ...
  $location_0[stackIndex] = 'ProcessDefinitionRef.java:' + '141' , def.suspended = ($location_0[stackIndex] = 'JSOModel.java:' + '112' , $clinit_515() , ($location_0[stackIndex] = 'Boolean.java:' + '35' , $equalsIgnoreCase('true', '' + ($location_0[stackIndex] = 'JSOModel.java:' + '96' , rootModel['suspended']))));
...
function equals_34(o){
  ...
  that = ($location_0[stackIndex] = 'ProcessDefinitionRef.java:' + '149' , dynamicCast(o, 231));
...
function $initOrUpdateState(this$static){
  ...
  this$static.assignee == null || ($location_0[stackIndex] = 'TaskRef.java:' + '170' , $equals_4(this$static.assignee, ''))?($location_0[stackIndex] = 'TaskRef.java:' + '172' , this$static.currentState = ($location_0[stackIndex] = 'TaskRef.java:' + '47' , $clinit_954() , OPEN)):($location_0[stackIndex] = 'TaskRef.java:' + '176' , this$static.currentState = ($location_0[stackIndex] = 'TaskRef.java:' + '47' , $clinit_954() , ASSIGNED));
  $stackDepth_0 = stackIndex - 1;
}
...
function $clinit_954(){
  ...
  $location_0[stackIndex] = 'TaskRef.java:' + '47' , $clinit_954 = nullMethod;
...
function $TaskRef$STATE(this$static, enum$name, enum$ordinal){
  ...
  $location_0[stackIndex] = 'TaskRef.java:' + '47' , $clinit_954();
  $location_0[stackIndex] = 'Enum.java:' + '76' , this$static.name_0 = enum$name;
  $location_0[stackIndex] = 'Enum.java:' + '77' , this$static.ordinal = enum$ordinal;
  $stackDepth_0 = stackIndex - 1;
  return this$static;
...
function values_27(){
  ...
  $location_0[stackIndex] = 'TaskRef.java:' + '47' , $clinit_954();
  returnTemp = initValues(_3Lorg_jboss_bpm_console_client_model_TaskRef$STATE_2_classLit, 717, 111, [OPEN, ASSIGNED, CLOSED]);
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function $getSelection_0(this$static){
  ...
  this$static.isInitialized && ($location_0[stackIndex] = 'AbstractTaskList.java:' + '66' , $getSelectedIndex_0(this$static.listBox)) != -1 && (selection = dynamicCast($getItem_0(this$static.listBox, ($location_0[stackIndex] = 'AbstractTaskList.java:' + '68' , $getSelectedIndex_0(this$static.listBox))), 252));
  $stackDepth_0 = stackIndex - 1;
  return selection;
}
...
_.listBox = null;
_.taskList = null;
function $clinit_1034(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_1034;
  $location_0[stackIndex] = 'AssignTaskAction.java:' + '35' , $clinit_1034 = nullMethod;
...
function $AssignTaskAction(this$static){
  ...
  $location_0[stackIndex] = 'AssignTaskAction.java:' + '35' , $clinit_1034();
...
function getUrl_15(event_0){
  ...
  payload = ($location_0[stackIndex] = 'AssignTaskAction.java:' + '47' , dynamicCast(event_0, 253));
...
function handleSuccessfulResponse_13(controller, event_0, response){
  ...
  $location_0[stackIndex] = 'AssignTaskAction.java:' + '60' , $handleEvent(controller, ($location_0[stackIndex] = 'AssignTaskAction.java:' + '61' , $Event(($location_0[stackIndex] = 'AssignTaskAction.java:' + '61' , new Event_0), ($location_0[stackIndex] = 'ReloadAllTaskListsAction.java:' + '38' , $clinit_1066() , ID_32), null)));
  $stackDepth_0 = stackIndex - 1;
}
...
_.typeId$ = 490;
var ID_25;
function $clinit_1037(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_1037;
  $location_0[stackIndex] = 'AssignedTasksView.java:' + '57' , $clinit_1037 = nullMethod;
...
function $initialize_3(this$static){
  ...
  if (!this$static.isInitialized) {
    ...
    this$static.taskList = $MosaicPanel_0(($location_0[stackIndex] = 'AssignedTasksView.java:' + '105' , new MosaicPanel), ($location_0[stackIndex] = 'AssignedTasksView.java:' + '105' , $BoxLayout_1(new BoxLayout, ($location_0[stackIndex] = 'BoxLayout.java:' + '170' , $clinit_796() , VERTICAL))));
    ...
    $location_0[stackIndex] = 'AssignedTasksView.java:' + '169' , $add_28(toolBar, $Button_2(($location_0[stackIndex] = 'AssignedTasksView.java:' + '170' , new Button), 'Refresh', $AssignedTasksView$3(new AssignedTasksView$3, this$static)));
    viewBtn = $Button_2(($location_0[stackIndex] = 'AssignedTasksView.java:' + '181' , new Button), 'View', $AssignedTasksView$4(new AssignedTasksView$4, this$static));
    $location_0[stackIndex] = 'AssignedTasksView.java:' + '220' , $add_28(toolBar, viewBtn);
    $location_0[stackIndex] = 'AssignedTasksView.java:' + '222' , $add_28(toolBar, $Button_2(($location_0[stackIndex] = 'AssignedTasksView.java:' + '223' , new Button), 'Release', $AssignedTasksView$5(new AssignedTasksView$5, this$static)));
    this$static.skipBtn = $Button_2(($location_0[stackIndex] = 'AssignedTasksView.java:' + '247' , new Button), 'Skip', $AssignedTasksView$6(new AssignedTasksView$6, this$static));
    ...
    $add_26(toolBox, toolBar, ($location_0[stackIndex] = 'AssignedTasksView.java:' + '272' , $BoxLayoutData_4(($location_0[stackIndex] = 'AssignedTasksView.java:' + '272' , new BoxLayoutData), ($location_0[stackIndex] = 'BoxLayoutData.java:' + '30' , $clinit_798() , HORIZONTAL_0))));
    ...
    $location_0[stackIndex] = 'AssignedTasksView.java:' + '306' , $clinit_1091();
...
function $renderUpdate_0(this$static){
  ...
  $location_0[stackIndex] = 'AssignedTasksView.java:' + '353' , $handleEvent(this$static.controller_0, $Event(($location_0[stackIndex] = 'AssignedTasksView.java:' + '354' , new Event_0), ($location_0[stackIndex] = 'UpdateDetailsAction.java:' + '35' , $clinit_1070() , ID_34), $DetailViewEvent(($location_0[stackIndex] = 'AssignedTasksView.java:' + '354' , new DetailViewEvent), 'AssignedDetailView', null)));
  ...
  for (task$iterator = ($location_0[stackIndex] = 'AssignedTasksView.java:' + '383' , trimmed.iterator_0()); $location_0[stackIndex] = 'AssignedTasksView.java:' + '383' , task$iterator.hasNext();) {
    task = dynamicCast(task$iterator.next_0(), 252);
    ($location_0[stackIndex] = 'TaskRef.java:' + '47' , $clinit_954() , ASSIGNED) == task.currentState && ($location_0[stackIndex] = 'DefaultListModel.java:' + '45' , $add_6(model.list, task));
  }
  $stackDepth_0 = stackIndex - 1;
}
...
function $update_8(this$static, data){
  ...
  this$static.cachedTasks = dynamicCast(($location_0[stackIndex] = 'AssignedTasksView.java:' + '361' , data[1]), 171);
...
function renderCell_5(p0, p1, p2, p3){
  ...
  $renderCell_4(this, p0, p1, p2, ($location_0[stackIndex] = 'com.google.gwt.dev.jjs.impl.GenerateJavaAST:' + '0' , dynamicCast(p3, 252)));
  $stackDepth_0 = stackIndex - 1;
}
...
function onRowSelection_1(rowSelectionEvent){
  ...
  if (task) {
    ...
    $location_0[stackIndex] = 'AssignedTasksView.java:' + '153' , $handleEvent(this.this$0.controller_0, $Event(($location_0[stackIndex] = 'AssignedTasksView.java:' + '154' , new Event_0), ($location_0[stackIndex] = 'UpdateDetailsAction.java:' + '35' , $clinit_1070() , ID_34), $DetailViewEvent(($location_0[stackIndex] = 'AssignedTasksView.java:' + '154' , new DetailViewEvent), 'AssignedDetailView', task)));
  }
  $stackDepth_0 = stackIndex - 1;
}
...
function onClick_27(clickEvent){
  ...
  $location_0[stackIndex] = 'AssignedTasksView.java:' + '340' , $handleEvent(this.this$0.controller_0, ($location_0[stackIndex] = 'AssignedTasksView.java:' + '341' , $Event(($location_0[stackIndex] = 'AssignedTasksView.java:' + '341' , new Event_0), ($location_0[stackIndex] = 'LoadTasksAction.java:' + '45' , $clinit_1049() , ID_28), dynamicCast(($location_0[stackIndex] = 'ErraiApplication.java:' + '129' , get_16(Lorg_jboss_bpm_console_client_Authentication_2_classLit)), 230).username)));
  $stackDepth_0 = stackIndex - 1;
}
...
function onClick_28(clickEvent){
  ...
  if (selection) {
    if (selection.url != null && !($location_0[stackIndex] = 'AssignedTasksView.java:' + '190' , $equals_4(selection.url, ''))) {
      ...
      $location_0[stackIndex] = 'AssignedTasksView.java:' + '210' , $clinit_684();
      $location_0[stackIndex] = 'MessageBox.java:' + '111' , alert_2(($location_0[stackIndex] = 'MessageBox.java:' + '60' , $clinit_693() , ALERT), 'Invalid operation', "The task doesn't provide a UI");
    }
  }
   else {
    $location_0[stackIndex] = 'AssignedTasksView.java:' + '215' , $clinit_684();
    $location_0[stackIndex] = 'MessageBox.java:' + '111' , alert_2(($location_0[stackIndex] = 'MessageBox.java:' + '60' , $clinit_693() , ALERT), 'Missing selection', 'Please select a task');
  }
  $stackDepth_0 = stackIndex - 1;
}
...
function onWindowClosed_0(){
  ...
  $location_0[stackIndex] = 'AssignedTasksView.java:' + '340' , $handleEvent(this.this$1.this$0.controller_0, ($location_0[stackIndex] = 'AssignedTasksView.java:' + '341' , $Event(($location_0[stackIndex] = 'AssignedTasksView.java:' + '341' , new Event_0), ($location_0[stackIndex] = 'LoadTasksAction.java:' + '45' , $clinit_1049() , ID_28), dynamicCast(($location_0[stackIndex] = 'ErraiApplication.java:' + '129' , get_16(Lorg_jboss_bpm_console_client_Authentication_2_classLit)), 230).username)));
  $stackDepth_0 = stackIndex - 1;
}
...
function onClick_29(clickEvent){
  ...
  if (selection) {
    ...
    $location_0[stackIndex] = 'AssignedTasksView.java:' + '234' , $handleEvent(this.this$0.controller_0, ($location_0[stackIndex] = 'AssignedTasksView.java:' + '235' , $Event(($location_0[stackIndex] = 'AssignedTasksView.java:' + '235' , new Event_0), ($location_0[stackIndex] = 'ReleaseTaskAction.java:' + '37' , $clinit_1065() , ID_31), payload)));
  }
   else {
    $location_0[stackIndex] = 'AssignedTasksView.java:' + '240' , $clinit_684();
    $location_0[stackIndex] = 'MessageBox.java:' + '111' , alert_2(($location_0[stackIndex] = 'MessageBox.java:' + '60' , $clinit_693() , ALERT), 'Missing selection', 'Please select a task');
  }
  $stackDepth_0 = stackIndex - 1;
}
...
function onClick_30(clickEvent){
  ...
  if (!!selection && !selection.isBlocking) {
    $location_0[stackIndex] = 'AssignedTasksView.java:' + '254' , $handleEvent(this.this$0.controller_0, ($location_0[stackIndex] = 'AssignedTasksView.java:' + '255' , $Event(($location_0[stackIndex] = 'AssignedTasksView.java:' + '255' , new Event_0), ($location_0[stackIndex] = 'SkipTaskAction.java:' + '14' , $clinit_1067() , ID_33), ($location_0[stackIndex] = 'AssignedTasksView.java:' + '257' , $TaskIdentityEvent(($location_0[stackIndex] = 'AssignedTasksView.java:' + '257' , new TaskIdentityEvent), dynamicCast(($location_0[stackIndex] = 'ErraiApplication.java:' + '129' , get_16(Lorg_jboss_bpm_console_client_Authentication_2_classLit)), 230).username, selection)))));
  }
   else {
    $location_0[stackIndex] = 'AssignedTasksView.java:' + '263' , $clinit_684();
    $location_0[stackIndex] = 'MessageBox.java:' + '111' , alert_2(($location_0[stackIndex] = 'MessageBox.java:' + '60' , $clinit_693() , ALERT), 'Missing selection', 'Please select a task');
  }
  $stackDepth_0 = stackIndex - 1;
}
...
function callback_2(message){
  ...
  ($location_0[stackIndex] = 'ModelCommands.java:' + '24' , $clinit_927() , ($location_0[stackIndex] = 'ModelCommands.java:' + '24' , valueOf_0(enum$map, ($location_0[stackIndex] = 'AssignedTasksView.java:' + '311' , message.getCommandType())))).ordinal == 1 && $equals_4(dynamicCast(($location_0[stackIndex] = 'AssignedTasksView.java:' + '314' , message.get_2(Ljava_lang_String_2_classLit, ($location_0[stackIndex] = 'ModelParts.java:' + '27' , $clinit_928() , CLASS))), 1), 'processModel') && ($location_0[stackIndex] = 'AssignedTasksView.java:' + '340' , $handleEvent(this.this$0.controller_0, ($location_0[stackIndex] = 'AssignedTasksView.java:' + '341' , $Event(($location_0[stackIndex] = 'AssignedTasksView.java:' + '341' , new Event_0), ($location_0[stackIndex] = 'LoadTasksAction.java:' + '45' , $clinit_1049() , ID_28), dynamicCast(($location_0[stackIndex] = 'ErraiApplication.java:' + '129' , get_16(Lorg_jboss_bpm_console_client_Authentication_2_classLit)), 230).username))));
  $stackDepth_0 = stackIndex - 1;
}
...
function $clinit_1047(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_1047;
  $location_0[stackIndex] = 'AssignedTasksView.java:' + '321' , $clinit_1047 = nullMethod;
  $clinit_43();
  $stackDepth_0 = stackIndex - 1;
}
...
function $AssignedTasksView$9(this$static, this$0){
  ...
  $location_0[stackIndex] = 'AssignedTasksView.java:' + '321' , $clinit_1047();
  this$static.this$0 = this$0;
  $stackDepth_0 = stackIndex - 1;
  return this$static;
}
...
_.typeId$ = 499;
_.this$0 = null;
function $clinit_1048(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_1048;
  $location_0[stackIndex] = 'ClaimTaskAction.java:' + '35' , $clinit_1048 = nullMethod;
...
function $ClaimTaskAction(this$static){
  ...
  $location_0[stackIndex] = 'ClaimTaskAction.java:' + '35' , $clinit_1048();
  dynamicCast(($location_0[stackIndex] = 'AbstractRESTAction.java:' + '44' , get_16(Lorg_jboss_bpm_console_client_ApplicationContext_2_classLit)), 225);
  $stackDepth_0 = stackIndex - 1;
  return this$static;
}
...
function getUrl_16(event_0){
  ...
  claimEvent = ($location_0[stackIndex] = 'ClaimTaskAction.java:' + '46' , dynamicCast(event_0, 254));
...
function handleSuccessfulResponse_14(controller, event_0, response){
  ...
  $location_0[stackIndex] = 'ClaimTaskAction.java:' + '60' , $handleEvent(controller, ($location_0[stackIndex] = 'ClaimTaskAction.java:' + '61' , $Event(($location_0[stackIndex] = 'ClaimTaskAction.java:' + '61' , new Event_0), ($location_0[stackIndex] = 'ReloadAllTaskListsAction.java:' + '38' , $clinit_1066() , ID_32), null)));
  $stackDepth_0 = stackIndex - 1;
}
...
function $clinit_1049(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_1049;
  $location_0[stackIndex] = 'LoadTasksAction.java:' + '43' , $clinit_1049 = nullMethod;
...
function $LoadTasksAction(this$static){
  ...
  $location_0[stackIndex] = 'LoadTasksAction.java:' + '43' , $clinit_1049();
  dynamicCast(($location_0[stackIndex] = 'AbstractRESTAction.java:' + '44' , get_16(Lorg_jboss_bpm_console_client_ApplicationContext_2_classLit)), 225);
  $stackDepth_0 = stackIndex - 1;
  return this$static;
}
...
function getDataDriven_2(controller){
  ...
  returnTemp = ($location_0[stackIndex] = 'LoadTasksAction.java:' + '66' , dynamicCast(dynamicCast(($location_0[stackIndex] = 'Controller.java:' + '67' , $get_7(controller.views, ($location_0[stackIndex] = 'AssignedTasksView.java:' + '60' , $clinit_1037() , ID_26))), 168), 255));
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function handleSuccessfulResponse_15(controller, event_0, response){
  ...
  view = ($location_0[stackIndex] = 'LoadTasksAction.java:' + '75' , dynamicCast(dynamicCast(($location_0[stackIndex] = 'Controller.java:' + '67' , $get_7(controller.views, ($location_0[stackIndex] = 'AssignedTasksView.java:' + '60' , $clinit_1037() , ID_26))), 168), 255));
  $update_8(view, ($location_0[stackIndex] = 'LoadTasksAction.java:' + '77' , initValues(_3Ljava_lang_Object_2_classLit, 689, 0, [identity, tasks])));
...
function $clinit_1050(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_1050;
  $location_0[stackIndex] = 'LoadTasksParticipationAction.java:' + '43' , $clinit_1050 = nullMethod;
...
function $LoadTasksParticipationAction(this$static){
  ...
  $location_0[stackIndex] = 'LoadTasksParticipationAction.java:' + '43' , $clinit_1050();
  dynamicCast(($location_0[stackIndex] = 'AbstractRESTAction.java:' + '44' , get_16(Lorg_jboss_bpm_console_client_ApplicationContext_2_classLit)), 225);
  $stackDepth_0 = stackIndex - 1;
  return this$static;
}
...
function getDataDriven_3(controller){
  ...
  returnTemp = ($location_0[stackIndex] = 'LoadTasksParticipationAction.java:' + '66' , dynamicCast(dynamicCast(($location_0[stackIndex] = 'Controller.java:' + '67' , $get_7(controller.views, ($location_0[stackIndex] = 'OpenTasksView.java:' + '59' , $clinit_1053() , ID_30))), 168), 256));
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function handleSuccessfulResponse_16(controller, event_0, response){
  ...
  view = ($location_0[stackIndex] = 'LoadTasksParticipationAction.java:' + '75' , dynamicCast(dynamicCast(($location_0[stackIndex] = 'Controller.java:' + '67' , $get_7(controller.views, ($location_0[stackIndex] = 'OpenTasksView.java:' + '59' , $clinit_1053() , ID_30))), 168), 256));
  $location_0[stackIndex] = 'Log.java:' + '354' , $clinit_24();
  $location_0[stackIndex] = 'Log.java:' + '403' , $info(impl, 'Loaded ' + tasks.size_0 + ' tasks', null);
  $update_9(view, ($location_0[stackIndex] = 'LoadTasksParticipationAction.java:' + '78' , initValues(_3Ljava_lang_Object_2_classLit, 689, 0, [identity, tasks])));
  $stackDepth_0 = stackIndex - 1;
}
...
function $clinit_1053(){
  ...
  $location_0[stackIndex] = 'OpenTasksView.java:' + '56' , $clinit_1053 = nullMethod;
...
function $initialize_4(this$static){
  ...
  if (!this$static.isInitialized) {
    this$static.taskList = $MosaicPanel_0(($location_0[stackIndex] = 'OpenTasksView.java:' + '127' , new MosaicPanel), ($location_0[stackIndex] = 'OpenTasksView.java:' + '127' , $BoxLayout_1(new BoxLayout, ($location_0[stackIndex] = 'BoxLayout.java:' + '170' , $clinit_796() , VERTICAL))));
    $location_0[stackIndex] = 'LayoutPanel.java:' + '289' , setStyleAttribute_0(this$static.taskList.element, 'padding', '0px');
    $location_0[stackIndex] = 'LayoutPanel.java:' + '297' , this$static.taskList.widgetSpacing = 0;
    $location_0[stackIndex] = 'OpenTasksView.java:' + '131' , this$static.listBox = ($location_0[stackIndex] = 'OpenTasksView.java:' + '132' , $ListBox_1(($location_0[stackIndex] = 'OpenTasksView.java:' + '132' , new ListBox_0), ($location_0[stackIndex] = 'OpenTasksView.java:' + '133' , initValues(_3Ljava_lang_String_2_classLit, 692, 1, ['Priority', 'Process', 'Task Name', 'Status', 'Due Date']))));
    ...
    $location_0[stackIndex] = 'OpenTasksView.java:' + '192' , $add_28(toolBar, $Button_2(($location_0[stackIndex] = 'OpenTasksView.java:' + '193' , new Button), 'Refresh', $OpenTasksView$3(new OpenTasksView$3, this$static)));
    $location_0[stackIndex] = 'OpenTasksView.java:' + '204' , $add_28(toolBar, $Button_2(($location_0[stackIndex] = 'OpenTasksView.java:' + '205' , new Button), 'Claim', $OpenTasksView$4(new OpenTasksView$4, this$static)));
    this$static.skipBtn = $Button_2(($location_0[stackIndex] = 'OpenTasksView.java:' + '228' , new Button), 'Skip', $OpenTasksView$5(new OpenTasksView$5, this$static));
    $location_0[stackIndex] = 'Element.java:' + '638' , this$static.skipBtn.element['disabled'] = !false;
    $location_0[stackIndex] = 'OpenTasksView.java:' + '249' , $add_28(toolBar, this$static.skipBtn);
    $add_26(toolBox, toolBar, ($location_0[stackIndex] = 'OpenTasksView.java:' + '251' , $BoxLayoutData_4(($location_0[stackIndex] = 'OpenTasksView.java:' + '251' , new BoxLayoutData), ($location_0[stackIndex] = 'BoxLayoutData.java:' + '30' , $clinit_798() , HORIZONTAL_0))));
    ...
    $location_0[stackIndex] = 'OpenTasksView.java:' + '284' , $clinit_1091();
...
function $renderUpdate_1(this$static){
  ...
  $location_0[stackIndex] = 'DefaultListModel.java:' + '61' , $clear_5(model_0.list);
  $location_0[stackIndex] = 'OpenTasksView.java:' + '332' , $handleEvent(this$static.controller, $Event(($location_0[stackIndex] = 'OpenTasksView.java:' + '333' , new Event_0), ($location_0[stackIndex] = 'UpdateDetailsAction.java:' + '35' , $clinit_1070() , ID_34), $DetailViewEvent(($location_0[stackIndex] = 'OpenTasksView.java:' + '333' , new DetailViewEvent), 'OpenDetailView', null)));
  ...
  for (task$iterator = ($location_0[stackIndex] = 'OpenTasksView.java:' + '362' , trimmed.iterator_0()); $location_0[stackIndex] = 'OpenTasksView.java:' + '362' , task$iterator.hasNext();) {
    task = dynamicCast(task$iterator.next_0(), 252);
    ($location_0[stackIndex] = 'TaskRef.java:' + '47' , $clinit_954() , OPEN) == task.currentState && ($location_0[stackIndex] = 'DefaultListModel.java:' + '45' , $add_6(model.list, task));
  }
  $stackDepth_0 = stackIndex - 1;
}
...
function $update_9(this$static, data){
  ...
  this$static.cachedTasks = dynamicCast(($location_0[stackIndex] = 'OpenTasksView.java:' + '340' , data[1]), 171);
...
function registerCommonActions(controller){
  ...
  $location_0[stackIndex] = 'OpenTasksView.java:' + '77' , $clinit_1053();
  if (!actionSetup) {
    $location_0[stackIndex] = 'Controller.java:' + '106' , $put_0(controller.actions, ($location_0[stackIndex] = 'LoadTasksAction.java:' + '45' , $clinit_1049() , ID_28), $LoadTasksAction(($location_0[stackIndex] = 'OpenTasksView.java:' + '82' , new LoadTasksAction)));
    $location_0[stackIndex] = 'Controller.java:' + '106' , $put_0(controller.actions, ($location_0[stackIndex] = 'LoadTasksParticipationAction.java:' + '45' , $clinit_1050() , ID_29), $LoadTasksParticipationAction(($location_0[stackIndex] = 'OpenTasksView.java:' + '83' , new LoadTasksParticipationAction)));
    $location_0[stackIndex] = 'Controller.java:' + '106' , $put_0(controller.actions, ($location_0[stackIndex] = 'ClaimTaskAction.java:' + '37' , $clinit_1048() , ID_27), $ClaimTaskAction(($location_0[stackIndex] = 'OpenTasksView.java:' + '84' , new ClaimTaskAction)));
    $location_0[stackIndex] = 'Controller.java:' + '106' , $put_0(controller.actions, ($location_0[stackIndex] = 'ReleaseTaskAction.java:' + '37' , $clinit_1065() , ID_31), $ReleaseTaskAction(($location_0[stackIndex] = 'OpenTasksView.java:' + '85' , new ReleaseTaskAction)));
    $location_0[stackIndex] = 'Controller.java:' + '106' , $put_0(controller.actions, ($location_0[stackIndex] = 'UpdateDetailsAction.java:' + '35' , $clinit_1070() , ID_34), ($location_0[stackIndex] = 'OpenTasksView.java:' + '86' , new UpdateDetailsAction));
    $location_0[stackIndex] = 'Controller.java:' + '106' , $put_0(controller.actions, ($location_0[stackIndex] = 'AssignTaskAction.java:' + '38' , $clinit_1034() , ID_25), $AssignTaskAction(($location_0[stackIndex] = 'OpenTasksView.java:' + '87' , new AssignTaskAction)));
    $location_0[stackIndex] = 'Controller.java:' + '106' , $put_0(controller.actions, ($location_0[stackIndex] = 'ReloadAllTaskListsAction.java:' + '38' , $clinit_1066() , ID_32), $ReloadAllTaskListsAction(($location_0[stackIndex] = 'OpenTasksView.java:' + '88' , new ReloadAllTaskListsAction)));
    $location_0[stackIndex] = 'Controller.java:' + '106' , $put_0(controller.actions, ($location_0[stackIndex] = 'SkipTaskAction.java:' + '14' , $clinit_1067() , ID_33), $SkipTaskAction(($location_0[stackIndex] = 'OpenTasksView.java:' + '89' , new SkipTaskAction)));
...
function renderCell_6(p0, p1, p2, p3){
  ...
  $renderCell_5(this, p0, p1, p2, ($location_0[stackIndex] = 'com.google.gwt.dev.jjs.impl.GenerateJavaAST:' + '0' , dynamicCast(p3, 252)));
  $stackDepth_0 = stackIndex - 1;
}
...
function onRowSelection_2(rowSelectionEvent){
  ...
  if (task) {
    task.isBlocking?($location_0[stackIndex] = 'Element.java:' + '638' , this.this$0.skipBtn.element['disabled'] = !false , undefined):(this.this$0.skipBtn.element['disabled'] = !true , undefined);
    $location_0[stackIndex] = 'OpenTasksView.java:' + '178' , $handleEvent(this.this$0.controller, $Event(($location_0[stackIndex] = 'OpenTasksView.java:' + '179' , new Event_0), ($location_0[stackIndex] = 'UpdateDetailsAction.java:' + '35' , $clinit_1070() , ID_34), $DetailViewEvent(($location_0[stackIndex] = 'OpenTasksView.java:' + '179' , new DetailViewEvent), 'OpenDetailView', task)));
  }
  $stackDepth_0 = stackIndex - 1;
}
...
function onClick_32(clickEvent){
  ...
  if (selection) {
    $location_0[stackIndex] = 'OpenTasksView.java:' + '212' , $handleEvent(this.this$0.controller, ($location_0[stackIndex] = 'OpenTasksView.java:' + '213' , $Event(($location_0[stackIndex] = 'OpenTasksView.java:' + '213' , new Event_0), ($location_0[stackIndex] = 'ClaimTaskAction.java:' + '37' , $clinit_1048() , ID_27), ($location_0[stackIndex] = 'OpenTasksView.java:' + '215' , $TaskIdentityEvent(($location_0[stackIndex] = 'OpenTasksView.java:' + '215' , new TaskIdentityEvent), dynamicCast(($location_0[stackIndex] = 'ErraiApplication.java:' + '129' , get_16(Lorg_jboss_bpm_console_client_Authentication_2_classLit)), 230).username, selection)))));
  }
   else {
    $location_0[stackIndex] = 'OpenTasksView.java:' + '221' , $clinit_684();
    $location_0[stackIndex] = 'MessageBox.java:' + '111' , alert_2(($location_0[stackIndex] = 'MessageBox.java:' + '60' , $clinit_693() , ALERT), 'Missing selection', 'Please select a task');
  }
  $stackDepth_0 = stackIndex - 1;
}
...
function onClick_33(clickEvent){
  ...
  if (!!selection && !selection.isBlocking) {
    $location_0[stackIndex] = 'OpenTasksView.java:' + '235' , $handleEvent(this.this$0.controller, ($location_0[stackIndex] = 'OpenTasksView.java:' + '236' , $Event(($location_0[stackIndex] = 'OpenTasksView.java:' + '236' , new Event_0), ($location_0[stackIndex] = 'SkipTaskAction.java:' + '14' , $clinit_1067() , ID_33), ($location_0[stackIndex] = 'OpenTasksView.java:' + '238' , $TaskIdentityEvent(($location_0[stackIndex] = 'OpenTasksView.java:' + '238' , new TaskIdentityEvent), dynamicCast(($location_0[stackIndex] = 'ErraiApplication.java:' + '129' , get_16(Lorg_jboss_bpm_console_client_Authentication_2_classLit)), 230).username, selection)))));
  }
   else {
    $location_0[stackIndex] = 'OpenTasksView.java:' + '243' , $clinit_684();
    $location_0[stackIndex] = 'MessageBox.java:' + '111' , alert_2(($location_0[stackIndex] = 'MessageBox.java:' + '60' , $clinit_693() , ALERT), 'Missing selection', 'Please select a task');
  }
  $stackDepth_0 = stackIndex - 1;
}
...
function callback_3(message){
  ...
  ($location_0[stackIndex] = 'ModelCommands.java:' + '24' , $clinit_927() , ($location_0[stackIndex] = 'ModelCommands.java:' + '24' , valueOf_0(enum$map, ($location_0[stackIndex] = 'OpenTasksView.java:' + '289' , message.getCommandType())))).ordinal == 1 && $equals_4(dynamicCast(($location_0[stackIndex] = 'OpenTasksView.java:' + '292' , message.get_2(Ljava_lang_String_2_classLit, ($location_0[stackIndex] = 'ModelParts.java:' + '27' , $clinit_928() , CLASS))), 1), 'processModel') && ($location_0[stackIndex] = 'OpenTasksView.java:' + '318' , $handleEvent(this.this$0.controller, ($location_0[stackIndex] = 'OpenTasksView.java:' + '319' , $Event(($location_0[stackIndex] = 'OpenTasksView.java:' + '319' , new Event_0), ($location_0[stackIndex] = 'LoadTasksParticipationAction.java:' + '45' , $clinit_1050() , ID_29), dynamicCast(($location_0[stackIndex] = 'AbstractTaskList.java:' + '75' , get_16(Lorg_jboss_bpm_console_client_Authentication_2_classLit)), 230).username))));
  $stackDepth_0 = stackIndex - 1;
}
...
function $clinit_1061(){
  ...
  $location_0[stackIndex] = 'OpenTasksView.java:' + '299' , $clinit_1061 = nullMethod;
  $clinit_43();
  $stackDepth_0 = stackIndex - 1;
}
...
function $OpenTasksView$8(this$static, this$0){
  ...
  $location_0[stackIndex] = 'OpenTasksView.java:' + '299' , $clinit_1061();
  this$static.this$0 = this$0;
  $stackDepth_0 = stackIndex - 1;
  return this$static;
}
...
function $ParticipantPanel(this$static){
  ...
  $MosaicPanel_0(this$static, ($location_0[stackIndex] = 'ParticipantPanel.java:' + '58' , $BoxLayout_1(($location_0[stackIndex] = 'ParticipantPanel.java:' + '58' , new BoxLayout), ($location_0[stackIndex] = 'BoxLayout.java:' + '170' , $clinit_796() , HORIZONTAL))));
  ...
  $add_26(this$static, treePanel, ($location_0[stackIndex] = 'ParticipantPanel.java:' + '68' , $BoxLayoutData_4(($location_0[stackIndex] = 'ParticipantPanel.java:' + '68' , new BoxLayoutData), ($location_0[stackIndex] = 'BoxLayoutData.java:' + '30' , $clinit_798() , BOTH))));
  ...
  this$static.assignmentBtn = ($location_0[stackIndex] = 'ParticipantPanel.java:' + '100' , $Button_1(($location_0[stackIndex] = 'ParticipantPanel.java:' + '100' , new Button), 'Assign', $ParticipantPanel$2(($location_0[stackIndex] = 'ParticipantPanel.java:' + '102' , new ParticipantPanel$2), this$static)));
...
function $update_10(this$static, task){
  ...
  for ($location_0[stackIndex] = 'ParticipantPanel.java:' + '137' , gref$iterator = $AbstractList$IteratorImpl(($location_0[stackIndex] = 'AbstractList.java:' + '278' , new AbstractList$IteratorImpl), task.participantGroups); gref$iterator.i < ($location_0[stackIndex] = 'AbstractList.java:' + '38' , gref$iterator.this$0.size_1());) {
    gref = dynamicCast(($location_0[stackIndex] = 'ParticipantPanel.java:' + '137' , $next_6(gref$iterator)), 257);
  ...
  for ($location_0[stackIndex] = 'ParticipantPanel.java:' + '144' , uref$iterator = $AbstractList$IteratorImpl(($location_0[stackIndex] = 'AbstractList.java:' + '278' , new AbstractList$IteratorImpl), task.participantUsers); uref$iterator.i < ($location_0[stackIndex] = 'AbstractList.java:' + '38' , uref$iterator.this$0.size_1());) {
    uref = dynamicCast(($location_0[stackIndex] = 'ParticipantPanel.java:' + '144' , $next_6(uref$iterator)), 257);
...
function $onTreeItemSelected(this$static, treeItem){
  ...
  $location_0[stackIndex] = 'ParticipantPanel.java:' + '75' , name_0 = ($location_0[stackIndex] = 'Element.java:' + '266' , $clinit_81() , treeItem.contentElem).textContent;
...
function onClick_34(widget){
  ...
  this.this$0.selection != null && ($location_0[stackIndex] = 'ParticipantPanel.java:' + '108' , $handleEvent(this.this$0.controller, $Event(($location_0[stackIndex] = 'ParticipantPanel.java:' + '109' , new Event_0), ($location_0[stackIndex] = 'AssignTaskAction.java:' + '38' , $clinit_1034() , ID_25), $AssignEvent(($location_0[stackIndex] = 'ParticipantPanel.java:' + '109' , new AssignEvent), this.this$0.selection, this.this$0.currentTask))));
  $stackDepth_0 = stackIndex - 1;
}
...
_.typeId$ = 513;
_.this$0 = null;
function $clinit_1065(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_1065;
  $location_0[stackIndex] = 'ReleaseTaskAction.java:' + '35' , $clinit_1065 = nullMethod;
...
function $ReleaseTaskAction(this$static){
  ...
  $location_0[stackIndex] = 'ReleaseTaskAction.java:' + '35' , $clinit_1065();
  dynamicCast(($location_0[stackIndex] = 'AbstractRESTAction.java:' + '44' , get_16(Lorg_jboss_bpm_console_client_ApplicationContext_2_classLit)), 225);
  $stackDepth_0 = stackIndex - 1;
  return this$static;
}
...
function getUrl_19(event_0){
  ...
  tie = ($location_0[stackIndex] = 'ReleaseTaskAction.java:' + '46' , dynamicCast(event_0, 254));
...
function handleSuccessfulResponse_17(controller, event_0, response){
  ...
  $location_0[stackIndex] = 'ReleaseTaskAction.java:' + '58' , currentUser = dynamicCast(($location_0[stackIndex] = 'ErraiApplication.java:' + '129' , get_16(Lorg_jboss_bpm_console_client_Authentication_2_classLit)), 230).username;
  $location_0[stackIndex] = 'ReleaseTaskAction.java:' + '59' , $handleEvent(controller, ($location_0[stackIndex] = 'ReleaseTaskAction.java:' + '60' , $Event(($location_0[stackIndex] = 'ReleaseTaskAction.java:' + '60' , new Event_0), ($location_0[stackIndex] = 'LoadTasksAction.java:' + '45' , $clinit_1049() , ID_28), currentUser)));
  $stackDepth_0 = stackIndex - 1;
}
...
function $clinit_1066(){
  ...
  $location_0[stackIndex] = 'ReloadAllTaskListsAction.java:' + '35' , $clinit_1066 = nullMethod;
...
function $ReloadAllTaskListsAction(this$static){
  ...
  $location_0[stackIndex] = 'ReloadAllTaskListsAction.java:' + '42' , $clinit_1066();
  dynamicCast(($location_0[stackIndex] = 'ReloadAllTaskListsAction.java:' + '44' , get_16(Lorg_jboss_bpm_console_client_ApplicationContext_2_classLit)), 225);
  $stackDepth_0 = stackIndex - 1;
  return this$static;
}
...
function execute_38(controller, object){
  ...
  $location_0[stackIndex] = 'ReloadAllTaskListsAction.java:' + '50' , currentUser = dynamicCast(($location_0[stackIndex] = 'ErraiApplication.java:' + '129' , get_16(Lorg_jboss_bpm_console_client_Authentication_2_classLit)), 230).username;
  $location_0[stackIndex] = 'ReloadAllTaskListsAction.java:' + '51' , $handleEvent(controller, ($location_0[stackIndex] = 'ReloadAllTaskListsAction.java:' + '52' , $Event(($location_0[stackIndex] = 'ReloadAllTaskListsAction.java:' + '52' , new Event_0), ($location_0[stackIndex] = 'LoadTasksAction.java:' + '45' , $clinit_1049() , ID_28), currentUser)));
  $location_0[stackIndex] = 'ReloadAllTaskListsAction.java:' + '56' , $handleEvent(controller, ($location_0[stackIndex] = 'ReloadAllTaskListsAction.java:' + '57' , $Event(($location_0[stackIndex] = 'ReloadAllTaskListsAction.java:' + '57' , new Event_0), ($location_0[stackIndex] = 'LoadTasksParticipationAction.java:' + '45' , $clinit_1050() , ID_29), currentUser)));
  $stackDepth_0 = stackIndex - 1;
}
...
function $clinit_1067(){
  ...
  $location_0[stackIndex] = 'SkipTaskAction.java:' + '12' , $clinit_1067 = nullMethod;
...
function $SkipTaskAction(this$static){
  ...
  $location_0[stackIndex] = 'SkipTaskAction.java:' + '12' , $clinit_1067();
  dynamicCast(($location_0[stackIndex] = 'AbstractRESTAction.java:' + '44' , get_16(Lorg_jboss_bpm_console_client_ApplicationContext_2_classLit)), 225);
  $stackDepth_0 = stackIndex - 1;
  return this$static;
}
...
function getUrl_20(event_0){
  ...
  skipEvent = ($location_0[stackIndex] = 'SkipTaskAction.java:' + '23' , dynamicCast(event_0, 254));
...
function handleSuccessfulResponse_18(controller, event_0, response){
  ...
  $location_0[stackIndex] = 'SkipTaskAction.java:' + '37' , $handleEvent(controller, ($location_0[stackIndex] = 'SkipTaskAction.java:' + '38' , $Event(($location_0[stackIndex] = 'SkipTaskAction.java:' + '38' , new Event_0), ($location_0[stackIndex] = 'ReloadAllTaskListsAction.java:' + '38' , $clinit_1066() , ID_32), null)));
  $stackDepth_0 = stackIndex - 1;
}
...
function $initialize_5(this$static){
  ...
  if (!this$static.initialzed) {
    this$static.grid = ($location_0[stackIndex] = 'TaskDetailView.java:' + '78' , $PropertyGrid(($location_0[stackIndex] = 'TaskDetailView.java:' + '78' , new PropertyGrid), ($location_0[stackIndex] = 'TaskDetailView.java:' + '79' , initValues(_3Ljava_lang_String_2_classLit, 692, 1, ['ID:', 'Process:', 'Name:', 'Assignee:', 'Description:']))));
    if (this$static.openView) {
      ...
      $location_0[stackIndex] = 'TaskDetailView.java:' + '106' , $add_17(this$static.caption, dropBox, ($location_0[stackIndex] = 'Caption.java:' + '61' , $clinit_649() , RIGHT));
      $location_0[stackIndex] = 'CaptionLayoutPanel.java:' + '91' , $add_26(this$static.body_0, deck, ($location_0[stackIndex] = 'TaskDetailView.java:' + '107' , $BoxLayoutData_4(($location_0[stackIndex] = 'TaskDetailView.java:' + '107' , new BoxLayoutData), ($location_0[stackIndex] = 'BoxLayoutData.java:' + '30' , $clinit_798() , BOTH))));
...
function $onChange(this$static){
  ...
  $location_0[stackIndex] = 'LayoutComposite.java:' + '125' , ($location_0[stackIndex] = 'LayoutComposite.java:' + '89' , dynamicCast(this$static.val$deck.widget, 183)).layout_0();
  $stackDepth_0 = stackIndex - 1;
}
...
function $clinit_1070(){
  ...
  $location_0[stackIndex] = 'UpdateDetailsAction.java:' + '32' , $clinit_1070 = nullMethod;
...
function $clinit_1075(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_1075;
  $location_0[stackIndex] = 'DateLocale.java:' + '27' , $clinit_1075 = nullMethod;
  $location_0[stackIndex] = 'DateLocale.java:' + '52' , SUPPORTED_DF_TOKENS = ($location_0[stackIndex] = 'Arrays.java:' + '99' , $Arrays$ArrayList(($location_0[stackIndex] = 'Arrays.java:' + '99' , new Arrays$ArrayList), ($location_0[stackIndex] = 'DateLocale.java:' + '52' , initValues(_3Ljava_lang_String_2_classLit, 692, 1, ['E', 'd', 'M', 'y', 'h', 'H', 'm', 's', 'a']))));
  $stackDepth_0 = stackIndex - 1;
}
...
function $DateLocale(this$static){
  ...
  $location_0[stackIndex] = 'DateLocale.java:' + '27' , $clinit_1075();
  this$static.MONTH_LONG = ($location_0[stackIndex] = 'DateLocale.java:' + '57' , initValues(_3Ljava_lang_String_2_classLit, 692, 1, ['January', 'February', 'March', 'April', 'May', 'June', 'July', 'August', 'September', 'October', 'November', 'December']));
  this$static.MONTH_SHORT = ($location_0[stackIndex] = 'DateLocale.java:' + '61' , initValues(_3Ljava_lang_String_2_classLit, 692, 1, ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sept', 'Oct', 'Nov', 'Dec']));
  this$static.WEEKDAY_LONG = ($location_0[stackIndex] = 'DateLocale.java:' + '64' , initValues(_3Ljava_lang_String_2_classLit, 692, 1, ['Sunday', 'Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday']));
  this$static.WEEKDAY_SHORT = ($location_0[stackIndex] = 'DateLocale.java:' + '67' , initValues(_3Ljava_lang_String_2_classLit, 692, 1, ['Sun', 'Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat']));
  $stackDepth_0 = stackIndex - 1;
  return this$static;
}
...
function $format_2(this$static, date){
  ...
  if (this$static.format != null && this$static.format.length > 0) {
    ...
    for ($location_0[stackIndex] = 'SimpleDateFormat.java:' + '59' , i = 0; i < this$static.format.length; $location_0[stackIndex] = 'SimpleDateFormat.java:' + '59' , ++i) {
      ...
      $location_0[stackIndex] = 'SimpleDateFormat.java:' + '61' , currentTokenType = ($location_0[stackIndex] = 'Arrays.java:' + '48' , $indexOf(($location_0[stackIndex] = 'DateLocale.java:' + '52' , $clinit_1075() , SUPPORTED_DF_TOKENS), thisChar)) != -1?thisChar:'';
...
function $handleToken(this$static, token, date){
  ...
  if ($location_0[stackIndex] = 'SimpleDateFormat.java:' + '96' , $equals_4('E', tc)) {
    ...
    hour > 11?(response = ($location_0[stackIndex] = 'SimpleDateFormat.java:' + '154' , $clinit_1075() , 'PM')):(response = ($location_0[stackIndex] = 'SimpleDateFormat.java:' + '156' , $clinit_1075() , 'AM'));
  }
  $stackDepth_0 = stackIndex - 1;
  return response;
}
...
_.typeId$ = 0;
_.format = null;
function $clinit_1079(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_1079;
  $location_0[stackIndex] = 'SimpleDateParser.java:' + '34' , $clinit_1079 = nullMethod;
  TOKENS = ($location_0[stackIndex] = 'SimpleDateParser.java:' + '55' , initValues(_3_3Ljava_lang_String_2_classLit, 740, 134, [($location_0[stackIndex] = 'SimpleDateParser.java:' + '56' , initValues(_3Ljava_lang_String_2_classLit, 692, 1, ['SSSS', '(\\d\\d\\d\\d)', 'S'])), ($location_0[stackIndex] = 'SimpleDateParser.java:' + '57' , initValues(_3Ljava_lang_String_2_classLit, 692, 1, ['SSS', '(\\d\\d\\d)', 'S'])), ($location_0[stackIndex] = 'SimpleDateParser.java:' + '58' , initValues(_3Ljava_lang_String_2_classLit, 692, 1, ['SS', '(\\d\\d)', 'S'])), ($location_0[stackIndex] = 'SimpleDateParser.java:' + '59' , initValues(_3Ljava_lang_String_2_classLit, 692, 1, ['S', '(\\d)', 'S'])), ($location_0[stackIndex] = 'SimpleDateParser.java:' + '60' , initValues(_3Ljava_lang_String_2_classLit, 692, 1, ['ss', '(\\d\\d)', 's'])), ($location_0[stackIndex] = 'SimpleDateParser.java:' + '61' , initValues(_3Ljava_lang_String_2_classLit, 692, 1, ['s', '(\\d)', 's'])), ($location_0[stackIndex] = 'SimpleDateParser.java:' + '62' , initValues(_3Ljava_lang_String_2_classLit, 692, 1, ['mm', '(\\d\\d)', 'm'])), ($location_0[stackIndex] = 'SimpleDateParser.java:' + '63' , initValues(_3Ljava_lang_String_2_classLit, 692, 1, ['m', '(\\d)', 'm'])), ($location_0[stackIndex] = 'SimpleDateParser.java:' + '64' , initValues(_3Ljava_lang_String_2_classLit, 692, 1, ['HH', '(\\d\\d)', 'H'])), ($location_0[stackIndex] = 'SimpleDateParser.java:' + '65' , initValues(_3Ljava_lang_String_2_classLit, 692, 1, ['H', '(\\d)', 'H'])), ($location_0[stackIndex] = 'SimpleDateParser.java:' + '66' , initValues(_3Ljava_lang_String_2_classLit, 692, 1, ['dd', '(\\d\\d)', 'd'])), ($location_0[stackIndex] = 'SimpleDateParser.java:' + '67' , initValues(_3Ljava_lang_String_2_classLit, 692, 1, ['d', '(\\d)', 'd'])), ($location_0[stackIndex] = 'SimpleDateParser.java:' + '68' , initValues(_3Ljava_lang_String_2_classLit, 692, 1, ['MM', '(\\d\\d)', 'M'])), ($location_0[stackIndex] = 'SimpleDateParser.java:' + '69' , initValues(_3Ljava_lang_String_2_classLit, 692, 1, ['M', '(\\d)', 'M'])), ($location_0[stackIndex] = 'SimpleDateParser.java:' + '70' , initValues(_3Ljava_lang_String_2_classLit, 692, 1, ['yyyy', '(\\d\\d\\d\\d)', 'y'])), ($location_0[stackIndex] = 'SimpleDateParser.java:' + '71' , initValues(_3Ljava_lang_String_2_classLit, 692, 1, ['yyy', '(\\d\\d\\d)', 'y'])), ($location_0[stackIndex] = 'SimpleDateParser.java:' + '72' , initValues(_3Ljava_lang_String_2_classLit, 692, 1, ['yy', '(\\d\\d)', 'y'])), ($location_0[stackIndex] = 'SimpleDateParser.java:' + '73' , initValues(_3Ljava_lang_String_2_classLit, 692, 1, ['y', '(\\d)', 'y']))]));
  $stackDepth_0 = stackIndex - 1;
}
...
function $SimpleDateParser(this$static, format){
  ...
  $location_0[stackIndex] = 'SimpleDateParser.java:' + '137' , $clinit_1079();
  args = ($location_0[stackIndex] = 'SimpleDateParser.java:' + '138' , initValues(_3Ljava_lang_String_2_classLit, 692, 1, ['', '']));
...
function parse_0(input, pattern){
  var stackIndex, returnTemp;
  $stack_0[stackIndex = ++$stackDepth_0] = parse_0;
  $location_0[stackIndex] = 'SimpleDateParser.java:' + '158' , $clinit_1079();
...
function addMaximizeButton(windowPanel, captionRegion){
  ...
  maximizeBtn = ($location_0[stackIndex] = 'WindowUtil.java:' + '42' , $ImageButton(($location_0[stackIndex] = 'WindowUtil.java:' + '42' , new ImageButton), ($location_0[stackIndex] = 'WindowUtil.java:' + '43' , $clinit_648() , ($location_0[stackIndex] = 'CaptionImages_generatedBundle.java:' + '65' , $clinit_650()) , windowMaximize_SINGLETON)));
...
function addMinimizeButton(windowPanel, captionRegion){
  ...
  minimizeBtn = ($location_0[stackIndex] = 'WindowUtil.java:' + '74' , $ImageButton(($location_0[stackIndex] = 'WindowUtil.java:' + '74' , new ImageButton), ($location_0[stackIndex] = 'WindowUtil.java:' + '75' , $clinit_648() , ($location_0[stackIndex] = 'CaptionImages_generatedBundle.java:' + '69' , $clinit_650()) , windowMinimize_SINGLETON)));
...
function onClick_35(sender){
  ...
  this.val$windowPanel.windowState == ($location_0[stackIndex] = 'WindowPanel.java:' + '118' , $clinit_745() , MAXIMIZED)?($location_0[stackIndex] = 'WindowUtil.java:' + '47' , $setWindowState(this.val$windowPanel, NORMAL)):($location_0[stackIndex] = 'WindowUtil.java:' + '49' , $setWindowState(this.val$windowPanel, MAXIMIZED));
  $stackDepth_0 = stackIndex - 1;
}
...
function onWindowStateChange_0(sender, windowState, windowState1){
  ...
  sender.windowState == ($location_0[stackIndex] = 'WindowPanel.java:' + '118' , $clinit_745() , MAXIMIZED)?$setImage(this.val$maximizeBtn, ($location_0[stackIndex] = 'WindowUtil.java:' + '58' , $createImage(($location_0[stackIndex] = 'WindowUtil.java:' + '58' , $clinit_648() , ($location_0[stackIndex] = 'CaptionImages_generatedBundle.java:' + '73' , $clinit_650()) , windowRestore_SINGLETON)))):$setImage(this.val$maximizeBtn, ($location_0[stackIndex] = 'WindowUtil.java:' + '60' , $createImage(($location_0[stackIndex] = 'WindowUtil.java:' + '60' , $clinit_648() , ($location_0[stackIndex] = 'CaptionImages_generatedBundle.java:' + '65' , $clinit_650()) , windowMaximize_SINGLETON))));
  $stackDepth_0 = stackIndex - 1;
}
...
function onClick_36(sender){
  ...
  $location_0[stackIndex] = 'WindowUtil.java:' + '78' , $setWindowState(this.val$windowPanel, ($location_0[stackIndex] = 'WindowPanel.java:' + '118' , $clinit_745() , NORMAL));
  $stackDepth_0 = stackIndex - 1;
}
...
function $match(this$static, text){
  ...
  arr = ($location_0[stackIndex] = 'Pattern.java:' + '136' , initDim(_3Ljava_lang_String_2_classLit, 692, 1, matches.size_0, 0));
...
_.typeId$ = 0;
_.regExp = null;
function $clinit_1228(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_1228;
  $location_0[stackIndex] = 'Workspace.java:' + '57' , $clinit_1228 = nullMethod;
