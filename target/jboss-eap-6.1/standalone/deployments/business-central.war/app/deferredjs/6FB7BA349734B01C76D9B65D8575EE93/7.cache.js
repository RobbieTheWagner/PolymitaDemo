...
function onLoad_5(){
  ...
  instance_8 = ($location_0[stackIndex] = 'AsyncLoader7.java:' + '5' , $clinit_284() , ($location_0[stackIndex] = 'AsyncLoader7.java:' + '22' , new AsyncLoader7));
...
function $OpenTasksView(this$static){
  ...
  $location_0[stackIndex] = 'OpenTasksView.java:' + '56' , $clinit_1053();
...
function $provideWidget_6(this$static, callback){
  ...
  this$static.controller = dynamicCast(($location_0[stackIndex] = 'OpenTasksView.java:' + '99' , get_16(Lcom_mvc4g_client_Controller_2_classLit)), 167);
  dynamicCast(($location_0[stackIndex] = 'OpenTasksView.java:' + '100' , get_16(Lorg_jboss_bpm_console_client_ApplicationContext_2_classLit)), 225);
  ...
  $add_26(this$static.panel, this$static.taskList, ($location_0[stackIndex] = 'OpenTasksView.java:' + '117' , $BorderLayoutData_1(($location_0[stackIndex] = 'OpenTasksView.java:' + '117' , new BorderLayoutData), ($location_0[stackIndex] = 'BorderLayout.java:' + '199' , $clinit_789() , CENTER_1))));
