...
function $clinit_288(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_288;
  $location_0[stackIndex] = 'AsyncLoader8.java:' + '5' , $clinit_288 = nullMethod;
...
function onLoad_6(){
  ...
  instance_9 = ($location_0[stackIndex] = 'AsyncLoader8.java:' + '5' , $clinit_288() , ($location_0[stackIndex] = 'AsyncLoader8.java:' + '22' , new AsyncLoader8));
