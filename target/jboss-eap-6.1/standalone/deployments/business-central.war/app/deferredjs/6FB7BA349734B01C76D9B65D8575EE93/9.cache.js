...
function runAsync_0(callback){
  ...
  $location_0[stackIndex] = 'AsyncLoader2.java:' + '28' , $clinit_264();
  var newCallback;
...
function runCallbackOnFailures_0(e){
  ...
  $location_0[stackIndex] = 'AsyncLoader2.java:' + '72' , $clinit_264();
...
function loadFailed_2(reason){
  ...
  $location_0[stackIndex] = 'AsyncLoader2.java:' + '9' , $clinit_264();
...
function runAsync_1(callback){
  ...
  $location_0[stackIndex] = 'AsyncLoader3.java:' + '28' , $clinit_268();
  var newCallback;
...
function runCallbackOnFailures_1(e){
  ...
  $location_0[stackIndex] = 'AsyncLoader3.java:' + '72' , $clinit_268();
...
function loadFailed_3(reason){
  ...
  $location_0[stackIndex] = 'AsyncLoader3.java:' + '9' , $clinit_268();
...
function runAsync_2(callback){
  ...
  $location_0[stackIndex] = 'AsyncLoader4.java:' + '28' , $clinit_272();
  var newCallback;
...
function runCallbackOnFailures_2(e){
  ...
  $location_0[stackIndex] = 'AsyncLoader4.java:' + '72' , $clinit_272();
...
function loadFailed_4(reason){
  ...
  $location_0[stackIndex] = 'AsyncLoader4.java:' + '9' , $clinit_272();
...
function runAsync_3(callback){
  ...
  $location_0[stackIndex] = 'AsyncLoader5.java:' + '28' , $clinit_276();
  var newCallback;
...
function runCallbackOnFailures_3(e){
  ...
  $location_0[stackIndex] = 'AsyncLoader5.java:' + '72' , $clinit_276();
...
function loadFailed_5(reason){
  ...
  $location_0[stackIndex] = 'AsyncLoader5.java:' + '9' , $clinit_276();
...
function runAsync_4(callback){
  ...
  $location_0[stackIndex] = 'AsyncLoader6.java:' + '28' , $clinit_280();
  var newCallback;
...
function runCallbackOnFailures_4(e){
  ...
  $location_0[stackIndex] = 'AsyncLoader6.java:' + '72' , $clinit_280();
...
function loadFailed_6(reason){
  ...
  $location_0[stackIndex] = 'AsyncLoader6.java:' + '9' , $clinit_280();
...
function runAsync_5(callback){
  ...
  $location_0[stackIndex] = 'AsyncLoader7.java:' + '28' , $clinit_284();
  var newCallback;
...
function runCallbackOnFailures_5(e){
  ...
  $location_0[stackIndex] = 'AsyncLoader7.java:' + '72' , $clinit_284();
...
function loadFailed_7(reason){
  ...
  $location_0[stackIndex] = 'AsyncLoader7.java:' + '9' , $clinit_284();
...
function onLoad_7(){
  ...
  instance_10 = ($location_0[stackIndex] = 'AsyncLoader9.java:' + '5' , $clinit_290() , ($location_0[stackIndex] = 'AsyncLoader9.java:' + '22' , new AsyncLoader9));
...
function $Label_1(this$static, text, wordWrap){
  ...
  $location_0[stackIndex] = 'DOMImplMozilla.java:' + '115' , this$static.element.textContent = text || '';
...
function $DecoratedTabLayoutPanel(this$static){
  ...
  $location_0[stackIndex] = 'DecoratedTabLayoutPanel.java:' + '39' , $TabLayoutPanel(this$static, ($location_0[stackIndex] = 'TabLayoutPanel.java:' + '65' , $clinit_727() , TOP), true, false);
  $stackDepth_0 = stackIndex - 1;
  return this$static;
}
...
function $add_27(this$static, w, stackText, asHTML){
  ...
  $location_0[stackIndex] = 'Caption.java:' + '133' , $addDomHandler(caption, this$static.clickHandler, ($location_0[stackIndex] = 'Caption.java:' + '133' , $clinit_131() , ($location_0[stackIndex] = 'ClickEvent.java:' + '27' , $clinit_131()) , TYPE_1));
...
function $setBounds_0(this$static, x, y, width, height){
  ...
  $location_0[stackIndex] = 'Viewport.java:' + '115' , $clinit_431();
...
function $clinit_731(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_731;
  $location_0[stackIndex] = 'Viewport.java:' + '42' , $clinit_731 = nullMethod;
  $clinit_43();
  $stackDepth_0 = stackIndex - 1;
}
...
function $Viewport$1(this$static, this$0){
  ...
  $location_0[stackIndex] = 'Viewport.java:' + '42' , $clinit_731();
    ...
    if (widget == this$static.west || widget == this$static.east || widget == this$static.north || widget == this$static.south) {
      if (!layoutData.collapsedStateWidget) {
        ...
        if (layoutData.region == ($location_0[stackIndex] = 'BorderLayout.java:' + '199' , $clinit_789() , NORTH_0)) {
          imgBtn = ($location_0[stackIndex] = 'BorderLayout.java:' + '705' , $ImageButton(($location_0[stackIndex] = 'BorderLayout.java:' + '705' , new ImageButton), ($clinit_648() , ($location_0[stackIndex] = 'CaptionImages_generatedBundle.java:' + '29' , $clinit_650()) , toolCollapseDown_SINGLETON)));
          $location_0[stackIndex] = 'UIObject.java:' + '449' , setStyleName(imgBtn.element, 'NorthCollapsedImageButton', true);
          $location_0[stackIndex] = 'BorderLayout.java:' + '707' , $setHorizontalAlignment_0(imgBtn, ($location_0[stackIndex] = 'HasHorizontalAlignment.java:' + '74' , $clinit_386() , ALIGN_RIGHT));
        }
         else if (layoutData.region == EAST_0) {
          imgBtn = ($location_0[stackIndex] = 'BorderLayout.java:' + '709' , $ImageButton(($location_0[stackIndex] = 'BorderLayout.java:' + '709' , new ImageButton), ($clinit_648() , ($location_0[stackIndex] = 'CaptionImages_generatedBundle.java:' + '33' , $clinit_650()) , toolCollapseLeft_SINGLETON)));
          $location_0[stackIndex] = 'UIObject.java:' + '449' , setStyleName(imgBtn.element, 'EastCollapsedImageButton', true);
          $location_0[stackIndex] = 'BorderLayout.java:' + '711' , $setVerticalAlignment_0(imgBtn, ($location_0[stackIndex] = 'HasVerticalAlignment.java:' + '73' , $clinit_391() , ALIGN_TOP));
        }
         else if (layoutData.region == SOUTH_0) {
          imgBtn = ($location_0[stackIndex] = 'BorderLayout.java:' + '713' , $ImageButton(($location_0[stackIndex] = 'BorderLayout.java:' + '713' , new ImageButton), ($clinit_648() , ($location_0[stackIndex] = 'CaptionImages_generatedBundle.java:' + '41' , $clinit_650()) , toolCollapseUp_SINGLETON)));
          $location_0[stackIndex] = 'UIObject.java:' + '449' , setStyleName(imgBtn.element, 'SouthCollapsedImageButton', true);
          $location_0[stackIndex] = 'BorderLayout.java:' + '715' , $setHorizontalAlignment_0(imgBtn, ($location_0[stackIndex] = 'HasHorizontalAlignment.java:' + '74' , $clinit_386() , ALIGN_RIGHT));
        }
         else if (layoutData.region == WEST_0) {
          imgBtn = ($location_0[stackIndex] = 'BorderLayout.java:' + '717' , $ImageButton(($location_0[stackIndex] = 'BorderLayout.java:' + '717' , new ImageButton), ($clinit_648() , ($location_0[stackIndex] = 'CaptionImages_generatedBundle.java:' + '37' , $clinit_650()) , toolCollapseRight_SINGLETON)));
          $location_0[stackIndex] = 'UIObject.java:' + '449' , setStyleName(imgBtn.element, 'WestCollapsedImageButton', true);
          $location_0[stackIndex] = 'BorderLayout.java:' + '719' , $setVerticalAlignment_0(imgBtn, ($location_0[stackIndex] = 'HasVerticalAlignment.java:' + '73' , $clinit_391() , ALIGN_TOP));
        }
        if (!imgBtn) {
          $stackDepth_0 = stackIndex - 1;
          return;
        }
        $location_0[stackIndex] = 'ImageButton.java:' + '58' , $addDomHandler(imgBtn, $BorderLayout$1(($location_0[stackIndex] = 'BorderLayout.java:' + '724' , new BorderLayout$1), layoutPanel, widget), ($location_0[stackIndex] = 'ImageButton.java:' + '58' , $clinit_131() , ($location_0[stackIndex] = 'ClickEvent.java:' + '27' , $clinit_131()) , TYPE_1));
...
function getClass_510(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_510;
  $stackDepth_0 = stackIndex - 1;
...
function getClass_614(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_614;
  $stackDepth_0 = stackIndex - 1;
...
function getClass_615(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_615;
  $stackDepth_0 = stackIndex - 1;
...
function getClass_862(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_862;
  $stackDepth_0 = stackIndex - 1;
...
function $createLogPanel(parent_0){
  ...
  collapseBtn = ($location_0[stackIndex] = 'Application.java:' + '319' , $ImageButton(($location_0[stackIndex] = 'Application.java:' + '319' , new ImageButton), ($clinit_648() , ($location_0[stackIndex] = 'CaptionImages_generatedBundle.java:' + '29' , $clinit_650()) , toolCollapseDown_SINGLETON)));
  $location_0[stackIndex] = 'Application.java:' + '320' , $add_17(messagePanel.caption, collapseBtn, ($location_0[stackIndex] = 'Caption.java:' + '61' , $clinit_649() , RIGHT));
  $location_0[stackIndex] = 'ImageButton.java:' + '58' , $addDomHandler(collapseBtn, $Application$6(($location_0[stackIndex] = 'Application.java:' + '322' , new Application$6), parent_0, messagePanel), ($location_0[stackIndex] = 'ImageButton.java:' + '58' , $clinit_131() , ($location_0[stackIndex] = 'ClickEvent.java:' + '27' , $clinit_131()) , TYPE_1));
  $stackDepth_0 = stackIndex - 1;
  return messagePanel;
}
...
function $initializeUI(this$static){
  ...
  $location_0[stackIndex] = 'Application.java:' + '220' , $clinit_431();
...
function getClass_870(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_870;
  $stackDepth_0 = stackIndex - 1;
...
function $recordHistory(toolsetId, toolId){
  ...
  $location_0[stackIndex] = 'History.java:' + '171' , $clinit_317();
...
function getClass_894(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_894;
  $stackDepth_0 = stackIndex - 1;
...
function $makeHeader(this$static){
  ...
  for ($location_0[stackIndex] = 'WorkspaceLogger.java:' + '234' , i = 0; i < levels.length; $location_0[stackIndex] = 'WorkspaceLogger.java:' + '234' , ++i) {
    ...
    $location_0[stackIndex] = 'FocusWidget.java:' + '91' , $addDomHandler(($location_0[stackIndex] = 'WorkspaceLogger.java:' + '238' , this$static.levelButtons[i]), $WorkspaceLogger$2(new WorkspaceLogger$2, level), ($location_0[stackIndex] = 'FocusWidget.java:' + '91' , $clinit_131() , ($location_0[stackIndex] = 'ClickEvent.java:' + '27' , $clinit_131()) , TYPE_1));
  }
  ...
  $location_0[stackIndex] = 'FocusWidget.java:' + '91' , $addDomHandler(clearButton, ($location_0[stackIndex] = 'WorkspaceLogger.java:' + '249' , new WorkspaceLogger$3), ($location_0[stackIndex] = 'FocusWidget.java:' + '91' , $clinit_131() , ($location_0[stackIndex] = 'ClickEvent.java:' + '27' , $clinit_131()) , TYPE_1));
...
function getClass_910(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_910;
  $stackDepth_0 = stackIndex - 1;
