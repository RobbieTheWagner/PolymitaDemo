...
function onLoad_3(){
  ...
  instance_6 = ($location_0[stackIndex] = 'AsyncLoader5.java:' + '5' , $clinit_277() , ($location_0[stackIndex] = 'AsyncLoader5.java:' + '22' , new AsyncLoader5));
  $location_0[stackIndex] = 'AsyncLoader5.java:' + '23' , $fragmentHasLoaded(($location_0[stackIndex] = 'AsyncFragmentLoader.java:' + '335' , $clinit_60() , BROWSER_LOADER), 5);
...
function parseReportConfig(json){
  ...
  for ($location_0[stackIndex] = 'JSOParser.java:' + '157' , i = 0; i < rootModel.length; $location_0[stackIndex] = 'JSOParser.java:' + '157' , ++i) {
    ...
    for ($location_0[stackIndex] = 'JSOParser.java:' + '171' , x = 0; x < params.length; $location_0[stackIndex] = 'JSOParser.java:' + '171' , ++x) {
      ...
      pmd = ($location_0[stackIndex] = 'JSOParser.java:' + '178' , $ReportParameter(($location_0[stackIndex] = 'JSOParser.java:' + '178' , new ReportParameter), name_0, ($clinit_1091() , dynamicCast(($location_0[stackIndex] = 'ReportParameter.java:' + '29' , valueOf_0(enum$map_1, type)), 113))));
      $location_0[stackIndex] = 'ReportParameter.java:' + '82' , pmd.dataType = ($location_0[stackIndex] = 'JSOParser.java:' + '179' , $clinit_1090() , dynamicCast(($location_0[stackIndex] = 'ReportParameter.java:' + '30' , valueOf_0(enum$map_0, dataType)), 112));
...
_.dispatchUrl = null;
_.parameters = 'None';
function $clinit_1017(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_1017;
  $location_0[stackIndex] = 'RenderReportAction.java:' + '41' , $clinit_1017 = nullMethod;
...
function $RenderReportAction(this$static){
  ...
  $location_0[stackIndex] = 'RenderReportAction.java:' + '48' , $clinit_1017();
  dynamicCast(($location_0[stackIndex] = 'RenderReportAction.java:' + '50' , get_16(Lorg_jboss_bpm_console_client_ApplicationContext_2_classLit)), 225);
  $stackDepth_0 = stackIndex - 1;
  return this$static;
}
...
function $handleError(controller, url, t){
  ...
  $location_0[stackIndex] = 'RenderReportAction.java:' + '154' , $handleEvent(controller, ($location_0[stackIndex] = 'LoadingStatusAction.java:' + '37' , $clinit_899() , OFF));
  $stackDepth_0 = stackIndex - 1;
}
...
function execute_37(controller, object){
  ...
  event_0 = ($location_0[stackIndex] = 'RenderReportAction.java:' + '55' , dynamicCast(object, 246));
  $location_0[stackIndex] = 'RenderReportAction.java:' + '57' , url = event_0.dispatchUrl;
  builder = ($location_0[stackIndex] = 'RenderReportAction.java:' + '58' , $RequestBuilder(($location_0[stackIndex] = 'RenderReportAction.java:' + '58' , new RequestBuilder), ($location_0[stackIndex] = 'RequestBuilder.java:' + '70' , $clinit_214() , POST), url));
  $location_0[stackIndex] = 'Log.java:' + '101' , $clinit_24();
  $location_0[stackIndex] = 'Log.java:' + '150' , $debug(impl, POST + ': ' + url, null);
  view = ($location_0[stackIndex] = 'RenderReportAction.java:' + '61' , dynamicCast(dynamicCast(($location_0[stackIndex] = 'Controller.java:' + '67' , $get_7(controller.views, ($location_0[stackIndex] = 'ReportLaunchPadView.java:' + '59' , $clinit_1021() , ID_21))), 168), 247));
  ...
  try {
    $location_0[stackIndex] = 'RenderReportAction.java:' + '68' , $handleEvent(controller, ($location_0[stackIndex] = 'LoadingStatusAction.java:' + '36' , $clinit_899() , ON));
    ...
    if (instanceOf($e0, 12)) {
      e = $e0;
      $location_0[stackIndex] = 'RenderReportAction.java:' + '135' , $handleEvent(controller, ($location_0[stackIndex] = 'LoadingStatusAction.java:' + '37' , $clinit_899() , OFF));
...
function onError_6(request, exception){
  ...
  $location_0[stackIndex] = 'RenderReportAction.java:' + '78' , $handleEvent(this.val$controller, ($location_0[stackIndex] = 'LoadingStatusAction.java:' + '37' , $clinit_899() , OFF));
  $stackDepth_0 = stackIndex - 1;
}
...
function onResponseReceived_6(request, response){
  ...
  try {
    ...
    $location_0[stackIndex] = 'RenderReportAction.java:' + '105' , $handleEvent(this.val$controller, ($location_0[stackIndex] = 'LoadingStatusAction.java:' + '37' , $clinit_899() , OFF));
...
function $clinit_1019(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_1019;
  $location_0[stackIndex] = 'RenderReportAction.java:' + '113' , $clinit_1019 = nullMethod;
  $clinit_43();
  $stackDepth_0 = stackIndex - 1;
}
...
function $RenderReportAction$2(this$static, val$request, val$controller, val$url){
  ...
  $location_0[stackIndex] = 'RenderReportAction.java:' + '113' , $clinit_1019();
...
function $clinit_1021(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_1021;
  $location_0[stackIndex] = 'ReportLaunchPadView.java:' + '57' , $clinit_1021 = nullMethod;
...
function $ReportLaunchPadView(this$static){
  ...
  $location_0[stackIndex] = 'ReportLaunchPadView.java:' + '73' , $clinit_1021();
  $MosaicPanel_0(this$static, ($location_0[stackIndex] = 'ReportLaunchPadView.java:' + '75' , $BoxLayout_1(($location_0[stackIndex] = 'ReportLaunchPadView.java:' + '75' , new BoxLayout), ($location_0[stackIndex] = 'BoxLayout.java:' + '170' , $clinit_798() , VERTICAL))));
  ...
  $location_0[stackIndex] = 'ListBox.java:' + '104' , $addDomHandler(this$static.dropBox, $ReportLaunchPadView$1(($location_0[stackIndex] = 'ReportLaunchPadView.java:' + '87' , new ReportLaunchPadView$1), this$static), ($location_0[stackIndex] = 'ListBox.java:' + '104' , $clinit_130() , ($location_0[stackIndex] = 'ChangeEvent.java:' + '27' , $clinit_130()) , TYPE_0));
  $add_26(templatePanel, this$static.dropBox, ($location_0[stackIndex] = 'ReportLaunchPadView.java:' + '96' , $BoxLayoutData_4(($location_0[stackIndex] = 'ReportLaunchPadView.java:' + '96' , new BoxLayoutData), ($location_0[stackIndex] = 'BoxLayoutData.java:' + '30' , $clinit_800() , HORIZONTAL_0))));
...
function $getCurrentSelection(this$static){
  ...
  for ($location_0[stackIndex] = 'ReportLaunchPadView.java:' + '152' , r$iterator = $AbstractList$IteratorImpl(($location_0[stackIndex] = 'AbstractList.java:' + '278' , new AbstractList$IteratorImpl), this$static.reportTemplates); r$iterator.i < ($location_0[stackIndex] = 'AbstractList.java:' + '38' , r$iterator.this$0.size_1());) {
    r = dynamicCast(($location_0[stackIndex] = 'ReportLaunchPadView.java:' + '152' , $next_6(r$iterator)), 248);
...
function $selectForm(this$static, reportTitle){
  ...
  $setInnerText_0(($location_0[stackIndex] = 'Element.java:' + '621' , $clinit_81() , this$static.description.element), current.description);
...
function $update_7(this$static, reports){
  ...
  for ($location_0[stackIndex] = 'ReportLaunchPadView.java:' + '166' , report$iterator = $AbstractList$IteratorImpl(($location_0[stackIndex] = 'AbstractList.java:' + '278' , new AbstractList$IteratorImpl), reports); report$iterator.i < ($location_0[stackIndex] = 'AbstractList.java:' + '38' , report$iterator.this$0.size_1());) {
    report = dynamicCast(($location_0[stackIndex] = 'ReportLaunchPadView.java:' + '166' , $next_6(report$iterator)), 248);
  ...
  dynamicCast(($location_0[stackIndex] = 'ReportLaunchPadView.java:' + '178' , get_16(Lorg_jboss_bpm_console_client_ApplicationContext_2_classLit)), 225);
  $stackDepth_0 = stackIndex - 1;
}
...
function fieldValues2PostParams(values){
  ...
  $location_0[stackIndex] = 'ReportLaunchPadView.java:' + '214' , $clinit_1021();
  var key, keys, sb;
  ...
  while ($location_0[stackIndex] = 'AbstractMap.java:' + '110' , keys.val$outerIter.hasNext()) {
    key = ($location_0[stackIndex] = 'ReportLaunchPadView.java:' + '220' , dynamicCast((entry = dynamicCast(($location_0[stackIndex] = 'AbstractMap.java:' + '114' , keys.val$outerIter.next_0()), 88) , ($location_0[stackIndex] = 'AbstractMap.java:' + '115' , entry.getKey())), 1));
...
function $onSumbit(this$static, paramValues){
  ...
  for ($location_0[stackIndex] = 'ReportLaunchPadView.java:' + '125' , key$iterator = (outerIter = ($location_0[stackIndex] = 'AbstractMap.java:' + '107' , (entrySet = ($location_0[stackIndex] = 'AbstractMap.java:' + '98' , paramValues.entrySet_0()) , $AbstractMap$1(($location_0[stackIndex] = 'AbstractMap.java:' + '99' , new AbstractMap$1), paramValues, entrySet)).val$entrySet.iterator_0()) , $AbstractMap$1$1(($location_0[stackIndex] = 'AbstractMap.java:' + '108' , new AbstractMap$1$1), outerIter)); $location_0[stackIndex] = 'AbstractMap.java:' + '110' , key$iterator.val$outerIter.hasNext();) {
    key = ($location_0[stackIndex] = 'ReportLaunchPadView.java:' + '125' , dynamicCast((entry = dynamicCast(($location_0[stackIndex] = 'AbstractMap.java:' + '114' , key$iterator.val$outerIter.next_0()), 88) , ($location_0[stackIndex] = 'AbstractMap.java:' + '115' , entry.getKey())), 1));
  ...
  if (valid) {
    ...
    $handleEvent(this$static.this$0.controller, ($location_0[stackIndex] = 'ReportLaunchPadView.java:' + '137' , $Event(($location_0[stackIndex] = 'ReportLaunchPadView.java:' + '137' , new Event_0), ($location_0[stackIndex] = 'RenderReportAction.java:' + '44' , $clinit_1017() , ID_20), eventPayload)));
  }
   else {
    $location_0[stackIndex] = 'ReportLaunchPadView.java:' + '141' , $clinit_686();
    $location_0[stackIndex] = 'MessageBox.java:' + '111' , alert_2(($location_0[stackIndex] = 'MessageBox.java:' + '60' , $clinit_695() , ALERT), 'Report Parameters', 'Please provide the required input parameters');
  }
  $stackDepth_0 = stackIndex - 1;
}
...
function $onSuccess_3(this$static){
  ...
  !this$static.this$0.instance && (this$static.this$0.instance = ($location_0[stackIndex] = 'ReportView.java:' + '42' , $clinit_1031() , ($location_0[stackIndex] = 'ReportModule.java:' + '49' , new ReportView)));
...
function $createForm_0(this$static, reportRef, callback){
  ...
  for ($location_0[stackIndex] = 'ReportParameterForm.java:' + '94' , reportParam$iterator = ($location_0[stackIndex] = 'AbstractList.java:' + '291' , $listIterator(reportRef.parameterMetaData, 0)); reportParam$iterator.currentNode != reportParam$iterator.this$0.header;) {
    reportParam = dynamicCast(($location_0[stackIndex] = 'ReportParameterForm.java:' + '94' , $next_9(reportParam$iterator)), 249);
    ...
    $location_0[stackIndex] = 'LayoutPanel.java:' + '391' , $insert_0(form, textBox, form.children.size_0);
  }
  !hasParameters && ($location_0[stackIndex] = 'ReportParameterForm.java:' + '128' , $add_26(form, $HTML_0(($location_0[stackIndex] = 'ReportParameterForm.java:' + '128' , new HTML), "This report doesn't require any paramters."), ($location_0[stackIndex] = 'ReportParameterForm.java:' + '129' , $GridLayoutData_2(($location_0[stackIndex] = 'ReportParameterForm.java:' + '129' , new GridLayoutData), 2, 1, ($location_0[stackIndex] = 'HasHorizontalAlignment.java:' + '62' , $clinit_387() , ALIGN_CENTER), ($location_0[stackIndex] = 'HasVerticalAlignment.java:' + '73' , $clinit_392() , ALIGN_TOP)))));
  $add_25(form, $HTML_0(($location_0[stackIndex] = 'ReportParameterForm.java:' + '133' , new HTML), ''));
  $add_26(form, createBtn, ($location_0[stackIndex] = 'ReportParameterForm.java:' + '134' , $GridLayoutData_0(($location_0[stackIndex] = 'ReportParameterForm.java:' + '134' , new GridLayoutData), ($location_0[stackIndex] = 'HasHorizontalAlignment.java:' + '74' , $clinit_387() , ALIGN_RIGHT), ($location_0[stackIndex] = 'HasVerticalAlignment.java:' + '61' , $clinit_392() , ALIGN_BOTTOM))));
  $stackDepth_0 = stackIndex - 1;
  return form;
}
...
function $writePrefs(values, reportRef){
  ...
  for ($location_0[stackIndex] = 'ReportParameterForm.java:' + '145' , key$iterator = (outerIter = ($location_0[stackIndex] = 'AbstractMap.java:' + '107' , (entrySet = ($location_0[stackIndex] = 'AbstractMap.java:' + '98' , values.entrySet_0()) , $AbstractMap$1(($location_0[stackIndex] = 'AbstractMap.java:' + '99' , new AbstractMap$1), values, entrySet)).val$entrySet.iterator_0()) , $AbstractMap$1$1(($location_0[stackIndex] = 'AbstractMap.java:' + '108' , new AbstractMap$1$1), outerIter)); $location_0[stackIndex] = 'AbstractMap.java:' + '110' , key$iterator.val$outerIter.hasNext();) {
    key = ($location_0[stackIndex] = 'ReportParameterForm.java:' + '145' , dynamicCast((entry = dynamicCast(($location_0[stackIndex] = 'AbstractMap.java:' + '114' , key$iterator.val$outerIter.next_0()), 88) , ($location_0[stackIndex] = 'AbstractMap.java:' + '115' , entry.getKey())), 1));
...
function onClick_26(clickEvent){
  ...
  for ($location_0[stackIndex] = 'ReportParameterForm.java:' + '78' , field$iterator = $AbstractList$IteratorImpl(($location_0[stackIndex] = 'AbstractList.java:' + '278' , new AbstractList$IteratorImpl), this.this$0.fields); field$iterator.i < ($location_0[stackIndex] = 'AbstractList.java:' + '38' , field$iterator.this$0.size_1());) {
    field = dynamicCast(($location_0[stackIndex] = 'ReportParameterForm.java:' + '78' , $next_6(field$iterator)), 250);
...
function $clinit_1031(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_1031;
  $location_0[stackIndex] = 'ReportView.java:' + '42' , $clinit_1031 = nullMethod;
...
function $initialize_2(this$static){
  ...
  if (!this$static.isInitialized) {
    ...
    $location_0[stackIndex] = 'ReportView.java:' + '93' , $addView(this$static.controller, ($location_0[stackIndex] = 'ReportLaunchPadView.java:' + '59' , $clinit_1021() , ID_21), this$static.coverpanel);
    $location_0[stackIndex] = 'Controller.java:' + '106' , $put_0(this$static.controller.actions, ($location_0[stackIndex] = 'UpdateSearchDefinitionsAction.java:' + '43' , $clinit_1034() , ID_24), $UpdateSearchDefinitionsAction(($location_0[stackIndex] = 'ReportView.java:' + '95' , new UpdateSearchDefinitionsAction)));
    $location_0[stackIndex] = 'Controller.java:' + '106' , $put_0(this$static.controller.actions, ($location_0[stackIndex] = 'RenderReportAction.java:' + '44' , $clinit_1017() , ID_20), $RenderReportAction(($location_0[stackIndex] = 'ReportView.java:' + '96' , new RenderReportAction)));
...
function $provideWidget_4(this$static, callback){
  ...
  this$static.controller = dynamicCast(($location_0[stackIndex] = 'ReportView.java:' + '56' , get_16(Lcom_mvc4g_client_Controller_2_classLit)), 167);
  ...
  $location_0[stackIndex] = 'Controller.java:' + '106' , $put_0(this$static.controller.actions, ($location_0[stackIndex] = 'UpdateReportConfigAction.java:' + '48' , $clinit_1033() , ID_23), $UpdateReportConfigAction(($location_0[stackIndex] = 'ReportView.java:' + '61' , new UpdateReportConfigAction)));
...
function $clinit_1032(){
  ...
  $location_0[stackIndex] = 'ReportView.java:' + '65' , $clinit_1032 = nullMethod;
  $clinit_43();
  $stackDepth_0 = stackIndex - 1;
}
...
function $ReportView$1(this$static, this$0){
  ...
  $location_0[stackIndex] = 'ReportView.java:' + '65' , $clinit_1032();
...
function run_21(){
  ...
  $handleEvent(this.this$0.controller, ($location_0[stackIndex] = 'ReportView.java:' + '70' , $Event(($location_0[stackIndex] = 'ReportView.java:' + '70' , new Event_0), ($location_0[stackIndex] = 'UpdateReportConfigAction.java:' + '48' , $clinit_1033() , ID_23), null)));
  $stackDepth_0 = stackIndex - 1;
}
...
function $clinit_1033(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_1033;
  $location_0[stackIndex] = 'UpdateReportConfigAction.java:' + '45' , $clinit_1033 = nullMethod;
...
function $UpdateReportConfigAction(this$static){
  ...
  $location_0[stackIndex] = 'UpdateReportConfigAction.java:' + '51' , $clinit_1033();
  ...
  this$static.appContext = dynamicCast(($location_0[stackIndex] = 'UpdateReportConfigAction.java:' + '53' , get_16(Lorg_jboss_bpm_console_client_ApplicationContext_2_classLit)), 225);
  $stackDepth_0 = stackIndex - 1;
  return this$static;
}
...
function handleSuccessfulResponse_11(controller, event_0, response){
  ...
  view = ($location_0[stackIndex] = 'UpdateReportConfigAction.java:' + '76' , dynamicCast(dynamicCast(($location_0[stackIndex] = 'Controller.java:' + '67' , $get_7(controller.views, ($location_0[stackIndex] = 'ReportView.java:' + '44' , $clinit_1031() , ID_22))), 168), 251));
...
function $clinit_1034(){
  ...
  $location_0[stackIndex] = 'UpdateSearchDefinitionsAction.java:' + '41' , $clinit_1034 = nullMethod;
...
function $UpdateSearchDefinitionsAction(this$static){
  ...
  $location_0[stackIndex] = 'UpdateSearchDefinitionsAction.java:' + '41' , $clinit_1034();
  dynamicCast(($location_0[stackIndex] = 'AbstractRESTAction.java:' + '44' , get_16(Lorg_jboss_bpm_console_client_ApplicationContext_2_classLit)), 225);
  $stackDepth_0 = stackIndex - 1;
  return this$static;
}
...
function handleSuccessfulResponse_12(controller, event_0, response){
  ...
  $location_0[stackIndex] = 'UpdateSearchDefinitionsAction.java:' + '65' , throwClassCastExceptionUnlessNull(dynamicCast(($location_0[stackIndex] = 'Controller.java:' + '67' , $get_7(controller.views, target)), 168));
...
function $ReportParameter(this$static, name_0, type){
  ...
  $location_0[stackIndex] = 'ReportParameter.java:' + '37' , this$static.dataType = ($location_0[stackIndex] = 'ReportParameter.java:' + '30' , $clinit_1090() , STRING);
...
function equals_37(o){
  ...
  that = ($location_0[stackIndex] = 'ReportParameter.java:' + '91' , dynamicCast(o, 249));
...
function getClass_780(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_780;
  $stackDepth_0 = stackIndex - 1;
...
_.promptText = null;
_.type_0 = null;
function $clinit_1090(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_1090;
  $location_0[stackIndex] = 'ReportParameter.java:' + '30' , $clinit_1090 = nullMethod;
...
function $ReportParameter$DataType(this$static, enum$name, enum$ordinal){
  ...
  $location_0[stackIndex] = 'ReportParameter.java:' + '30' , $clinit_1090();
...
function getClass_781(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_781;
  $stackDepth_0 = stackIndex - 1;
...
function values_28(){
  ...
  $location_0[stackIndex] = 'ReportParameter.java:' + '30' , $clinit_1090();
  returnTemp = initValues(_3Lorg_jboss_bpm_report_model_ReportParameter$DataType_2_classLit, 718, 112, [STRING, NUMBER, DATETIME, BOOLEAN, ANY]);
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
_.getClass$ = getClass_781;
_.typeId$ = 527;
var ANY, BOOLEAN, DATETIME, NUMBER, STRING, enum$map_0 = null;
function $clinit_1091(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_1091;
  $location_0[stackIndex] = 'ReportParameter.java:' + '29' , $clinit_1091 = nullMethod;
...
function $ReportParameter$Type(this$static, enum$name, enum$ordinal){
  ...
  $location_0[stackIndex] = 'ReportParameter.java:' + '29' , $clinit_1091();
  $location_0[stackIndex] = 'Enum.java:' + '76' , this$static.name_0 = enum$name;
  $location_0[stackIndex] = 'Enum.java:' + '77' , this$static.ordinal = enum$ordinal;
  $stackDepth_0 = stackIndex - 1;
  return this$static;
...
function getClass_782(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_782;
  $stackDepth_0 = stackIndex - 1;
...
function values_29(){
  var stackIndex, returnTemp;
  $stack_0[stackIndex = ++$stackDepth_0] = values_29;
  $location_0[stackIndex] = 'ReportParameter.java:' + '29' , $clinit_1091();
  returnTemp = initValues(_3Lorg_jboss_bpm_report_model_ReportParameter$Type_2_classLit, 719, 113, [LISTBOX, TEXTBOX, CHECKBOX_0, RADIO_BUTTON]);
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function equals_38(o){
  ...
  that = ($location_0[stackIndex] = 'ReportReference.java:' + '91' , dynamicCast(o, 248));
...
function getClass_783(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_783;
  $stackDepth_0 = stackIndex - 1;
