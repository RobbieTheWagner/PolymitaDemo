...
function onLoad_0(){
  ...
  instance_3 = ($location_0[stackIndex] = 'AsyncLoader2.java:' + '5' , $clinit_260() , ($location_0[stackIndex] = 'AsyncLoader2.java:' + '22' , new AsyncLoader2));
...
function $ListBox(this$static){
  ...
  $location_0[stackIndex] = 'ListBox.java:' + '77' , $clinit_401();
  $location_0[stackIndex] = 'ListBox.java:' + '88' , $FocusWidget(this$static, ($location_0[stackIndex] = 'DOMImpl.java:' + '65' , select = ($location_0[stackIndex] = 'DOMImpl.java:' + '35' , ($location_0[stackIndex] = 'Document.java:' + '921' , $clinit_82() , $doc).createElement('select')) , select));
...
function $setItemSelected(this$static, index, selected){
  ...
  $location_0[stackIndex] = 'OptionElement.java:' + '146' , ($location_0[stackIndex] = 'SelectElement.java:' + '112' , $clinit_82() , this$static.element).children[index].selected = selected;
  $stackDepth_0 = stackIndex - 1;
}
...
function $provideWidget(this$static, callback){
  ...
  this$static.panel = $MosaicPanel_0(($location_0[stackIndex] = 'PreferencesView.java:' + '65' , new MosaicPanel), ($location_0[stackIndex] = 'PreferencesView.java:' + '65' , $BoxLayout_1(new BoxLayout, ($location_0[stackIndex] = 'BoxLayout.java:' + '170' , $clinit_791() , VERTICAL))));
  ...
  $add_26(this$static.panel, $HeaderLabel(($location_0[stackIndex] = 'PreferencesView.java:' + '68' , new HeaderLabel), 'User Preferences'), ($location_0[stackIndex] = 'PreferencesView.java:' + '68' , $BoxLayoutData_4(new BoxLayoutData, ($location_0[stackIndex] = 'BoxLayoutData.java:' + '30' , $clinit_793() , HORIZONTAL_0))));
  ...
  $location_0[stackIndex] = 'PreferencesView.java:' + '76' , toolsets = ($location_0[stackIndex] = 'PreferencesView.java:' + '77' , $clinit_1223() , ($location_0[stackIndex] = 'Workspace.java:' + '61' , $clinit_1223()) , toolSets_0);
  ...
  for ($location_0[stackIndex] = 'PreferencesView.java:' + '85' , ts$iterator = $AbstractList$IteratorImpl(($location_0[stackIndex] = 'AbstractList.java:' + '278' , new AbstractList$IteratorImpl), toolsets); ts$iterator.i < ($location_0[stackIndex] = 'AbstractList.java:' + '38' , ts$iterator.this$0.size_1());) {
    ...
    $equals_4(($location_0[stackIndex] = 'PreferencesView.java:' + '88' , ts.getToolSetName()), prefEditor) && ($location_0[stackIndex] = 'PreferencesView.java:' + '89' , $setItemSelected(multiBox, ($location_0[stackIndex] = 'SelectElement.java:' + '112' , $clinit_82() , multiBox.element).children.length - 1, true));
  }
  $location_0[stackIndex] = 'FocusWidget.java:' + '91' , $addDomHandler(multiBox, $PreferencesView$1(($location_0[stackIndex] = 'PreferencesView.java:' + '93' , new PreferencesView$1), multiBox, toolsets), ($location_0[stackIndex] = 'FocusWidget.java:' + '91' , $clinit_127() , ($location_0[stackIndex] = 'ClickEvent.java:' + '27' , $clinit_127()) , TYPE_1));
