...
function $clinit_284(){
  ...
  $location_0[stackIndex] = 'AsyncLoader8.java:' + '5' , $clinit_284 = nullMethod;
...
function onLoad_6(){
  ...
  instance_9 = ($location_0[stackIndex] = 'AsyncLoader8.java:' + '5' , $clinit_284() , ($location_0[stackIndex] = 'AsyncLoader8.java:' + '22' , new AsyncLoader8));
