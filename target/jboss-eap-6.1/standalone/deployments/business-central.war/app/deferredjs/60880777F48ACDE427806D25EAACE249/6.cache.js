...
function onLoad_4(){
  ...
  instance_7 = ($location_0[stackIndex] = 'AsyncLoader6.java:' + '5' , $clinit_276() , ($location_0[stackIndex] = 'AsyncLoader6.java:' + '22' , new AsyncLoader6));
...
function $AssignedTasksView(this$static){
  ...
  $location_0[stackIndex] = 'AssignedTasksView.java:' + '78' , $clinit_1032();
...
function $provideWidget_5(this$static, callback){
  ...
  $add_26(this$static.panel, this$static.taskList, ($location_0[stackIndex] = 'AssignedTasksView.java:' + '90' , $BorderLayoutData_1(($location_0[stackIndex] = 'AssignedTasksView.java:' + '90' , new BorderLayoutData), ($location_0[stackIndex] = 'BorderLayout.java:' + '199' , $clinit_784() , CENTER_1))));
