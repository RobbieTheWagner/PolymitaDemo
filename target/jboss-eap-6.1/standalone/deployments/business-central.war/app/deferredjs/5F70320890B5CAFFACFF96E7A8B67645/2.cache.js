...
function onLoad_0(){
  ...
  instance_3 = ($location_0[stackIndex] = 'AsyncLoader2.java:' + '5' , $clinit_262() , ($location_0[stackIndex] = 'AsyncLoader2.java:' + '22' , new AsyncLoader2));
...
function $provideWidget(this$static, callback){
  ...
  $location_0[stackIndex] = 'FocusWidget.java:' + '91' , $addDomHandler(multiBox, $PreferencesView$1(($location_0[stackIndex] = 'PreferencesView.java:' + '93' , new PreferencesView$1), multiBox, toolsets), ($location_0[stackIndex] = 'FocusWidget.java:' + '91' , $clinit_129() , ($location_0[stackIndex] = 'ClickEvent.java:' + '27' , $clinit_129()) , TYPE_1));
...
function getClass_609(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_609;
  $stackDepth_0 = stackIndex - 1;
