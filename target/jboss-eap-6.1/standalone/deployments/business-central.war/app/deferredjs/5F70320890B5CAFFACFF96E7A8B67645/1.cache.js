...
function onLoad(){
  ...
  instance_2 = ($location_0[stackIndex] = 'AsyncLoader1.java:' + '5' , $clinit_258() , ($location_0[stackIndex] = 'AsyncLoader1.java:' + '22' , new AsyncLoader1));
...
function getClass_603(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_603;
  $stackDepth_0 = stackIndex - 1;
