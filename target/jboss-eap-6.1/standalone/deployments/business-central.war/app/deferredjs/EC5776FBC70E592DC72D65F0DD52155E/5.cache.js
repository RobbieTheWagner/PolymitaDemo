...
function onLoad_3(){
  ...
  instance_6 = ($location_0[stackIndex] = 'AsyncLoader5.java:' + '5' , $clinit_271() , ($location_0[stackIndex] = 'AsyncLoader5.java:' + '22' , new AsyncLoader5));
...
function parseReportConfig(json){
  ...
  for ($location_0[stackIndex] = 'JSOParser.java:' + '157' , i = 0; i < rootModel.length; $location_0[stackIndex] = 'JSOParser.java:' + '157' , ++i) {
    ...
    for ($location_0[stackIndex] = 'JSOParser.java:' + '171' , x = 0; x < params.length; $location_0[stackIndex] = 'JSOParser.java:' + '171' , ++x) {
      ...
      pmd = ($location_0[stackIndex] = 'JSOParser.java:' + '178' , $ReportParameter(($location_0[stackIndex] = 'JSOParser.java:' + '178' , new ReportParameter), name_0, ($clinit_1080() , dynamicCast(($location_0[stackIndex] = 'ReportParameter.java:' + '29' , valueOf_0(enum$map_1, type)), 112))));
      $location_0[stackIndex] = 'ReportParameter.java:' + '82' , pmd.dataType = ($location_0[stackIndex] = 'JSOParser.java:' + '179' , $clinit_1079() , dynamicCast(($location_0[stackIndex] = 'ReportParameter.java:' + '30' , valueOf_0(enum$map_0, dataType)), 111));
...
function $clinit_1006(){
  ...
  $location_0[stackIndex] = 'RenderReportAction.java:' + '41' , $clinit_1006 = nullMethod;
...
function $RenderReportAction(this$static){
  ...
  $location_0[stackIndex] = 'RenderReportAction.java:' + '48' , $clinit_1006();
...
function $handleError(controller, url, t){
  ...
  $location_0[stackIndex] = 'RenderReportAction.java:' + '154' , $handleEvent(controller, ($location_0[stackIndex] = 'LoadingStatusAction.java:' + '37' , $clinit_888() , OFF));
  $stackDepth_0 = stackIndex - 1;
}
...
function execute_36(controller, object){
  ...
  builder = ($location_0[stackIndex] = 'RenderReportAction.java:' + '58' , $RequestBuilder(($location_0[stackIndex] = 'RenderReportAction.java:' + '58' , new RequestBuilder), ($location_0[stackIndex] = 'RequestBuilder.java:' + '70' , $clinit_208() , POST), url));
  $location_0[stackIndex] = 'Log.java:' + '101' , $clinit_24();
  $location_0[stackIndex] = 'Log.java:' + '150' , $debug(impl, POST + ': ' + url, null);
  view = ($location_0[stackIndex] = 'RenderReportAction.java:' + '61' , dynamicCast(dynamicCast(($location_0[stackIndex] = 'Controller.java:' + '67' , $get_7(controller.views, ($location_0[stackIndex] = 'ReportLaunchPadView.java:' + '59' , $clinit_1010() , ID_21))), 167), 246));
  ...
  try {
    $location_0[stackIndex] = 'RenderReportAction.java:' + '68' , $handleEvent(controller, ($location_0[stackIndex] = 'LoadingStatusAction.java:' + '36' , $clinit_888() , ON));
    ...
    if (instanceOf($e0, 12)) {
      e = $e0;
      $location_0[stackIndex] = 'RenderReportAction.java:' + '135' , $handleEvent(controller, ($location_0[stackIndex] = 'LoadingStatusAction.java:' + '37' , $clinit_888() , OFF));
...
function onError_6(request, exception){
  ...
  $location_0[stackIndex] = 'RenderReportAction.java:' + '78' , $handleEvent(this.val$controller, ($location_0[stackIndex] = 'LoadingStatusAction.java:' + '37' , $clinit_888() , OFF));
  $stackDepth_0 = stackIndex - 1;
}
...
function onResponseReceived_6(request, response){
  ...
  try {
    ...
    $location_0[stackIndex] = 'RenderReportAction.java:' + '105' , $handleEvent(this.val$controller, ($location_0[stackIndex] = 'LoadingStatusAction.java:' + '37' , $clinit_888() , OFF));
...
function $clinit_1008(){
  ...
  $location_0[stackIndex] = 'RenderReportAction.java:' + '113' , $clinit_1008 = nullMethod;
  $clinit_43();
  $stackDepth_0 = stackIndex - 1;
}
...
function $RenderReportAction$2(this$static, val$request, val$controller, val$url){
  ...
  $location_0[stackIndex] = 'RenderReportAction.java:' + '113' , $clinit_1008();
...
function $clinit_1010(){
  ...
  $location_0[stackIndex] = 'ReportLaunchPadView.java:' + '57' , $clinit_1010 = nullMethod;
...
function $ReportLaunchPadView(this$static){
  ...
  $location_0[stackIndex] = 'ReportLaunchPadView.java:' + '73' , $clinit_1010();
  $MosaicPanel_0(this$static, ($location_0[stackIndex] = 'ReportLaunchPadView.java:' + '75' , $BoxLayout_1(($location_0[stackIndex] = 'ReportLaunchPadView.java:' + '75' , new BoxLayout), ($location_0[stackIndex] = 'BoxLayout.java:' + '170' , $clinit_787() , VERTICAL))));
  ...
  $location_0[stackIndex] = 'ListBox.java:' + '104' , $addDomHandler(this$static.dropBox, $ReportLaunchPadView$1(($location_0[stackIndex] = 'ReportLaunchPadView.java:' + '87' , new ReportLaunchPadView$1), this$static), ($location_0[stackIndex] = 'ListBox.java:' + '104' , $clinit_124() , ($location_0[stackIndex] = 'ChangeEvent.java:' + '27' , $clinit_124()) , TYPE_0));
  $add_26(templatePanel, this$static.dropBox, ($location_0[stackIndex] = 'ReportLaunchPadView.java:' + '96' , $BoxLayoutData_4(($location_0[stackIndex] = 'ReportLaunchPadView.java:' + '96' , new BoxLayoutData), ($location_0[stackIndex] = 'BoxLayoutData.java:' + '30' , $clinit_789() , HORIZONTAL_0))));
...
function fieldValues2PostParams(values){
  ...
  $location_0[stackIndex] = 'ReportLaunchPadView.java:' + '214' , $clinit_1010();
  var key, keys, sb;
...
function $onSumbit(this$static, paramValues){
  ...
  if (valid) {
    ...
    $handleEvent(this$static.this$0.controller, ($location_0[stackIndex] = 'ReportLaunchPadView.java:' + '137' , $Event(($location_0[stackIndex] = 'ReportLaunchPadView.java:' + '137' , new Event_0), ($location_0[stackIndex] = 'RenderReportAction.java:' + '44' , $clinit_1006() , ID_20), eventPayload)));
  }
   else {
    $location_0[stackIndex] = 'ReportLaunchPadView.java:' + '141' , $clinit_676();
    $location_0[stackIndex] = 'MessageBox.java:' + '111' , alert_2(($location_0[stackIndex] = 'MessageBox.java:' + '60' , $clinit_685() , ALERT), 'Report Parameters', 'Please provide the required input parameters');
  }
  $stackDepth_0 = stackIndex - 1;
}
...
function $onSuccess_3(this$static){
  ...
  !this$static.this$0.instance && (this$static.this$0.instance = ($location_0[stackIndex] = 'ReportView.java:' + '42' , $clinit_1020() , ($location_0[stackIndex] = 'ReportModule.java:' + '49' , new ReportView)));
...
function $createForm_0(this$static, reportRef, callback){
  ...
  !hasParameters && ($location_0[stackIndex] = 'ReportParameterForm.java:' + '128' , $add_26(form, $HTML_0(($location_0[stackIndex] = 'ReportParameterForm.java:' + '128' , new HTML), "This report doesn't require any paramters."), ($location_0[stackIndex] = 'ReportParameterForm.java:' + '129' , $GridLayoutData_2(($location_0[stackIndex] = 'ReportParameterForm.java:' + '129' , new GridLayoutData), 2, 1, ($location_0[stackIndex] = 'HasHorizontalAlignment.java:' + '62' , $clinit_380() , ALIGN_CENTER), ($location_0[stackIndex] = 'HasVerticalAlignment.java:' + '73' , $clinit_385() , ALIGN_TOP)))));
  $add_25(form, $HTML_0(($location_0[stackIndex] = 'ReportParameterForm.java:' + '133' , new HTML), ''));
  $add_26(form, createBtn, ($location_0[stackIndex] = 'ReportParameterForm.java:' + '134' , $GridLayoutData_0(($location_0[stackIndex] = 'ReportParameterForm.java:' + '134' , new GridLayoutData), ($location_0[stackIndex] = 'HasHorizontalAlignment.java:' + '74' , $clinit_380() , ALIGN_RIGHT), ($location_0[stackIndex] = 'HasVerticalAlignment.java:' + '61' , $clinit_385() , ALIGN_BOTTOM))));
  $stackDepth_0 = stackIndex - 1;
  return form;
}
...
_.val$textBox = null;
function $clinit_1020(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_1020;
  $location_0[stackIndex] = 'ReportView.java:' + '42' , $clinit_1020 = nullMethod;
...
function $initialize_2(this$static){
  ...
  if (!this$static.isInitialized) {
    ...
    $location_0[stackIndex] = 'ReportView.java:' + '93' , $addView(this$static.controller, ($location_0[stackIndex] = 'ReportLaunchPadView.java:' + '59' , $clinit_1010() , ID_21), this$static.coverpanel);
    $location_0[stackIndex] = 'Controller.java:' + '106' , $put_0(this$static.controller.actions, ($location_0[stackIndex] = 'UpdateSearchDefinitionsAction.java:' + '43' , $clinit_1023() , ID_24), $UpdateSearchDefinitionsAction(($location_0[stackIndex] = 'ReportView.java:' + '95' , new UpdateSearchDefinitionsAction)));
    $location_0[stackIndex] = 'Controller.java:' + '106' , $put_0(this$static.controller.actions, ($location_0[stackIndex] = 'RenderReportAction.java:' + '44' , $clinit_1006() , ID_20), $RenderReportAction(($location_0[stackIndex] = 'ReportView.java:' + '96' , new RenderReportAction)));
...
function $provideWidget_4(this$static, callback){
  ...
  $location_0[stackIndex] = 'Controller.java:' + '106' , $put_0(this$static.controller.actions, ($location_0[stackIndex] = 'UpdateReportConfigAction.java:' + '48' , $clinit_1022() , ID_23), $UpdateReportConfigAction(($location_0[stackIndex] = 'ReportView.java:' + '61' , new UpdateReportConfigAction)));
...
function $clinit_1021(){
  ...
  $location_0[stackIndex] = 'ReportView.java:' + '65' , $clinit_1021 = nullMethod;
  $clinit_43();
  $stackDepth_0 = stackIndex - 1;
}
...
function $ReportView$1(this$static, this$0){
  ...
  $location_0[stackIndex] = 'ReportView.java:' + '65' , $clinit_1021();
...
function run_21(){
  ...
  $handleEvent(this.this$0.controller, ($location_0[stackIndex] = 'ReportView.java:' + '70' , $Event(($location_0[stackIndex] = 'ReportView.java:' + '70' , new Event_0), ($location_0[stackIndex] = 'UpdateReportConfigAction.java:' + '48' , $clinit_1022() , ID_23), null)));
  $stackDepth_0 = stackIndex - 1;
}
...
function $clinit_1022(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_1022;
  $location_0[stackIndex] = 'UpdateReportConfigAction.java:' + '45' , $clinit_1022 = nullMethod;
...
function $UpdateReportConfigAction(this$static){
  ...
  $location_0[stackIndex] = 'UpdateReportConfigAction.java:' + '51' , $clinit_1022();
...
function handleSuccessfulResponse_11(controller, event_0, response){
  ...
  view = ($location_0[stackIndex] = 'UpdateReportConfigAction.java:' + '76' , dynamicCast(dynamicCast(($location_0[stackIndex] = 'Controller.java:' + '67' , $get_7(controller.views, ($location_0[stackIndex] = 'ReportView.java:' + '44' , $clinit_1020() , ID_22))), 167), 250));
...
function $clinit_1023(){
  ...
  $location_0[stackIndex] = 'UpdateSearchDefinitionsAction.java:' + '41' , $clinit_1023 = nullMethod;
...
function $UpdateSearchDefinitionsAction(this$static){
  ...
  $location_0[stackIndex] = 'UpdateSearchDefinitionsAction.java:' + '41' , $clinit_1023();
  dynamicCast(($location_0[stackIndex] = 'AbstractRESTAction.java:' + '44' , get_16(Lorg_jboss_bpm_console_client_ApplicationContext_2_classLit)), 224);
  $stackDepth_0 = stackIndex - 1;
  return this$static;
}
...
function $ReportParameter(this$static, name_0, type){
  ...
  $location_0[stackIndex] = 'ReportParameter.java:' + '37' , this$static.dataType = ($location_0[stackIndex] = 'ReportParameter.java:' + '30' , $clinit_1079() , STRING);
...
function $clinit_1079(){
  ...
  $location_0[stackIndex] = 'ReportParameter.java:' + '30' , $clinit_1079 = nullMethod;
...
function $ReportParameter$DataType(this$static, enum$name, enum$ordinal){
  ...
  $location_0[stackIndex] = 'ReportParameter.java:' + '30' , $clinit_1079();
...
function values_27(){
  ...
  $location_0[stackIndex] = 'ReportParameter.java:' + '30' , $clinit_1079();
  returnTemp = initValues(_3Lorg_jboss_bpm_report_model_ReportParameter$DataType_2_classLit, 710, 111, [STRING, NUMBER, DATETIME, BOOLEAN, ANY]);
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function $clinit_1080(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_1080;
  $location_0[stackIndex] = 'ReportParameter.java:' + '29' , $clinit_1080 = nullMethod;
...
function $ReportParameter$Type(this$static, enum$name, enum$ordinal){
  ...
  $location_0[stackIndex] = 'ReportParameter.java:' + '29' , $clinit_1080();
  $location_0[stackIndex] = 'Enum.java:' + '76' , this$static.name_0 = enum$name;
  $location_0[stackIndex] = 'Enum.java:' + '77' , this$static.ordinal = enum$ordinal;
  $stackDepth_0 = stackIndex - 1;
  return this$static;
...
function values_28(){
  ...
  $location_0[stackIndex] = 'ReportParameter.java:' + '29' , $clinit_1080();
  returnTemp = initValues(_3Lorg_jboss_bpm_report_model_ReportParameter$Type_2_classLit, 711, 112, [LISTBOX, TEXTBOX, CHECKBOX_0, RADIO_BUTTON]);
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
