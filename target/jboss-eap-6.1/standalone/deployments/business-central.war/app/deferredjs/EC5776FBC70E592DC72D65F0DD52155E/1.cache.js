...
function onLoad(){
  ...
  instance_2 = ($location_0[stackIndex] = 'AsyncLoader1.java:' + '5' , $clinit_255() , ($location_0[stackIndex] = 'AsyncLoader1.java:' + '22' , new AsyncLoader1));
...
function $clinit_895(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_895;
  $location_0[stackIndex] = 'LoginView.java:' + '172' , $clinit_895 = nullMethod;
  $clinit_43();
  $stackDepth_0 = stackIndex - 1;
}

function getClass_601(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_601;
  $stackDepth_0 = stackIndex - 1;
...
function getClass_602(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_602;
  $stackDepth_0 = stackIndex - 1;
