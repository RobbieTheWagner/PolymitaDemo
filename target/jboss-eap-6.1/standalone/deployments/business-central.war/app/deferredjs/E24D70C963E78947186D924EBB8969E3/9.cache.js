...
function runAsync_0(callback){
  ...
  $location_0[stackIndex] = 'AsyncLoader2.java:' + '28' , $clinit_263();
  var newCallback;
...
function runCallbackOnFailures_0(e){
  ...
  $location_0[stackIndex] = 'AsyncLoader2.java:' + '72' , $clinit_263();
...
function loadFailed_2(reason){
  ...
  $location_0[stackIndex] = 'AsyncLoader2.java:' + '9' , $clinit_263();
...
function runAsync_1(callback){
  ...
  $location_0[stackIndex] = 'AsyncLoader3.java:' + '28' , $clinit_267();
  var newCallback;
...
function runCallbackOnFailures_1(e){
  ...
  $location_0[stackIndex] = 'AsyncLoader3.java:' + '72' , $clinit_267();
...
function loadFailed_3(reason){
  ...
  $location_0[stackIndex] = 'AsyncLoader3.java:' + '9' , $clinit_267();
...
function runAsync_2(callback){
  ...
  $location_0[stackIndex] = 'AsyncLoader4.java:' + '28' , $clinit_271();
  var newCallback;
...
function runCallbackOnFailures_2(e){
  ...
  $location_0[stackIndex] = 'AsyncLoader4.java:' + '72' , $clinit_271();
...
function loadFailed_4(reason){
  ...
  $location_0[stackIndex] = 'AsyncLoader4.java:' + '9' , $clinit_271();
...
function runAsync_3(callback){
  ...
  $location_0[stackIndex] = 'AsyncLoader5.java:' + '28' , $clinit_275();
  var newCallback;
...
function runCallbackOnFailures_3(e){
  ...
  $location_0[stackIndex] = 'AsyncLoader5.java:' + '72' , $clinit_275();
...
function loadFailed_5(reason){
  ...
  $location_0[stackIndex] = 'AsyncLoader5.java:' + '9' , $clinit_275();
...
function runAsync_4(callback){
  ...
  $location_0[stackIndex] = 'AsyncLoader6.java:' + '28' , $clinit_279();
  var newCallback;
...
function runCallbackOnFailures_4(e){
  ...
  $location_0[stackIndex] = 'AsyncLoader6.java:' + '72' , $clinit_279();
...
function loadFailed_6(reason){
  ...
  $location_0[stackIndex] = 'AsyncLoader6.java:' + '9' , $clinit_279();
...
function runAsync_5(callback){
  ...
  $location_0[stackIndex] = 'AsyncLoader7.java:' + '28' , $clinit_283();
  var newCallback;
...
function runCallbackOnFailures_5(e){
  ...
  $location_0[stackIndex] = 'AsyncLoader7.java:' + '72' , $clinit_283();
...
function loadFailed_7(reason){
  ...
  $location_0[stackIndex] = 'AsyncLoader7.java:' + '9' , $clinit_283();
...
function onLoad_7(){
  ...
  instance_10 = ($location_0[stackIndex] = 'AsyncLoader9.java:' + '5' , $clinit_289() , ($location_0[stackIndex] = 'AsyncLoader9.java:' + '22' , new AsyncLoader9));
...
function $newItem(this$static, historyToken, issueEvent){
  ...
  if (!($location_0[stackIndex] = 'HistoryImpl.java:' + '114' , $equals_4(historyToken, $wnd.__gwt_historyToken || ''))) {
    ...
    $wnd.location.hash = ($location_0[stackIndex] = 'HistoryImplIE6.java:' + '203' , this$static.encodeFragment(historyToken));
    $location_0[stackIndex] = 'HistoryImplIE6.java:' + '98' , $navigateFrame(this$static, historyToken);
...
function $DecoratedTabLayoutPanel(this$static){
  ...
  $location_0[stackIndex] = 'DecoratedTabLayoutPanel.java:' + '39' , $TabLayoutPanel(this$static, ($location_0[stackIndex] = 'TabLayoutPanel.java:' + '65' , $clinit_734() , TOP), true, false);
  $stackDepth_0 = stackIndex - 1;
  return this$static;
}
...
function $add_27(this$static, w, stackText, asHTML){
  ...
  $location_0[stackIndex] = 'Caption.java:' + '133' , $addDomHandler(caption, this$static.clickHandler, ($location_0[stackIndex] = 'Caption.java:' + '133' , $clinit_130() , ($location_0[stackIndex] = 'ClickEvent.java:' + '27' , $clinit_130()) , TYPE_1));
  ...
  $add_26(layoutPanel, caption, ($location_0[stackIndex] = 'StackLayoutPanel.java:' + '128' , $BoxLayoutData_4(($location_0[stackIndex] = 'StackLayoutPanel.java:' + '128' , new BoxLayoutData), ($location_0[stackIndex] = 'BoxLayoutData.java:' + '30' , $clinit_804() , HORIZONTAL_0))));
...
function $setBounds_0(this$static, x, y, width, height){
  ...
  $location_0[stackIndex] = 'Viewport.java:' + '115' , $clinit_436();
...
function $clinit_738(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_738;
  $location_0[stackIndex] = 'Viewport.java:' + '42' , $clinit_738 = nullMethod;
  $clinit_43();
  $stackDepth_0 = stackIndex - 1;
}
...
function $Viewport$1(this$static, this$0){
  ...
  $location_0[stackIndex] = 'Viewport.java:' + '42' , $clinit_738();
  ...
  if (collapse) {
    if (widget == this$static.west || widget == this$static.east || widget == this$static.north || widget == this$static.south) {
      if (!layoutData.collapsedStateWidget) {
        ...
        if (layoutData.region == ($location_0[stackIndex] = 'BorderLayout.java:' + '199' , $clinit_795() , NORTH_0)) {
          imgBtn = ($location_0[stackIndex] = 'BorderLayout.java:' + '705' , $ImageButton(($location_0[stackIndex] = 'BorderLayout.java:' + '705' , new ImageButton), ($clinit_655() , ($location_0[stackIndex] = 'CaptionImages_generatedBundle.java:' + '29' , $clinit_657()) , toolCollapseDown_SINGLETON)));
          $location_0[stackIndex] = 'UIObject.java:' + '449' , setStyleName(imgBtn.element, 'NorthCollapsedImageButton', true);
          $location_0[stackIndex] = 'BorderLayout.java:' + '707' , $setHorizontalAlignment_0(imgBtn, ($location_0[stackIndex] = 'HasHorizontalAlignment.java:' + '74' , $clinit_390() , ALIGN_RIGHT));
        }
         else if (layoutData.region == EAST_0) {
          imgBtn = ($location_0[stackIndex] = 'BorderLayout.java:' + '709' , $ImageButton(($location_0[stackIndex] = 'BorderLayout.java:' + '709' , new ImageButton), ($clinit_655() , ($location_0[stackIndex] = 'CaptionImages_generatedBundle.java:' + '33' , $clinit_657()) , toolCollapseLeft_SINGLETON)));
          $location_0[stackIndex] = 'UIObject.java:' + '449' , setStyleName(imgBtn.element, 'EastCollapsedImageButton', true);
          $location_0[stackIndex] = 'BorderLayout.java:' + '711' , $setVerticalAlignment_0(imgBtn, ($location_0[stackIndex] = 'HasVerticalAlignment.java:' + '73' , $clinit_395() , ALIGN_TOP));
        }
         else if (layoutData.region == SOUTH_0) {
          imgBtn = ($location_0[stackIndex] = 'BorderLayout.java:' + '713' , $ImageButton(($location_0[stackIndex] = 'BorderLayout.java:' + '713' , new ImageButton), ($clinit_655() , ($location_0[stackIndex] = 'CaptionImages_generatedBundle.java:' + '41' , $clinit_657()) , toolCollapseUp_SINGLETON)));
          $location_0[stackIndex] = 'UIObject.java:' + '449' , setStyleName(imgBtn.element, 'SouthCollapsedImageButton', true);
          $location_0[stackIndex] = 'BorderLayout.java:' + '715' , $setHorizontalAlignment_0(imgBtn, ($location_0[stackIndex] = 'HasHorizontalAlignment.java:' + '74' , $clinit_390() , ALIGN_RIGHT));
        }
         else if (layoutData.region == WEST_0) {
          imgBtn = ($location_0[stackIndex] = 'BorderLayout.java:' + '717' , $ImageButton(($location_0[stackIndex] = 'BorderLayout.java:' + '717' , new ImageButton), ($clinit_655() , ($location_0[stackIndex] = 'CaptionImages_generatedBundle.java:' + '37' , $clinit_657()) , toolCollapseRight_SINGLETON)));
          $location_0[stackIndex] = 'UIObject.java:' + '449' , setStyleName(imgBtn.element, 'WestCollapsedImageButton', true);
          $location_0[stackIndex] = 'BorderLayout.java:' + '719' , $setVerticalAlignment_0(imgBtn, ($location_0[stackIndex] = 'HasVerticalAlignment.java:' + '73' , $clinit_395() , ALIGN_TOP));
        }
        if (!imgBtn) {
          $stackDepth_0 = stackIndex - 1;
          return;
        }
        $location_0[stackIndex] = 'ImageButton.java:' + '58' , $addDomHandler(imgBtn, $BorderLayout$1(($location_0[stackIndex] = 'BorderLayout.java:' + '724' , new BorderLayout$1), layoutPanel, widget), ($location_0[stackIndex] = 'ImageButton.java:' + '58' , $clinit_130() , ($location_0[stackIndex] = 'ClickEvent.java:' + '27' , $clinit_130()) , TYPE_1));
...
function getClass_506(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_506;
  $stackDepth_0 = stackIndex - 1;
...
function $processIcon(){
  ...
  !processIcon && (processIcon = $ImageResourcePrototype(($location_0[stackIndex] = 'org_jboss_bpm_console_client_icons_ConsoleIconBundle_default_StaticClientBundleGenerator.java:' + '179' , new ImageResourcePrototype), internedUrl0_2, 160, 0, 16, 16));
  $stackDepth_0 = stackIndex - 1;
  return processIcon;
}
...
_.typeId$ = 0;
_.val$callback = null;
function getClass_714(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_714;
  $stackDepth_0 = stackIndex - 1;
...
function getClass_715(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_715;
  $stackDepth_0 = stackIndex - 1;
...
function $WSLaunchButton(this$static, resource, name_0){
  ...
  $LayoutPanel_1(this$static, ($location_0[stackIndex] = 'WSLaunchButton.java:' + '45' , $BoxLayout_1(($location_0[stackIndex] = 'WSLaunchButton.java:' + '45' , new BoxLayout), ($location_0[stackIndex] = 'BoxLayout.java:' + '170' , $clinit_802() , VERTICAL))));
  ...
  html = $HTML_0(($location_0[stackIndex] = 'WSLaunchButton.java:' + '52' , new HTML), '&nbsp;&nbsp;' + ($location_0[stackIndex] = 'WSLaunchButton.java:' + '52' , $getHTML_1($ClippedImagePrototype(($location_0[stackIndex] = 'AbstractImagePrototype.java:' + '73' , new ClippedImagePrototype), resource.url, resource.left_0, resource.top_0, resource.width_0, resource.height_0))) + '&nbsp;<span class="WSLaunchButton-contents"> ' + this$static.name_0 + '<\/span>');
  $add_26(this$static, html, ($location_0[stackIndex] = 'WSLaunchButton.java:' + '53' , $BoxLayoutData_4(($location_0[stackIndex] = 'WSLaunchButton.java:' + '53' , new BoxLayoutData), ($location_0[stackIndex] = 'BoxLayoutData.java:' + '30' , $clinit_804() , VERTICAL_0))));
...
function getClass_858(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_858;
  $stackDepth_0 = stackIndex - 1;
...
function $createLogPanel(parent_0){
  ...
  collapseBtn = ($location_0[stackIndex] = 'Application.java:' + '319' , $ImageButton(($location_0[stackIndex] = 'Application.java:' + '319' , new ImageButton), ($clinit_655() , ($location_0[stackIndex] = 'CaptionImages_generatedBundle.java:' + '29' , $clinit_657()) , toolCollapseDown_SINGLETON)));
  $location_0[stackIndex] = 'Application.java:' + '320' , $add_17(messagePanel.caption, collapseBtn, ($location_0[stackIndex] = 'Caption.java:' + '61' , $clinit_656() , RIGHT));
  $location_0[stackIndex] = 'ImageButton.java:' + '58' , $addDomHandler(collapseBtn, $Application$6(($location_0[stackIndex] = 'Application.java:' + '322' , new Application$6), parent_0, messagePanel), ($location_0[stackIndex] = 'ImageButton.java:' + '58' , $clinit_130() , ($location_0[stackIndex] = 'ClickEvent.java:' + '27' , $clinit_130()) , TYPE_1));
  $stackDepth_0 = stackIndex - 1;
  return messagePanel;
}
...
function $initializeUI(this$static){
  ...
  $add_26(this$static.mainLayout, this$static.menu, ($location_0[stackIndex] = 'Application.java:' + '203' , $BorderLayoutData_4(($location_0[stackIndex] = 'Application.java:' + '203' , new BorderLayoutData), ($location_0[stackIndex] = 'BorderLayout.java:' + '199' , $clinit_795() , WEST_0), '180 px', false)));
  ...
  $location_0[stackIndex] = 'WorkspaceBuilder.java:' + '40' , $clinit_1254();
  ...
  $location_0[stackIndex] = 'Application.java:' + '220' , $clinit_436();
...
function execute_44(){
  ...
  if (null == initialToolSet) {
    $location_0[stackIndex] = 'Application.java:' + '244' , preferedTool = ($location_0[stackIndex] = 'CookiePreferences.java:' + '39' , getCookie('workspace.default.tool')) != null?($location_0[stackIndex] = 'Application.java:' + '245' , $clinit_1234() , 'ToolSet_' + ($location_0[stackIndex] = 'Workspace.java:' + '266' , $replace_0(($location_0[stackIndex] = 'CookiePreferences.java:' + '39' , getCookie('workspace.default.tool')), ' ', '_'))):null;
    if (preferedTool != null && !!($location_0[stackIndex] = 'Workspace.java:' + '158' , $findToolSet(this.this$0.workspace, preferedTool))) {
      ...
      $location_0[stackIndex] = 'Application.java:' + '254' , toolSets = ($location_0[stackIndex] = 'Workspace.java:' + '61' , $clinit_1234() , toolSets_0);
...
function getClass_867(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_867;
  $stackDepth_0 = stackIndex - 1;
...
function getClass_868(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_868;
  $stackDepth_0 = stackIndex - 1;
...
function getClass_869(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_869;
  $stackDepth_0 = stackIndex - 1;
...
function $Menu(this$static){
  ...
  $LayoutPanel_1(this$static, ($location_0[stackIndex] = 'Menu.java:' + '40' , $BoxLayout_1(($location_0[stackIndex] = 'Menu.java:' + '40' , new BoxLayout), ($location_0[stackIndex] = 'BoxLayout.java:' + '170' , $clinit_802() , VERTICAL))));
  ...
  $add_26(this$static, this$static.stack, ($location_0[stackIndex] = 'Menu.java:' + '46' , $BoxLayoutData_5(($location_0[stackIndex] = 'Menu.java:' + '46' , new BoxLayoutData), ($location_0[stackIndex] = 'BoxLayoutData.java:' + '30' , $clinit_804() , BOTH), true)));
  $stackDepth_0 = stackIndex - 1;
  return this$static;
}
...
_.typeId$ = 597;
_.this$0 = null;
function $clinit_1233(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_1233;
  $location_0[stackIndex] = 'Viewport.java:' + '42' , $clinit_1233 = nullMethod;
  $clinit_43();
  $stackDepth_0 = stackIndex - 1;
}
...
function $Viewport$1$1(this$static, this$1){
  ...
  $location_0[stackIndex] = 'Viewport.java:' + '42' , $clinit_1233();
...
function $Workspace(this$static, menu){
  ...
  $location_0[stackIndex] = 'Workspace.java:' + '76' , $clinit_1234();
  ...
  $location_0[stackIndex] = 'Workspace.java:' + '82' , $clinit_1097();
...
function $showToolSet(this$static, toolSetId, toolId){
  ...
  if (!isOpen) {
    ...
    $location_0[stackIndex] = 'org_jboss_errai_workspaces_client_icons_ErraiImageBundle_default_StaticClientBundleGenerator.java:' + '6' , $clinit_1259();
...
function createInstance(menu){
  ...
  $location_0[stackIndex] = 'Workspace.java:' + '65' , $clinit_1234();
...
function splitHistoryToken(tokenString){
  ...
  $location_0[stackIndex] = 'Workspace.java:' + '135' , $clinit_1234();
  var s, token;
...
function callback_13(message){
  ...
  switch (($location_0[stackIndex] = 'LayoutCommands.java:' + '20' , $clinit_1273() , ($location_0[stackIndex] = 'LayoutCommands.java:' + '20' , valueOf_0(enum$map_6, ($location_0[stackIndex] = 'Workspace.java:' + '86' , message.getCommandType())))).ordinal) {
    case 7:
      toolsetId = dynamicCast(($location_0[stackIndex] = 'Workspace.java:' + '88' , message.get_2(Ljava_lang_String_2_classLit, ($location_0[stackIndex] = 'LayoutParts.java:' + '22' , $clinit_1274() , TOOLSET))), 1);
...
function $ResourceFactoryImpl(this$static){
  ...
  $location_0[stackIndex] = 'ResourceFactoryImpl.java:' + '14' , $put_0(this$static.mapping, 'Group Tasks', (!taskIcon && (taskIcon = $ImageResourcePrototype(($location_0[stackIndex] = 'org_jboss_bpm_console_client_icons_ConsoleIconBundle_default_StaticClientBundleGenerator.java:' + '259' , new ImageResourcePrototype), internedUrl0_2, 112, 0, 16, 16)) , taskIcon));
  $location_0[stackIndex] = 'ResourceFactoryImpl.java:' + '15' , $put_0(this$static.mapping, 'Jobs', (!jobsIcon && (jobsIcon = $ImageResourcePrototype(($location_0[stackIndex] = 'org_jboss_bpm_console_client_icons_ConsoleIconBundle_default_StaticClientBundleGenerator.java:' + '149' , new ImageResourcePrototype), internedUrl0_2, 176, 0, 16, 16)) , jobsIcon));
  $location_0[stackIndex] = 'ResourceFactoryImpl.java:' + '16' , $put_0(this$static.mapping, 'Personal Tasks', (!userIcon && (userIcon = $ImageResourcePrototype(($location_0[stackIndex] = 'org_jboss_bpm_console_client_icons_ConsoleIconBundle_default_StaticClientBundleGenerator.java:' + '269' , new ImageResourcePrototype), internedUrl0_2, 96, 16, 16, 16)) , userIcon));
  $location_0[stackIndex] = 'ResourceFactoryImpl.java:' + '17' , $put_0(this$static.mapping, 'History Query', (!historySearchIcon && (historySearchIcon = $ImageResourcePrototype(($location_0[stackIndex] = 'org_jboss_bpm_console_client_icons_ConsoleIconBundle_default_StaticClientBundleGenerator.java:' + '119' , new ImageResourcePrototype), internedUrl0_2, 192, 0, 16, 16)) , historySearchIcon));
  $location_0[stackIndex] = 'ResourceFactoryImpl.java:' + '18' , $put_0(this$static.mapping, 'Preferences', (!runtimeIcon && (runtimeIcon = $ImageResourcePrototype(($location_0[stackIndex] = 'org_jboss_bpm_console_client_icons_ConsoleIconBundle_default_StaticClientBundleGenerator.java:' + '239' , new ImageResourcePrototype), internedUrl0_2, 128, 0, 16, 16)) , runtimeIcon));
  ...
  $location_0[stackIndex] = 'ResourceFactoryImpl.java:' + '21' , $put_0(this$static.mapping, 'Report Templates', (!reportIcon && (reportIcon = $ImageResourcePrototype(($location_0[stackIndex] = 'org_jboss_bpm_console_client_icons_ConsoleIconBundle_default_StaticClientBundleGenerator.java:' + '219' , new ImageResourcePrototype), internedUrl0_2, 144, 0, 16, 16)) , reportIcon));
  $location_0[stackIndex] = 'ResourceFactoryImpl.java:' + '22' , $put_0(this$static.mapping, 'Deployments', (!deploymentIcon && (deploymentIcon = $ImageResourcePrototype(($location_0[stackIndex] = 'org_jboss_bpm_console_client_icons_ConsoleIconBundle_default_StaticClientBundleGenerator.java:' + '59' , new ImageResourcePrototype), internedUrl0_2, 224, 0, 16, 16)) , deploymentIcon));
  $location_0[stackIndex] = 'ResourceFactoryImpl.java:' + '23' , $put_0(this$static.mapping, 'System', (!docIcon && (docIcon = $ImageResourcePrototype(($location_0[stackIndex] = 'org_jboss_bpm_console_client_icons_ConsoleIconBundle_default_StaticClientBundleGenerator.java:' + '69' , new ImageResourcePrototype), internedUrl0_2, 208, 16, 16, 16)) , docIcon));
  $location_0[stackIndex] = 'ResourceFactoryImpl.java:' + '24' , $put_0(this$static.mapping, 'Execution History', (!databaseIcon && (databaseIcon = $ImageResourcePrototype(($location_0[stackIndex] = 'org_jboss_bpm_console_client_icons_ConsoleIconBundle_default_StaticClientBundleGenerator.java:' + '49' , new ImageResourcePrototype), internedUrl0_2, 224, 16, 16, 16)) , databaseIcon));
  $stackDepth_0 = stackIndex - 1;
  return this$static;
}
...
_.id_0 = null;
_.name_0 = null;
function $clinit_1254(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_1254;
  $location_0[stackIndex] = 'WorkspaceBuilder.java:' + '40' , $clinit_1254 = nullMethod;
  $location_0[stackIndex] = 'org_jboss_errai_workspaces_client_icons_ErraiImageBundle_default_StaticClientBundleGenerator.java:' + '6' , $clinit_1259();
...
function getAllProvidedTools(){
  ...
  toolArray = ($location_0[stackIndex] = 'WorkspaceBuilder.java:' + '176' , initDim(_3Lorg_jboss_errai_workspaces_client_api_Tool_2_classLit, 722, 120, this.val$toBeRendered.size_0, 0));
...
function getAllProvidedTools_0(){
  ...
  toolArray = ($location_0[stackIndex] = 'WorkspaceBuilder.java:' + '216' , initDim(_3Lorg_jboss_errai_workspaces_client_api_Tool_2_classLit, 722, 120, this.val$toBeRendered.size_0, 0));
...
function $application(){
  ...
  !application && (application = $ImageResourcePrototype(($location_0[stackIndex] = 'org_jboss_errai_workspaces_client_icons_ErraiImageBundle_default_StaticClientBundleGenerator.java:' + '9' , new ImageResourcePrototype), internedUrl0_3, 64, 0, 16, 16));
  $stackDepth_0 = stackIndex - 1;
  return application;
}
...
_.typeId$ = 611;
function $clinit_1274(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_1274;
  $location_0[stackIndex] = 'LayoutParts.java:' + '20' , $clinit_1274 = nullMethod;
...
function $LayoutParts(this$static, enum$name, enum$ordinal){
  ...
  $location_0[stackIndex] = 'LayoutParts.java:' + '20' , $clinit_1274();
...
function values_36(){
  ...
  $location_0[stackIndex] = 'LayoutParts.java:' + '20' , $clinit_1274();
  returnTemp = initValues(_3Lorg_jboss_errai_workspaces_client_protocols_LayoutParts_2_classLit, 725, 123, [CommandType_0, ComponentID, InstanceID, Name_1, MultipleInstances, IconURI, Subject_0, DOMID, RespondWithCommand, NestedData, Width, Height, SizeHintsSubject, InitSubject, TOOLSET, TOOL]);
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function $clinit_1276(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_1276;
  $location_0[stackIndex] = 'WorkspaceLogger.java:' + '44' , $clinit_1276 = nullMethod;
  levels = ($location_0[stackIndex] = 'WorkspaceLogger.java:' + '48' , initValues(_3I_classLit, 672, -1, [5000, 10000, 20000, 30000, 40000, 50000, 2147483647]));
  $stackDepth_0 = stackIndex - 1;
}
...
function $WorkspaceLogger(this$static, notification){
  ...
  $location_0[stackIndex] = 'WorkspaceLogger.java:' + '77' , $clinit_1276();
  ...
  $location_0[stackIndex] = 'WorkspaceLogger.java:' + '81' , $addStyleName(this$static.logDockPanel, (!css_1 && (css_1 = ($location_0[stackIndex] = 'com_allen_sauer_gwt_log_client_impl_LogClientBundle_default_StaticClientBundleGenerator.java:' + '9' , new com_allen_sauer_gwt_log_client_impl_LogClientBundle_default_StaticClientBundleGenerator$1)) , 'log-panel'));
  $location_0[stackIndex] = 'WorkspaceLogger.java:' + '82' , $addStyleName(this$static.logTextArea, (!css_1 && (css_1 = ($location_0[stackIndex] = 'com_allen_sauer_gwt_log_client_impl_LogClientBundle_default_StaticClientBundleGenerator.java:' + '9' , new com_allen_sauer_gwt_log_client_impl_LogClientBundle_default_StaticClientBundleGenerator$1)) , 'Gtuw1jkDB'));
  $location_0[stackIndex] = 'WorkspaceLogger.java:' + '83' , $addStyleName(this$static.scrollPanel, (!css_1 && (css_1 = ($location_0[stackIndex] = 'com_allen_sauer_gwt_log_client_impl_LogClientBundle_default_StaticClientBundleGenerator.java:' + '9' , new com_allen_sauer_gwt_log_client_impl_LogClientBundle_default_StaticClientBundleGenerator$1)) , 'Gtuw1jkBB'));
  headerPanel = ($location_0[stackIndex] = 'WorkspaceLogger.java:' + '87' , $makeHeader(this$static));
  $add_26(this$static.logDockPanel, headerPanel, ($location_0[stackIndex] = 'WorkspaceLogger.java:' + '89' , $BorderLayoutData_4(($location_0[stackIndex] = 'WorkspaceLogger.java:' + '89' , new BorderLayoutData), ($location_0[stackIndex] = 'BorderLayout.java:' + '199' , $clinit_795() , NORTH_0), '30 px', false)));
...
function $makeHeader(this$static){
  ...
  $location_0[stackIndex] = 'WorkspaceLogger.java:' + '230' , $setStylePrimaryName(titleLabel, (!css_1 && (css_1 = ($location_0[stackIndex] = 'com_allen_sauer_gwt_log_client_impl_LogClientBundle_default_StaticClientBundleGenerator.java:' + '9' , new com_allen_sauer_gwt_log_client_impl_LogClientBundle_default_StaticClientBundleGenerator$1)) , 'Gtuw1jkEB'));
  buttonPanel = $HorizontalPanel(($location_0[stackIndex] = 'WorkspaceLogger.java:' + '232' , new HorizontalPanel));
  this$static.levelButtons = ($location_0[stackIndex] = 'WorkspaceLogger.java:' + '233' , initDim(_3Lcom_google_gwt_user_client_ui_Button_2_classLit, 658, 62, levels.length, 0));
  for ($location_0[stackIndex] = 'WorkspaceLogger.java:' + '234' , i = 0; i < levels.length; $location_0[stackIndex] = 'WorkspaceLogger.java:' + '234' , ++i) {
    ...
    $location_0[stackIndex] = 'FocusWidget.java:' + '91' , $addDomHandler(($location_0[stackIndex] = 'WorkspaceLogger.java:' + '238' , this$static.levelButtons[i]), $WorkspaceLogger$2(new WorkspaceLogger$2, level), ($location_0[stackIndex] = 'FocusWidget.java:' + '91' , $clinit_130() , ($location_0[stackIndex] = 'ClickEvent.java:' + '27' , $clinit_130()) , TYPE_1));
  }
  clearButton = $Button(($location_0[stackIndex] = 'WorkspaceLogger.java:' + '246' , new Button), 'Clear');
  $location_0[stackIndex] = 'WorkspaceLogger.java:' + '247' , $addStyleName(clearButton, (!css_1 && (css_1 = ($location_0[stackIndex] = 'com_allen_sauer_gwt_log_client_impl_LogClientBundle_default_StaticClientBundleGenerator.java:' + '9' , new com_allen_sauer_gwt_log_client_impl_LogClientBundle_default_StaticClientBundleGenerator$1)) , 'Gtuw1jkM'));
  $location_0[stackIndex] = 'Style.java:' + '1449' , clearButton.element.style['color'] = '#00c';
  $location_0[stackIndex] = 'FocusWidget.java:' + '91' , $addDomHandler(clearButton, ($location_0[stackIndex] = 'WorkspaceLogger.java:' + '249' , new WorkspaceLogger$3), ($location_0[stackIndex] = 'FocusWidget.java:' + '91' , $clinit_130() , ($location_0[stackIndex] = 'ClickEvent.java:' + '27' , $clinit_130()) , TYPE_1));
...
function $clinit_1277(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_1277;
  $location_0[stackIndex] = 'WorkspaceLogger.java:' + '96' , $clinit_1277 = nullMethod;
  $clinit_43();
  $stackDepth_0 = stackIndex - 1;
}
...
function $WorkspaceLogger$1(this$static, this$0){
  ...
  $location_0[stackIndex] = 'WorkspaceLogger.java:' + '96' , $clinit_1277();
  this$static.this$0 = this$0;
  $stackDepth_0 = stackIndex - 1;
  return this$static;
}
...
function execute_50(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = execute_50;
...
function $WSToolSetLauncher(this$static, id, toolSet){
  ...
  $LayoutPanel_1(this$static, ($location_0[stackIndex] = 'WSToolSetLauncher.java:' + '52' , $BoxLayout_1(($location_0[stackIndex] = 'WSToolSetLauncher.java:' + '52' , new BoxLayout), ($location_0[stackIndex] = 'BoxLayout.java:' + '170' , $clinit_802() , VERTICAL))));
  $location_0[stackIndex] = 'org_jboss_errai_workspaces_client_icons_ErraiImageBundle_default_StaticClientBundleGenerator.java:' + '6' , $clinit_1259();
...
function $addLink(this$static, name_0, tool){
  ...
  $add_26(this$static, button, ($location_0[stackIndex] = 'WSToolSetLauncher.java:' + '100' , $BoxLayoutData_4(($location_0[stackIndex] = 'WSToolSetLauncher.java:' + '100' , new BoxLayoutData), ($location_0[stackIndex] = 'BoxLayoutData.java:' + '30' , $clinit_804() , HORIZONTAL_0))));
  $stackDepth_0 = stackIndex - 1;
}
