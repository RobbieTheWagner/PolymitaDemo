...
function $scrollIntoView_0(elem){
  var left = elem.offsetLeft, top_0 = elem.offsetTop, stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $scrollIntoView_0;
  var width = elem.offsetWidth, height = elem.offsetHeight;
  if (elem.parentNode != elem.offsetParent) {
    $location_0[stackIndex] = 'DOMImpl.java:' + '278' , left -= elem.parentNode.offsetLeft;
    $location_0[stackIndex] = 'DOMImpl.java:' + '279' , top_0 -= elem.parentNode.offsetTop;
  }
  var cur = elem.parentNode;
  while (cur && cur.nodeType == 1) {
    left < cur.scrollLeft && ($location_0[stackIndex] = 'DOMImpl.java:' + '285' , cur.scrollLeft = left);
    left + width > cur.scrollLeft + cur.clientWidth && ($location_0[stackIndex] = 'DOMImpl.java:' + '288' , cur.scrollLeft = left + width - cur.clientWidth);
    top_0 < cur.scrollTop && ($location_0[stackIndex] = 'DOMImpl.java:' + '291' , cur.scrollTop = top_0);
    top_0 + height > cur.scrollTop + cur.clientHeight && ($location_0[stackIndex] = 'DOMImpl.java:' + '294' , cur.scrollTop = top_0 + height - cur.clientHeight);
    var offsetLeft = cur.offsetLeft, offsetTop = cur.offsetTop;
    if (cur.parentNode != cur.offsetParent) {
      $location_0[stackIndex] = 'DOMImpl.java:' + '299' , offsetLeft -= cur.parentNode.offsetLeft;
      $location_0[stackIndex] = 'DOMImpl.java:' + '300' , offsetTop -= cur.parentNode.offsetTop;
    }
    $location_0[stackIndex] = 'DOMImpl.java:' + '303' , left += offsetLeft - cur.scrollLeft;
    $location_0[stackIndex] = 'DOMImpl.java:' + '304' , top_0 += offsetTop - cur.scrollTop;
    $location_0[stackIndex] = 'DOMImpl.java:' + '305' , cur = cur.parentNode;
  }
  $stackDepth_0 = stackIndex - 1;
}

function $createSelectElement(doc, multiple){
  var html = multiple?'<SELECT MULTIPLE>':'<SELECT>', stackIndex, returnTemp;
  $stack_0[stackIndex = ++$stackDepth_0] = $createSelectElement;
  returnTemp = ($location_0[stackIndex] = 'DOMImplTrident.java:' + '128' , doc.createElement(html));
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function $dispatchEvent_0(target, evt){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $dispatchEvent_0;
  $location_0[stackIndex] = 'DOMImplTrident.java:' + '138' , target.fireEvent('on' + evt.type, evt);
  $stackDepth_0 = stackIndex - 1;
}
...
function $clinit_128(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_128;
  $location_0[stackIndex] = 'ChangeEvent.java:' + '21' , $clinit_128 = nullMethod;
  TYPE_0 = ($location_0[stackIndex] = 'ChangeEvent.java:' + '27' , $DomEvent$Type(($location_0[stackIndex] = 'ChangeEvent.java:' + '27' , new DomEvent$Type), 'change', ($location_0[stackIndex] = 'ChangeEvent.java:' + '44' , $clinit_128() , ($location_0[stackIndex] = 'ChangeEvent.java:' + '28' , new ChangeEvent))));
  $stackDepth_0 = stackIndex - 1;
}
...
function initDims_0(arrayClasses, typeIdExprs, queryIdExprs, dimExprs, index, count, seedType){
  ...
  $location_0[stackIndex] = 'Array.java:' + '169' , $clinit_248();
...
function $clinit_263(){
  ...
  $location_0[stackIndex] = 'AsyncLoader2.java:' + '5' , $clinit_263 = nullMethod;
...
function $clinit_267(){
  ...
  $location_0[stackIndex] = 'AsyncLoader3.java:' + '5' , $clinit_267 = nullMethod;
...
function $clinit_271(){
  ...
  $location_0[stackIndex] = 'AsyncLoader4.java:' + '5' , $clinit_271 = nullMethod;
...
function $clinit_275(){
  ...
  $location_0[stackIndex] = 'AsyncLoader5.java:' + '5' , $clinit_275 = nullMethod;
...
function $clinit_279(){
  ...
  $location_0[stackIndex] = 'AsyncLoader6.java:' + '5' , $clinit_279 = nullMethod;
...
function $clinit_283(){
  ...
  $location_0[stackIndex] = 'AsyncLoader7.java:' + '5' , $clinit_283 = nullMethod;
...
function $clinit_299(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_299;
  $location_0[stackIndex] = 'AbstractWindowClosingEvent.java:' + '27' , $clinit_299 = nullMethod;
  $clinit_298();
  $stackDepth_0 = stackIndex - 1;
}
...
function sinkEvents_0(elem, eventBits){
  ...
  $location_0[stackIndex] = 'DOMImplTrident.java:' + '196' , $maybeInitializeEventSystem();
  $location_0[stackIndex] = 'DOMImplTrident.java:' + '197' , $sinkEventsImpl(elem, eventBits);
  $stackDepth_0 = stackIndex - 1;
}
...
function $doLogicalClear(this$static){
  ...
  try {
    ...
    this$static.children_0 = $WidgetCollection(($location_0[stackIndex] = 'ComplexPanel.java:' + '224' , new WidgetCollection), this$static);
  }
  $stackDepth_0 = stackIndex - 1;
}
...
function $setPopupPositionAndShow(this$static, callback){
  ...
  $location_0[stackIndex] = 'PopupPanel.java:' + '925' , $setVisible_1(this$static.element, false);
  ...
  $location_0[stackIndex] = 'PopupPanel.java:' + '925' , $setVisible_1(this$static.element, true);
  $stackDepth_0 = stackIndex - 1;
}
...
function create_1(resource){
  ...
  returnTemp = $ClippedImagePrototype(($location_0[stackIndex] = 'AbstractImagePrototype.java:' + '73' , new ClippedImagePrototype), resource.url, resource.left_0, resource.top_0, resource.width_0, resource.height_0);
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function addClickHandler(handler){
  ...
  returnTemp = ($location_0[stackIndex] = 'FocusWidget.java:' + '91' , $addDomHandler(this, handler, ($location_0[stackIndex] = 'FocusWidget.java:' + '91' , $clinit_130() , ($location_0[stackIndex] = 'ClickEvent.java:' + '27' , $clinit_130()) , TYPE_1)));
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function $Button_0(this$static, html, listener){
  ...
  $location_0[stackIndex] = 'Button.java:' + '69' , $ButtonBase(this$static, ($location_0[stackIndex] = 'DOMImplTrident.java:' + '32' , ($location_0[stackIndex] = 'Document.java:' + '834' , $clinit_82() , $doc).createElement("<BUTTON type='button'><\/BUTTON>")));
...
function $TabBar(this$static){
  ...
  $location_0[stackIndex] = 'HorizontalPanel.java:' + '106' , this$static.panel.vertAlign = ($location_0[stackIndex] = 'HasVerticalAlignment.java:' + '61' , $clinit_395() , ALIGN_BOTTOM);
...
function $getSelectedTab(this$static){
  ...
  returnTemp = ($location_0[stackIndex] = 'ComplexPanel.java:' + '44' , $indexOf_1(this$static.panel.children_0, this$static.selectedTab)) - 1;
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function $getTabHTML(this$static, index){
  ...
  if (index >= this$static.panel.children_0.size_0 - 2) {
    $stackDepth_0 = stackIndex - 1;
    return null;
  }
  delPanel = ($location_0[stackIndex] = 'TabBar.java:' + '309' , dynamicCast(($location_0[stackIndex] = 'ComplexPanel.java:' + '36' , $get_7(this$static.panel.children_0, index + 1)), 159));
  ...
  if (widget != null && ($location_0[stackIndex] = 'Cast.java:' + '76' , canCast(widget.typeId$, 160))) {
    returnTemp = ($location_0[stackIndex] = 'Element.java:' + '259' , $clinit_82() , ($location_0[stackIndex] = 'TabBar.java:' + '313' , dynamicCast(widget, 160)).element).innerHTML;
    $stackDepth_0 = stackIndex - 1;
    return returnTemp;
  }
   else if (widget != null && ($location_0[stackIndex] = 'Cast.java:' + '76' , canCast(widget.typeId$, 161))) {
    returnTemp = ($location_0[stackIndex] = 'Element.java:' + '266' , $clinit_82() , ($location_0[stackIndex] = 'TabBar.java:' + '315' , dynamicCast(widget, 161)).element).innerText;
    $stackDepth_0 = stackIndex - 1;
    return returnTemp;
  }
   else {
    returnTemp = ($location_0[stackIndex] = 'Element.java:' + '259' , $clinit_82() , ($location_0[stackIndex] = 'TabBar.java:' + '318' , $getParentElement(focusablePanel.element))).innerHTML;
    $stackDepth_0 = stackIndex - 1;
    return returnTemp;
  }
  $stackDepth_0 = stackIndex - 1;
...
function $removeTab(this$static, index){
  ...
  $location_0[stackIndex] = 'TabBar.java:' + '421' , toRemove = ($location_0[stackIndex] = 'ComplexPanel.java:' + '36' , $get_7(this$static.panel.children_0, index + 1));
...
function $selectTab(this$static, index){
  ...
  $location_0[stackIndex] = 'TabBar.java:' + '460' , this$static.selectedTab = ($location_0[stackIndex] = 'ComplexPanel.java:' + '36' , $get_7(this$static.panel.children_0, index + 1));
...
function $selectTabByTabWidget(this$static, tabWidget){
  ...
  $location_0[stackIndex] = 'TabBar.java:' + '597' , numTabs = this$static.panel.children_0.size_0 - 1;
  for ($location_0[stackIndex] = 'TabBar.java:' + '599' , i = 1; i < numTabs; $location_0[stackIndex] = 'TabBar.java:' + '599' , ++i) {
    if (($location_0[stackIndex] = 'ComplexPanel.java:' + '36' , $get_7(this$static.panel.children_0, i)) == tabWidget) {
...
function $clinit_366(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_366;
  $location_0[stackIndex] = 'DecoratedTabBar.java:' + '52' , $clinit_366 = nullMethod;
  TAB_ROW_STYLES = ($location_0[stackIndex] = 'DecoratedTabBar.java:' + '53' , initValues(_3Ljava_lang_String_2_classLit, 687, 1, ['tabTop', 'tabMiddle']));
  $stackDepth_0 = stackIndex - 1;
}
...
function getClass_207(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_207;
  $stackDepth_0 = stackIndex - 1;
...
function addClickHandler_0(handler){
  ...
  returnTemp = ($location_0[stackIndex] = 'Label.java:' + '128' , $addDomHandler(this, handler, ($location_0[stackIndex] = 'Label.java:' + '128' , $clinit_130() , ($location_0[stackIndex] = 'ClickEvent.java:' + '27' , $clinit_130()) , TYPE_1)));
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function $FlowPanel(this$static){
  ...
  this$static.children_0 = $WidgetCollection(($location_0[stackIndex] = 'ComplexPanel.java:' + '28' , new WidgetCollection), this$static);
  $location_0[stackIndex] = 'UIObject.java:' + '799' , this$static.element = $createElement(($location_0[stackIndex] = 'Document.java:' + '252' , $clinit_82() , $doc), 'div');
  $stackDepth_0 = stackIndex - 1;
  return this$static;
}
...
function getClass_214(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_214;
  $stackDepth_0 = stackIndex - 1;
...
function addClickHandler_1(handler){
  ...
  returnTemp = ($location_0[stackIndex] = 'FocusPanel.java:' + '75' , $addDomHandler(this, handler, ($location_0[stackIndex] = 'FocusPanel.java:' + '75' , $clinit_130() , ($location_0[stackIndex] = 'ClickEvent.java:' + '27' , $clinit_130()) , TYPE_1)));
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function getClass_216(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_216;
  $stackDepth_0 = stackIndex - 1;
...
function addClickHandler_2(handler){
  ...
  returnTemp = ($location_0[stackIndex] = 'HTMLTable.java:' + '694' , $addDomHandler(this, handler, ($location_0[stackIndex] = 'HTMLTable.java:' + '694' , $clinit_130() , ($location_0[stackIndex] = 'ClickEvent.java:' + '27' , $clinit_130()) , TYPE_1)));
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function $ensureColumn(this$static, col){
  ...
  $location_0[stackIndex] = 'HTMLTable.java:' + '472' , num = this$static.columnGroup.children.length;
  if (num <= col) {
    ...
    for ($location_0[stackIndex] = 'HTMLTable.java:' + '475' , i = num; i <= col; $location_0[stackIndex] = 'HTMLTable.java:' + '475' , ++i) {
      $location_0[stackIndex] = 'HTMLTable.java:' + '476' , colElement = $createElement(($location_0[stackIndex] = 'Document.java:' + '271' , $clinit_82() , $doc), 'col');
      $location_0[stackIndex] = 'Node.java:' + '72' , this$static.columnGroup.appendChild(colElement);
    }
    $stackDepth_0 = stackIndex - 1;
    return colElement;
  }
  returnTemp = ($location_0[stackIndex] = 'DOMImplTrident.java:' + '67' , this$static.columnGroup.children[col]);
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function $Image(this$static){
  ...
  $location_0[stackIndex] = 'Image.java:' + '345' , $clinit_400();
...
function $Image_1(this$static, url){
  ...
  $location_0[stackIndex] = 'Image.java:' + '366' , $clinit_400();
...
function addClickHandler_3(handler){
  ...
  returnTemp = ($location_0[stackIndex] = 'Image.java:' + '406' , $addHandler_1(this, handler, ($location_0[stackIndex] = 'Image.java:' + '406' , $clinit_130() , ($location_0[stackIndex] = 'ClickEvent.java:' + '27' , $clinit_130()) , TYPE_1)));
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function setUrlAndVisibleRect(image, url, left, top_0, width, height){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = setUrlAndVisibleRect;
  if (!($location_0[stackIndex] = 'Image.java:' + '149' , $equals_4(this.url, url)) || this.left_0 != left || this.top_0 != top_0 || this.width_0 != width || this.height_0 != height) {
    $location_0[stackIndex] = 'Image.java:' + '152' , this.url = url;
    $location_0[stackIndex] = 'Image.java:' + '153' , this.left_0 = left;
    ...
    $location_0[stackIndex] = 'Image.java:' + '158' , $adjust_0(image.element, url, left, top_0, width, height);
    $location_0[stackIndex] = 'Image.java:' + '159' , $fireSyntheticLoadEvent(image);
  }
  $stackDepth_0 = stackIndex - 1;
}
...
function $Image$UnclippedState(this$static, image){
  ...
  $location_0[stackIndex] = 'Image.java:' + '233' , $replaceElement_0(image, $createElement(($location_0[stackIndex] = 'Document.java:' + '417' , $clinit_82() , $doc), 'img'));
...
function $Image$UnclippedState_0(this$static, image, url){
  ...
  $location_0[stackIndex] = 'DOMImplIE6.java:' + '74' , setImgSrc(($location_0[stackIndex] = 'ImageElement.java:' + '120' , $clinit_82() , image.element), url);
  $stackDepth_0 = stackIndex - 1;
  return this$static;
}
...
function getClass_229(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_229;
  $stackDepth_0 = stackIndex - 1;
...
function getUrl_0(image){
  ...
  returnTemp = ($location_0[stackIndex] = 'DOMImplIE6.java:' + '62' , getImgSrc(($location_0[stackIndex] = 'ImageElement.java:' + '65' , $clinit_82() , image.element)));
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function $ListBox_0(this$static, isMultipleSelect){
  ...
  $location_0[stackIndex] = 'ListBox.java:' + '88' , $FocusWidget(this$static, $createSelectElement(($location_0[stackIndex] = 'Document.java:' + '921' , $clinit_82() , $doc), isMultipleSelect));
...
function $checkIndex(this$static, index){
  ...
  if (index < 0 || index >= ($location_0[stackIndex] = 'SelectElement.java:' + '112' , $clinit_82() , this$static.element).options.length) {
...
function $getItemText(this$static, index){
  ...
  returnTemp = ($location_0[stackIndex] = 'NodeList.java:' + '44' , ($location_0[stackIndex] = 'SelectElement.java:' + '112' , $clinit_82() , this$static.element).options[index]).text;
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function $insertItem(this$static, item, value, index){
  ...
  $location_0[stackIndex] = 'ListBox.java:' + '230' , option = $createElement(($location_0[stackIndex] = 'Document.java:' + '788' , $clinit_82() , $doc), 'option');
  ...
  if (index == -1 || index == select.options.length) {
    $location_0[stackIndex] = 'DOMImplTrident.java:' + '254' , select.add(option);
  }
   else {
    $location_0[stackIndex] = 'ListBox.java:' + '237' , before = ($location_0[stackIndex] = 'NodeList.java:' + '44' , select.options[index]);
    before?($location_0[stackIndex] = 'DOMImplTrident.java:' + '252' , select.add(option, before.index)):($location_0[stackIndex] = 'DOMImplTrident.java:' + '254' , select.add(option));
  }
  $stackDepth_0 = stackIndex - 1;
}
...
function add_11(source, listener){
  ...
  $location_0[stackIndex] = 'ListBox.java:' + '104' , $addDomHandler(source, rtn, ($location_0[stackIndex] = 'ListBox.java:' + '104' , $clinit_128() , ($location_0[stackIndex] = 'ChangeEvent.java:' + '27' , $clinit_128()) , TYPE_0));
  $stackDepth_0 = stackIndex - 1;
  return rtn;
}
...
function onClose_0(event_0){
  ...
  dynamicCast(event_0.target, 155);
  $stackDepth_0 = stackIndex - 1;
}
...
_.typeId$ = 130;
function $MenuBar(this$static, vertical){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $MenuBar;
  ...
  $location_0[stackIndex] = 'MenuBar.java:' + '233' , $init_2(this$static, vertical, ($location_0[stackIndex] = 'MenuBar.java:' + '234' , create_1((!menuBarSubMenuIcon && (menuBarSubMenuIcon = ($location_0[stackIndex] = 'com_google_gwt_user_client_ui_MenuBar_Resources_default_StaticClientBundleGenerator.java:' + '9' , $ImageResourcePrototype(($location_0[stackIndex] = 'com_google_gwt_user_client_ui_MenuBar_Resources_default_StaticClientBundleGenerator.java:' + '9' , new ImageResourcePrototype), ($location_0[stackIndex] = 'com_google_gwt_user_client_ui_MenuBar_Resources_default_StaticClientBundleGenerator.java:' + '11' , $clinit_227() , internedUrl0), 0, 0, 5, 9))) , menuBarSubMenuIcon))));
  $stackDepth_0 = stackIndex - 1;
  return this$static;
}
...
function $addItemElement(this$static, beforeIndex, tdElem){
  ...
  if (this$static.vertical) {
    $location_0[stackIndex] = 'MenuBar.java:' + '944' , tr = $createElement(($location_0[stackIndex] = 'Document.java:' + '1063' , $clinit_82() , $doc), 'tr');
    ...
    $location_0[stackIndex] = 'MenuBar.java:' + '948' , tr = ($location_0[stackIndex] = 'DOMImplTrident.java:' + '67' , this$static.body_0.children[0]);
    beforeIndex >= tr.children.length?($location_0[stackIndex] = 'DOMImplTrident.java:' + '177' , tr.appendChild(tdElem)):tr.insertBefore(tdElem, ($location_0[stackIndex] = 'DOMImplTrident.java:' + '179' , tr.children[beforeIndex]));
  }
  $stackDepth_0 = stackIndex - 1;
}
...
function $findItem(this$static, hItem){
  ...
  for ($location_0[stackIndex] = 'MenuBar.java:' + '969' , item$iterator = $AbstractList$IteratorImpl(($location_0[stackIndex] = 'AbstractList.java:' + '278' , new AbstractList$IteratorImpl), this$static.items); item$iterator.i < ($location_0[stackIndex] = 'AbstractList.java:' + '38' , item$iterator.this$0.size_1());) {
    ...
    if ($isOrHasChild_0(($location_0[stackIndex] = 'Node.java:' + '274' , $clinit_82() , item.element), hItem)) {
      $stackDepth_0 = stackIndex - 1;
      return item;
    }
  }
...
function $getItemContainerElement(this$static){
  ...
  if (this$static.vertical) {
    ...
    returnTemp = ($location_0[stackIndex] = 'DOMImplTrident.java:' + '67' , this$static.body_0.children[0]);
    $stackDepth_0 = stackIndex - 1;
    return returnTemp;
  }
  $stackDepth_0 = stackIndex - 1;
...
function $init_2(this$static, vertical){
  ...
  $location_0[stackIndex] = 'MenuBar.java:' + '988' , table = $createElement(($location_0[stackIndex] = 'Document.java:' + '966' , $clinit_82() , $doc), 'table');
  $location_0[stackIndex] = 'MenuBar.java:' + '989' , this$static.body_0 = ($location_0[stackIndex] = 'Document.java:' + '975' , $createElement($doc, 'tbody'));
  $location_0[stackIndex] = 'Node.java:' + '72' , table.appendChild(this$static.body_0);
  if (!vertical) {
    $location_0[stackIndex] = 'MenuBar.java:' + '993' , tr = ($location_0[stackIndex] = 'Document.java:' + '1063' , $createElement($doc, 'tr'));
...
function $insertItem_0(this$static, item, beforeIndex){
  ...
  for ($location_0[stackIndex] = 'MenuBar.java:' + '426' , i = 0; i < beforeIndex; $location_0[stackIndex] = 'MenuBar.java:' + '426' , ++i) {
    instanceOf(($location_0[stackIndex] = 'MenuBar.java:' + '427' , $get_6(this$static.allItems, i)), 156) && ($location_0[stackIndex] = 'MenuBar.java:' + '428' , ++itemsIndex);
  }
...
function $itemOver(this$static, item, focus_0){
  ...
  focus_0 && ($location_0[stackIndex] = 'MenuBar.java:' + '375' , $focus(this$static.element));
...
function $onBrowserEvent_1(this$static, event_0){
  ...
  item = ($location_0[stackIndex] = 'MenuBar.java:' + '543' , $findItem(this$static, ($location_0[stackIndex] = 'NativeEvent.java:' + '109' , $clinit_82() , event_0).srcElement));
  switch ($location_0[stackIndex] = 'DOMImpl.java:' + '61' , $eventGetTypeInt(event_0.type)) {
    case 1:
      {
        $location_0[stackIndex] = 'MenuBar.java:' + '546' , $focus(this$static.element);
    ...
    case 128:
      {
        ...
        switch (keyCode) {
          case 37:
            {
              $location_0[stackIndex] = 'MenuBar.java:' + '577' , $clinit_227();
            ...
            $location_0[stackIndex] = 'DOMImplTrident.java:' + '166' , event_0.returnValue = false;
            break;
          case 39:
            {
              $location_0[stackIndex] = 'MenuBar.java:' + '585' , $clinit_227();
...
function $selectFirstItemIfNoneSelected(this$static){
  ...
  if (!this$static.selectedItem) {
    if (this$static.items.size_0 > 0) {
      nextItem = dynamicCast(($location_0[stackIndex] = 'MenuBar.java:' + '1199' , $get_6(this$static.items, 0)), 156);
...
function $selectItem(this$static, item){
  var td, tr, parent_0, attr, stackIndex;
  ...
  if (this$static.selectedItem) {
    ...
    if (this$static.vertical) {
      $location_0[stackIndex] = 'MenuBar.java:' + '691' , tr = ($location_0[stackIndex] = 'DOMImpl.java:' + '236' , parent_0 = ($location_0[stackIndex] = 'Node.java:' + '184' , $clinit_82() , this$static.selectedItem.element).parentNode , (!parent_0 || parent_0.nodeType != 1) && ($location_0[stackIndex] = 'DOMImpl.java:' + '238' , parent_0 = null) , parent_0);
      if (tr.children.length == 2) {
        $location_0[stackIndex] = 'MenuBar.java:' + '693' , td = ($location_0[stackIndex] = 'DOMImplTrident.java:' + '67' , tr.children[1]);
  ...
  if (item) {
    ...
    if (this$static.vertical) {
      ...
      if (tr.children.length == 2) {
        $location_0[stackIndex] = 'MenuBar.java:' + '706' , td = ($location_0[stackIndex] = 'DOMImplTrident.java:' + '67' , tr.children[1]);
        $location_0[stackIndex] = 'MenuBar.java:' + '707' , setStyleName(td, 'subMenuIcon-selected', true);
      }
    }
    $location_0[stackIndex] = 'Element.java:' + '576' , this$static.element.setAttribute('aria-activedescendant', (attr = ($location_0[stackIndex] = 'DOMImplTrident.java:' + '187' , ($location_0[stackIndex] = 'Element.java:' + '180' , $clinit_82() , item.element).getAttribute('id')) , attr == null?'':attr + ''));
  }
...
function $selectNextItem(this$static){
  ...
  index < this$static.items.size_0 - 1?(itemToBeSelected = dynamicCast(($location_0[stackIndex] = 'MenuBar.java:' + '1221' , $get_6(this$static.items, index + 1)), 156)):(itemToBeSelected = dynamicCast(($location_0[stackIndex] = 'MenuBar.java:' + '1223' , $get_6(this$static.items, 0)), 156));
...
function $selectPrevItem(this$static){
  ...
  index > 0?(itemToBeSelected = dynamicCast(($location_0[stackIndex] = 'MenuBar.java:' + '1245' , $get_6(this$static.items, index - 1)), 156)):(itemToBeSelected = dynamicCast(($location_0[stackIndex] = 'MenuBar.java:' + '1248' , $get_6(this$static.items, this$static.items.size_0 - 1)), 156));
...
function $updateSubmenuIcon(this$static, item){
  ...
  $location_0[stackIndex] = 'MenuBar.java:' + '915' , tr = ($location_0[stackIndex] = 'DOMImplTrident.java:' + '67' , container.children[idx]);
  $location_0[stackIndex] = 'MenuBar.java:' + '916' , tdCount = tr.children.length;
  tdCount == 2 && ($location_0[stackIndex] = 'Node.java:' + '285' , tr.removeChild(($location_0[stackIndex] = 'DOMImplTrident.java:' + '67' , tr.children[1])));
...
function $MenuItem(this$static, text, asHTML, cmd){
  ...
  $location_0[stackIndex] = 'UIObject.java:' + '799' , this$static.element = $createElement(($location_0[stackIndex] = 'Document.java:' + '985' , $clinit_82() , $doc), 'td');
  $location_0[stackIndex] = 'MenuItem.java:' + '85' , $setSelectionStyle_0(this$static, false);
  asHTML?($location_0[stackIndex] = 'Element.java:' + '614' , this$static.element.innerHTML = text || '' , undefined):($location_0[stackIndex] = 'DOMImplTrident.java:' + '260' , this$static.element.innerText = text || '' , undefined);
...
function $MenuItemSeparator(this$static){
  ...
  $location_0[stackIndex] = 'MenuItemSeparator.java:' + '39' , div = ($location_0[stackIndex] = 'Document.java:' + '252' , $createElement($doc, 'div'));
...
function getClass_242(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_242;
  $stackDepth_0 = stackIndex - 1;
...
function addClickHandler_4(handler){
  ...
  returnTemp = ($location_0[stackIndex] = 'TabBar.java:' + '107' , $addHandler_1(this, handler, ($location_0[stackIndex] = 'TabBar.java:' + '107' , $clinit_130() , ($location_0[stackIndex] = 'ClickEvent.java:' + '27' , $clinit_130()) , TYPE_1)));
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function $collectElementChain(this$static, chain, hRoot, hElem){
  ...
  $location_0[stackIndex] = 'Tree.java:' + '866' , $collectElementChain(this$static, chain, hRoot, ($location_0[stackIndex] = 'DOMImpl.java:' + '236' , parent_0 = ($location_0[stackIndex] = 'Node.java:' + '184' , $clinit_82() , hElem).parentNode , (!parent_0 || parent_0.nodeType != 1) && ($location_0[stackIndex] = 'DOMImpl.java:' + '238' , parent_0 = null) , parent_0));
...
function $elementClicked(this$static, hElem){
  ...
  if (!!item && item != this$static.root) {
    if (($location_0[stackIndex] = 'Tree.java:' + '876' , $getChildCount_0(item)) > 0 && ($location_0[stackIndex] = 'Tree.java:' + '877' , isOrHasChild(($location_0[stackIndex] = 'Element.java:' + '241' , $getFirstChildElement_0(($location_0[stackIndex] = 'Element.java:' + '241' , $clinit_82() , ($location_0[stackIndex] = 'TreeItem.java:' + '699' , $getImageHolderElement(item))))), hElem))) {
      $location_0[stackIndex] = 'Tree.java:' + '878' , $setState_1(item, !item.open_0, true);
      $stackDepth_0 = stackIndex - 1;
      return true;
    }
     else if ($isOrHasChild_0(($location_0[stackIndex] = 'Node.java:' + '274' , $clinit_82() , item.element), hElem)) {
...
function $keyboardNavigation(this$static, event_0){
  ...
  $location_0[stackIndex] = 'Tree.java:' + '1014' , code = $eventGetKeyCode(($location_0[stackIndex] = 'NativeEvent.java:' + '125' , $clinit_82() , event_0));
...
function $moveFocus(this$static){
  ...
  $location_0[stackIndex] = 'Tree.java:' + '1081' , containerLeft = $getAbsoluteLeft_0(($location_0[stackIndex] = 'Element.java:' + '150' , $clinit_82() , this$static.element));
  ...
  $location_0[stackIndex] = 'Element.java:' + '565' , $scrollIntoView_0(this$static.focusable);
  $location_0[stackIndex] = 'Tree.java:' + '1108' , $updateAriaAttributes(this$static);
  $location_0[stackIndex] = 'Tree.java:' + '664' , $focus(this$static.focusable);
  $stackDepth_0 = stackIndex - 1;
}
...
function $remove_9(this$static, w){
  ...
  item = dynamicCast(($location_0[stackIndex] = 'Tree.java:' + '590' , $get_8(this$static.childWidgets, w)), 155);
  if (!item) {
    $stackDepth_0 = stackIndex - 1;
    return false;
  }
...
function $setImages(this$static, images, useLeafImages){
  ...
  if (!useLeafImages) {
    ...
    $location_0[stackIndex] = 'Tree.java:' + '1204' , $clinit_436();
...
function $showImage(treeItem, proto){
  ...
  holder = ($location_0[stackIndex] = 'Tree.java:' + '1212' , $getImageHolderElement(treeItem));
  $location_0[stackIndex] = 'Tree.java:' + '1213' , child = $getFirstChildElement_0(($location_0[stackIndex] = 'Element.java:' + '241' , $clinit_82() , holder));
  !child?($location_0[stackIndex] = 'Node.java:' + '72' , holder.appendChild(($location_0[stackIndex] = 'ClippedImagePrototype.java:' + '58' , $createStructure_0(proto.url, proto.left_0, proto.top_0, proto.width_0, proto.height_0)))):($location_0[stackIndex] = 'ClippedImagePrototype.java:' + '53' , $adjust_0(child, proto.url, proto.left_0, proto.top_0, proto.width_0, proto.height_0));
  $stackDepth_0 = stackIndex - 1;
}
...
function $showLeafImage(this$static, treeItem){
  ...
  if (this$static.useLeafImages || !!treeItem.imageHolder) {
    ...
    $location_0[stackIndex] = 'Tree.java:' + '841' , $clinit_227();
...
function $updateAriaAttributes(this$static){
  var curSelectionContentElem, curSelectionIndex, curSelectionLevel, curSelectionParent, tempItem, attr, stackIndex;
  ...
  $location_0[stackIndex] = 'Element.java:' + '576' , this$static.focusable.setAttribute('aria-activedescendant', (attr = ($location_0[stackIndex] = 'DOMImplTrident.java:' + '187' , ($location_0[stackIndex] = 'Element.java:' + '180' , $clinit_82() , curSelectionContentElem).getAttribute('id')) , attr == null?'':attr + ''));
  $stackDepth_0 = stackIndex - 1;
}
...
function addMouseDownHandler_3(handler){
  ...
  returnTemp = ($location_0[stackIndex] = 'Tree.java:' + '374' , $addHandler_1(this, handler, ($location_0[stackIndex] = 'Tree.java:' + '374' , $clinit_169() , ($location_0[stackIndex] = 'MouseDownEvent.java:' + '27' , $clinit_169()) , TYPE_7)));
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function addMouseMoveHandler_3(handler){
  ...
  returnTemp = ($location_0[stackIndex] = 'Tree.java:' + '388' , $addDomHandler(this, handler, ($location_0[stackIndex] = 'Tree.java:' + '388' , $clinit_171() , ($location_0[stackIndex] = 'MouseMoveEvent.java:' + '27' , $clinit_171()) , TYPE_8)));
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function addMouseOutHandler_3(handler){
  ...
  returnTemp = ($location_0[stackIndex] = 'Tree.java:' + '392' , $addDomHandler(this, handler, ($location_0[stackIndex] = 'Tree.java:' + '392' , $clinit_173() , ($location_0[stackIndex] = 'MouseOutEvent.java:' + '29' , $clinit_173()) , TYPE_9)));
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function addMouseUpHandler_3(handler){
  ...
  returnTemp = ($location_0[stackIndex] = 'Tree.java:' + '400' , $addDomHandler(this, handler, ($location_0[stackIndex] = 'Tree.java:' + '400' , $clinit_177() , ($location_0[stackIndex] = 'MouseUpEvent.java:' + '27' , $clinit_177()) , TYPE_11)));
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function doAttachChildren_3(){
  ...
  try {
    $location_0[stackIndex] = 'Tree.java:' + '718' , tryCommand(this, ($location_0[stackIndex] = 'AttachDetachException.java:' + '30' , $clinit_353() , attachCommand));
  }
   catch (e) {
...
function doDetachChildren_3(){
  ...
  try {
    $location_0[stackIndex] = 'Tree.java:' + '728' , tryCommand(this, ($location_0[stackIndex] = 'AttachDetachException.java:' + '39' , $clinit_353() , detachCommand));
  }
   catch (e) {
...
function iterator_6(){
  ...
  widgets = ($location_0[stackIndex] = 'Tree.java:' + '488' , initDim(_3Lcom_google_gwt_user_client_ui_Widget_2_classLit, 670, 2, this.childWidgets.size_0, 0));
...
function onBrowserEvent_5(event_0){
  ...
  $location_0[stackIndex] = 'Tree.java:' + '496' , eventType = ($location_0[stackIndex] = 'DOMImpl.java:' + '61' , $eventGetTypeInt(($location_0[stackIndex] = 'NativeEvent.java:' + '209' , $clinit_82() , event_0).type));
  switch (eventType) {
    case 128:
      {
  ...
  switch (eventType) {
    case 1:
      {
        $location_0[stackIndex] = 'Tree.java:' + '523' , e = event_0.srcElement;
        ($location_0[stackIndex] = 'Tree.java:' + '524' , shouldTreeDelegateFocusToElement(e)) || !!this.curSelection && ($location_0[stackIndex] = 'Tree.java:' + '664' , $focus(this.focusable) , undefined);
        break;
      }

    case 4:
      {
        ($location_0[stackIndex] = 'DOMImplTrident.java:' + '28' , $clinit_83() , currentEventTarget) == this.element && (event_0.button || 0) == 1 && ($location_0[stackIndex] = 'Tree.java:' + '541' , $elementClicked(this, event_0.srcElement));
        break;
      }
    ...
    case 512:
      {
        if ((event_0.which || event_0.keyCode || 0) == 9) {
          ...
          $location_0[stackIndex] = 'Tree.java:' + '562' , $collectElementChain(this, chain, this.element, event_0.srcElement);
...
function standardizeKeycode(code){
  ...
  $location_0[stackIndex] = 'Tree.java:' + '206' , $clinit_227();
  $stackDepth_0 = stackIndex - 1;
  return code;
}
...
function $clinit_458(){
  ...
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_458;
  $location_0[stackIndex] = 'TreeItem.java:' + '39' , $clinit_458 = nullMethod;
  itemAnimation = ($location_0[stackIndex] = 'TreeItem.java:' + '233' , new TreeItem$TreeItemAnimation);
  $location_0[stackIndex] = 'TreeItem.java:' + '239' , $clinit_458();
  $location_0[stackIndex] = 'TreeItem.java:' + '70' , BASE_INTERNAL_ELEM = $createElement(($location_0[stackIndex] = 'Document.java:' + '966' , $clinit_82() , $doc), 'table');
  $location_0[stackIndex] = 'TreeItem.java:' + '71' , contentElem = ($location_0[stackIndex] = 'Document.java:' + '252' , $createElement($doc, 'div'));
  $location_0[stackIndex] = 'TreeItem.java:' + '72' , tbody = ($location_0[stackIndex] = 'Document.java:' + '975' , $createElement($doc, 'tbody'));
  $location_0[stackIndex] = 'TreeItem.java:' + '72' , tr = ($location_0[stackIndex] = 'Document.java:' + '1063' , $createElement($doc, 'tr'));
  $location_0[stackIndex] = 'TreeItem.java:' + '73' , tdImg = ($location_0[stackIndex] = 'Document.java:' + '985' , $createElement($doc, 'td'));
  $location_0[stackIndex] = 'TreeItem.java:' + '73' , tdContent = ($location_0[stackIndex] = 'Document.java:' + '985' , $createElement($doc, 'td'));
  ...
  $location_0[stackIndex] = 'TreeItem.java:' + '86' , BASE_BARE_ELEM = ($location_0[stackIndex] = 'Document.java:' + '252' , $createElement($doc, 'div'));
...
function $TreeItem(this$static){
  ...
  $location_0[stackIndex] = 'TreeItem.java:' + '262' , $clinit_458();
  $location_0[stackIndex] = 'TreeItem.java:' + '263' , elem = ($location_0[stackIndex] = 'Node.java:' + '94' , BASE_BARE_ELEM.cloneNode(true));
  $location_0[stackIndex] = 'UIObject.java:' + '799' , this$static.element = elem;
  $location_0[stackIndex] = 'TreeItem.java:' + '265' , this$static.contentElem = $getFirstChildElement_0(($location_0[stackIndex] = 'Element.java:' + '241' , $clinit_82() , elem));
...
function $TreeItem_0(this$static, html){
  ...
  $location_0[stackIndex] = 'TreeItem.java:' + '274' , $clinit_458();
...
function $getChild_0(this$static, index){
  ...
  returnTemp = dynamicCast(($location_0[stackIndex] = 'TreeItem.java:' + '361' , $get_6(this$static.children_0, index)), 155);
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function $getChildCount_0(this$static){
  ...
  returnTemp = this$static.children_0.size_0;
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function $getChildIndex(this$static, child){
  ...
  returnTemp = ($location_0[stackIndex] = 'ArrayList.java:' + '163' , $indexOf_0(this$static.children_0, child, 0));
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function $getImageHolderElement(this$static){
  var stackIndex, returnTemp;
  $stack_0[stackIndex = ++$stackDepth_0] = $getImageHolderElement;
  if (!this$static.imageHolder) {
    $location_0[stackIndex] = 'TreeItem.java:' + '102' , $convertToFullNode(this$static);
    $location_0[stackIndex] = 'Style.java:' + '1449' , this$static.element.style['marginBottom'] = '0px';
  }
  returnTemp = this$static.imageHolder;
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function $initChildren(this$static){
  ...
  $location_0[stackIndex] = 'TreeItem.java:' + '102' , $convertToFullNode(this$static);
  $location_0[stackIndex] = 'Style.java:' + '1449' , this$static.element.style['marginBottom'] = '0px';
  $location_0[stackIndex] = 'TreeItem.java:' + '711' , this$static.childSpanElem = $createElement(($location_0[stackIndex] = 'Document.java:' + '252' , $clinit_82() , $doc), 'div');
  ...
  this$static.children_0 = $ArrayList(($location_0[stackIndex] = 'TreeItem.java:' + '714' , new ArrayList));
  $stackDepth_0 = stackIndex - 1;
}
...
function $setTree(this$static, newTree){
  ...
  for ($location_0[stackIndex] = 'TreeItem.java:' + '743' , i = 0 , n = $getChildCount_0(this$static); i < n; $location_0[stackIndex] = 'TreeItem.java:' + '743' , ++i) {
    $setTree(dynamicCast(($location_0[stackIndex] = 'TreeItem.java:' + '744' , $get_6(this$static.children_0, i)), 155), newTree);
  }
...
function $updateStateRecursiveHelper(this$static){
  ...
  for ($location_0[stackIndex] = 'TreeItem.java:' + '806' , i = 0 , n = $getChildCount_0(this$static); i < n; $location_0[stackIndex] = 'TreeItem.java:' + '806' , ++i) {
    $updateStateRecursiveHelper(dynamicCast(($location_0[stackIndex] = 'TreeItem.java:' + '807' , $get_6(this$static.children_0, i)), 155));
  }
  $stackDepth_0 = stackIndex - 1;
}
...
function addItem(item){
  ...
  !this.children_0 && ($location_0[stackIndex] = 'TreeItem.java:' + '313' , $initChildren(this));
  $location_0[stackIndex] = 'TreeItem.java:' + '722' , item.parent_0 = this;
  $location_0[stackIndex] = 'TreeItem.java:' + '318' , $add_7(this.children_0, item);
  $location_0[stackIndex] = 'TreeItem.java:' + '321' , $clinit_227();
  ...
  this.children_0.size_0 == 1 && ($location_0[stackIndex] = 'TreeItem.java:' + '333' , $updateState(this, false, false));
  $stackDepth_0 = stackIndex - 1;
}
...
function removeItem(item){
  ...
  if (!this.children_0 || ($location_0[stackIndex] = 'ArrayList.java:' + '163' , $indexOf_0(this.children_0, item, 0)) == -1) {
    $stackDepth_0 = stackIndex - 1;
    return;
  }
  ...
  $location_0[stackIndex] = 'TreeItem.java:' + '487' , $remove_8(this.children_0, item);
  this.children_0.size_0 == 0 && ($location_0[stackIndex] = 'TreeItem.java:' + '490' , $updateState(this, false, false));
  $stackDepth_0 = stackIndex - 1;
}
...
function $clinit_459(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_459;
  $location_0[stackIndex] = 'Tree.java:' + '965' , $clinit_459 = nullMethod;
  $clinit_458();
  $stackDepth_0 = stackIndex - 1;
}
...
function $Tree$1(this$static, this$0){
  ...
  $location_0[stackIndex] = 'Tree.java:' + '965' , $clinit_459();
...
function $addItem_3(this$static, item){
  ...
  $location_0[stackIndex] = 'TreeItem.java:' + '722' , item.parent_0 = null;
  $location_0[stackIndex] = 'Tree.java:' + '978' , $add_7(this$static.children_0, item);
  $location_0[stackIndex] = 'Tree.java:' + '981' , $clinit_227();
...
function $removeItem_0(this$static, item){
  ...
  if (($location_0[stackIndex] = 'ArrayList.java:' + '163' , $indexOf_0(this$static.children_0, item, 0)) == -1) {
    $stackDepth_0 = stackIndex - 1;
    return;
  }
  $location_0[stackIndex] = 'Tree.java:' + '995' , $setTree(item, null);
  $location_0[stackIndex] = 'TreeItem.java:' + '722' , item.parent_0 = null;
  $location_0[stackIndex] = 'Tree.java:' + '997' , $remove_8(this$static.children_0, item);
...
function $clinit_460(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_460;
  $location_0[stackIndex] = 'Tree.java:' + '121' , $clinit_460 = nullMethod;
  $location_0[stackIndex] = 'com_google_gwt_user_client_ui_Tree_Resources_default_StaticClientBundleGenerator.java:' + '6' , $clinit_470();
  $stackDepth_0 = stackIndex - 1;
}
...
function $Tree$ImageAdapter(this$static){
  ...
  $location_0[stackIndex] = 'Tree.java:' + '127' , $clinit_460();
  this$static.treeClosed = ($location_0[stackIndex] = 'Tree.java:' + '132' , create_1((!treeClosed && (treeClosed = $ImageResourcePrototype(($location_0[stackIndex] = 'com_google_gwt_user_client_ui_Tree_Resources_default_StaticClientBundleGenerator.java:' + '9' , new ImageResourcePrototype), internedUrl0_0, 32, 0, 16, 16)) , treeClosed)));
  this$static.treeLeaf = ($location_0[stackIndex] = 'Tree.java:' + '133' , create_1((!treeLeaf && (treeLeaf = $ImageResourcePrototype(($location_0[stackIndex] = 'com_google_gwt_user_client_ui_Tree_Resources_default_StaticClientBundleGenerator.java:' + '19' , new ImageResourcePrototype), internedUrl0_0, 16, 0, 16, 16)) , treeLeaf)));
  this$static.treeOpen = ($location_0[stackIndex] = 'Tree.java:' + '134' , create_1((!treeOpen && (treeOpen = $ImageResourcePrototype(($location_0[stackIndex] = 'com_google_gwt_user_client_ui_Tree_Resources_default_StaticClientBundleGenerator.java:' + '29' , new ImageResourcePrototype), internedUrl0_0, 0, 0, 16, 16)) , treeOpen)));
  $stackDepth_0 = stackIndex - 1;
  return this$static;
}
...
function getClass_263(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_263;
  $stackDepth_0 = stackIndex - 1;
...
function $convertToFullNode(item){
  ...
  if (!item.imageHolder) {
    $location_0[stackIndex] = 'TreeItem.java:' + '51' , itemTable = ($location_0[stackIndex] = 'Node.java:' + '94' , ($location_0[stackIndex] = 'TreeItem.java:' + '239' , $clinit_458() , BASE_INTERNAL_ELEM).cloneNode(true));
    $location_0[stackIndex] = 'Node.java:' + '72' , item.element.appendChild(itemTable);
    tr = ($location_0[stackIndex] = 'TreeItem.java:' + '53' , getFirstChild($getFirstChildElement_0(($location_0[stackIndex] = 'Element.java:' + '241' , $clinit_82() , itemTable))));
...
function copyWidgetArray(widgets){
  ...
  clone = ($location_0[stackIndex] = 'WidgetIterators.java:' + '29' , initDim(_3Lcom_google_gwt_user_client_ui_Widget_2_classLit, 670, 2, widgets.length, 0));
...
function $clinit_469(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_469;
  $location_0[stackIndex] = 'com_google_gwt_user_client_ui_MenuBar_Resources_default_StaticClientBundleGenerator.java:' + '6' , $clinit_469 = nullMethod;
  $location_0[stackIndex] = 'com_google_gwt_user_client_ui_MenuBar_Resources_default_StaticClientBundleGenerator.java:' + '17' , internedUrl0 = $moduleBase + 'DF7764EEC1903CD03C9545B354D8D8E4.cache.png';
  $stackDepth_0 = stackIndex - 1;
}
...
_.typeId$ = 0;
var internedUrl0, menuBarSubMenuIcon = null;
function $clinit_470(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_470;
  $location_0[stackIndex] = 'com_google_gwt_user_client_ui_Tree_Resources_default_StaticClientBundleGenerator.java:' + '6' , $clinit_470 = nullMethod;
  $location_0[stackIndex] = 'com_google_gwt_user_client_ui_Tree_Resources_default_StaticClientBundleGenerator.java:' + '37' , internedUrl0_0 = $moduleBase + 'EDC7827FEEA59EE44AD790B1C6430C45.cache.png';
  $stackDepth_0 = stackIndex - 1;
}

var internedUrl0_0, treeClosed = null, treeLeaf = null, treeOpen = null;
...
function execute_12(){
  ...
  $location_0[stackIndex] = 'ClippedImageImpl.java:' + '78' , evt = (evt_0 = ($location_0[stackIndex] = 'DOMImplTrident.java:' + '61' , ($location_0[stackIndex] = 'Document.java:' + '399' , $clinit_82() , $doc).createEventObject()) , ($location_0[stackIndex] = 'DOMImplTrident.java:' + '62' , evt_0.type = 'load') , evt_0);
  $location_0[stackIndex] = 'Element.java:' + '127' , $dispatchEvent_0(this.val$image.element, evt);
  $stackDepth_0 = stackIndex - 1;
}
...
function $adjust_0(clipper, url, left, top_0, width, height){
  var img, imgHeight, imgWidth, style, stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $adjust_0;
  if (!isIE6) {
    $location_0[stackIndex] = 'ClippedImageImpl.java:' + '37' , style = 'url(' + url + ') no-repeat ' + -left + 'px ' + -top_0 + 'px';
    $location_0[stackIndex] = 'Style.java:' + '1449' , clipper.style['background'] = style;
    $location_0[stackIndex] = 'Style.java:' + '1449' , clipper.style['width'] = width + ($location_0[stackIndex] = 'Style.java:' + '1369' , $clinit_109() , 'px');
  ...
  $location_0[stackIndex] = 'Style.java:' + '1449' , clipper.style['width'] = width + ($location_0[stackIndex] = 'Style.java:' + '1369' , $clinit_109() , 'px');
  clipper.style['height'] = height + 'px';
  $location_0[stackIndex] = 'ClippedImageImplIE6.java:' + '86' , img = $getFirstChildElement_0(($location_0[stackIndex] = 'Element.java:' + '241' , $clinit_82() , clipper));
  $location_0[stackIndex] = 'Style.java:' + '1449' , img.style['filter'] = "progid:DXImageTransform.Microsoft.AlphaImageLoader(src='" + url + "',sizingMethod='crop')";
  img.style['marginLeft'] = -left + 'px';
  img.style['marginTop'] = -top_0 + 'px';
  $location_0[stackIndex] = 'ClippedImageImplIE6.java:' + '95' , imgWidth = left + width;
  $location_0[stackIndex] = 'ClippedImageImplIE6.java:' + '96' , imgHeight = top_0 + height;
  $location_0[stackIndex] = 'Element.java:' + '658' , img['width'] = imgWidth;
  img['height'] = imgHeight;
  $stackDepth_0 = stackIndex - 1;
}

function $fireSyntheticLoadEvent(image){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $fireSyntheticLoadEvent;
  if (!isIE6) {
    addCommand($ClippedImageImpl$1(($location_0[stackIndex] = 'ClippedImageImpl.java:' + '76' , new ClippedImageImpl$1), image));
    $stackDepth_0 = stackIndex - 1;
    return;
  }
  addCommand($ClippedImageImplIE6$1(($location_0[stackIndex] = 'ClippedImageImplIE6.java:' + '125' , new ClippedImageImplIE6$1), image));
  $stackDepth_0 = stackIndex - 1;
}

function $ClippedImageImplIE6$1(this$static, val$image){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $ClippedImageImplIE6$1;
  $location_0[stackIndex] = 'ClippedImageImplIE6.java:' + '125' , this$static.val$image = val$image;
  $stackDepth_0 = stackIndex - 1;
  return this$static;
}

function execute_13(){
  var clipper, evt, img, evt_0, stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = execute_13;
  $location_0[stackIndex] = 'ClippedImageImplIE6.java:' + '127' , evt = (evt_0 = ($location_0[stackIndex] = 'DOMImplTrident.java:' + '61' , ($location_0[stackIndex] = 'Document.java:' + '399' , $clinit_82() , $doc).createEventObject()) , ($location_0[stackIndex] = 'DOMImplTrident.java:' + '62' , evt_0.type = 'load') , evt_0);
  $location_0[stackIndex] = 'ClippedImageImplIE6.java:' + '128' , clipper = this.val$image.element;
  $location_0[stackIndex] = 'ClippedImageImplIE6.java:' + '129' , img = ($location_0[stackIndex] = 'Element.java:' + '241' , $getFirstChildElement_0(clipper));
  $location_0[stackIndex] = 'DOMImplTrident.java:' + '138' , img.fireEvent('on' + evt.type, evt);
  $stackDepth_0 = stackIndex - 1;
}
...
function getClass_270(){
  ...
  $stackDepth_0 = stackIndex - 1;
  return Lcom_google_gwt_user_client_ui_impl_ClippedImageImplIE6$1_2_classLit;
}

function ClippedImageImplIE6$1(){
}

_ = ClippedImageImplIE6$1.prototype = new Object_0;
...
function $getHTML_1(this$static){
  var stackIndex, returnTemp;
  $stack_0[stackIndex = ++$stackDepth_0] = $getHTML_1;
  returnTemp = ($location_0[stackIndex] = 'ClippedImagePrototype.java:' + '68' , $getHTML_0(this$static.url, this$static.left_0, this$static.top_0, this$static.width_0, this$static.height_0));
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function hexDigit(c, s){
  var val = ($location_0[stackIndex] = 'Long.java:' + '273' , ($location_0[stackIndex] = 'Long.java:' + '35' , $clinit_543() , hexLookup)[c]), stackIndex;
...
function $clinit_543(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_543;
  $location_0[stackIndex] = 'Long.java:' + '31' , $clinit_543 = nullMethod;
  var c;
  hexLookup = ($location_0[stackIndex] = 'Long.java:' + '35' , initDim(_3I_classLit, 672, -1, 0, 1));
...
function $Date_0(this$static, year, month, date, hrs, min, sec){
  ...
  $location_0[stackIndex] = 'Date.java:' + '127' , $clinit_558();
...
function sort(target, c){
  ...
  $location_0[stackIndex] = 'Collections.java:' + '843' , $clinit_576();
  var x;
  ...
  $location_0[stackIndex] = 'Arrays.java:' + '997' , mergeSort(x, 0, x.length, c?c:($location_0[stackIndex] = 'Arrays.java:' + '997' , $clinit_587() , ($location_0[stackIndex] = 'Comparators.java:' + '32' , $clinit_587()) , NATURAL));
...
function $clinit_587(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_587;
  $location_0[stackIndex] = 'Comparators.java:' + '18' , $clinit_587 = nullMethod;
...
function getClass_341(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_341;
  $stackDepth_0 = stackIndex - 1;
...
function getClass_342(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_342;
  $stackDepth_0 = stackIndex - 1;
...
function $clinit_611(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_611;
  $location_0[stackIndex] = 'TreeMap.java:' + '29' , $clinit_611 = nullMethod;
...
function $TreeMap(this$static){
  ...
  $location_0[stackIndex] = 'TreeMap.java:' + '602' , $clinit_611();
...
function $TreeMap_0(this$static, c){
  ...
  $location_0[stackIndex] = 'TreeMap.java:' + '607' , $clinit_611();
...
function $TreeMap$EntryIterator(this$static, this$0){
  ...
  $location_0[stackIndex] = 'TreeMap.java:' + '51' , $TreeMap$EntryIterator_0(this$static, ($location_0[stackIndex] = 'TreeMap.java:' + '500' , $clinit_617() , All), null, null, this$0);
  $stackDepth_0 = stackIndex - 1;
  return this$static;
}
...
function $TreeMap$Node(this$static, key, value){
  ...
  this$static.child = ($location_0[stackIndex] = 'TreeMap.java:' + '198' , initDim(_3Ljava_util_TreeMap$Node_2_classLit, 690, 88, 2, 0));
...
function $clinit_617(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_617;
  $location_0[stackIndex] = 'TreeMap.java:' + '499' , $clinit_617 = nullMethod;
...
function $TreeMap$SubMapType(this$static, enum$name, enum$ordinal){
  ...
  $location_0[stackIndex] = 'TreeMap.java:' + '499' , $clinit_617();
...
function values_5(){
  ...
  $location_0[stackIndex] = 'TreeMap.java:' + '499' , $clinit_617();
  returnTemp = initValues(_3Ljava_util_TreeMap$SubMapType_2_classLit, 691, 89, [All, Head, Range, Tail]);
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function $clinit_618(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_618;
  $location_0[stackIndex] = 'TreeMap.java:' + '502' , $clinit_618 = nullMethod;
  $clinit_617();
  $stackDepth_0 = stackIndex - 1;
}
...
function $TreeMap$SubMapType$1(this$static, enum$name, enum$ordinal){
  ...
  $location_0[stackIndex] = 'TreeMap.java:' + '502' , $clinit_618();
  $location_0[stackIndex] = 'Enum.java:' + '76' , this$static.name_0 = enum$name;
  $location_0[stackIndex] = 'Enum.java:' + '77' , this$static.ordinal = enum$ordinal;
  $stackDepth_0 = stackIndex - 1;
  return this$static;
...
function $clinit_619(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_619;
  $location_0[stackIndex] = 'TreeMap.java:' + '509' , $clinit_619 = nullMethod;
  $clinit_617();
  $stackDepth_0 = stackIndex - 1;
}
...
function $TreeMap$SubMapType$2(this$static, enum$name, enum$ordinal){
  ...
  $location_0[stackIndex] = 'TreeMap.java:' + '509' , $clinit_619();
  $location_0[stackIndex] = 'Enum.java:' + '76' , this$static.name_0 = enum$name;
  $location_0[stackIndex] = 'Enum.java:' + '77' , this$static.ordinal = enum$ordinal;
  $stackDepth_0 = stackIndex - 1;
  return this$static;
...
function $clinit_620(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_620;
  $location_0[stackIndex] = 'TreeMap.java:' + '521' , $clinit_620 = nullMethod;
  $clinit_617();
  $stackDepth_0 = stackIndex - 1;
}
...
function $TreeMap$SubMapType$3(this$static, enum$name, enum$ordinal){
  ...
  $location_0[stackIndex] = 'TreeMap.java:' + '521' , $clinit_620();
  $location_0[stackIndex] = 'Enum.java:' + '76' , this$static.name_0 = enum$name;
  $location_0[stackIndex] = 'Enum.java:' + '77' , this$static.ordinal = enum$ordinal;
  $stackDepth_0 = stackIndex - 1;
  return this$static;
...
function getClass_361(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_361;
  $stackDepth_0 = stackIndex - 1;
...
function add_22(o){
  ...
  returnTemp = ($location_0[stackIndex] = 'TreeSet.java:' + '69' , $put_1(this.map, o, ($location_0[stackIndex] = 'Boolean.java:' + '29' , $clinit_521() , FALSE_0))) == null;
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function get_9(index){
  ...
  returnTemp = ($location_0[stackIndex] = 'Vector.java:' + '133' , $get_6(this.list.arrayList, index));
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function getClass_364(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_364;
  $stackDepth_0 = stackIndex - 1;
...
function $clinit_639(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_639;
  $location_0[stackIndex] = 'DelayedRunnable.java:' + '42' , $clinit_639 = nullMethod;
  $clinit_43();
  $stackDepth_0 = stackIndex - 1;
}
...
function $DelayedRunnable$1(this$static, this$0){
  ...
  $location_0[stackIndex] = 'DelayedRunnable.java:' + '42' , $clinit_639();
  this$static.this$0 = this$0;
  $stackDepth_0 = stackIndex - 1;
  return this$static;
}
...
function $HTMLTable_0(this$static){
  ...
  $location_0[stackIndex] = 'HTMLTable.java:' + '814' , this$static.tableElem = $createElement(($location_0[stackIndex] = 'Document.java:' + '966' , $clinit_82() , $doc), 'table');
  $location_0[stackIndex] = 'HTMLTable.java:' + '815' , this$static.bodyElem = ($location_0[stackIndex] = 'Document.java:' + '975' , $createElement($doc, 'tbody'));
...
function $getEventTargetCell(this$static, event_0){
  ...
  $location_0[stackIndex] = 'HTMLTable.java:' + '928' , td = ($location_0[stackIndex] = 'NativeEvent.java:' + '109' , $clinit_82() , event_0).srcElement;
...
function $getWidgetImpl(this$static, row, column){
  ...
  $location_0[stackIndex] = 'HTMLTable.java:' + '1585' , child = $getFirstChildElement_0(($location_0[stackIndex] = 'Element.java:' + '241' , $clinit_82() , e));
  if (!child) {
    $stackDepth_0 = stackIndex - 1;
    return null;
  }
...
function $internalClearCell_0(this$static, td, clearInnerHTML){
  ...
  $location_0[stackIndex] = 'HTMLTable.java:' + '1443' , maybeChild = $getFirstChildElement_0(($location_0[stackIndex] = 'Element.java:' + '241' , $clinit_82() , td));
...
function $remove_22(this$static, widget){
  ...
  $location_0[stackIndex] = 'Node.java:' + '285' , ($location_0[stackIndex] = 'DOMImpl.java:' + '236' , parent_0 = ($location_0[stackIndex] = 'Node.java:' + '184' , $clinit_82() , elem).parentNode , (!parent_0 || parent_0.nodeType != 1) && ($location_0[stackIndex] = 'DOMImpl.java:' + '238' , parent_0 = null) , parent_0).removeChild(elem);
...
function $setText_4(this$static, row, column, text){
  ...
  $stack_0[stackIndex = ++$stackDepth_0] = $setText_4;
  ...
  text != null && ($location_0[stackIndex] = 'DOMImplTrident.java:' + '260' , ($location_0[stackIndex] = 'Element.java:' + '621' , $clinit_82() , td).innerText = text || '' , undefined);
  $stackDepth_0 = stackIndex - 1;
}
...
function createRow(){
  ...
  returnTemp = $createElement(($location_0[stackIndex] = 'Document.java:' + '1063' , $clinit_82() , $doc), 'tr');
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function onBrowserEvent_6(event_0){
  ...
  $location_0[stackIndex] = 'DOMImpl.java:' + '61' , $eventGetTypeInt(($location_0[stackIndex] = 'NativeEvent.java:' + '209' , $clinit_82() , event_0).type);
  $stackDepth_0 = stackIndex - 1;
}
...
function $createCell_0(){
  ...
  $location_0[stackIndex] = 'Grid.java:' + '207' , td = $createElement(($location_0[stackIndex] = 'Document.java:' + '271' , $clinit_82() , $doc), 'td');
  $location_0[stackIndex] = 'Element.java:' + '614' , td.innerHTML = '&nbsp;';
  $stackDepth_0 = stackIndex - 1;
  return td;
}
...
function $createRow_0(this$static){
  ...
  $location_0[stackIndex] = 'Grid.java:' + '217' , tr = $createElement(($location_0[stackIndex] = 'Document.java:' + '1063' , $clinit_82() , $doc), 'tr');
  ...
  if (!this$static.columnGroup) {
    ...
    if (childs) {
      for ($location_0[stackIndex] = 'HTMLTable.java:' + '462' , i = 0 , n = childs.length; i < n; $location_0[stackIndex] = 'HTMLTable.java:' + '462' , ++i) {
        ...
        if ($location_0[stackIndex] = 'HTMLTable.java:' + '464' , $equalsIgnoreCase($getTagName(($location_0[stackIndex] = 'Element.java:' + '450' , $clinit_82() , node)), 'colgroup')) {
    ...
    $location_0[stackIndex] = 'HTMLTable.java:' + '470' , this$static.columnGroup = $createElement(($location_0[stackIndex] = 'Document.java:' + '271' , $clinit_82() , $doc), 'colgroup');
    $location_0[stackIndex] = 'DOM.java:' + '929' , $insertChild(this$static.this$0.tableElem, this$static.columnGroup, 0);
    $location_0[stackIndex] = 'Node.java:' + '72' , this$static.columnGroup.appendChild(($location_0[stackIndex] = 'Document.java:' + '271' , $createElement($doc, 'col')));
  }
  $stackDepth_0 = stackIndex - 1;
}
...
function $getWidget_2(this$static, elem){
  ...
  returnTemp = dynamicCast(($location_0[stackIndex] = 'HTMLTable.java:' + '686' , $get_6(this$static.widgetList, index)), 2);
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function $putWidget(this$static, widget){
  ...
  if (!this$static.freeList) {
    ...
    $location_0[stackIndex] = 'HTMLTable.java:' + '701' , $set_2(this$static.widgetList, index, widget);
...
function $removeWidgetByElement(this$static, elem){
  ...
  $location_0[stackIndex] = 'HTMLTable.java:' + '767' , $set_2(this$static.widgetList, index, null);
...
function $findNext_0(this$static){
  ...
  while (($location_0[stackIndex] = 'HTMLTable.java:' + '756' , ++this$static.nextIndex) < this$static.this$1.widgetList.size_0) {
    if (($location_0[stackIndex] = 'HTMLTable.java:' + '757' , $get_6(this$static.this$1.widgetList, this$static.nextIndex)) != null) {
      $stackDepth_0 = stackIndex - 1;
      return;
    }
  }
...
function getClass_381(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_381;
  $stackDepth_0 = stackIndex - 1;
...
function next_13(){
  ...
  result = ($location_0[stackIndex] = 'HTMLTable.java:' + '739' , $get_6(this.this$1.widgetList, this.nextIndex));
...
function remove_27(){
  ...
  w = dynamicCast(($location_0[stackIndex] = 'HTMLTable.java:' + '749' , $get_6(this.this$1.widgetList, this.lastIndex_0)), 2);
...
function getClass_382(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_382;
  $stackDepth_0 = stackIndex - 1;
...
function addClickHandler_5(handler){
  ...
  returnTemp = ($location_0[stackIndex] = 'Caption.java:' + '133' , $addDomHandler(this, handler, ($location_0[stackIndex] = 'Caption.java:' + '133' , $clinit_130() , ($location_0[stackIndex] = 'ClickEvent.java:' + '27' , $clinit_130()) , TYPE_1)));
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function $showWidget(this$static, index){
  ...
  $location_0[stackIndex] = 'DeckLayoutPanel.java:' + '177' , this$static.visibleWidget = ($location_0[stackIndex] = 'LayoutPanel.java:' + '490' , $getUnDecoratedWidget(($location_0[stackIndex] = 'ComplexPanel.java:' + '36' , $get_7(($location_0[stackIndex] = 'LayoutComposite.java:' + '89' , dynamicCast(this$static.widget, 182)).children_0, index))));
...
function getClass_388(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_388;
  $stackDepth_0 = stackIndex - 1;
...
function $TabLayoutPanel(this$static, region, decorate, decorateBody){
  ...
  decorate?region == ($location_0[stackIndex] = 'TabLayoutPanel.java:' + '65' , $clinit_734() , TOP)?(this$static.tabBar = $ScrollTabBar_0(($location_0[stackIndex] = 'TabLayoutPanel.java:' + '143' , new ScrollTabBar), true, false)):(this$static.tabBar = $ScrollTabBar_0(($location_0[stackIndex] = 'TabLayoutPanel.java:' + '145' , new ScrollTabBar), true, true)):(this$static.tabBar = $ScrollTabBar(($location_0[stackIndex] = 'TabLayoutPanel.java:' + '148' , new ScrollTabBar)));
  ...
  region == ($location_0[stackIndex] = 'TabLayoutPanel.java:' + '65' , $clinit_734() , TOP)?$add_26(layoutPanel, this$static.tabBar, ($location_0[stackIndex] = 'TabLayoutPanel.java:' + '160' , $BorderLayoutData_1(($location_0[stackIndex] = 'TabLayoutPanel.java:' + '160' , new BorderLayoutData), ($location_0[stackIndex] = 'BorderLayout.java:' + '199' , $clinit_795() , NORTH_0)))):$add_26(layoutPanel, this$static.tabBar, ($location_0[stackIndex] = 'TabLayoutPanel.java:' + '162' , $BorderLayoutData_1(($location_0[stackIndex] = 'TabLayoutPanel.java:' + '162' , new BorderLayoutData), ($location_0[stackIndex] = 'BorderLayout.java:' + '199' , $clinit_795() , SOUTH_0))));
...
function $insert_5(this$static, widget, tabText, asHTML, beforeIndex){
  ...
  if (selection == -1 && this$static.tabBar.tabBar.panel.children_0.size_0 - 2 > 0) {
...
function getClass_391(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_391;
  $stackDepth_0 = stackIndex - 1;
...
function getClass_392(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_392;
  $stackDepth_0 = stackIndex - 1;
...
function $ImageButton(this$static, image){
  ...
  $location_0[stackIndex] = 'ImageButton.java:' + '49' , $ImageButton_0(this$static, $Image_2(($location_0[stackIndex] = 'ClippedImagePrototype.java:' + '63' , new Image_0), image.url, image.left_0, image.top_0, image.width_0, image.height_0));
  $stackDepth_0 = stackIndex - 1;
  return this$static;
}
...
function addClickHandler_6(handler){
  ...
  returnTemp = ($location_0[stackIndex] = 'ImageButton.java:' + '58' , $addDomHandler(this, handler, ($location_0[stackIndex] = 'ImageButton.java:' + '58' , $clinit_130() , ($location_0[stackIndex] = 'ClickEvent.java:' + '27' , $clinit_130()) , TYPE_1)));
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function $LayoutPanel_0(this$static, elem, layout){
  ...
  this$static.children_0 = $WidgetCollection(($location_0[stackIndex] = 'ComplexPanel.java:' + '28' , new WidgetCollection), this$static);
  $location_0[stackIndex] = 'UIObject.java:' + '799' , this$static.element = elem;
  $location_0[stackIndex] = 'LayoutPanel.java:' + '124' , $$init_54(this$static);
...
function getClass_409(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_409;
  $stackDepth_0 = stackIndex - 1;
...
function $ListBox_1(this$static, columns){
  ...
  $location_0[stackIndex] = 'ListBox.java:' + '140' , $setResizePolicy(this$static.scrollTable, ($location_0[stackIndex] = 'AbstractScrollTable.java:' + '844' , $clinit_841() , FILL_WIDTH));
  ...
  $location_0[stackIndex] = 'ListBox.java:' + '854' , $setSelectionPolicy_0(this$static.dataTable, ($location_0[stackIndex] = 'SelectionGrid.java:' + '127' , $clinit_872() , ONE_ROW));
...
function $contentsChanged(this$static, event_0){
  ...
  if (this$static.dataModel == event_0.source_0) {
    ...
    for (; index0 < index1; $location_0[stackIndex] = 'ListBox.java:' + '315' , ++index0) {
      index0 < this$static.dataTable.numRows?($location_0[stackIndex] = 'ListBox.java:' + '317' , $renderItemOnUpdate(this$static, index0, ($location_0[stackIndex] = 'Vector.java:' + '133' , $get_6(this$static.dataModel.list.list.arrayList, index0)))):($location_0[stackIndex] = 'ListBox.java:' + '319' , $renderItemOnInsert(this$static, ($location_0[stackIndex] = 'Vector.java:' + '133' , $get_6(this$static.dataModel.list.list.arrayList, index0)), -1));
    }
  }
  $stackDepth_0 = stackIndex - 1;
}
...
function $intervalAdded(this$static, event_0){
  ...
  if (this$static.dataModel == event_0.source_0) {
    for ($location_0[stackIndex] = 'ListBox.java:' + '275' , i = event_0.index0 , n = event_0.index1; i <= n && i >= 0; $location_0[stackIndex] = 'ListBox.java:' + '275' , ++i) {
      i < this$static.dataTable.numRows?($location_0[stackIndex] = 'ListBox.java:' + '277' , $renderItemOnInsert(this$static, ($location_0[stackIndex] = 'Vector.java:' + '133' , $get_6(this$static.dataModel.list.list.arrayList, i)), i)):($location_0[stackIndex] = 'ListBox.java:' + '279' , $renderItemOnInsert(this$static, ($location_0[stackIndex] = 'Vector.java:' + '133' , $get_6(this$static.dataModel.list.list.arrayList, i)), -1));
    }
  }
  $stackDepth_0 = stackIndex - 1;
}
...
function $selectNextItem_0(this$static){
  ...
  $location_0[stackIndex] = 'Element.java:' + '565' , $scrollIntoView_0(($location_0[stackIndex] = 'Element.java:' + '565' , $clinit_82() , ($location_0[stackIndex] = 'ListBox.java:' + '685' , $getElement_0(this$static.dataTable.rowFormatter, ($location_0[stackIndex] = 'ListBox.java:' + '686' , $getSelectedIndex_0(this$static)))).firstChild));
  $stackDepth_0 = stackIndex - 1;
}
...
function $selectPrevItem_0(this$static){
  ...
  $location_0[stackIndex] = 'Element.java:' + '565' , $scrollIntoView_0(($location_0[stackIndex] = 'Element.java:' + '565' , $clinit_82() , ($location_0[stackIndex] = 'ListBox.java:' + '702' , $getElement_0(this$static.dataTable.rowFormatter, ($location_0[stackIndex] = 'ListBox.java:' + '703' , $getSelectedIndex_0(this$static)))).firstChild));
  $stackDepth_0 = stackIndex - 1;
}
...
function $setHeader_0(this$static, listHeader){
  ...
  if (listHeader.size_0 > 0) {
    ...
    $location_0[stackIndex] = 'ListBox.java:' + '233' , $setText_8(this$static.headerTable, 0, 0, null);
...
function $setModel(this$static, dataModel){
  ...
  for ($location_0[stackIndex] = 'ListBox.java:' + '839' , i = 0 , n = dataModel.list.list.arrayList.size_0; i < n; $location_0[stackIndex] = 'ListBox.java:' + '839' , ++i) {
    $location_0[stackIndex] = 'ListBox.java:' + '840' , $renderItemOnInsert(this$static, ($location_0[stackIndex] = 'Vector.java:' + '133' , $get_6(dataModel.list.list.arrayList, i)), -1);
  }
...
function $setText_6(this$static, row, column, text){
  ...
  $location_0[stackIndex] = 'ListBox.java:' + '913' , $setText_7(this$static.dataTable, (trElem = dynamicCastJso(($location_0[stackIndex] = 'ListBox.java:' + '925' , $get_6(this$static.rowsInModelOrder, row))) , trElem.sectionRowIndex - 1), column, text);
  $stackDepth_0 = stackIndex - 1;
}
...
function $setWidget_5(this$static, row, column, widget){
  ...
  $location_0[stackIndex] = 'ListBox.java:' + '921' , $setWidget_9(this$static.dataTable, (trElem = dynamicCastJso(($location_0[stackIndex] = 'ListBox.java:' + '925' , $get_6(this$static.rowsInModelOrder, row))) , trElem.sectionRowIndex - 1), column, widget);
  $stackDepth_0 = stackIndex - 1;
}
    ...
    case 128:
      ...
      switch (keyCode) {
        ...
        case 40:
          ...
          break;
        case 37:
          $location_0[stackIndex] = 'Element.java:' + '565' , $scrollIntoView_0(($location_0[stackIndex] = 'ListBox.java:' + '562' , $getElement_0(this.dataTable.rowFormatter, ($location_0[stackIndex] = 'ListBox.java:' + '563' , $getSelectedIndex_0(this)))).firstChild);
          break;
        case 39:
          $location_0[stackIndex] = 'Element.java:' + '565' , $scrollIntoView_0(($location_0[stackIndex] = 'ListBox.java:' + '566' , $getElement_0(this.dataTable.rowFormatter, ($location_0[stackIndex] = 'ListBox.java:' + '567' , $getSelectedIndex_0(this)))).lastChild);
          break;
      ...
      break;
    case 1:
      $location_0[stackIndex] = 'ListBox.java:' + '769' , $focus(this.element);
    default:$location_0[stackIndex] = 'Composite.java:' + '51' , $onBrowserEvent(this, event_0);
      $location_0[stackIndex] = 'Composite.java:' + '54' , this.widget.onBrowserEvent(event_0);
  }
  $stackDepth_0 = stackIndex - 1;
...
function getClass_413(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_413;
  $stackDepth_0 = stackIndex - 1;
...
function renderCell(listBox, row, column, item){
  ...
  item != null && ($location_0[stackIndex] = 'Cast.java:' + '76' , canCast(item.typeId$, 2))?$setWidget_5(listBox, row, column, ($location_0[stackIndex] = 'ListBox.java:' + '106' , dynamicCast(item, 2))):$setText_6(listBox, row, column, ($location_0[stackIndex] = 'ListBox.java:' + '108' , toString__devirtual$(item)));
  $stackDepth_0 = stackIndex - 1;
}
...
function add_27(windowPanel, listener){
  ...
  $location_0[stackIndex] = 'WindowPanel.java:' + '433' , $addHandler_1(windowPanel, handler, ($location_0[stackIndex] = 'WindowPanel.java:' + '433' , $clinit_299() , ($location_0[stackIndex] = 'Window.java:' + '55' , $clinit_298()) , TYPE_18));
...
function getClass_414(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_414;
  $stackDepth_0 = stackIndex - 1;
...
function $WindowPanel(this$static){
  ...
  $location_0[stackIndex] = 'WindowPanel.java:' + '271' , $clinit_690();
  $location_0[stackIndex] = 'WindowPanel.java:' + '302' , $WindowPanel_2(this$static, ($location_0[stackIndex] = 'WindowPanel.java:' + '302' , $clinit_436() , ($location_0[stackIndex] = 'RootPanel.java:' + '151' , get_1(null))), null, true, false);
  $stackDepth_0 = stackIndex - 1;
  return this$static;
}
...
function $PopupMenu(this$static){
  ...
  $location_0[stackIndex] = 'PopupMenu.java:' + '41' , $AbstractDecoratedPopupPanel(this$static, true, false, 'menuPopup', ($location_0[stackIndex] = 'AbstractDecoratedPopupPanel.java:' + '37' , $clinit_349() , ONE_WAY_CORNER));
  ...
  $location_0[stackIndex] = 'Element.java:' + '688' , ($location_0[stackIndex] = 'PopupPanel.java:' + '1008' , $getStyleElement_1($getFirstChildElement_0(($location_0[stackIndex] = 'Element.java:' + '241' , $clinit_82() , this$static.element))))['className'] = 'gwt-MenuBarPopup';
...
function onBrowserEvent_9(event_0){
  ...
  ($location_0[stackIndex] = 'DOMImpl.java:' + '61' , $eventGetTypeInt(($location_0[stackIndex] = 'NativeEvent.java:' + '209' , $clinit_82() , event_0).type)) == 1 && ($location_0[stackIndex] = 'PopupPanel.java:' + '571' , $hide_0(this));
  $stackDepth_0 = stackIndex - 1;
}
...
function $PopupMenu$1(this$static, $anonymous0){
  ...
  $MenuBar(this$static, $anonymous0, ($location_0[stackIndex] = 'com_google_gwt_user_client_ui_MenuBar_Resources_default_StaticClientBundleGenerator.java:' + '6' , $clinit_469() , ($location_0[stackIndex] = 'MenuBar.java:' + '209' , new com_google_gwt_user_client_ui_MenuBar_Resources_default_StaticClientBundleGenerator)));
  $stackDepth_0 = stackIndex - 1;
  return this$static;
}
...
function $ScrollTabBar_0(this$static, decorated, atBottom){
  ...
  this$static.scrollLeftBtn = ($location_0[stackIndex] = 'ScrollTabBar.java:' + '255' , $Button_1(($location_0[stackIndex] = 'ScrollTabBar.java:' + '255' , new Button), ($location_0[stackIndex] = 'ScrollTabBar.java:' + '255' , $getHTML_1(($clinit_655() , ($location_0[stackIndex] = 'CaptionImages_generatedBundle.java:' + '17' , $clinit_657()) , toolArrowLeft_SINGLETON))), $ScrollTabBar$7(($location_0[stackIndex] = 'ScrollTabBar.java:' + '256' , new ScrollTabBar$7), this$static)));
  $location_0[stackIndex] = 'FocusWidget.java:' + '136' , $addDomHandler(this$static.scrollLeftBtn, $ScrollTabBar$8(($location_0[stackIndex] = 'ScrollTabBar.java:' + '263' , new ScrollTabBar$8), this$static), ($location_0[stackIndex] = 'FocusWidget.java:' + '136' , $clinit_169() , ($location_0[stackIndex] = 'MouseDownEvent.java:' + '27' , $clinit_169()) , TYPE_7));
  $location_0[stackIndex] = 'FocusWidget.java:' + '162' , $addDomHandler(this$static.scrollLeftBtn, $ScrollTabBar$9(($location_0[stackIndex] = 'ScrollTabBar.java:' + '269' , new ScrollTabBar$9), this$static), ($location_0[stackIndex] = 'FocusWidget.java:' + '162' , $clinit_177() , ($location_0[stackIndex] = 'MouseUpEvent.java:' + '27' , $clinit_177()) , TYPE_11));
  $location_0[stackIndex] = 'ScrollTabBar.java:' + '275' , $add_5(this$static.navBar, this$static.scrollLeftBtn);
  this$static.scrollRightBtn = ($location_0[stackIndex] = 'ScrollTabBar.java:' + '277' , $Button_1(($location_0[stackIndex] = 'ScrollTabBar.java:' + '277' , new Button), $getHTML_1(toolArrowRight_SINGLETON), $ScrollTabBar$10(($location_0[stackIndex] = 'ScrollTabBar.java:' + '278' , new ScrollTabBar$10), this$static)));
  ...
  this$static.tabBarMenuBtn = ($location_0[stackIndex] = 'ScrollTabBar.java:' + '299' , $Button_1(($location_0[stackIndex] = 'ScrollTabBar.java:' + '299' , new Button), $getHTML_1(toolArrowDown_SINGLETON), $ScrollTabBar$13(($location_0[stackIndex] = 'ScrollTabBar.java:' + '300' , new ScrollTabBar$13), this$static)));
  $location_0[stackIndex] = 'ScrollTabBar.java:' + '334' , $add_5(this$static.navBar, this$static.tabBarMenuBtn);
  $add_26(layoutPanel, this$static.tabBarWrapper, ($location_0[stackIndex] = 'ScrollTabBar.java:' + '336' , $BoxLayoutData_4(($location_0[stackIndex] = 'ScrollTabBar.java:' + '336' , new BoxLayoutData), ($location_0[stackIndex] = 'BoxLayoutData.java:' + '30' , $clinit_804() , HORIZONTAL_0))));
...
function $updateNavBarState(this$static){
  ...
  $location_0[stackIndex] = 'ScrollTabBar.java:' + '485' , scrollLeft = $getScrollLeft_2(($location_0[stackIndex] = 'Element.java:' + '398' , $clinit_82() , this$static.tabBarWrapper.element));
...
function $clinit_706(){
  ...
  $location_0[stackIndex] = 'ScrollTabBar.java:' + '151' , $clinit_706 = nullMethod;
  $clinit_43();
  $stackDepth_0 = stackIndex - 1;
}
...
function $ScrollTabBar$1(this$static, this$0){
  ...
  $location_0[stackIndex] = 'ScrollTabBar.java:' + '151' , $clinit_706();
  this$static.this$0 = this$0;
  $stackDepth_0 = stackIndex - 1;
  return this$static;
}
...
function onClick_5(event_0){
  ...
  for ($location_0[stackIndex] = 'ScrollTabBar.java:' + '310' , i = 0 , n = this.this$0.tabBar.panel.children_0.size_0 - 2; i < n; $location_0[stackIndex] = 'ScrollTabBar.java:' + '310' , ++i) {
...
function $setPosition(this$static, offsetWidth){
  ...
  $location_0[stackIndex] = 'ScrollTabBar.java:' + '323' , left = $getAbsoluteLeft_0(($location_0[stackIndex] = 'Element.java:' + '150' , $clinit_82() , this$static.this$1.this$0.tabBarMenuBtn.element));
...
function execute_21(){
  ...
  if ((parseInt(($location_0[stackIndex] = 'Element.java:' + '349' , this.this$0.tabBar.element['offsetWidth'])) || 0) > (parseInt(this.this$0.tabBarWrapper.element['offsetWidth']) || 0) + (parseInt(this.this$0.navBar.element['offsetWidth']) || 0)) {
    if (this.this$0.navBar.element.style.display != 'none') {
      $location_0[stackIndex] = 'ScrollTabBar.java:' + '432' , scrollLeft = $getScrollLeft_2(($location_0[stackIndex] = 'Element.java:' + '398' , $clinit_82() , this.this$0.tabBarWrapper.element));
      (parseInt(($location_0[stackIndex] = 'Element.java:' + '349' , this.this$0.tabBarWrapper.element['offsetWidth'])) || 0) > (parseInt(this.this$0.tabBar.element['offsetWidth']) || 0) - scrollLeft && ($location_0[stackIndex] = 'Element.java:' + '695' , $setScrollLeft_1(this.this$0.tabBarWrapper.element, ($location_0[stackIndex] = 'ScrollTabBar.java:' + '436' , min_1(scrollLeft, (parseInt(this.this$0.tabBar.element['offsetWidth']) || 0) - scrollLeft))) , undefined);
    }
     else {
    ...
    $setScrollLeft_1(($location_0[stackIndex] = 'Element.java:' + '695' , $clinit_82() , this.this$0.tabBarWrapper.element), 0);
...
function execute_22(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = execute_22;
...
function execute_23(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = execute_23;
  $location_0[stackIndex] = 'Element.java:' + '565' , $scrollIntoView_0(($location_0[stackIndex] = 'Element.java:' + '565' , $clinit_82() , dynamicCast($get_6(this.this$0.tabs, ($location_0[stackIndex] = 'ScrollTabBar.java:' + '471' , $getSelectedTab(this.this$0.tabBar))), 2).element));
  $stackDepth_0 = stackIndex - 1;
}
...
_.execute = execute_23;
_.getClass$ = getClass_440;
_.typeId$ = 294;
_.this$0 = null;
function $clinit_718(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_718;
  $location_0[stackIndex] = 'ScrollTabBar.java:' + '164' , $clinit_718 = nullMethod;
  $clinit_43();
  $stackDepth_0 = stackIndex - 1;
}
...
function $ScrollTabBar$2(this$static, this$0){
  ...
  $location_0[stackIndex] = 'ScrollTabBar.java:' + '164' , $clinit_718();
  this$static.this$0 = this$0;
  $stackDepth_0 = stackIndex - 1;
  return this$static;
}
...
function $clinit_719(){
  ...
  $location_0[stackIndex] = 'ScrollTabBar.java:' + '47' , $clinit_719 = nullMethod;
  TAB_ROW_STYLES_0 = ($location_0[stackIndex] = 'ScrollTabBar.java:' + '48' , initValues(_3Ljava_lang_String_2_classLit, 687, 1, ['tabTop', 'tabMiddle', 'tabBottom']));
  $stackDepth_0 = stackIndex - 1;
}
...
function $clinit_720(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_720;
  $location_0[stackIndex] = 'ScrollTabBar.java:' + '194' , $clinit_720 = nullMethod;
  $clinit_719();
  $stackDepth_0 = stackIndex - 1;
}
...
function $ScrollTabBar$3(this$static, this$0){
  ...
  $location_0[stackIndex] = 'ScrollTabBar.java:' + '194' , $clinit_720();
  this$static.this$0 = this$0;
...
function $clinit_721(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_721;
  $location_0[stackIndex] = 'ScrollTabBar.java:' + '208' , $clinit_721 = nullMethod;
  $clinit_366();
  $stackDepth_0 = stackIndex - 1;
}
...
function $ScrollTabBar$4(this$static, this$0){
  ...
  $location_0[stackIndex] = 'ScrollTabBar.java:' + '208' , $clinit_721();
  this$static.this$0 = this$0;
...
function execute_24(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = execute_24;
...
function $clinit_728(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_728;
  $location_0[stackIndex] = 'ScrollTabBar.java:' + '62' , $clinit_728 = nullMethod;
  $clinit_351();
  $stackDepth_0 = stackIndex - 1;
}
...
function $ScrollTabBar$DecoratedBottomTabBar$1(this$static, $anonymous0, $anonymous1){
  ...
  $location_0[stackIndex] = 'ScrollTabBar.java:' + '62' , $clinit_728();
...
function $onUpdate_1(this$static, progress){
  ...
  $location_0[stackIndex] = 'ScrollTabBar.java:' + '96' , scrollLeft = $getScrollLeft_2(($location_0[stackIndex] = 'Element.java:' + '398' , $clinit_82() , this$static.scrollTabBar.tabBarWrapper.element));
  ...
  $location_0[stackIndex] = 'Element.java:' + '695' , $setScrollLeft_1(this$static.scrollTabBar.tabBarWrapper.element, scrollLeft);
  $stackDepth_0 = stackIndex - 1;
}
...
function $clinit_734(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_734;
  $location_0[stackIndex] = 'TabLayoutPanel.java:' + '64' , $clinit_734 = nullMethod;
...
function $TabLayoutPanel$TabBarPosition(this$static, enum$name, enum$ordinal){
  ...
  $location_0[stackIndex] = 'TabLayoutPanel.java:' + '64' , $clinit_734();
  $location_0[stackIndex] = 'Enum.java:' + '76' , this$static.name_0 = enum$name;
  $location_0[stackIndex] = 'Enum.java:' + '77' , this$static.ordinal = enum$ordinal;
  $stackDepth_0 = stackIndex - 1;
  return this$static;
...
function values_8(){
  ...
  $location_0[stackIndex] = 'TabLayoutPanel.java:' + '64' , $clinit_734();
  returnTemp = initValues(_3Lorg_gwt_mosaic_ui_client_TabLayoutPanel$TabBarPosition_2_classLit, 694, 92, [TOP, BOTTOM]);
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function $add_28(this$static, w){
  ...
  if (boxLayoutMgr.orientation == ($location_0[stackIndex] = 'BoxLayout.java:' + '170' , $clinit_802() , HORIZONTAL)) {
    ...
    $add_26(layoutPanel, w, ($location_0[stackIndex] = 'ToolBar.java:' + '100' , $BoxLayoutData_6(($location_0[stackIndex] = 'ToolBar.java:' + '100' , new BoxLayoutData), ($location_0[stackIndex] = 'BoxLayoutData.java:' + '30' , $clinit_804() , VERTICAL_0), width, null)));
  }
   else {
    ...
    $add_26(($location_0[stackIndex] = 'LayoutComposite.java:' + '89' , dynamicCast(this$static.widget, 182)), w, ($location_0[stackIndex] = 'ToolBar.java:' + '103' , $BoxLayoutData_6(($location_0[stackIndex] = 'ToolBar.java:' + '103' , new BoxLayoutData), ($location_0[stackIndex] = 'BoxLayoutData.java:' + '30' , $clinit_804() , BOTH), null, height)));
  }
  $stackDepth_0 = stackIndex - 1;
}
...
function addClickHandler_7(handler){
  ...
  returnTemp = ($location_0[stackIndex] = 'WindowPanel.java:' + '154' , $addDomHandler(this, handler, ($location_0[stackIndex] = 'WindowPanel.java:' + '154' , $clinit_130() , ($location_0[stackIndex] = 'ClickEvent.java:' + '27' , $clinit_130()) , TYPE_1)));
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function $InfoPanel_0(this$static, caption, description, autoHide){
  ...
  $location_0[stackIndex] = 'UIObject.java:' + '449' , setStyleName(($location_0[stackIndex] = 'PopupPanel.java:' + '1008' , $getStyleElement_1($getFirstChildElement_0(($location_0[stackIndex] = 'Element.java:' + '241' , $clinit_82() , this$static.element)))), 'mosaic-InfoPanel', true);
  $location_0[stackIndex] = 'Style.java:' + '1449' , this$static.element.style['zIndex'] = '2.147483647E9';
  $stackDepth_0 = stackIndex - 1;
  return this$static;
}
...
function getClass_485(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_485;
  $stackDepth_0 = stackIndex - 1;
...
function $clinit_772(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_772;
  $location_0[stackIndex] = 'InfoPanel.java:' + '62' , $clinit_772 = nullMethod;
  $clinit_43();
  $stackDepth_0 = stackIndex - 1;
}
...
function $InfoPanel$1(this$static, this$0){
  ...
  $location_0[stackIndex] = 'InfoPanel.java:' + '62' , $clinit_772();
  this$static.this$0 = this$0;
  $stackDepth_0 = stackIndex - 1;
  return this$static;
}

function getClass_486(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_486;
  $stackDepth_0 = stackIndex - 1;
...
function getClass_487(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_487;
  $stackDepth_0 = stackIndex - 1;
...
_.getClass$ = getClass_487;
_.typeId$ = 0;
_.this$0 = null;
function $BorderLayoutData_0(this$static, decorate){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $BorderLayoutData_0;
  $location_0[stackIndex] = 'BorderLayoutData.java:' + '68' , $BorderLayoutData_2(this$static, ($location_0[stackIndex] = 'BorderLayout.java:' + '199' , $clinit_795() , CENTER_1), decorate);
  $stackDepth_0 = stackIndex - 1;
  return this$static;
}
...
function $BorderLayoutData_6(this$static, region, preferredSize, minSize, maxSize, decorate){
  ...
  if (region == ($location_0[stackIndex] = 'BorderLayout.java:' + '199' , $clinit_795() , NORTH_0) || region == SOUTH_0) {
  ...
  this$static.minSize = (0 > minSize?0:minSize) + ($location_0[stackIndex] = 'BorderLayoutData.java:' + '397' , $clinit_109() , 'px');
...
function $BoxLayout_0(this$static, alignment){
  ...
  $location_0[stackIndex] = 'BoxLayout.java:' + '187' , $BoxLayout_2(this$static, ($location_0[stackIndex] = 'BoxLayout.java:' + '170' , $clinit_802() , HORIZONTAL), alignment);
  $stackDepth_0 = stackIndex - 1;
  return this$static;
}
...
function $clinit_812(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_812;
  $location_0[stackIndex] = 'GridLayout.java:' + '61' , $clinit_812 = nullMethod;
...
function $GridLayout(this$static, columns, rows){
  ...
  $location_0[stackIndex] = 'GridLayout.java:' + '98' , $clinit_812();
...
function $buildWidgetMatrix(this$static, layoutPanel){
  ...
  $location_0[stackIndex] = 'GridLayout.java:' + '341' , this$static.widgetMatrix = ($location_0[stackIndex] = 'Array.java:' + '153' , initDims_0([_3_3Lcom_google_gwt_user_client_ui_Widget_2_classLit, _3Lcom_google_gwt_user_client_ui_Widget_2_classLit], [729, 670], [127, 2], [this$static.cols, this$static.rows_0], 0, 2, 0));
  for ($location_0[stackIndex] = 'GridLayout.java:' + '343' , iter = $LayoutPanel$3(($location_0[stackIndex] = 'LayoutPanel.java:' + '553' , new LayoutPanel$3), layoutPanel); $location_0[stackIndex] = 'LayoutPanel.java:' + '557' , $hasNext_1(iter.iter);) {
    ...
    $location_0[stackIndex] = 'GridLayout.java:' + '348' , $clinit_629();
...
function $fireIntervalAdded(this$static, source, index0, index1){
  ...
  event_0 = ($location_0[stackIndex] = 'AbstractListModel.java:' + '64' , $ListDataEvent(($location_0[stackIndex] = 'AbstractListModel.java:' + '64' , new ListDataEvent), source, ($location_0[stackIndex] = 'ListDataEvent.java:' + '33' , $clinit_829() , INTERVAL_ADDED), index0, index1));
...
function $fireIntervalRemoved(this$static, source, index0, index1){
  ...
  event_0 = ($location_0[stackIndex] = 'AbstractListModel.java:' + '78' , $ListDataEvent(($location_0[stackIndex] = 'AbstractListModel.java:' + '78' , new ListDataEvent), source, ($location_0[stackIndex] = 'ListDataEvent.java:' + '35' , $clinit_829() , INTERVAL_REMOVED), index0, index1));
...
function $clinit_829(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_829;
  $location_0[stackIndex] = 'ListDataEvent.java:' + '29' , $clinit_829 = nullMethod;
...
function $ListDataEvent$Type(this$static, enum$name, enum$ordinal){
  ...
  $location_0[stackIndex] = 'ListDataEvent.java:' + '29' , $clinit_829();
  $location_0[stackIndex] = 'Enum.java:' + '76' , this$static.name_0 = enum$name;
  $location_0[stackIndex] = 'Enum.java:' + '77' , this$static.ordinal = enum$ordinal;
  $stackDepth_0 = stackIndex - 1;
  return this$static;
...
function values_15(){
  ...
  $location_0[stackIndex] = 'ListDataEvent.java:' + '29' , $clinit_829();
  returnTemp = initValues(_3Lorg_gwt_mosaic_ui_client_list_ListDataEvent$Type_2_classLit, 701, 99, [CONTENTS_CHANGED, INTERVAL_ADDED, INTERVAL_REMOVED]);
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function $ListHeader(this$static, names){
  ...
  this$static.array = ($location_0[stackIndex] = 'ArrayList.java:' + '64' , initDim(_3Ljava_lang_Object_2_classLit, 684, 0, 0, 0));
  if (names != null) {
...
function $AbstractScrollTable(this$static, dataTable, headerTable, resources){
  ...
  this$static.children_0 = $WidgetCollection(($location_0[stackIndex] = 'ComplexPanel.java:' + '28' , new WidgetCollection), this$static);
  $location_0[stackIndex] = 'AbstractScrollTable.java:' + '903' , this$static.columnResizePolicy = ($location_0[stackIndex] = 'AbstractScrollTable.java:' + '823' , $clinit_836() , MULTI_CELL);
  $location_0[stackIndex] = 'AbstractScrollTable.java:' + '981' , this$static.resizePolicy = ($location_0[stackIndex] = 'AbstractScrollTable.java:' + '844' , $clinit_841() , FLOW);
  ...
  $location_0[stackIndex] = 'AbstractScrollTable.java:' + '991' , this$static.scrollPolicy = ($location_0[stackIndex] = 'AbstractScrollTable.java:' + '874' , $clinit_842() , BOTH_0);
  $location_0[stackIndex] = 'AbstractScrollTable.java:' + '996' , this$static.sortPolicy = ($location_0[stackIndex] = 'AbstractScrollTable.java:' + '887' , $clinit_846() , SINGLE_CELL_0);
  ...
  $location_0[stackIndex] = 'AbstractScrollTable.java:' + '1064' , mainElem = $createElement(($location_0[stackIndex] = 'Document.java:' + '252' , $clinit_82() , $doc), 'div');
  ...
  $location_0[stackIndex] = 'AbstractScrollTable.java:' + '1072' , this$static.absoluteElem = ($location_0[stackIndex] = 'Document.java:' + '252' , $createElement($doc, 'div'));
  ...
  imageResource = ($location_0[stackIndex] = 'AbstractScrollTable.java:' + '1111' , $scrollTableFillWidth((!resources.style_0 && (resources.style_0 = ($location_0[stackIndex] = 'org_gwt_mosaic_ui_client_table_AbstractScrollTable_ScrollTableStyle_default_StaticClientBundleGenerator.java:' + '6' , $clinit_881() , ($location_0[stackIndex] = 'AbstractScrollTable.java:' + '800' , new org_gwt_mosaic_ui_client_table_AbstractScrollTable_ScrollTableStyle_default_StaticClientBundleGenerator))) , resources.style_0)));
  $location_0[stackIndex] = 'AbstractScrollTable.java:' + '1112' , $setUrlAndVisibleRect(this$static.fillWidthImage, imageResource.url, imageResource.left_0, imageResource.top_0, imageResource.width_0, imageResource.height_0);
  ...
  $location_0[stackIndex] = 'AbstractScrollTable.java:' + '1128' , this$static.sortedColumnWrapper = ($location_0[stackIndex] = 'Document.java:' + '930' , $createElement($doc, 'span'));
...
function $adoptTable(this$static, table, wrapper, index){
  ...
  $location_0[stackIndex] = 'ComplexPanel.java:' + '87' , $add_10(this$static.children_0, table);
...
function $applySortedColumnIndicator(this$static, tdElem, ascending){
  ...
  $location_0[stackIndex] = 'AbstractScrollTable.java:' + '1776' , $setUrlAndVisibleRect(sortIndicator, imageResource.url, imageResource.left_0, imageResource.top_0, imageResource.width_0, imageResource.height_0);
  $location_0[stackIndex] = 'Element.java:' + '614' , this$static.sortedColumnWrapper.innerHTML = '&nbsp;' + ($location_0[stackIndex] = 'AbstractScrollTable.java:' + '1779' , $toString_11(sortIndicator)) || '';
...
function $applyTableWrapperSizes(this$static, sizes){
  ...
  $location_0[stackIndex] = 'Style.java:' + '1449' , this$static.headerWrapper.style['height'] = sizes.headerTableHeight + ($location_0[stackIndex] = 'Style.java:' + '1369' , $clinit_109() , 'px');
...
function $createWrapper_0(cssName){
  ...
  $location_0[stackIndex] = 'AbstractScrollTable.java:' + '1795' , wrapper = $createElement(($location_0[stackIndex] = 'Document.java:' + '252' , $clinit_82() , $doc), 'div');
  $location_0[stackIndex] = 'Style.java:' + '1449' , wrapper.style['width'] = '100%';
  wrapper.style['overflow'] = 'hidden';
  $location_0[stackIndex] = 'Style.java:' + '1449' , wrapper.style['padding'] = 0 + ($location_0[stackIndex] = 'Style.java:' + '1369' , $clinit_109() , 'px');
...
function $getAvailableWidth(this$static){
  ...
  if (this$static.scrollPolicy == ($location_0[stackIndex] = 'AbstractScrollTable.java:' + '874' , $clinit_842() , BOTH_0)) {
...
function $getTableWrapperSizes(this$static){
  ...
  if (this$static.scrollPolicy == ($location_0[stackIndex] = 'AbstractScrollTable.java:' + '874' , $clinit_842() , DISABLED_0) || this$static.scrollPolicy == HORIZONTAL_1) {
    $stackDepth_0 = stackIndex - 1;
    return null;
  }
...
function $resizeTablesVertically(this$static){
  ...
  if (this$static.scrollPolicy == ($location_0[stackIndex] = 'AbstractScrollTable.java:' + '874' , $clinit_842() , DISABLED_0)) {
...
function $scrollTables(this$static, baseHeader){
  ...
  if (this$static.lastScrollLeft >= 0) {
    $setScrollLeft_1(($location_0[stackIndex] = 'Element.java:' + '695' , $clinit_82() , this$static.headerWrapper), this$static.lastScrollLeft);
    baseHeader && ($setScrollLeft_1(this$static.dataWrapper, this$static.lastScrollLeft) , undefined);
  }
  $stackDepth_0 = stackIndex - 1;
}
...
function $updateFillWidthImage(this$static){
  ...
  this$static.columnResizePolicy == ($location_0[stackIndex] = 'AbstractScrollTable.java:' + '823' , $clinit_836() , DISABLED) || this$static.resizePolicy.isFixedWidth?($location_0[stackIndex] = 'UIObject.java:' + '214' , this$static.fillWidthImage.element.style.display = 'none' , undefined):(this$static.fillWidthImage.element.style.display = '' , undefined);
  $stackDepth_0 = stackIndex - 1;
}
...
function onBrowserEvent_12(event_0){
  ...
  $location_0[stackIndex] = 'AbstractScrollTable.java:' + '1375' , target = ($location_0[stackIndex] = 'NativeEvent.java:' + '109' , $clinit_82() , event_0).srcElement;
  switch ($location_0[stackIndex] = 'DOMImpl.java:' + '61' , $eventGetTypeInt(event_0.type)) {
    case 16384:
      $location_0[stackIndex] = 'AbstractScrollTable.java:' + '1379' , this.lastScrollLeft = ($location_0[stackIndex] = 'Element.java:' + '398' , $getScrollLeft_2(this.dataWrapper));
      $location_0[stackIndex] = 'AbstractScrollTable.java:' + '1380' , $scrollTables(this, false);
      ($location_0[stackIndex] = 'Node.java:' + '274' , $isOrHasChild_0(this.dataWrapper, target)) && ($location_0[stackIndex] = 'DomEvent.java:' + '91' , fireNativeEvent(event_0, this, null));
      break;
    case 4:
    ...
    case 8:
      ...
      if (this.resizeWorker.resizing) {
        ...
        ($location_0[stackIndex] = 'Node.java:' + '274' , $isOrHasChild_0(this.headerWrapper, target))?($location_0[stackIndex] = 'AbstractScrollTable.java:' + '1407' , $scrollTables(this, true)):($location_0[stackIndex] = 'AbstractScrollTable.java:' + '1409' , $scrollTables(this, false));
        cellElem = ($location_0[stackIndex] = 'AbstractScrollTable.java:' + '1413' , $getEventTargetCell(this.headerTable, event_0));
        if (cellElem) {
          if (this.sortPolicy == ($location_0[stackIndex] = 'AbstractScrollTable.java:' + '887' , $clinit_846() , DISABLED_1)) {
            $stackDepth_0 = stackIndex - 1;
            return;
          }
    ...
    case 64:
      ...
      break;
    case 32:
      $location_0[stackIndex] = 'AbstractScrollTable.java:' + '1451' , toElem = event_0.relatedTarget || event_0.toElement;
      if (!toElem || !($location_0[stackIndex] = 'Node.java:' + '274' , $isOrHasChild_0(this.dataWrapper, toElem))) {
...
function $clinit_834(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_834;
  $location_0[stackIndex] = 'AbstractScrollTable.java:' + '1101' , $clinit_834 = nullMethod;
  $clinit_400();
  $stackDepth_0 = stackIndex - 1;
}
...
function $AbstractScrollTable$1(this$static, this$0){
  ...
  $location_0[stackIndex] = 'AbstractScrollTable.java:' + '1101' , $clinit_834();
  this$static.this$0 = this$0;
  $Image(this$static);
  $stackDepth_0 = stackIndex - 1;
  return this$static;
...
function onBrowserEvent_13(event_0){
  ...
  ($location_0[stackIndex] = 'DOMImpl.java:' + '61' , $eventGetTypeInt(($location_0[stackIndex] = 'NativeEvent.java:' + '209' , $clinit_82() , event_0).type)) == 1 && ($location_0[stackIndex] = 'AbstractScrollTable.java:' + '1106' , $fillWidth(this.this$0));
  $stackDepth_0 = stackIndex - 1;
}
...
function $onColumnSorted(this$static, event_0){
  ...
  if ($location_0[stackIndex] = 'AbstractScrollTable.java:' + '1151' , $isColumnSortable(this$static.this$0, column)) {
    $location_0[stackIndex] = 'AbstractScrollTable.java:' + '1152' , parent_0 = ($location_0[stackIndex] = 'DOMImpl.java:' + '236' , parent_1 = ($location_0[stackIndex] = 'Node.java:' + '184' , $clinit_82() , this$static.this$0.sortedColumnWrapper).parentNode , (!parent_1 || parent_1.nodeType != 1) && ($location_0[stackIndex] = 'DOMImpl.java:' + '238' , parent_1 = null) , parent_1);
...
function $clinit_836(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_836;
  $location_0[stackIndex] = 'AbstractScrollTable.java:' + '822' , $clinit_836 = nullMethod;
...
function $AbstractScrollTable$ColumnResizePolicy(this$static, enum$name, enum$ordinal){
  ...
  $location_0[stackIndex] = 'AbstractScrollTable.java:' + '822' , $clinit_836();
  $location_0[stackIndex] = 'Enum.java:' + '76' , this$static.name_0 = enum$name;
  $location_0[stackIndex] = 'Enum.java:' + '77' , this$static.ordinal = enum$ordinal;
  $stackDepth_0 = stackIndex - 1;
  return this$static;
...
function values_16(){
  ...
  $location_0[stackIndex] = 'AbstractScrollTable.java:' + '822' , $clinit_836();
  returnTemp = initValues(_3Lorg_gwt_mosaic_ui_client_table_AbstractScrollTable$ColumnResizePolicy_2_classLit, 702, 100, [DISABLED, SINGLE_CELL, MULTI_CELL]);
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function $getStyle_0(this$static){
  ...
  !this$static.style_0 && (this$static.style_0 = ($location_0[stackIndex] = 'org_gwt_mosaic_ui_client_table_AbstractScrollTable_ScrollTableStyle_default_StaticClientBundleGenerator.java:' + '6' , $clinit_881() , ($location_0[stackIndex] = 'AbstractScrollTable.java:' + '800' , new org_gwt_mosaic_ui_client_table_AbstractScrollTable_ScrollTableStyle_default_StaticClientBundleGenerator)));
...
function $repositionSpacer(scrollTable, force){
  ...
  if (!force && scrollTable.scrollPolicy != ($location_0[stackIndex] = 'AbstractScrollTable.java:' + '874' , $clinit_842() , BOTH_0)) {
    $stackDepth_0 = stackIndex - 1;
    return;
  }
...
function $resizeSpacer(table, spacerWidth){
  ...
  $location_0[stackIndex] = 'Style.java:' + '1449' , table.element.style['paddingRight'] = spacerWidth + ($location_0[stackIndex] = 'Style.java:' + '1369' , $clinit_109() , 'px');
  $stackDepth_0 = stackIndex - 1;
}
...
function $resizeColumn_0(this$static){
  ...
  if (this$static.mouseXLast != this$static.mouseXCurrent) {
    ...
    $location_0[stackIndex] = 'AbstractScrollTable.java:' + '588' , $clinit_227();
...
function $setCurrentCell(this$static, event_0){
  ...
  if (this$static.table.columnResizePolicy == ($location_0[stackIndex] = 'AbstractScrollTable.java:' + '823' , $clinit_836() , MULTI_CELL)) {
  ...
  $location_0[stackIndex] = 'AbstractScrollTable.java:' + '444' , clientX = ($location_0[stackIndex] = 'NativeEvent.java:' + '72' , $clinit_82() , event_0).clientX || 0;
  if (cell) {
    ...
    $location_0[stackIndex] = 'AbstractScrollTable.java:' + '447' , $clinit_227();
...
function $startResizing(this$static, event_0){
  ...
  if (this$static.curCell) {
    ...
    $location_0[stackIndex] = 'AbstractScrollTable.java:' + '520' , this$static.mouseXStart = ($location_0[stackIndex] = 'NativeEvent.java:' + '72' , $clinit_82() , event_0).clientX || 0;
...
function $clinit_840(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_840;
  $location_0[stackIndex] = 'AbstractScrollTable.java:' + '373' , $clinit_840 = nullMethod;
  $clinit_43();
  $stackDepth_0 = stackIndex - 1;
}
...
function $AbstractScrollTable$MouseResizeWorker$1(this$static, this$1){
  ...
  $location_0[stackIndex] = 'AbstractScrollTable.java:' + '373' , $clinit_840();
...
function $clinit_841(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_841;
  $location_0[stackIndex] = 'AbstractScrollTable.java:' + '843' , $clinit_841 = nullMethod;
...
function $AbstractScrollTable$ResizePolicy(this$static, enum$name, enum$ordinal, isFixedWidth, isSacrificial){
  ...
  $location_0[stackIndex] = 'AbstractScrollTable.java:' + '850' , $clinit_841();
  $location_0[stackIndex] = 'Enum.java:' + '76' , this$static.name_0 = enum$name;
  $location_0[stackIndex] = 'Enum.java:' + '77' , this$static.ordinal = enum$ordinal;
...
function values_17(){
  ...
  $location_0[stackIndex] = 'AbstractScrollTable.java:' + '843' , $clinit_841();
  returnTemp = initValues(_3Lorg_gwt_mosaic_ui_client_table_AbstractScrollTable$ResizePolicy_2_classLit, 703, 101, [UNCONSTRAINED, FLOW, FIXED_WIDTH, FILL_WIDTH]);
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function $clinit_842(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_842;
  $location_0[stackIndex] = 'AbstractScrollTable.java:' + '873' , $clinit_842 = nullMethod;
...
function $AbstractScrollTable$ScrollPolicy(this$static, enum$name, enum$ordinal){
  ...
  $location_0[stackIndex] = 'AbstractScrollTable.java:' + '873' , $clinit_842();
  $location_0[stackIndex] = 'Enum.java:' + '76' , this$static.name_0 = enum$name;
  $location_0[stackIndex] = 'Enum.java:' + '77' , this$static.ordinal = enum$ordinal;
  $stackDepth_0 = stackIndex - 1;
  return this$static;
...
function values_18(){
  ...
  $location_0[stackIndex] = 'AbstractScrollTable.java:' + '873' , $clinit_842();
  returnTemp = initValues(_3Lorg_gwt_mosaic_ui_client_table_AbstractScrollTable$ScrollPolicy_2_classLit, 704, 102, [HORIZONTAL_1, BOTH_0, DISABLED_0]);
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function $clinit_846(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_846;
  $location_0[stackIndex] = 'AbstractScrollTable.java:' + '886' , $clinit_846 = nullMethod;
...
function $AbstractScrollTable$SortPolicy(this$static, enum$name, enum$ordinal){
  ...
  $location_0[stackIndex] = 'AbstractScrollTable.java:' + '886' , $clinit_846();
  $location_0[stackIndex] = 'Enum.java:' + '76' , this$static.name_0 = enum$name;
  $location_0[stackIndex] = 'Enum.java:' + '77' , this$static.ordinal = enum$ordinal;
  $stackDepth_0 = stackIndex - 1;
  return this$static;
...
function values_19(){
  ...
  $location_0[stackIndex] = 'AbstractScrollTable.java:' + '886' , $clinit_846();
  returnTemp = initValues(_3Lorg_gwt_mosaic_ui_client_table_AbstractScrollTable$SortPolicy_2_classLit, 705, 103, [DISABLED_1, SINGLE_CELL_0, MULTI_CELL_0]);
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function $createRow_1(this$static){
  ...
  if (this$static.selectionPolicy.inputHtml != null) {
    ...
    0 >= tr.children.length?($location_0[stackIndex] = 'DOMImplTrident.java:' + '177' , tr.appendChild(td)):tr.insertBefore(td, ($location_0[stackIndex] = 'DOMImplTrident.java:' + '179' , tr.children[0]));
...
function $deselectAllRows(this$static, fireEvent){
  ...
  for ($location_0[stackIndex] = 'SelectionGrid.java:' + '591' , rowElem$iterator = ($location_0[stackIndex] = 'AbstractMap.java:' + '180' , outerIter = ($location_0[stackIndex] = 'AbstractHashMap.java:' + '64' , $AbstractHashMap$EntrySetIterator(($location_0[stackIndex] = 'AbstractHashMap.java:' + '64' , new AbstractHashMap$EntrySetIterator), ($location_0[stackIndex] = 'SelectionGrid.java:' + '591' , $values(this$static.selectedRows)).val$entrySet.this$0)) , $AbstractMap$2$1(($location_0[stackIndex] = 'AbstractMap.java:' + '181' , new AbstractMap$2$1), outerIter)); $location_0[stackIndex] = 'AbstractHashMap.java:' + '104' , $hasNext_4(rowElem$iterator.val$outerIter.iter);) {
    ...
    hasInputColumn && ($location_0[stackIndex] = 'InputElement.java:' + '267' , $getFirstChildElement_0(($location_0[stackIndex] = 'Element.java:' + '241' , $clinit_82() , rowElem)).firstChild.checked = false , undefined);
  }
...
function $deselectRow(this$static, row, fireEvent){
  ...
  if (rowElem) {
    ...
    this$static.selectionPolicy.inputHtml != null && ($location_0[stackIndex] = 'InputElement.java:' + '267' , $getFirstChildElement_0(($location_0[stackIndex] = 'Element.java:' + '241' , $clinit_82() , rowElem)).firstChild.checked = false , undefined);
...
function $getSelectedRowsSet(this$static){
  ...
  for ($location_0[stackIndex] = 'SelectionGrid.java:' + '696' , rowIndex$iterator = (outerIter = ($location_0[stackIndex] = 'AbstractMap.java:' + '107' , ($location_0[stackIndex] = 'SelectionGrid.java:' + '696' , $keySet_1(this$static.selectedRows)).val$entrySet.iterator_0()) , $AbstractMap$1$1(($location_0[stackIndex] = 'AbstractMap.java:' + '108' , new AbstractMap$1$1), outerIter)); $location_0[stackIndex] = 'AbstractMap.java:' + '110' , rowIndex$iterator.val$outerIter.hasNext();) {
    ...
    ($location_0[stackIndex] = 'TreeSet.java:' + '69' , $put_1(rowSet.map, $TableEvent$Row(($location_0[stackIndex] = 'SelectionGrid.java:' + '697' , new TableEvent$Row), rowIndex.value_0), ($location_0[stackIndex] = 'Boolean.java:' + '29' , $clinit_521() , FALSE_0))) == null;
  }
  $stackDepth_0 = stackIndex - 1;
  return rowSet;
}
...
function $highlightCell(this$static, cellElem){
  ...
  !!cellElem && ($location_0[stackIndex] = 'SelectionGrid.java:' + '716' , rowElem = ($location_0[stackIndex] = 'DOMImpl.java:' + '236' , parent_0 = ($location_0[stackIndex] = 'Node.java:' + '184' , $clinit_82() , cellElem).parentNode , (!parent_0 || parent_0.nodeType != 1) && ($location_0[stackIndex] = 'DOMImpl.java:' + '238' , parent_0 = null) , parent_0));
...
function $onBrowserEvent_3(this$static, event_0){
  ...
  switch ($eventGetTypeInt(event_0.type)) {
    case 16:
      ...
      break;
    case 32:
      $location_0[stackIndex] = 'SelectionGrid.java:' + '339' , toElem = event_0.relatedTarget || event_0.toElement;
      if (!!this$static.highlightedRowElem && (!toElem || !($location_0[stackIndex] = 'Node.java:' + '274' , $isOrHasChild_0(this$static.highlightedRowElem, toElem)))) {
...
function $onMouseClick(this$static, event_0){
  ...
  $location_0[stackIndex] = 'SelectionGrid.java:' + '382' , targetRow = ($location_0[stackIndex] = 'DOMImpl.java:' + '236' , parent_0 = ($location_0[stackIndex] = 'Node.java:' + '184' , $clinit_82() , targetCell).parentNode , (!parent_0 || parent_0.nodeType != 1) && ($location_0[stackIndex] = 'DOMImpl.java:' + '238' , parent_0 = null) , parent_0);
  targetRowIndex = ($location_0[stackIndex] = 'SelectionGrid.java:' + '383' , this$static.getRowIndex(targetRow));
  if (this$static.selectionPolicy == ($location_0[stackIndex] = 'SelectionGrid.java:' + '127' , $clinit_872() , MULTI_ROW)) {
    ...
    (ctrlKey || shiftKey) && ($location_0[stackIndex] = 'DOMImplTrident.java:' + '166' , event_0.returnValue = false , undefined);
...
function $selectRow_1(this$static, row, rowElem, unselectAll, fireEvent){
  ...
  this$static.selectionPolicy.inputHtml != null && ($location_0[stackIndex] = 'InputElement.java:' + '267' , $getFirstChildElement_0(($location_0[stackIndex] = 'Element.java:' + '241' , $clinit_82() , rowElem)).firstChild.checked = true , undefined);
  ...
  if (selectionPolicy.inputHtml != null) {
    if (this$static.selectionPolicy.inputHtml != null) {
      ...
      for ($location_0[stackIndex] = 'SelectionGrid.java:' + '535' , i = 0; i < this$static.numRows; $location_0[stackIndex] = 'SelectionGrid.java:' + '535' , ++i) {
        ...
        $location_0[stackIndex] = 'Element.java:' + '614' , $getFirstChildElement_0(($location_0[stackIndex] = 'Element.java:' + '241' , $clinit_82() , tr)).innerHTML = inputHtml || '';
      }
    }
     else {
      ...
      for ($location_0[stackIndex] = 'SelectionGrid.java:' + '544' , i = 0; i < this$static.numRows; $location_0[stackIndex] = 'SelectionGrid.java:' + '544' , ++i) {
        ...
        $location_0[stackIndex] = 'Node.java:' + '250' , tr.insertBefore(($location_0[stackIndex] = 'Node.java:' + '94' , td.cloneNode(true)), $getFirstChildElement_0(($location_0[stackIndex] = 'Element.java:' + '241' , $clinit_82() , tr)));
      }
    }
  }
    ...
    for ($location_0[stackIndex] = 'SelectionGrid.java:' + '551' , i = 0; i < this$static.numRows; $location_0[stackIndex] = 'SelectionGrid.java:' + '551' , ++i) {
      ...
      $location_0[stackIndex] = 'Node.java:' + '285' , tr.removeChild($getFirstChildElement_0(($location_0[stackIndex] = 'Element.java:' + '241' , $clinit_82() , tr)));
    }
  }
...
function $sortColumn_0(this$static, column, ascending){
  ...
  selectedRows = dynamicCast(($location_0[stackIndex] = 'SortableGrid.java:' + '347' , $toArray(($location_0[stackIndex] = 'SortableGrid.java:' + '347' , $values(this$static.selectedRows)), ($location_0[stackIndex] = 'SortableGrid.java:' + '348' , initDim(_3Lcom_google_gwt_core_client_JavaScriptObject_2_classLit, 632, -1, 0, 0)))), 220);
  $location_0[stackIndex] = 'SelectionGrid.java:' + '255' , $deselectAllRows(this$static, true);
...
function $applySort(this$static, trElems){
  ...
  for ($location_0[stackIndex] = 'FixedWidthGrid.java:' + '452' , i = trElems.length - 1; i >= 0; $location_0[stackIndex] = 'FixedWidthGrid.java:' + '452' , --i) {
    if ($location_0[stackIndex] = 'FixedWidthGrid.java:' + '453' , trElems[i]) {
      ...
      1 >= bodyElem.children.length?($location_0[stackIndex] = 'DOMImplTrident.java:' + '177' , bodyElem.appendChild(($location_0[stackIndex] = 'FixedWidthGrid.java:' + '456' , trElems[i]))):bodyElem.insertBefore(($location_0[stackIndex] = 'FixedWidthGrid.java:' + '456' , trElems[i]), ($location_0[stackIndex] = 'DOMImplTrident.java:' + '179' , bodyElem.children[1]));
    }
  }
  $stackDepth_0 = stackIndex - 1;
}
...
function $getColumnWidth(this$static, column){
  ...
  colWidth = dynamicCast($get_8(this$static.colWidths, ($location_0[stackIndex] = 'FixedWidthGrid.java:' + '173' , valueOf_4(column))), 82);
  if (!colWidth) {
    $stackDepth_0 = stackIndex - 1;
    return 80;
  }
...
function $getGhostCellElement(this$static, column){
  ...
  returnTemp = ($location_0[stackIndex] = 'DOMImplTrident.java:' + '67' , (!impl_4 && (impl_4 = ($location_0[stackIndex] = 'FixedWidthTableImpl.java:' + '65' , new FixedWidthTableImpl$Impl)) , this$static.ghostRow).children[column]);
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function $recalculateIdealColumnWidths_0(this$static){
  ...
  if (!this$static.attached || this$static.numRows == 0 || columnCount < 1) {
    this$static.idealWidths = ($location_0[stackIndex] = 'FixedWidthGrid.java:' + '408' , initDim(_3I_classLit, 672, -1, 0, 1));
    $stackDepth_0 = stackIndex - 1;
    return;
  }
...
function $setColumnWidthImpl(this$static, column, width){
  ...
  $location_0[stackIndex] = 'Style.java:' + '1449' , ($location_0[stackIndex] = 'DOMImplTrident.java:' + '67' , (!impl_4 && (impl_4 = ($location_0[stackIndex] = 'FixedWidthTableImpl.java:' + '65' , new FixedWidthTableImpl$Impl)) , this$static.ghostRow).children[column]).style['width'] = width + ($location_0[stackIndex] = 'Style.java:' + '1369' , $clinit_109() , 'px');
  $stackDepth_0 = stackIndex - 1;
}
...
function $setSelectionPolicy_0(this$static, selectionPolicy){
  ...
  if (selectionPolicy.inputHtml != null && this$static.selectionPolicy.inputHtml == null) {
    ...
    $location_0[stackIndex] = 'Node.java:' + '250' , tr.insertBefore(td, $getFirstChildElement_0(($location_0[stackIndex] = 'Element.java:' + '241' , $clinit_82() , tr)));
...
function $setText_7(this$static, row, column, text){
  ...
  $location_0[stackIndex] = 'FixedWidthGrid.java:' + '314' , $setText_4(this$static, row, column, text);
  $location_0[stackIndex] = 'FixedWidthGrid.java:' + '465' , this$static.idealWidths = null;
  $stackDepth_0 = stackIndex - 1;
}
...
function $DataTable(this$static){
  ...
  $location_0[stackIndex] = 'SelectionGrid.java:' + '200' , this$static.selectionPolicy = ($location_0[stackIndex] = 'SelectionGrid.java:' + '127' , $clinit_872() , MULTI_ROW);
...
function $getColumnWidth_0(this$static, column){
  ...
  colWidth = $get_8(this$static.colWidths, ($location_0[stackIndex] = 'FixedWidthFlexTable.java:' + '272' , valueOf_4(column)));
  if (colWidth == null) {
    $stackDepth_0 = stackIndex - 1;
    return 80;
  }
...
function $getNumColumnsPerRow(this$static, row){
  ...
  if (this$static.columnsPerRow.size_0 <= row) {
    ...
    returnTemp = dynamicCast(($location_0[stackIndex] = 'FixedWidthFlexTable.java:' + '646' , $get_6(this$static.columnsPerRow, row)), 82).value_0;
    $stackDepth_0 = stackIndex - 1;
    return returnTemp;
  }
  $stackDepth_0 = stackIndex - 1;
...
function $recalculateIdealColumnWidths_1(this$static){
  ...
  if (!this$static.attached || this$static.bodyElem.rows.length - 1 == 0 || columnCount < 1) {
    this$static.idealWidths = ($location_0[stackIndex] = 'FixedWidthFlexTable.java:' + '588' , initDim(_3I_classLit, 672, -1, 0, 1));
    $stackDepth_0 = stackIndex - 1;
    return;
  }
...
function $setNumColumnsPerRow(this$static, row, numColumns){
  ...
  row < this$static.columnsPerRow.size_0?($location_0[stackIndex] = 'FixedWidthFlexTable.java:' + '678' , $set_2(this$static.columnsPerRow, row, numColumnsI)):($location_0[stackIndex] = 'FixedWidthFlexTable.java:' + '680' , $add_7(this$static.columnsPerRow, numColumnsI));
  ...
  if ($location_0[stackIndex] = 'FixedWidthFlexTable.java:' + '685' , $containsKey_0(this$static.columnCountMap, oldNumColumnsI)) {
    numRows = dynamicCast(($location_0[stackIndex] = 'FixedWidthFlexTable.java:' + '686' , $get_8(this$static.columnCountMap, oldNumColumnsI)), 82).value_0;
    if (numRows == 1) {
  ...
  if (numColumns > 0) {
    if ($location_0[stackIndex] = 'FixedWidthFlexTable.java:' + '697' , $containsKey_0(this$static.columnCountMap, numColumnsI)) {
      numRows = dynamicCast(($location_0[stackIndex] = 'FixedWidthFlexTable.java:' + '698' , $get_8(this$static.columnCountMap, numColumnsI)), 82).value_0;
...
function $setText_8(this$static, row, column, text){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $setText_8;
  $location_0[stackIndex] = 'FixedWidthFlexTable.java:' + '490' , $setText_4(this$static, row, column, text);
  $location_0[stackIndex] = 'FixedWidthFlexTable.java:' + '601' , this$static.idealWidths = null;
  $stackDepth_0 = stackIndex - 1;
}
...
function $updateGhostRow_0(this$static){
  ...
  if (this$static.maxRawColumnCount > curNumGhosts) {
    ...
    for ($location_0[stackIndex] = 'FixedWidthFlexTable.java:' + '730' , i = curNumGhosts; i < this$static.maxRawColumnCount; $location_0[stackIndex] = 'FixedWidthFlexTable.java:' + '730' , ++i) {
      $location_0[stackIndex] = 'FixedWidthFlexTable.java:' + '731' , td = ($location_0[stackIndex] = 'DOMImplTrident.java:' + '67' , (!impl_4 && (impl_4 = ($location_0[stackIndex] = 'FixedWidthTableImpl.java:' + '65' , new FixedWidthTableImpl$Impl)) , this$static.ghostRow).children[i]);
    ...
    for ($location_0[stackIndex] = 'FixedWidthFlexTable.java:' + '738' , i = 0; i < cellsToRemove; $location_0[stackIndex] = 'FixedWidthFlexTable.java:' + '738' , ++i) {
      $location_0[stackIndex] = 'Node.java:' + '285' , this$static.ghostRow.removeChild(($location_0[stackIndex] = 'DOMImplTrident.java:' + '67' , (!impl_4 && (impl_4 = ($location_0[stackIndex] = 'FixedWidthTableImpl.java:' + '65' , new FixedWidthTableImpl$Impl)) , this$static.ghostRow).children[this$static.maxRawColumnCount]));
    }
  }
  $stackDepth_0 = stackIndex - 1;
}
...
function insertRow_0(beforeRow){
  ...
  $location_0[stackIndex] = 'FixedWidthFlexTable.java:' + '334' , tr = $createElement(($location_0[stackIndex] = 'Document.java:' + '1063' , $clinit_82() , $doc), 'tr');
...
function $createGhostCell(td){
  ...
  !td && ($location_0[stackIndex] = 'FixedWidthTableImpl.java:' + '102' , td = $createElement(($location_0[stackIndex] = 'Document.java:' + '271' , $clinit_82() , $doc), 'td'));
  $location_0[stackIndex] = 'Style.java:' + '1449' , td.style['height'] = 0 + ($location_0[stackIndex] = 'Style.java:' + '1369' , $clinit_109() , 'px');
...
function $createGhostRow(){
  ...
  $location_0[stackIndex] = 'FixedWidthTableImpl.java:' + '120' , ghostRow = $createElement(($location_0[stackIndex] = 'Document.java:' + '1063' , $clinit_82() , $doc), 'tr');
  $location_0[stackIndex] = 'Style.java:' + '1449' , ghostRow.style['margin'] = 0 + ($location_0[stackIndex] = 'Style.java:' + '1369' , $clinit_109() , 'px');
...
function $recalculateIdealColumnWidths_2(info){
  ...
  if (!info) {
    returnTemp = ($location_0[stackIndex] = 'FixedWidthTableImpl.java:' + '148' , initDim(_3I_classLit, 672, -1, 0, 1));
    $stackDepth_0 = stackIndex - 1;
    return returnTemp;
  }
  ...
  if (!table.attached || ($location_0[stackIndex] = 'FixedWidthTableImpl.java:' + '154' , table.getRowCount()) == 0 || columnCount < 1) {
    returnTemp = ($location_0[stackIndex] = 'FixedWidthTableImpl.java:' + '155' , initDim(_3I_classLit, 672, -1, 0, 1));
    $stackDepth_0 = stackIndex - 1;
    return returnTemp;
  }
  idealWidths = ($location_0[stackIndex] = 'FixedWidthTableImpl.java:' + '159' , initDim(_3I_classLit, 672, -1, columnCount, 1));
  $location_0[stackIndex] = 'FixedWidthTableImpl.java:' + '160' , td = $getFirstChildElement_0(($location_0[stackIndex] = 'Element.java:' + '241' , $clinit_82() , info.tr));
...
function $recalculateIdealColumnWidthsSetup_0(table, columnCount, offset){
  ...
  $location_0[stackIndex] = 'FixedWidthTableImpl.java:' + '185' , tr = $createElement(($location_0[stackIndex] = 'Document.java:' + '1063' , $clinit_82() , $doc), 'tr');
  $location_0[stackIndex] = 'FixedWidthTableImpl.java:' + '186' , td = ($location_0[stackIndex] = 'Document.java:' + '985' , $createElement($doc, 'td'));
...
function $getColumnWidthInfo_1(this$static, column){
  ...
  info = dynamicCast($get_8(this$static.columnWidthInfos, ($location_0[stackIndex] = 'ScrollTable.java:' + '239' , valueOf_4(column))), 216);
  if (!info) {
...
function $isColumnSortable(this$static, column){
  ...
  returnTemp = this$static.sortPolicy != ($location_0[stackIndex] = 'AbstractScrollTable.java:' + '887' , $clinit_846() , DISABLED_1) && !($location_0[stackIndex] = 'HashSet.java:' + '83' , $containsKey_0(this$static.unsortableColumns.map, ($location_0[stackIndex] = 'ScrollTable.java:' + '116' , valueOf_4(column))));
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function isColumnSortable(column){
  var stackIndex, returnTemp;
  $stack_0[stackIndex = ++$stackDepth_0] = isColumnSortable;
  returnTemp = this.sortPolicy != ($location_0[stackIndex] = 'AbstractScrollTable.java:' + '887' , $clinit_846() , DISABLED_1) && !($location_0[stackIndex] = 'HashSet.java:' + '83' , $containsKey_0(this.unsortableColumns.map, ($location_0[stackIndex] = 'ScrollTable.java:' + '116' , valueOf_4(column))));
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function $clinit_872(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_872;
  $location_0[stackIndex] = 'SelectionGrid.java:' + '126' , $clinit_872 = nullMethod;
...
function $SelectionGrid$SelectionPolicy(this$static, enum$name, enum$ordinal, inputHtml){
  ...
  $location_0[stackIndex] = 'SelectionGrid.java:' + '132' , $clinit_872();
  $location_0[stackIndex] = 'Enum.java:' + '76' , this$static.name_0 = enum$name;
  $location_0[stackIndex] = 'Enum.java:' + '77' , this$static.ordinal = enum$ordinal;
...
function values_20(){
  ...
  $location_0[stackIndex] = 'SelectionGrid.java:' + '126' , $clinit_872();
  returnTemp = initValues(_3Lorg_gwt_mosaic_ui_client_table_SelectionGrid$SelectionPolicy_2_classLit, 706, 104, [ONE_ROW, MULTI_ROW, CHECKBOX, RADIO]);
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function compare_5(p0, p1){
  ...
  returnTemp = ($location_0[stackIndex] = 'String.java:' + '435' , compareTo_8(($location_0[stackIndex] = 'Element.java:' + '266' , $clinit_82() , ($location_0[stackIndex] = 'com.google.gwt.dev.jjs.impl.GenerateJavaAST:' + '0' , dynamicCastJso(p0))).innerText, dynamicCastJso(p1).innerText));
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function $compare_4(o1, o2){
  var stackIndex, returnTemp;
  $stack_0[stackIndex = ++$stackDepth_0] = $compare_4;
  returnTemp = ($location_0[stackIndex] = 'String.java:' + '435' , compareTo_8(($location_0[stackIndex] = 'Element.java:' + '266' , $clinit_82() , o2).innerText, o1.innerText));
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function $add_30(this$static, index, sortInfo){
  ...
  for ($location_0[stackIndex] = 'TableModelHelper.java:' + '188' , i = 0; i < this$static.infos.size_0; $location_0[stackIndex] = 'TableModelHelper.java:' + '188' , ++i) {
    curInfo = dynamicCast(($location_0[stackIndex] = 'TableModelHelper.java:' + '189' , $get_6(this$static.infos, i)), 221);
...
function $equals_8(this$static, csl){
  ...
  for ($location_0[stackIndex] = 'TableModelHelper.java:' + '237' , i = 0; i < size; $location_0[stackIndex] = 'TableModelHelper.java:' + '237' , ++i) {
    if (!$equals_7(dynamicCast(($location_0[stackIndex] = 'TableModelHelper.java:' + '238' , $get_6(this$static.infos, i)), 221), dynamicCast($get_6(csl.infos, i), 221))) {
      $stackDepth_0 = stackIndex - 1;
      return false;
    }
  }
...
function $getPrimaryColumnSortInfo(this$static){
  ...
  if (this$static.infos.size_0 > 0) {
    returnTemp = dynamicCast(($location_0[stackIndex] = 'TableModelHelper.java:' + '267' , $get_6(this$static.infos, 0)), 221);
    $stackDepth_0 = stackIndex - 1;
    return returnTemp;
  }
  $stackDepth_0 = stackIndex - 1;
...
function getClass_579(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_579;
  $stackDepth_0 = stackIndex - 1;
...
function getClass_580(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_580;
  $stackDepth_0 = stackIndex - 1;
...
function $clinit_881(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_881;
  $location_0[stackIndex] = 'org_gwt_mosaic_ui_client_table_AbstractScrollTable_ScrollTableStyle_default_StaticClientBundleGenerator.java:' + '6' , $clinit_881 = nullMethod;
  $location_0[stackIndex] = 'org_gwt_mosaic_ui_client_table_AbstractScrollTable_ScrollTableStyle_default_StaticClientBundleGenerator.java:' + '47' , internedUrl0_1 = $moduleBase + 'AE1C1C4D580D33A664B903058FE836CA.cache.png';
  $stackDepth_0 = stackIndex - 1;
}
...
function $scrollTableAscending(){
  ...
  !scrollTableAscending && (scrollTableAscending = $ImageResourcePrototype(($location_0[stackIndex] = 'org_gwt_mosaic_ui_client_table_AbstractScrollTable_ScrollTableStyle_default_StaticClientBundleGenerator.java:' + '19' , new ImageResourcePrototype), internedUrl0_1, 16, 7, 11, 7));
  $stackDepth_0 = stackIndex - 1;
...
function $scrollTableDescending(){
  ...
  !scrollTableDescending && (scrollTableDescending = $ImageResourcePrototype(($location_0[stackIndex] = 'org_gwt_mosaic_ui_client_table_AbstractScrollTable_ScrollTableStyle_default_StaticClientBundleGenerator.java:' + '29' , new ImageResourcePrototype), internedUrl0_1, 16, 0, 11, 7));
  $stackDepth_0 = stackIndex - 1;
...
function $scrollTableFillWidth(){
  ...
  !scrollTableFillWidth && (scrollTableFillWidth = $ImageResourcePrototype(($location_0[stackIndex] = 'org_gwt_mosaic_ui_client_table_AbstractScrollTable_ScrollTableStyle_default_StaticClientBundleGenerator.java:' + '39' , new ImageResourcePrototype), internedUrl0_1, 0, 0, 16, 14));
  $stackDepth_0 = stackIndex - 1;
  return scrollTableFillWidth;
}

function getClass_581(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_581;
  $stackDepth_0 = stackIndex - 1;
  return Lorg_gwt_mosaic_ui_client_table_org_1gwt_1mosaic_1ui_1client_1table_1AbstractScrollTable_1ScrollTableStyle_1default_1StaticClientBundleGenerator_2_classLit;
}

function org_gwt_mosaic_ui_client_table_AbstractScrollTable_ScrollTableStyle_default_StaticClientBundleGenerator(){
}

_ = org_gwt_mosaic_ui_client_table_AbstractScrollTable_ScrollTableStyle_default_StaticClientBundleGenerator.prototype = new Object_0;
_.getClass$ = getClass_581;
_.typeId$ = 0;
var internedUrl0_1, scrollTableAscending = null, scrollTableDescending = null, scrollTableFillWidth = null;
function createButtonLabel(image, text, type){
  ...
  $location_0[stackIndex] = 'ButtonHelper.java:' + '45' , img = $Image_2(($location_0[stackIndex] = 'ClippedImagePrototype.java:' + '63' , new Image_0), image.url, image.left_0, image.top_0, image.width_0, image.height_0);
  if (type == ($location_0[stackIndex] = 'ButtonHelper.java:' + '34' , $clinit_883() , TEXT_ONLY)) {
    $stackDepth_0 = stackIndex - 1;
    return text;
  }
   else if (type == NO_TEXT) {
    returnTemp = ($location_0[stackIndex] = 'ClippedImagePrototype.java:' + '68' , $getHTML_0(image.url, image.left_0, image.top_0, image.width_0, image.height_0));
    $stackDepth_0 = stackIndex - 1;
    return returnTemp;
  }
    ...
    $location_0[stackIndex] = 'ButtonHelper.java:' + '69' , $setCellVerticalAlignment(hpanel, html, ($location_0[stackIndex] = 'HasVerticalAlignment.java:' + '67' , $clinit_395() , ALIGN_MIDDLE));
    $location_0[stackIndex] = 'ButtonHelper.java:' + '70' , $setCellVerticalAlignment(hpanel, img, ALIGN_MIDDLE);
    returnTemp = ($location_0[stackIndex] = 'Element.java:' + '424' , $clinit_82() , hpanel.element).outerHTML;
    $stackDepth_0 = stackIndex - 1;
    return returnTemp;
  }
   else {
    ...
    $location_0[stackIndex] = 'ButtonHelper.java:' + '81' , $setCellHorizontalAlignment(vpanel, html, ($location_0[stackIndex] = 'HasHorizontalAlignment.java:' + '62' , $clinit_390() , ALIGN_CENTER));
    $location_0[stackIndex] = 'ButtonHelper.java:' + '83' , $setCellHorizontalAlignment(vpanel, img, ALIGN_CENTER);
    returnTemp = ($location_0[stackIndex] = 'Element.java:' + '424' , $clinit_82() , vpanel.element).outerHTML;
    $stackDepth_0 = stackIndex - 1;
    return returnTemp;
  }
  $stackDepth_0 = stackIndex - 1;
...
function $clinit_883(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_883;
  $location_0[stackIndex] = 'ButtonHelper.java:' + '33' , $clinit_883 = nullMethod;
...
function $ButtonHelper$ButtonLabelType(this$static, enum$name, enum$ordinal){
  ...
  $location_0[stackIndex] = 'ButtonHelper.java:' + '33' , $clinit_883();
  $location_0[stackIndex] = 'Enum.java:' + '76' , this$static.name_0 = enum$name;
  $location_0[stackIndex] = 'Enum.java:' + '77' , this$static.ordinal = enum$ordinal;
  $stackDepth_0 = stackIndex - 1;
  return this$static;
...
function getClass_582(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_582;
  $stackDepth_0 = stackIndex - 1;
...
function values_21(){
  ...
  $location_0[stackIndex] = 'ButtonHelper.java:' + '33' , $clinit_883();
  returnTemp = initValues(_3Lorg_gwt_mosaic_ui_client_util_ButtonHelper$ButtonLabelType_2_classLit, 707, 105, [TEXT_ON_TOP, TEXT_ON_RIGHT, TEXT_ON_BOTTOM, TEXT_ON_LEFT, TEXT_ONLY, NO_TEXT]);
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function $createWindow(this$static){
  ...
  layout = $ScrollLayoutPanel_0(($location_0[stackIndex] = 'IFrameWindowPanel.java:' + '78' , new ScrollLayoutPanel), ($location_0[stackIndex] = 'IFrameWindowPanel.java:' + '78' , $BoxLayout_1(new BoxLayout, ($location_0[stackIndex] = 'BoxLayout.java:' + '170' , $clinit_802() , VERTICAL))));
  ...
  $add_26(layout, header, ($location_0[stackIndex] = 'IFrameWindowPanel.java:' + '84' , $BoxLayoutData_4(($location_0[stackIndex] = 'IFrameWindowPanel.java:' + '84' , new BoxLayoutData), ($location_0[stackIndex] = 'BoxLayoutData.java:' + '30' , $clinit_804() , HORIZONTAL_0))));
  ...
  $location_0[stackIndex] = 'IFrameWindowPanel.java:' + '154' , addMaximizeButton(this$static.windowPanel, ($location_0[stackIndex] = 'Caption.java:' + '61' , $clinit_656() , RIGHT));
...
function $IFrameWindowPanel$2(this$static){
  ...
  $location_0[stackIndex] = 'UIObject.java:' + '799' , this$static.element = $createElement(($location_0[stackIndex] = 'Document.java:' + '408' , $clinit_82() , $doc), 'iframe');
...
function on(parent_0, loading){
  ...
  if (!!parent_0 && loading) {
    $location_0[stackIndex] = 'LoadingOverlay.java:' + '37' , left = $getAbsoluteLeft_0(($location_0[stackIndex] = 'Element.java:' + '150' , $clinit_82() , parent_0.element));
...
function $clinit_933(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_933;
  $location_0[stackIndex] = 'ModelCommands.java:' + '24' , $clinit_933 = nullMethod;
...
function $ModelCommands(this$static, enum$name, enum$ordinal){
  ...
  $location_0[stackIndex] = 'ModelCommands.java:' + '24' , $clinit_933();
  $location_0[stackIndex] = 'Enum.java:' + '76' , this$static.name_0 = enum$name;
  $location_0[stackIndex] = 'Enum.java:' + '77' , this$static.ordinal = enum$ordinal;
  $stackDepth_0 = stackIndex - 1;
  return this$static;
...
function values_22(){
  ...
  $location_0[stackIndex] = 'ModelCommands.java:' + '24' , $clinit_933();
  returnTemp = initValues(_3Lorg_jboss_bpm_console_client_common_ModelCommands_2_classLit, 708, 106, [HAS_BECOME_STALE, HAS_BEEN_UPDATED]);
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function $clinit_934(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_934;
  $location_0[stackIndex] = 'ModelParts.java:' + '24' , $clinit_934 = nullMethod;
...
function $ModelParts(this$static, enum$name, enum$ordinal){
  ...
  $location_0[stackIndex] = 'ModelParts.java:' + '24' , $clinit_934();
  $location_0[stackIndex] = 'Enum.java:' + '76' , this$static.name_0 = enum$name;
  $location_0[stackIndex] = 'Enum.java:' + '77' , this$static.ordinal = enum$ordinal;
  $stackDepth_0 = stackIndex - 1;
  return this$static;
...
function values_23(){
  ...
  $location_0[stackIndex] = 'ModelParts.java:' + '24' , $clinit_934();
  returnTemp = initValues(_3Lorg_jboss_bpm_console_client_common_ModelParts_2_classLit, 709, 107, [CLASS]);
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function $PagingPanel(this$static, callback){
  ...
  $MosaicPanel_0(this$static, ($location_0[stackIndex] = 'PagingPanel.java:' + '55' , $BoxLayout_1(($location_0[stackIndex] = 'PagingPanel.java:' + '55' , new BoxLayout), ($location_0[stackIndex] = 'BoxLayout.java:' + '170' , $clinit_802() , HORIZONTAL))));
  ...
  this$static.revBtn = ($location_0[stackIndex] = 'PagingPanel.java:' + '69' , $Button_1(($location_0[stackIndex] = 'PagingPanel.java:' + '69' , new Button), ($location_0[stackIndex] = 'ButtonHelper.java:' + '39' , createButtonLabel(($location_0[stackIndex] = 'PagingPanel.java:' + '71' , $clinit_655() , ($location_0[stackIndex] = 'CaptionImages_generatedBundle.java:' + '33' , $clinit_657()) , toolCollapseLeft_SINGLETON), '', ($location_0[stackIndex] = 'ButtonHelper.java:' + '34' , $clinit_883() , NO_TEXT))), clickHandler));
...
function $clinit_941(){
  ...
  $location_0[stackIndex] = 'org_jboss_bpm_console_client_icons_ConsoleIconBundle_default_StaticClientBundleGenerator.java:' + '6' , $clinit_941 = nullMethod;
  $location_0[stackIndex] = 'org_jboss_bpm_console_client_icons_ConsoleIconBundle_default_StaticClientBundleGenerator.java:' + '307' , internedUrl0_2 = $moduleBase + 'C10B8F9B0264009CADE5255D5C76DD5D.cache.png';
  $stackDepth_0 = stackIndex - 1;
}
...
function parseTaskReference(item){
  ...
  for ($location_0[stackIndex] = 'DTOParser.java:' + '99' , k = 0; k < arrUsers.jsArray.length; $location_0[stackIndex] = 'DTOParser.java:' + '99' , ++k) {
    jsonValue = ($location_0[stackIndex] = 'DTOParser.java:' + '101' , $get_3(arrUsers, k));
  ...
  for ($location_0[stackIndex] = 'DTOParser.java:' + '107' , k = 0; k < arrGroups.jsArray.length; $location_0[stackIndex] = 'DTOParser.java:' + '107' , ++k) {
    jsonValue = ($location_0[stackIndex] = 'DTOParser.java:' + '109' , $get_3(arrGroups, k));
  ...
  if (isSignalling) {
    ...
    for ($location_0[stackIndex] = 'DTOParser.java:' + '117' , k = 0; k < arr.jsArray.length; $location_0[stackIndex] = 'DTOParser.java:' + '117' , ++k) {
      jsonValue = ($location_0[stackIndex] = 'DTOParser.java:' + '119' , $get_3(arr, k));
      if ($equals_4(($location_0[stackIndex] = 'DTOParser.java:' + '120' , jsonValue.toString$()), 'null')) {
        $location_0[stackIndex] = 'Log.java:' + '651' , $warn(impl, 'FIXME JBPM-1828: Null value on outcomes:' + ($location_0[stackIndex] = 'DTOParser.java:' + '122' , $toString_6(arr)), null);
        continue;
      }
...
function parseTaskReferenceList(json){
  ...
  for ($location_0[stackIndex] = 'DTOParser.java:' + '48' , i = 0; i < array.jsArray.length; $location_0[stackIndex] = 'DTOParser.java:' + '48' , ++i) {
    item = ($location_0[stackIndex] = 'DTOParser.java:' + '50' , $get_3(array, i)).isObject();
...
function parseProcessDefinition(rootModel){
  ...
  $location_0[stackIndex] = 'ProcessDefinitionRef.java:' + '141' , def.suspended = ($location_0[stackIndex] = 'JSOModel.java:' + '112' , $clinit_521() , ($location_0[stackIndex] = 'Boolean.java:' + '35' , $equalsIgnoreCase('true', '' + ($location_0[stackIndex] = 'JSOModel.java:' + '96' , rootModel['suspended']))));
...
function $initOrUpdateState(this$static){
  ...
  this$static.assignee == null || ($location_0[stackIndex] = 'TaskRef.java:' + '170' , $equals_4(this$static.assignee, ''))?($location_0[stackIndex] = 'TaskRef.java:' + '172' , this$static.currentState = ($location_0[stackIndex] = 'TaskRef.java:' + '47' , $clinit_960() , OPEN)):($location_0[stackIndex] = 'TaskRef.java:' + '176' , this$static.currentState = ($location_0[stackIndex] = 'TaskRef.java:' + '47' , $clinit_960() , ASSIGNED));
  $stackDepth_0 = stackIndex - 1;
}
...
function $clinit_960(){
  ...
  $location_0[stackIndex] = 'TaskRef.java:' + '47' , $clinit_960 = nullMethod;
...
function $TaskRef$STATE(this$static, enum$name, enum$ordinal){
  ...
  $location_0[stackIndex] = 'TaskRef.java:' + '47' , $clinit_960();
  $location_0[stackIndex] = 'Enum.java:' + '76' , this$static.name_0 = enum$name;
  $location_0[stackIndex] = 'Enum.java:' + '77' , this$static.ordinal = enum$ordinal;
  $stackDepth_0 = stackIndex - 1;
  return this$static;
...
function values_26(){
  ...
  $location_0[stackIndex] = 'TaskRef.java:' + '47' , $clinit_960();
  returnTemp = initValues(_3Lorg_jboss_bpm_console_client_model_TaskRef$STATE_2_classLit, 712, 110, [OPEN, ASSIGNED, CLOSED]);
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function $clinit_1040(){
  ...
  $location_0[stackIndex] = 'AssignTaskAction.java:' + '35' , $clinit_1040 = nullMethod;
...
function $AssignTaskAction(this$static){
  ...
  $location_0[stackIndex] = 'AssignTaskAction.java:' + '35' , $clinit_1040();
...
function handleSuccessfulResponse_13(controller, event_0, response){
  ...
  $location_0[stackIndex] = 'AssignTaskAction.java:' + '60' , $handleEvent(controller, ($location_0[stackIndex] = 'AssignTaskAction.java:' + '61' , $Event(($location_0[stackIndex] = 'AssignTaskAction.java:' + '61' , new Event_0), ($location_0[stackIndex] = 'ReloadAllTaskListsAction.java:' + '38' , $clinit_1072() , ID_32), null)));
  $stackDepth_0 = stackIndex - 1;
}
...
function $clinit_1043(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_1043;
  $location_0[stackIndex] = 'AssignedTasksView.java:' + '57' , $clinit_1043 = nullMethod;
...
function $initialize_3(this$static){
  ...
  if (!this$static.isInitialized) {
    ...
    this$static.taskList = $MosaicPanel_0(($location_0[stackIndex] = 'AssignedTasksView.java:' + '105' , new MosaicPanel), ($location_0[stackIndex] = 'AssignedTasksView.java:' + '105' , $BoxLayout_1(new BoxLayout, ($location_0[stackIndex] = 'BoxLayout.java:' + '170' , $clinit_802() , VERTICAL))));
    ...
    $add_26(toolBox, toolBar, ($location_0[stackIndex] = 'AssignedTasksView.java:' + '272' , $BoxLayoutData_4(($location_0[stackIndex] = 'AssignedTasksView.java:' + '272' , new BoxLayoutData), ($location_0[stackIndex] = 'BoxLayoutData.java:' + '30' , $clinit_804() , HORIZONTAL_0))));
    ...
    $location_0[stackIndex] = 'AssignedTasksView.java:' + '306' , $clinit_1097();
...
function $renderUpdate_0(this$static){
  ...
  $location_0[stackIndex] = 'AssignedTasksView.java:' + '353' , $handleEvent(this$static.controller_0, $Event(($location_0[stackIndex] = 'AssignedTasksView.java:' + '354' , new Event_0), ($location_0[stackIndex] = 'UpdateDetailsAction.java:' + '35' , $clinit_1076() , ID_34), $DetailViewEvent(($location_0[stackIndex] = 'AssignedTasksView.java:' + '354' , new DetailViewEvent), 'AssignedDetailView', null)));
  ...
  for (task$iterator = ($location_0[stackIndex] = 'AssignedTasksView.java:' + '383' , trimmed.iterator_0()); $location_0[stackIndex] = 'AssignedTasksView.java:' + '383' , task$iterator.hasNext();) {
    ...
    ($location_0[stackIndex] = 'TaskRef.java:' + '47' , $clinit_960() , ASSIGNED) == task.currentState && ($location_0[stackIndex] = 'DefaultListModel.java:' + '45' , $add_6(model.list, task));
  }
  $stackDepth_0 = stackIndex - 1;
}
...
function $renderCell_4(this$static, listBox, row, column, item){
  ...
  switch (column) {
    case 0:
      $location_0[stackIndex] = 'AssignedTasksView.java:' + '122' , $setText_6(listBox, row, column, '' + item.priority);
      break;
    case 1:
      $location_0[stackIndex] = 'AssignedTasksView.java:' + '125' , $setText_6(listBox, row, column, item.processId);
      break;
    case 2:
      $location_0[stackIndex] = 'AssignedTasksView.java:' + '128' , $setText_6(listBox, row, column, item.name_0);
      break;
    case 3:
...
function onRowSelection_1(rowSelectionEvent){
  ...
  if (task) {
    ...
    $location_0[stackIndex] = 'AssignedTasksView.java:' + '153' , $handleEvent(this.this$0.controller_0, $Event(($location_0[stackIndex] = 'AssignedTasksView.java:' + '154' , new Event_0), ($location_0[stackIndex] = 'UpdateDetailsAction.java:' + '35' , $clinit_1076() , ID_34), $DetailViewEvent(($location_0[stackIndex] = 'AssignedTasksView.java:' + '154' , new DetailViewEvent), 'AssignedDetailView', task)));
  }
  $stackDepth_0 = stackIndex - 1;
}
...
function onClick_27(clickEvent){
  ...
  $location_0[stackIndex] = 'AssignedTasksView.java:' + '340' , $handleEvent(this.this$0.controller_0, ($location_0[stackIndex] = 'AssignedTasksView.java:' + '341' , $Event(($location_0[stackIndex] = 'AssignedTasksView.java:' + '341' , new Event_0), ($location_0[stackIndex] = 'LoadTasksAction.java:' + '45' , $clinit_1055() , ID_28), dynamicCast(($location_0[stackIndex] = 'ErraiApplication.java:' + '129' , get_16(Lorg_jboss_bpm_console_client_Authentication_2_classLit)), 229).username)));
  $stackDepth_0 = stackIndex - 1;
}
...
function onClick_28(clickEvent){
  ...
  if (selection) {
    if (selection.url != null && !($location_0[stackIndex] = 'AssignedTasksView.java:' + '190' , $equals_4(selection.url, ''))) {
      ...
      $location_0[stackIndex] = 'AssignedTasksView.java:' + '210' , $clinit_691();
      $location_0[stackIndex] = 'MessageBox.java:' + '111' , alert_2(($location_0[stackIndex] = 'MessageBox.java:' + '60' , $clinit_700() , ALERT), 'Invalid operation', "The task doesn't provide a UI");
    }
  }
   else {
    $location_0[stackIndex] = 'AssignedTasksView.java:' + '215' , $clinit_691();
    $location_0[stackIndex] = 'MessageBox.java:' + '111' , alert_2(($location_0[stackIndex] = 'MessageBox.java:' + '60' , $clinit_700() , ALERT), 'Missing selection', 'Please select a task');
  }
  $stackDepth_0 = stackIndex - 1;
}
...
function onWindowClosed_0(){
  ...
  $location_0[stackIndex] = 'AssignedTasksView.java:' + '340' , $handleEvent(this.this$1.this$0.controller_0, ($location_0[stackIndex] = 'AssignedTasksView.java:' + '341' , $Event(($location_0[stackIndex] = 'AssignedTasksView.java:' + '341' , new Event_0), ($location_0[stackIndex] = 'LoadTasksAction.java:' + '45' , $clinit_1055() , ID_28), dynamicCast(($location_0[stackIndex] = 'ErraiApplication.java:' + '129' , get_16(Lorg_jboss_bpm_console_client_Authentication_2_classLit)), 229).username)));
  $stackDepth_0 = stackIndex - 1;
}
...
function onClick_29(clickEvent){
  ...
  if (selection) {
    ...
    $location_0[stackIndex] = 'AssignedTasksView.java:' + '234' , $handleEvent(this.this$0.controller_0, ($location_0[stackIndex] = 'AssignedTasksView.java:' + '235' , $Event(($location_0[stackIndex] = 'AssignedTasksView.java:' + '235' , new Event_0), ($location_0[stackIndex] = 'ReleaseTaskAction.java:' + '37' , $clinit_1071() , ID_31), payload)));
  }
   else {
    $location_0[stackIndex] = 'AssignedTasksView.java:' + '240' , $clinit_691();
    $location_0[stackIndex] = 'MessageBox.java:' + '111' , alert_2(($location_0[stackIndex] = 'MessageBox.java:' + '60' , $clinit_700() , ALERT), 'Missing selection', 'Please select a task');
  }
  $stackDepth_0 = stackIndex - 1;
}
...
function onClick_30(clickEvent){
  ...
  if (!!selection && !selection.isBlocking) {
    $location_0[stackIndex] = 'AssignedTasksView.java:' + '254' , $handleEvent(this.this$0.controller_0, ($location_0[stackIndex] = 'AssignedTasksView.java:' + '255' , $Event(($location_0[stackIndex] = 'AssignedTasksView.java:' + '255' , new Event_0), ($location_0[stackIndex] = 'SkipTaskAction.java:' + '14' , $clinit_1073() , ID_33), ($location_0[stackIndex] = 'AssignedTasksView.java:' + '257' , $TaskIdentityEvent(($location_0[stackIndex] = 'AssignedTasksView.java:' + '257' , new TaskIdentityEvent), dynamicCast(($location_0[stackIndex] = 'ErraiApplication.java:' + '129' , get_16(Lorg_jboss_bpm_console_client_Authentication_2_classLit)), 229).username, selection)))));
  }
   else {
    $location_0[stackIndex] = 'AssignedTasksView.java:' + '263' , $clinit_691();
    $location_0[stackIndex] = 'MessageBox.java:' + '111' , alert_2(($location_0[stackIndex] = 'MessageBox.java:' + '60' , $clinit_700() , ALERT), 'Missing selection', 'Please select a task');
  }
  $stackDepth_0 = stackIndex - 1;
}
...
function callback_2(message){
  ...
  ($location_0[stackIndex] = 'ModelCommands.java:' + '24' , $clinit_933() , ($location_0[stackIndex] = 'ModelCommands.java:' + '24' , valueOf_0(enum$map, ($location_0[stackIndex] = 'AssignedTasksView.java:' + '311' , message.getCommandType())))).ordinal == 1 && $equals_4(dynamicCast(($location_0[stackIndex] = 'AssignedTasksView.java:' + '314' , message.get_2(Ljava_lang_String_2_classLit, ($location_0[stackIndex] = 'ModelParts.java:' + '27' , $clinit_934() , CLASS))), 1), 'processModel') && ($location_0[stackIndex] = 'AssignedTasksView.java:' + '340' , $handleEvent(this.this$0.controller_0, ($location_0[stackIndex] = 'AssignedTasksView.java:' + '341' , $Event(($location_0[stackIndex] = 'AssignedTasksView.java:' + '341' , new Event_0), ($location_0[stackIndex] = 'LoadTasksAction.java:' + '45' , $clinit_1055() , ID_28), dynamicCast(($location_0[stackIndex] = 'ErraiApplication.java:' + '129' , get_16(Lorg_jboss_bpm_console_client_Authentication_2_classLit)), 229).username))));
  $stackDepth_0 = stackIndex - 1;
}
...
_.typeId$ = 494;
_.this$0 = null;
function $clinit_1053(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_1053;
  $location_0[stackIndex] = 'AssignedTasksView.java:' + '321' , $clinit_1053 = nullMethod;
  $clinit_43();
  $stackDepth_0 = stackIndex - 1;
}
...
function $AssignedTasksView$9(this$static, this$0){
  ...
  $location_0[stackIndex] = 'AssignedTasksView.java:' + '321' , $clinit_1053();
  this$static.this$0 = this$0;
  $stackDepth_0 = stackIndex - 1;
  return this$static;
}

function getClass_738(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_738;
  $stackDepth_0 = stackIndex - 1;
...
_.getClass$ = getClass_738;
_.run = run_22;
_.typeId$ = 495;
_.this$0 = null;
function $clinit_1054(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_1054;
  $location_0[stackIndex] = 'ClaimTaskAction.java:' + '35' , $clinit_1054 = nullMethod;
...
function $ClaimTaskAction(this$static){
  ...
  $location_0[stackIndex] = 'ClaimTaskAction.java:' + '35' , $clinit_1054();
  dynamicCast(($location_0[stackIndex] = 'AbstractRESTAction.java:' + '44' , get_16(Lorg_jboss_bpm_console_client_ApplicationContext_2_classLit)), 224);
  $stackDepth_0 = stackIndex - 1;
  return this$static;
}
...
function handleSuccessfulResponse_14(controller, event_0, response){
  ...
  $location_0[stackIndex] = 'ClaimTaskAction.java:' + '60' , $handleEvent(controller, ($location_0[stackIndex] = 'ClaimTaskAction.java:' + '61' , $Event(($location_0[stackIndex] = 'ClaimTaskAction.java:' + '61' , new Event_0), ($location_0[stackIndex] = 'ReloadAllTaskListsAction.java:' + '38' , $clinit_1072() , ID_32), null)));
  $stackDepth_0 = stackIndex - 1;
}
...
_.typeId$ = 496;
var ID_27;
function $clinit_1055(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_1055;
  $location_0[stackIndex] = 'LoadTasksAction.java:' + '43' , $clinit_1055 = nullMethod;
...
function $LoadTasksAction(this$static){
  ...
  $location_0[stackIndex] = 'LoadTasksAction.java:' + '43' , $clinit_1055();
  dynamicCast(($location_0[stackIndex] = 'AbstractRESTAction.java:' + '44' , get_16(Lorg_jboss_bpm_console_client_ApplicationContext_2_classLit)), 224);
  $stackDepth_0 = stackIndex - 1;
  return this$static;
}
...
function getDataDriven_2(controller){
  ...
  returnTemp = ($location_0[stackIndex] = 'LoadTasksAction.java:' + '66' , dynamicCast(dynamicCast(($location_0[stackIndex] = 'Controller.java:' + '67' , $get_8(controller.views, ($location_0[stackIndex] = 'AssignedTasksView.java:' + '60' , $clinit_1043() , ID_26))), 167), 254));
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function handleSuccessfulResponse_15(controller, event_0, response){
  ...
  view = ($location_0[stackIndex] = 'LoadTasksAction.java:' + '75' , dynamicCast(dynamicCast(($location_0[stackIndex] = 'Controller.java:' + '67' , $get_8(controller.views, ($location_0[stackIndex] = 'AssignedTasksView.java:' + '60' , $clinit_1043() , ID_26))), 167), 254));
  $update_8(view, ($location_0[stackIndex] = 'LoadTasksAction.java:' + '77' , initValues(_3Ljava_lang_Object_2_classLit, 684, 0, [identity, tasks])));
...
function $clinit_1056(){
  ...
  $location_0[stackIndex] = 'LoadTasksParticipationAction.java:' + '43' , $clinit_1056 = nullMethod;
...
function $LoadTasksParticipationAction(this$static){
  ...
  $location_0[stackIndex] = 'LoadTasksParticipationAction.java:' + '43' , $clinit_1056();
  dynamicCast(($location_0[stackIndex] = 'AbstractRESTAction.java:' + '44' , get_16(Lorg_jboss_bpm_console_client_ApplicationContext_2_classLit)), 224);
  $stackDepth_0 = stackIndex - 1;
  return this$static;
}
...
function getDataDriven_3(controller){
  ...
  returnTemp = ($location_0[stackIndex] = 'LoadTasksParticipationAction.java:' + '66' , dynamicCast(dynamicCast(($location_0[stackIndex] = 'Controller.java:' + '67' , $get_8(controller.views, ($location_0[stackIndex] = 'OpenTasksView.java:' + '59' , $clinit_1059() , ID_30))), 167), 255));
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function handleSuccessfulResponse_16(controller, event_0, response){
  ...
  view = ($location_0[stackIndex] = 'LoadTasksParticipationAction.java:' + '75' , dynamicCast(dynamicCast(($location_0[stackIndex] = 'Controller.java:' + '67' , $get_8(controller.views, ($location_0[stackIndex] = 'OpenTasksView.java:' + '59' , $clinit_1059() , ID_30))), 167), 255));
  $location_0[stackIndex] = 'Log.java:' + '354' , $clinit_24();
  $location_0[stackIndex] = 'Log.java:' + '403' , $info(impl, 'Loaded ' + tasks.size_0 + ' tasks', null);
  $update_9(view, ($location_0[stackIndex] = 'LoadTasksParticipationAction.java:' + '78' , initValues(_3Ljava_lang_Object_2_classLit, 684, 0, [identity, tasks])));
  $stackDepth_0 = stackIndex - 1;
}
...
_.typeId$ = 498;
var ID_29;
function $clinit_1059(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_1059;
  $location_0[stackIndex] = 'OpenTasksView.java:' + '56' , $clinit_1059 = nullMethod;
...
function $initialize_4(this$static){
  ...
  if (!this$static.isInitialized) {
    this$static.taskList = $MosaicPanel_0(($location_0[stackIndex] = 'OpenTasksView.java:' + '127' , new MosaicPanel), ($location_0[stackIndex] = 'OpenTasksView.java:' + '127' , $BoxLayout_1(new BoxLayout, ($location_0[stackIndex] = 'BoxLayout.java:' + '170' , $clinit_802() , VERTICAL))));
    $location_0[stackIndex] = 'LayoutPanel.java:' + '289' , setStyleAttribute_0(this$static.taskList.element, 'padding', '0px');
    $location_0[stackIndex] = 'LayoutPanel.java:' + '297' , this$static.taskList.widgetSpacing = 0;
    $location_0[stackIndex] = 'OpenTasksView.java:' + '131' , this$static.listBox = ($location_0[stackIndex] = 'OpenTasksView.java:' + '132' , $ListBox_1(($location_0[stackIndex] = 'OpenTasksView.java:' + '132' , new ListBox_0), ($location_0[stackIndex] = 'OpenTasksView.java:' + '133' , initValues(_3Ljava_lang_String_2_classLit, 687, 1, ['Priority', 'Process', 'Task Name', 'Status', 'Due Date']))));
    ...
    $add_26(toolBox, toolBar, ($location_0[stackIndex] = 'OpenTasksView.java:' + '251' , $BoxLayoutData_4(($location_0[stackIndex] = 'OpenTasksView.java:' + '251' , new BoxLayoutData), ($location_0[stackIndex] = 'BoxLayoutData.java:' + '30' , $clinit_804() , HORIZONTAL_0))));
    ...
    $location_0[stackIndex] = 'OpenTasksView.java:' + '284' , $clinit_1097();
...
function $renderUpdate_1(this$static){
  ...
  $location_0[stackIndex] = 'DefaultListModel.java:' + '61' , $clear_5(model_0.list);
  $location_0[stackIndex] = 'OpenTasksView.java:' + '332' , $handleEvent(this$static.controller, $Event(($location_0[stackIndex] = 'OpenTasksView.java:' + '333' , new Event_0), ($location_0[stackIndex] = 'UpdateDetailsAction.java:' + '35' , $clinit_1076() , ID_34), $DetailViewEvent(($location_0[stackIndex] = 'OpenTasksView.java:' + '333' , new DetailViewEvent), 'OpenDetailView', null)));
  ...
  for (task$iterator = ($location_0[stackIndex] = 'OpenTasksView.java:' + '362' , trimmed.iterator_0()); $location_0[stackIndex] = 'OpenTasksView.java:' + '362' , task$iterator.hasNext();) {
    task = dynamicCast(task$iterator.next_0(), 251);
    ($location_0[stackIndex] = 'TaskRef.java:' + '47' , $clinit_960() , OPEN) == task.currentState && ($location_0[stackIndex] = 'DefaultListModel.java:' + '45' , $add_6(model.list, task));
  }
  $stackDepth_0 = stackIndex - 1;
}
...
function registerCommonActions(controller){
  ...
  $location_0[stackIndex] = 'OpenTasksView.java:' + '77' , $clinit_1059();
  if (!actionSetup) {
    $location_0[stackIndex] = 'Controller.java:' + '106' , $put_0(controller.actions, ($location_0[stackIndex] = 'LoadTasksAction.java:' + '45' , $clinit_1055() , ID_28), $LoadTasksAction(($location_0[stackIndex] = 'OpenTasksView.java:' + '82' , new LoadTasksAction)));
    $location_0[stackIndex] = 'Controller.java:' + '106' , $put_0(controller.actions, ($location_0[stackIndex] = 'LoadTasksParticipationAction.java:' + '45' , $clinit_1056() , ID_29), $LoadTasksParticipationAction(($location_0[stackIndex] = 'OpenTasksView.java:' + '83' , new LoadTasksParticipationAction)));
    $location_0[stackIndex] = 'Controller.java:' + '106' , $put_0(controller.actions, ($location_0[stackIndex] = 'ClaimTaskAction.java:' + '37' , $clinit_1054() , ID_27), $ClaimTaskAction(($location_0[stackIndex] = 'OpenTasksView.java:' + '84' , new ClaimTaskAction)));
    $location_0[stackIndex] = 'Controller.java:' + '106' , $put_0(controller.actions, ($location_0[stackIndex] = 'ReleaseTaskAction.java:' + '37' , $clinit_1071() , ID_31), $ReleaseTaskAction(($location_0[stackIndex] = 'OpenTasksView.java:' + '85' , new ReleaseTaskAction)));
    $location_0[stackIndex] = 'Controller.java:' + '106' , $put_0(controller.actions, ($location_0[stackIndex] = 'UpdateDetailsAction.java:' + '35' , $clinit_1076() , ID_34), ($location_0[stackIndex] = 'OpenTasksView.java:' + '86' , new UpdateDetailsAction));
    $location_0[stackIndex] = 'Controller.java:' + '106' , $put_0(controller.actions, ($location_0[stackIndex] = 'AssignTaskAction.java:' + '38' , $clinit_1040() , ID_25), $AssignTaskAction(($location_0[stackIndex] = 'OpenTasksView.java:' + '87' , new AssignTaskAction)));
    $location_0[stackIndex] = 'Controller.java:' + '106' , $put_0(controller.actions, ($location_0[stackIndex] = 'ReloadAllTaskListsAction.java:' + '38' , $clinit_1072() , ID_32), $ReloadAllTaskListsAction(($location_0[stackIndex] = 'OpenTasksView.java:' + '88' , new ReloadAllTaskListsAction)));
    $location_0[stackIndex] = 'Controller.java:' + '106' , $put_0(controller.actions, ($location_0[stackIndex] = 'SkipTaskAction.java:' + '14' , $clinit_1073() , ID_33), $SkipTaskAction(($location_0[stackIndex] = 'OpenTasksView.java:' + '89' , new SkipTaskAction)));
...
function $renderCell_5(this$static, listBox, row, column, item){
  ...
  switch (column) {
    case 0:
      $location_0[stackIndex] = 'OpenTasksView.java:' + '143' , $setText_6(listBox, row, column, '' + item.priority);
      break;
    case 1:
      $location_0[stackIndex] = 'OpenTasksView.java:' + '146' , $setText_6(listBox, row, column, item.processId);
      break;
    case 2:
      $location_0[stackIndex] = 'OpenTasksView.java:' + '149' , $setText_6(listBox, row, column, item.name_0);
      break;
    case 3:
      $location_0[stackIndex] = 'OpenTasksView.java:' + '152' , $setText_6(listBox, row, column, '' + item.currentState);
      break;
    case 4:
...
function onRowSelection_2(rowSelectionEvent){
  ...
  if (task) {
    task.isBlocking?($location_0[stackIndex] = 'Element.java:' + '638' , this.this$0.skipBtn.element['disabled'] = !false , undefined):(this.this$0.skipBtn.element['disabled'] = !true , undefined);
    $location_0[stackIndex] = 'OpenTasksView.java:' + '178' , $handleEvent(this.this$0.controller, $Event(($location_0[stackIndex] = 'OpenTasksView.java:' + '179' , new Event_0), ($location_0[stackIndex] = 'UpdateDetailsAction.java:' + '35' , $clinit_1076() , ID_34), $DetailViewEvent(($location_0[stackIndex] = 'OpenTasksView.java:' + '179' , new DetailViewEvent), 'OpenDetailView', task)));
  }
  $stackDepth_0 = stackIndex - 1;
}
...
function onClick_32(clickEvent){
  ...
  if (selection) {
    $location_0[stackIndex] = 'OpenTasksView.java:' + '212' , $handleEvent(this.this$0.controller, ($location_0[stackIndex] = 'OpenTasksView.java:' + '213' , $Event(($location_0[stackIndex] = 'OpenTasksView.java:' + '213' , new Event_0), ($location_0[stackIndex] = 'ClaimTaskAction.java:' + '37' , $clinit_1054() , ID_27), ($location_0[stackIndex] = 'OpenTasksView.java:' + '215' , $TaskIdentityEvent(($location_0[stackIndex] = 'OpenTasksView.java:' + '215' , new TaskIdentityEvent), dynamicCast(($location_0[stackIndex] = 'ErraiApplication.java:' + '129' , get_16(Lorg_jboss_bpm_console_client_Authentication_2_classLit)), 229).username, selection)))));
  }
   else {
    $location_0[stackIndex] = 'OpenTasksView.java:' + '221' , $clinit_691();
    $location_0[stackIndex] = 'MessageBox.java:' + '111' , alert_2(($location_0[stackIndex] = 'MessageBox.java:' + '60' , $clinit_700() , ALERT), 'Missing selection', 'Please select a task');
  }
  $stackDepth_0 = stackIndex - 1;
}
...
function onClick_33(clickEvent){
  ...
  if (!!selection && !selection.isBlocking) {
    $location_0[stackIndex] = 'OpenTasksView.java:' + '235' , $handleEvent(this.this$0.controller, ($location_0[stackIndex] = 'OpenTasksView.java:' + '236' , $Event(($location_0[stackIndex] = 'OpenTasksView.java:' + '236' , new Event_0), ($location_0[stackIndex] = 'SkipTaskAction.java:' + '14' , $clinit_1073() , ID_33), ($location_0[stackIndex] = 'OpenTasksView.java:' + '238' , $TaskIdentityEvent(($location_0[stackIndex] = 'OpenTasksView.java:' + '238' , new TaskIdentityEvent), dynamicCast(($location_0[stackIndex] = 'ErraiApplication.java:' + '129' , get_16(Lorg_jboss_bpm_console_client_Authentication_2_classLit)), 229).username, selection)))));
  }
   else {
    $location_0[stackIndex] = 'OpenTasksView.java:' + '243' , $clinit_691();
    $location_0[stackIndex] = 'MessageBox.java:' + '111' , alert_2(($location_0[stackIndex] = 'MessageBox.java:' + '60' , $clinit_700() , ALERT), 'Missing selection', 'Please select a task');
  }
  $stackDepth_0 = stackIndex - 1;
}
...
function callback_3(message){
  ...
  ($location_0[stackIndex] = 'ModelCommands.java:' + '24' , $clinit_933() , ($location_0[stackIndex] = 'ModelCommands.java:' + '24' , valueOf_0(enum$map, ($location_0[stackIndex] = 'OpenTasksView.java:' + '289' , message.getCommandType())))).ordinal == 1 && $equals_4(dynamicCast(($location_0[stackIndex] = 'OpenTasksView.java:' + '292' , message.get_2(Ljava_lang_String_2_classLit, ($location_0[stackIndex] = 'ModelParts.java:' + '27' , $clinit_934() , CLASS))), 1), 'processModel') && ($location_0[stackIndex] = 'OpenTasksView.java:' + '318' , $handleEvent(this.this$0.controller, ($location_0[stackIndex] = 'OpenTasksView.java:' + '319' , $Event(($location_0[stackIndex] = 'OpenTasksView.java:' + '319' , new Event_0), ($location_0[stackIndex] = 'LoadTasksParticipationAction.java:' + '45' , $clinit_1056() , ID_29), dynamicCast(($location_0[stackIndex] = 'AbstractTaskList.java:' + '75' , get_16(Lorg_jboss_bpm_console_client_Authentication_2_classLit)), 229).username))));
  $stackDepth_0 = stackIndex - 1;
}
...
_.typeId$ = 505;
_.this$0 = null;
function $clinit_1067(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_1067;
  $location_0[stackIndex] = 'OpenTasksView.java:' + '299' , $clinit_1067 = nullMethod;
  $clinit_43();
  $stackDepth_0 = stackIndex - 1;
}
...
function $OpenTasksView$8(this$static, this$0){
  ...
  $location_0[stackIndex] = 'OpenTasksView.java:' + '299' , $clinit_1067();
  this$static.this$0 = this$0;
  $stackDepth_0 = stackIndex - 1;
  return this$static;
}
...
function $ParticipantPanel(this$static){
  ...
  $MosaicPanel_0(this$static, ($location_0[stackIndex] = 'ParticipantPanel.java:' + '58' , $BoxLayout_1(($location_0[stackIndex] = 'ParticipantPanel.java:' + '58' , new BoxLayout), ($location_0[stackIndex] = 'BoxLayout.java:' + '170' , $clinit_802() , HORIZONTAL))));
  ...
  $add_26(this$static, treePanel, ($location_0[stackIndex] = 'ParticipantPanel.java:' + '68' , $BoxLayoutData_4(($location_0[stackIndex] = 'ParticipantPanel.java:' + '68' , new BoxLayoutData), ($location_0[stackIndex] = 'BoxLayoutData.java:' + '30' , $clinit_804() , BOTH))));
...
function $onTreeItemSelected(this$static, treeItem){
  ...
  $location_0[stackIndex] = 'ParticipantPanel.java:' + '75' , name_0 = ($location_0[stackIndex] = 'Element.java:' + '266' , $clinit_82() , treeItem.contentElem).innerText;
  if (!($location_0[stackIndex] = 'ParticipantPanel.java:' + '77' , $equals_4(name_0, 'Participants')) & !($location_0[stackIndex] = 'ParticipantPanel.java:' + '78' , $equals_4(name_0, 'Groups')) & !($location_0[stackIndex] = 'ParticipantPanel.java:' + '79' , $equals_4(name_0, 'Users'))) {
    $location_0[stackIndex] = 'ParticipantPanel.java:' + '82' , this$static.this$0.selection_0 = name_0;
    $location_0[stackIndex] = 'Element.java:' + '638' , this$static.this$0.assignmentBtn.element['disabled'] = !true;
  }
   else {
    $location_0[stackIndex] = 'ParticipantPanel.java:' + '87' , this$static.this$0.selection_0 = null;
...
function onClick_34(widget){
  ...
  this.this$0.selection_0 != null && ($location_0[stackIndex] = 'ParticipantPanel.java:' + '108' , $handleEvent(this.this$0.controller, $Event(($location_0[stackIndex] = 'ParticipantPanel.java:' + '109' , new Event_0), ($location_0[stackIndex] = 'AssignTaskAction.java:' + '38' , $clinit_1040() , ID_25), $AssignEvent(($location_0[stackIndex] = 'ParticipantPanel.java:' + '109' , new AssignEvent), this.this$0.selection_0, this.this$0.currentTask))));
  $stackDepth_0 = stackIndex - 1;
}
...
_.typeId$ = 509;
_.this$0 = null;
function $clinit_1071(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_1071;
  $location_0[stackIndex] = 'ReleaseTaskAction.java:' + '35' , $clinit_1071 = nullMethod;
...
function $ReleaseTaskAction(this$static){
  ...
  $location_0[stackIndex] = 'ReleaseTaskAction.java:' + '35' , $clinit_1071();
  dynamicCast(($location_0[stackIndex] = 'AbstractRESTAction.java:' + '44' , get_16(Lorg_jboss_bpm_console_client_ApplicationContext_2_classLit)), 224);
  $stackDepth_0 = stackIndex - 1;
  return this$static;
}
...
function handleSuccessfulResponse_17(controller, event_0, response){
  ...
  $location_0[stackIndex] = 'ReleaseTaskAction.java:' + '59' , $handleEvent(controller, ($location_0[stackIndex] = 'ReleaseTaskAction.java:' + '60' , $Event(($location_0[stackIndex] = 'ReleaseTaskAction.java:' + '60' , new Event_0), ($location_0[stackIndex] = 'LoadTasksAction.java:' + '45' , $clinit_1055() , ID_28), currentUser)));
  $stackDepth_0 = stackIndex - 1;
}
...
function $clinit_1072(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_1072;
  $location_0[stackIndex] = 'ReloadAllTaskListsAction.java:' + '35' , $clinit_1072 = nullMethod;
...
function $ReloadAllTaskListsAction(this$static){
  ...
  $location_0[stackIndex] = 'ReloadAllTaskListsAction.java:' + '42' , $clinit_1072();
...
function execute_40(controller, object){
  var currentUser, stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = execute_40;
  ...
  $location_0[stackIndex] = 'ReloadAllTaskListsAction.java:' + '51' , $handleEvent(controller, ($location_0[stackIndex] = 'ReloadAllTaskListsAction.java:' + '52' , $Event(($location_0[stackIndex] = 'ReloadAllTaskListsAction.java:' + '52' , new Event_0), ($location_0[stackIndex] = 'LoadTasksAction.java:' + '45' , $clinit_1055() , ID_28), currentUser)));
  $location_0[stackIndex] = 'ReloadAllTaskListsAction.java:' + '56' , $handleEvent(controller, ($location_0[stackIndex] = 'ReloadAllTaskListsAction.java:' + '57' , $Event(($location_0[stackIndex] = 'ReloadAllTaskListsAction.java:' + '57' , new Event_0), ($location_0[stackIndex] = 'LoadTasksParticipationAction.java:' + '45' , $clinit_1056() , ID_29), currentUser)));
  $stackDepth_0 = stackIndex - 1;
}
...
_.execute_2 = execute_40;
_.getClass$ = getClass_757;
_.typeId$ = 511;
var ID_32;
function $clinit_1073(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_1073;
  $location_0[stackIndex] = 'SkipTaskAction.java:' + '12' , $clinit_1073 = nullMethod;
...
function $SkipTaskAction(this$static){
  ...
  $location_0[stackIndex] = 'SkipTaskAction.java:' + '12' , $clinit_1073();
  dynamicCast(($location_0[stackIndex] = 'AbstractRESTAction.java:' + '44' , get_16(Lorg_jboss_bpm_console_client_ApplicationContext_2_classLit)), 224);
  $stackDepth_0 = stackIndex - 1;
  return this$static;
}
...
function handleSuccessfulResponse_18(controller, event_0, response){
  ...
  $location_0[stackIndex] = 'SkipTaskAction.java:' + '37' , $handleEvent(controller, ($location_0[stackIndex] = 'SkipTaskAction.java:' + '38' , $Event(($location_0[stackIndex] = 'SkipTaskAction.java:' + '38' , new Event_0), ($location_0[stackIndex] = 'ReloadAllTaskListsAction.java:' + '38' , $clinit_1072() , ID_32), null)));
  $stackDepth_0 = stackIndex - 1;
}
...
function $initialize_5(this$static){
  ...
  if (!this$static.initialzed) {
    this$static.grid = ($location_0[stackIndex] = 'TaskDetailView.java:' + '78' , $PropertyGrid(($location_0[stackIndex] = 'TaskDetailView.java:' + '78' , new PropertyGrid), ($location_0[stackIndex] = 'TaskDetailView.java:' + '79' , initValues(_3Ljava_lang_String_2_classLit, 687, 1, ['ID:', 'Process:', 'Name:', 'Assignee:', 'Description:']))));
    if (this$static.openView) {
      ...
      $location_0[stackIndex] = 'TaskDetailView.java:' + '106' , $add_17(this$static.caption, dropBox, ($location_0[stackIndex] = 'Caption.java:' + '61' , $clinit_656() , RIGHT));
      $location_0[stackIndex] = 'CaptionLayoutPanel.java:' + '91' , $add_26(this$static.body_0, deck, ($location_0[stackIndex] = 'TaskDetailView.java:' + '107' , $BoxLayoutData_4(($location_0[stackIndex] = 'TaskDetailView.java:' + '107' , new BoxLayoutData), ($location_0[stackIndex] = 'BoxLayoutData.java:' + '30' , $clinit_804() , BOTH))));
...
function $clinit_1076(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_1076;
  $location_0[stackIndex] = 'UpdateDetailsAction.java:' + '32' , $clinit_1076 = nullMethod;
...
function execute_41(controller, object){
  var event_0, task, view, values, stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = execute_41;
...
function getClass_762(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_762;
  $stackDepth_0 = stackIndex - 1;
...
function getClass_763(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_763;
  $stackDepth_0 = stackIndex - 1;
...
_.identity = null;
_.task = null;
function $clinit_1081(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_1081;
  $location_0[stackIndex] = 'DateLocale.java:' + '27' , $clinit_1081 = nullMethod;
  $location_0[stackIndex] = 'DateLocale.java:' + '52' , SUPPORTED_DF_TOKENS = ($location_0[stackIndex] = 'Arrays.java:' + '99' , $Arrays$ArrayList(($location_0[stackIndex] = 'Arrays.java:' + '99' , new Arrays$ArrayList), ($location_0[stackIndex] = 'DateLocale.java:' + '52' , initValues(_3Ljava_lang_String_2_classLit, 687, 1, ['E', 'd', 'M', 'y', 'h', 'H', 'm', 's', 'a']))));
  $stackDepth_0 = stackIndex - 1;
}
...
function $DateLocale(this$static){
  ...
  $location_0[stackIndex] = 'DateLocale.java:' + '27' , $clinit_1081();
  this$static.MONTH_LONG = ($location_0[stackIndex] = 'DateLocale.java:' + '57' , initValues(_3Ljava_lang_String_2_classLit, 687, 1, ['January', 'February', 'March', 'April', 'May', 'June', 'July', 'August', 'September', 'October', 'November', 'December']));
  this$static.MONTH_SHORT = ($location_0[stackIndex] = 'DateLocale.java:' + '61' , initValues(_3Ljava_lang_String_2_classLit, 687, 1, ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sept', 'Oct', 'Nov', 'Dec']));
  this$static.WEEKDAY_LONG = ($location_0[stackIndex] = 'DateLocale.java:' + '64' , initValues(_3Ljava_lang_String_2_classLit, 687, 1, ['Sunday', 'Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday']));
  this$static.WEEKDAY_SHORT = ($location_0[stackIndex] = 'DateLocale.java:' + '67' , initValues(_3Ljava_lang_String_2_classLit, 687, 1, ['Sun', 'Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat']));
  $stackDepth_0 = stackIndex - 1;
  return this$static;
}
...
function $format_2(this$static, date){
  ...
  if (this$static.format != null && this$static.format.length > 0) {
    ...
    for ($location_0[stackIndex] = 'SimpleDateFormat.java:' + '59' , i = 0; i < this$static.format.length; $location_0[stackIndex] = 'SimpleDateFormat.java:' + '59' , ++i) {
      ...
      $location_0[stackIndex] = 'SimpleDateFormat.java:' + '61' , currentTokenType = ($location_0[stackIndex] = 'Arrays.java:' + '48' , $indexOf(($location_0[stackIndex] = 'DateLocale.java:' + '52' , $clinit_1081() , SUPPORTED_DF_TOKENS), thisChar)) != -1?thisChar:'';
...
function $handleToken(this$static, token, date){
  ...
  if ($location_0[stackIndex] = 'SimpleDateFormat.java:' + '96' , $equals_4('E', tc)) {
    ...
    hour > 11?(response = ($location_0[stackIndex] = 'SimpleDateFormat.java:' + '154' , $clinit_1081() , 'PM')):(response = ($location_0[stackIndex] = 'SimpleDateFormat.java:' + '156' , $clinit_1081() , 'AM'));
  }
  $stackDepth_0 = stackIndex - 1;
  return response;
}
...
_.typeId$ = 0;
_.format = null;
function $clinit_1085(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_1085;
  $location_0[stackIndex] = 'SimpleDateParser.java:' + '34' , $clinit_1085 = nullMethod;
  TOKENS = ($location_0[stackIndex] = 'SimpleDateParser.java:' + '55' , initValues(_3_3Ljava_lang_String_2_classLit, 735, 133, [($location_0[stackIndex] = 'SimpleDateParser.java:' + '56' , initValues(_3Ljava_lang_String_2_classLit, 687, 1, ['SSSS', '(\\d\\d\\d\\d)', 'S'])), ($location_0[stackIndex] = 'SimpleDateParser.java:' + '57' , initValues(_3Ljava_lang_String_2_classLit, 687, 1, ['SSS', '(\\d\\d\\d)', 'S'])), ($location_0[stackIndex] = 'SimpleDateParser.java:' + '58' , initValues(_3Ljava_lang_String_2_classLit, 687, 1, ['SS', '(\\d\\d)', 'S'])), ($location_0[stackIndex] = 'SimpleDateParser.java:' + '59' , initValues(_3Ljava_lang_String_2_classLit, 687, 1, ['S', '(\\d)', 'S'])), ($location_0[stackIndex] = 'SimpleDateParser.java:' + '60' , initValues(_3Ljava_lang_String_2_classLit, 687, 1, ['ss', '(\\d\\d)', 's'])), ($location_0[stackIndex] = 'SimpleDateParser.java:' + '61' , initValues(_3Ljava_lang_String_2_classLit, 687, 1, ['s', '(\\d)', 's'])), ($location_0[stackIndex] = 'SimpleDateParser.java:' + '62' , initValues(_3Ljava_lang_String_2_classLit, 687, 1, ['mm', '(\\d\\d)', 'm'])), ($location_0[stackIndex] = 'SimpleDateParser.java:' + '63' , initValues(_3Ljava_lang_String_2_classLit, 687, 1, ['m', '(\\d)', 'm'])), ($location_0[stackIndex] = 'SimpleDateParser.java:' + '64' , initValues(_3Ljava_lang_String_2_classLit, 687, 1, ['HH', '(\\d\\d)', 'H'])), ($location_0[stackIndex] = 'SimpleDateParser.java:' + '65' , initValues(_3Ljava_lang_String_2_classLit, 687, 1, ['H', '(\\d)', 'H'])), ($location_0[stackIndex] = 'SimpleDateParser.java:' + '66' , initValues(_3Ljava_lang_String_2_classLit, 687, 1, ['dd', '(\\d\\d)', 'd'])), ($location_0[stackIndex] = 'SimpleDateParser.java:' + '67' , initValues(_3Ljava_lang_String_2_classLit, 687, 1, ['d', '(\\d)', 'd'])), ($location_0[stackIndex] = 'SimpleDateParser.java:' + '68' , initValues(_3Ljava_lang_String_2_classLit, 687, 1, ['MM', '(\\d\\d)', 'M'])), ($location_0[stackIndex] = 'SimpleDateParser.java:' + '69' , initValues(_3Ljava_lang_String_2_classLit, 687, 1, ['M', '(\\d)', 'M'])), ($location_0[stackIndex] = 'SimpleDateParser.java:' + '70' , initValues(_3Ljava_lang_String_2_classLit, 687, 1, ['yyyy', '(\\d\\d\\d\\d)', 'y'])), ($location_0[stackIndex] = 'SimpleDateParser.java:' + '71' , initValues(_3Ljava_lang_String_2_classLit, 687, 1, ['yyy', '(\\d\\d\\d)', 'y'])), ($location_0[stackIndex] = 'SimpleDateParser.java:' + '72' , initValues(_3Ljava_lang_String_2_classLit, 687, 1, ['yy', '(\\d\\d)', 'y'])), ($location_0[stackIndex] = 'SimpleDateParser.java:' + '73' , initValues(_3Ljava_lang_String_2_classLit, 687, 1, ['y', '(\\d)', 'y']))]));
  $stackDepth_0 = stackIndex - 1;
}
...
function $SimpleDateParser(this$static, format){
  ...
  $location_0[stackIndex] = 'SimpleDateParser.java:' + '137' , $clinit_1085();
  args = ($location_0[stackIndex] = 'SimpleDateParser.java:' + '138' , initValues(_3Ljava_lang_String_2_classLit, 687, 1, ['', '']));
...
function parse_0(input, pattern){
  var stackIndex, returnTemp;
  $stack_0[stackIndex = ++$stackDepth_0] = parse_0;
  $location_0[stackIndex] = 'SimpleDateParser.java:' + '158' , $clinit_1085();
...
function addMaximizeButton(windowPanel, captionRegion){
  ...
  maximizeBtn = ($location_0[stackIndex] = 'WindowUtil.java:' + '42' , $ImageButton(($location_0[stackIndex] = 'WindowUtil.java:' + '42' , new ImageButton), ($location_0[stackIndex] = 'WindowUtil.java:' + '43' , $clinit_655() , ($location_0[stackIndex] = 'CaptionImages_generatedBundle.java:' + '65' , $clinit_657()) , windowMaximize_SINGLETON)));
...
function addMinimizeButton(windowPanel, captionRegion){
  ...
  minimizeBtn = ($location_0[stackIndex] = 'WindowUtil.java:' + '74' , $ImageButton(($location_0[stackIndex] = 'WindowUtil.java:' + '74' , new ImageButton), ($location_0[stackIndex] = 'WindowUtil.java:' + '75' , $clinit_655() , ($location_0[stackIndex] = 'CaptionImages_generatedBundle.java:' + '69' , $clinit_657()) , windowMinimize_SINGLETON)));
...
function getClass_770(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_770;
  $stackDepth_0 = stackIndex - 1;
...
function onClick_35(sender){
  ...
  this.val$windowPanel.windowState == ($location_0[stackIndex] = 'WindowPanel.java:' + '118' , $clinit_752() , MAXIMIZED)?($location_0[stackIndex] = 'WindowUtil.java:' + '47' , $setWindowState(this.val$windowPanel, NORMAL)):($location_0[stackIndex] = 'WindowUtil.java:' + '49' , $setWindowState(this.val$windowPanel, MAXIMIZED));
  $stackDepth_0 = stackIndex - 1;
}
...
function getClass_771(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_771;
  $stackDepth_0 = stackIndex - 1;
...
function onWindowStateChange_0(sender, windowState, windowState1){
  ...
  sender.windowState == ($location_0[stackIndex] = 'WindowPanel.java:' + '118' , $clinit_752() , MAXIMIZED)?$setImage(this.val$maximizeBtn, ($location_0[stackIndex] = 'WindowUtil.java:' + '58' , $createImage(($location_0[stackIndex] = 'WindowUtil.java:' + '58' , $clinit_655() , ($location_0[stackIndex] = 'CaptionImages_generatedBundle.java:' + '73' , $clinit_657()) , windowRestore_SINGLETON)))):$setImage(this.val$maximizeBtn, ($location_0[stackIndex] = 'WindowUtil.java:' + '60' , $createImage(($location_0[stackIndex] = 'WindowUtil.java:' + '60' , $clinit_655() , ($location_0[stackIndex] = 'CaptionImages_generatedBundle.java:' + '65' , $clinit_657()) , windowMaximize_SINGLETON))));
  $stackDepth_0 = stackIndex - 1;
}
...
function getClass_772(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_772;
  $stackDepth_0 = stackIndex - 1;
...
function onClick_36(sender){
  ...
  $location_0[stackIndex] = 'WindowUtil.java:' + '78' , $setWindowState(this.val$windowPanel, ($location_0[stackIndex] = 'WindowPanel.java:' + '118' , $clinit_752() , NORMAL));
  $stackDepth_0 = stackIndex - 1;
}
...
function $match(this$static, text){
  ...
  arr = ($location_0[stackIndex] = 'Pattern.java:' + '136' , initDim(_3Ljava_lang_String_2_classLit, 687, 1, matches.size_0, 0));
...
function getClass_773(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_773;
  $stackDepth_0 = stackIndex - 1;
...
_.getClass$ = getClass_773;
_.toString$ = toString_59;
_.typeId$ = 0;
_.regExp = null;
function $clinit_1234(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_1234;
  $location_0[stackIndex] = 'Workspace.java:' + '57' , $clinit_1234 = nullMethod;
  toolSets_0 = $ArrayList(($location_0[stackIndex] = 'Workspace.java:' + '61' , new ArrayList));
  $stackDepth_0 = stackIndex - 1;
}

var toolSets_0;
function $set_5(key, value){
  var twoWeeks, stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $set_5;
