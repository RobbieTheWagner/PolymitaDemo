...
function onLoad_0(){
  ...
  instance_3 = ($location_0[stackIndex] = 'AsyncLoader2.java:' + '5' , $clinit_263() , ($location_0[stackIndex] = 'AsyncLoader2.java:' + '22' , new AsyncLoader2));
  $location_0[stackIndex] = 'AsyncLoader2.java:' + '23' , $fragmentHasLoaded(($location_0[stackIndex] = 'AsyncFragmentLoader.java:' + '335' , $clinit_61() , BROWSER_LOADER), 2);
...
function $ListBox(this$static){
  ...
  $location_0[stackIndex] = 'ListBox.java:' + '88' , $FocusWidget(this$static, ($location_0[stackIndex] = 'DOMImplTrident.java:' + '127' , html = '<SELECT>' , ($location_0[stackIndex] = 'DOMImplTrident.java:' + '128' , ($location_0[stackIndex] = 'Document.java:' + '921' , $clinit_82() , $doc).createElement(html))));
...
function $setItemSelected(this$static, index, selected){
  ...
  $location_0[stackIndex] = 'OptionElement.java:' + '146' , ($location_0[stackIndex] = 'SelectElement.java:' + '112' , $clinit_82() , this$static.element).options[index].selected = selected;
  $stackDepth_0 = stackIndex - 1;
}
...
function $provideWidget(this$static, callback){
  ...
  this$static.panel = $MosaicPanel_0(($location_0[stackIndex] = 'PreferencesView.java:' + '65' , new MosaicPanel), ($location_0[stackIndex] = 'PreferencesView.java:' + '65' , $BoxLayout_1(new BoxLayout, ($location_0[stackIndex] = 'BoxLayout.java:' + '170' , $clinit_802() , VERTICAL))));
  dynamicCast(($location_0[stackIndex] = 'PreferencesView.java:' + '67' , get_16(Lorg_jboss_bpm_console_client_ApplicationContext_2_classLit)), 224);
  $add_26(this$static.panel, $HeaderLabel(($location_0[stackIndex] = 'PreferencesView.java:' + '68' , new HeaderLabel), 'User Preferences'), ($location_0[stackIndex] = 'PreferencesView.java:' + '68' , $BoxLayoutData_4(new BoxLayoutData, ($location_0[stackIndex] = 'BoxLayoutData.java:' + '30' , $clinit_804() , HORIZONTAL_0))));
  ...
  $location_0[stackIndex] = 'PreferencesView.java:' + '76' , toolsets = ($location_0[stackIndex] = 'PreferencesView.java:' + '77' , $clinit_1234() , ($location_0[stackIndex] = 'Workspace.java:' + '61' , $clinit_1234()) , toolSets_0);
  ...
  $location_0[stackIndex] = 'LayoutPanel.java:' + '391' , $insert_0(layout, multiBox, layout.children_0.size_0);
  ...
  for ($location_0[stackIndex] = 'PreferencesView.java:' + '85' , ts$iterator = $AbstractList$IteratorImpl(($location_0[stackIndex] = 'AbstractList.java:' + '278' , new AbstractList$IteratorImpl), toolsets); ts$iterator.i < ($location_0[stackIndex] = 'AbstractList.java:' + '38' , ts$iterator.this$0.size_1());) {
    ts = dynamicCast(($location_0[stackIndex] = 'PreferencesView.java:' + '85' , $next_6(ts$iterator)), 227);
    $addItem(multiBox, ($location_0[stackIndex] = 'PreferencesView.java:' + '87' , ts.getToolSetName()));
    $equals_4(($location_0[stackIndex] = 'PreferencesView.java:' + '88' , ts.getToolSetName()), prefEditor) && ($location_0[stackIndex] = 'PreferencesView.java:' + '89' , $setItemSelected(multiBox, ($location_0[stackIndex] = 'SelectElement.java:' + '112' , $clinit_82() , multiBox.element).options.length - 1, true));
  }
  $location_0[stackIndex] = 'FocusWidget.java:' + '91' , $addDomHandler(multiBox, $PreferencesView$1(($location_0[stackIndex] = 'PreferencesView.java:' + '93' , new PreferencesView$1), multiBox, toolsets), ($location_0[stackIndex] = 'FocusWidget.java:' + '91' , $clinit_130() , ($location_0[stackIndex] = 'ClickEvent.java:' + '27' , $clinit_130()) , TYPE_1));
...
function onClick_12(clickEvent){
  ...
  for ($location_0[stackIndex] = 'PreferencesView.java:' + '98' , ts$iterator = $AbstractList$IteratorImpl(($location_0[stackIndex] = 'AbstractList.java:' + '278' , new AbstractList$IteratorImpl), this.val$toolsets); ts$iterator.i < ($location_0[stackIndex] = 'AbstractList.java:' + '38' , ts$iterator.this$0.size_1());) {
    ts = dynamicCast(($location_0[stackIndex] = 'PreferencesView.java:' + '98' , $next_6(ts$iterator)), 227);
    $equals_4(($location_0[stackIndex] = 'PreferencesView.java:' + '100' , ts.getToolSetName()), title) && $set_5('workspace.default.tool', ($location_0[stackIndex] = 'PreferencesView.java:' + '102' , ts.getToolSetName()));
  }
  $stackDepth_0 = stackIndex - 1;
}
