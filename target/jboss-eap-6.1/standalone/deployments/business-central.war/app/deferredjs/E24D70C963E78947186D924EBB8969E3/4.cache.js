...
function handlePostError_0(controller, event_0){
  ...
  view = ($location_0[stackIndex] = 'DeleteInstanceAction.java:' + '86' , dynamicCast(dynamicCast(($location_0[stackIndex] = 'Controller.java:' + '67' , $get_8(controller.views, ($location_0[stackIndex] = 'InstanceListView.java:' + '75' , $clinit_985() , ID_10))), 167), 234));
  $location_0[stackIndex] = 'DeleteInstanceAction.java:' + '87' , def = view.currentDefinition;
  $handleEvent(controller, ($location_0[stackIndex] = 'DeleteInstanceAction.java:' + '90' , $Event(($location_0[stackIndex] = 'DeleteInstanceAction.java:' + '90' , new Event_0), ($location_0[stackIndex] = 'UpdateInstancesAction.java:' + '47' , $clinit_1016() , ID_19), def)));
  $stackDepth_0 = stackIndex - 1;
}
...
function $InstanceDetailView(this$static){
  ...
  this$static.instanceDataBtn = ($location_0[stackIndex] = 'InstanceDetailView.java:' + '188' , $Button_1(($location_0[stackIndex] = 'InstanceDetailView.java:' + '188' , new Button), 'Instance Data', $InstanceDetailView$3(($location_0[stackIndex] = 'InstanceDetailView.java:' + '189' , new InstanceDetailView$3), this$static)));
...
function $createDiagramWindow(this$static, inst){
  ...
  if (this$static.isRiftsawInstance) {
    ...
    $add_26(layout, header, ($location_0[stackIndex] = 'InstanceDetailView.java:' + '227' , $BoxLayoutData_4(($location_0[stackIndex] = 'InstanceDetailView.java:' + '227' , new BoxLayoutData), ($location_0[stackIndex] = 'BoxLayoutData.java:' + '30' , $clinit_804() , HORIZONTAL_0))));
    ...
    this$static.processEvents = $ListBox_1(($location_0[stackIndex] = 'InstanceDetailView.java:' + '237' , new ListBox_0), initValues(_3Ljava_lang_String_2_classLit, 687, 1, ['Process Events']));
    ...
    $handleEvent(this$static.controller, ($location_0[stackIndex] = 'InstanceDetailView.java:' + '266' , $Event(($location_0[stackIndex] = 'InstanceDetailView.java:' + '266' , new Event_0), ($location_0[stackIndex] = 'GetProcessInstanceEventsAction.java:' + '19' , $clinit_975() , ID_7), inst.id_0)));
  }
   else if (this$static.isjBPMInstance) {
    layout = $MosaicPanel_0(($location_0[stackIndex] = 'InstanceDetailView.java:' + '268' , new MosaicPanel), ($location_0[stackIndex] = 'InstanceDetailView.java:' + '268' , $BoxLayout_1(new BoxLayout, ($location_0[stackIndex] = 'BoxLayout.java:' + '170' , $clinit_802() , VERTICAL))));
    $location_0[stackIndex] = 'Element.java:' + '688' , layout.element['className'] = 'bpm-window-layout';
    $location_0[stackIndex] = 'LayoutPanel.java:' + '289' , setStyleAttribute_0(layout.element, 'padding', '5px');
    header = $Label_0(($location_0[stackIndex] = 'InstanceDetailView.java:' + '272' , new Label), 'Instance: ' + inst.id_0);
    $location_0[stackIndex] = 'Element.java:' + '688' , header.element['className'] = 'bpm-label-header';
    $add_26(layout, header, ($location_0[stackIndex] = 'InstanceDetailView.java:' + '274' , $BoxLayoutData_4(($location_0[stackIndex] = 'InstanceDetailView.java:' + '274' , new BoxLayoutData), ($location_0[stackIndex] = 'BoxLayoutData.java:' + '30' , $clinit_804() , HORIZONTAL_0))));
...
function $formatResult(value){
  ...
  $append_4(sbuffer, ($location_0[stackIndex] = 'InstanceDetailView.java:' + '297' , $nextToken(st)) + ' : ');
  while ($location_0[stackIndex] = 'InstanceDetailView.java:' + '299' , $hasMoreTokens(st)) {
    ...
    $append_4(sbuffer, ($location_0[stackIndex] = 'InstanceDetailView.java:' + '301' , $nextToken(st)));
  }
...
function $populateProcessInstanceEvents(this$static, refs){
  ...
  for ($location_0[stackIndex] = 'InstanceDetailView.java:' + '289' , value$iterator = ($location_0[stackIndex] = 'AbstractList.java:' + '291' , $listIterator(refs, 0)); value$iterator.currentNode != value$iterator.this$0.header;) {
    value = dynamicCast(($location_0[stackIndex] = 'InstanceDetailView.java:' + '289' , $next_9(value$iterator)), 238);
...
function $update_5(this$static, def, instance){
  ...
  values = ($location_0[stackIndex] = 'InstanceDetailView.java:' + '344' , initValues(_3Ljava_lang_String_2_classLit, 687, 1, [def.name_0, instance.id_0, '' + instance.lifecycle.current, ($location_0[stackIndex] = 'InstanceDetailView.java:' + '348' , $format_2(this$static.dateFormat, instance.startDate)), currentNodeName]));
...
function setController_5(controller){
  ...
  $location_0[stackIndex] = 'InstanceDetailView.java:' + '327' , $addView(controller, ($location_0[stackIndex] = 'ActivityDiagramView.java:' + '43' , $clinit_962() , ID_2), this.diagramView);
  $location_0[stackIndex] = 'InstanceDetailView.java:' + '328' , $addView(controller, ($location_0[stackIndex] = 'InstanceDataView.java:' + '48' , $clinit_976() , ID_8), this.instanceDataView);
  $location_0[stackIndex] = 'Controller.java:' + '106' , $put_0(controller.actions, ($location_0[stackIndex] = 'LoadActivityDiagramAction.java:' + '45' , $clinit_1002() , ID_11), $LoadActivityDiagramAction(($location_0[stackIndex] = 'InstanceDetailView.java:' + '329' , new LoadActivityDiagramAction)));
  ...
  $location_0[stackIndex] = 'Controller.java:' + '106' , $put_0(controller.actions, ($location_0[stackIndex] = 'UpdateInstanceDataAction.java:' + '44' , $clinit_1014() , ID_17), $UpdateInstanceDataAction(($location_0[stackIndex] = 'InstanceDetailView.java:' + '333' , new UpdateInstanceDataAction)));
  $stackDepth_0 = stackIndex - 1;
}
  ...
  if (diagramUrl != null && !($location_0[stackIndex] = 'InstanceDetailView.java:' + '156' , $equals_4(diagramUrl, ''))) {
    ...
    if (selection) {
      if (selection.lifecycle.current == ($location_0[stackIndex] = 'ProcessInstanceRef.java:' + '45' , $clinit_956() , ENDED)) {
        $location_0[stackIndex] = 'InstanceDetailView.java:' + '162' , $clinit_691();
        ...
        $location_0[stackIndex] = 'InstanceDetailView.java:' + '163' , $handleEvent(this.this$0.controller, ($location_0[stackIndex] = 'InstanceDetailView.java:' + '164' , $Event(($location_0[stackIndex] = 'InstanceDetailView.java:' + '164' , new Event_0), ($location_0[stackIndex] = 'UpdateInstancesAction.java:' + '47' , $clinit_1016() , ID_19), this.this$0.currentDefintion)));
      }
       else {
        $location_0[stackIndex] = 'InstanceDetailView.java:' + '171' , $handleEvent(this.this$0.controller, ($location_0[stackIndex] = 'InstanceDetailView.java:' + '172' , $Event(($location_0[stackIndex] = 'InstanceDetailView.java:' + '172' , new Event_0), ($location_0[stackIndex] = 'LoadActivityDiagramAction.java:' + '45' , $clinit_1002() , ID_11), selection)));
      }
    }
  }
   else {
    $location_0[stackIndex] = 'InstanceDetailView.java:' + '179' , $clinit_691();
    $location_0[stackIndex] = 'MessageBox.java:' + '111' , alert_2(($location_0[stackIndex] = 'MessageBox.java:' + '60' , $clinit_700() , ALERT), 'Incomplete deployment', 'No diagram associated with process');
  }
  $stackDepth_0 = stackIndex - 1;
}
...
function onClick_18(clickEvent){
  ...
  !!this.this$0.currentInstance && ($location_0[stackIndex] = 'InstanceDetailView.java:' + '196' , $handleEvent(this.this$0.controller, ($location_0[stackIndex] = 'InstanceDetailView.java:' + '197' , $Event(($location_0[stackIndex] = 'InstanceDetailView.java:' + '197' , new Event_0), ($location_0[stackIndex] = 'UpdateInstanceDataAction.java:' + '44' , $clinit_1014() , ID_17), this.this$0.currentInstance.id_0))));
  $stackDepth_0 = stackIndex - 1;
}
...
function $collectSignalableTokens(this$static, tokenParent, tokensToSignal){
  ...
  if (tokenParent.children_0) {
    for ($location_0[stackIndex] = 'InstanceListView.java:' + '545' , token$iterator = $AbstractList$IteratorImpl(($location_0[stackIndex] = 'AbstractList.java:' + '278' , new AbstractList$IteratorImpl), tokenParent.children_0); token$iterator.i < ($location_0[stackIndex] = 'AbstractList.java:' + '38' , token$iterator.this$0.size_1());) {
      token = dynamicCast(($location_0[stackIndex] = 'InstanceListView.java:' + '545' , $next_6(token$iterator)), 239);
...
function $createSignalWindow(this$static){
  ...
  (new ArrayList).array = ($location_0[stackIndex] = 'ArrayList.java:' + '64' , initDim(_3Ljava_lang_Object_2_classLit, 684, 0, 0, 0));
  layout = $MosaicPanel_0(($location_0[stackIndex] = 'InstanceListView.java:' + '559' , new MosaicPanel), ($location_0[stackIndex] = 'InstanceListView.java:' + '559' , $BoxLayout_1(new BoxLayout, ($location_0[stackIndex] = 'BoxLayout.java:' + '170' , $clinit_802() , VERTICAL))));
  $location_0[stackIndex] = 'Element.java:' + '688' , layout.element['className'] = 'bpm-window-layout';
  $location_0[stackIndex] = 'LayoutPanel.java:' + '289' , setStyleAttribute_0(layout.element, 'padding', '5px');
  ...
  $location_0[stackIndex] = 'InstanceListView.java:' + '570' , $add_28(toolBar, $Button_1(($location_0[stackIndex] = 'InstanceListView.java:' + '571' , new Button), 'Signal', $InstanceListView$8(new InstanceListView$8, this$static)));
  $location_0[stackIndex] = 'InstanceListView.java:' + '619' , $add_28(toolBar, $Button_1(($location_0[stackIndex] = 'InstanceListView.java:' + '620' , new Button), 'Close', $InstanceListView$9(new InstanceListView$9, this$static)));
  $add_26(toolBox, toolBar, ($location_0[stackIndex] = 'InstanceListView.java:' + '634' , $BoxLayoutData_4(($location_0[stackIndex] = 'InstanceListView.java:' + '634' , new BoxLayoutData), ($location_0[stackIndex] = 'BoxLayoutData.java:' + '30' , $clinit_804() , HORIZONTAL_0))));
  ...
  this$static.listBoxTokens = $ListBox_1(($location_0[stackIndex] = 'InstanceListView.java:' + '642' , new ListBox_0), initValues(_3Ljava_lang_String_2_classLit, 687, 1, ['Node name', 'Signal ref']));
  ...
  $location_0[stackIndex] = 'FocusWidget.java:' + '103' , $addDomHandler(this$static.signalRef, $InstanceListView$11(($location_0[stackIndex] = 'InstanceListView.java:' + '669' , new InstanceListView$11), this$static), ($location_0[stackIndex] = 'FocusWidget.java:' + '103' , $clinit_136() , ($location_0[stackIndex] = 'FocusEvent.java:' + '27' , $clinit_136()) , TYPE_3));
...
function $getSelection(this$static){
  ...
  ($location_0[stackIndex] = 'InstanceListView.java:' + '445' , $getSelectedIndex_0(this$static.listBox)) != -1 && (selection = dynamicCast($getItem_0(this$static.listBox, ($location_0[stackIndex] = 'InstanceListView.java:' + '446' , $getSelectedIndex_0(this$static.listBox))), 231));
  $stackDepth_0 = stackIndex - 1;
  return selection;
}
...
function $initialize_1(this$static){
  ...
  if (!this$static.isInitialized) {
    ...
    this$static.deleteBtn = $Button_1(($location_0[stackIndex] = 'InstanceListView.java:' + '321' , new Button), 'Delete', $InstanceListView$6(new InstanceListView$6, this$static));
    this$static.signalBtn = $Button_1(($location_0[stackIndex] = 'InstanceListView.java:' + '364' , new Button), 'Signal', $InstanceListView$7(new InstanceListView$7, this$static));
    if (!this$static.isRiftsawInstance) {
    ...
    $add_26(toolBox, toolBar, ($location_0[stackIndex] = 'InstanceListView.java:' + '396' , $BoxLayoutData_4(($location_0[stackIndex] = 'InstanceListView.java:' + '396' , new BoxLayoutData), ($location_0[stackIndex] = 'BoxLayoutData.java:' + '30' , $clinit_804() , HORIZONTAL_0))));
    ...
    $add_26(layout, this$static.instanceList, ($location_0[stackIndex] = 'InstanceListView.java:' + '425' , $BorderLayoutData_1(($location_0[stackIndex] = 'InstanceListView.java:' + '425' , new BorderLayoutData), ($location_0[stackIndex] = 'BorderLayout.java:' + '199' , $clinit_795() , CENTER_1))));
    detailsView = $InstanceDetailView(($location_0[stackIndex] = 'InstanceListView.java:' + '428' , new InstanceDetailView));
    $location_0[stackIndex] = 'InstanceListView.java:' + '429' , $addView(this$static.controller, ($location_0[stackIndex] = 'InstanceDetailView.java:' + '58' , $clinit_979() , ID_9), detailsView);
    $location_0[stackIndex] = 'Controller.java:' + '106' , $put_0(this$static.controller.actions, ($location_0[stackIndex] = 'UpdateInstanceDetailAction.java:' + '33' , $clinit_1015() , ID_18), ($location_0[stackIndex] = 'InstanceListView.java:' + '430' , new UpdateInstanceDetailAction));
    $location_0[stackIndex] = 'Controller.java:' + '106' , $put_0(this$static.controller.actions, ($location_0[stackIndex] = 'ClearInstancesAction.java:' + '32' , $clinit_963() , ID_3), ($location_0[stackIndex] = 'InstanceListView.java:' + '431' , new ClearInstancesAction));
    $location_0[stackIndex] = 'Controller.java:' + '106' , $put_0(this$static.controller.actions, ($location_0[stackIndex] = 'SignalExecutionAction.java:' + '42' , $clinit_1009() , ID_13), $SignalExecutionAction(($location_0[stackIndex] = 'InstanceListView.java:' + '432' , new SignalExecutionAction)));
...
function $renderSignalListBox(this$static, i){
  ...
  if (this$static.tokensToSignal.size_0 != 0) {
    for ($location_0[stackIndex] = 'InstanceListView.java:' + '707' , token$iterator = $AbstractList$IteratorImpl(($location_0[stackIndex] = 'AbstractList.java:' + '278' , new AbstractList$IteratorImpl), this$static.tokensToSignal); token$iterator.i < ($location_0[stackIndex] = 'AbstractList.java:' + '38' , token$iterator.this$0.size_1());) {
      token = dynamicCast(($location_0[stackIndex] = 'InstanceListView.java:' + '707' , $next_6(token$iterator)), 239);
...
function $renderUpdate(this$static){
  ...
  if (this$static.isInitialized) {
    ...
    $location_0[stackIndex] = 'InstanceListView.java:' + '494' , $handleEvent(this$static.controller, ($location_0[stackIndex] = 'InstanceListView.java:' + '495' , $Event(($location_0[stackIndex] = 'InstanceListView.java:' + '495' , new Event_0), ($location_0[stackIndex] = 'UpdateInstanceDetailAction.java:' + '33' , $clinit_1015() , ID_18), $InstanceEvent(($location_0[stackIndex] = 'InstanceListView.java:' + '496' , new InstanceEvent), this$static.currentDefinition, null))));
...
function $update_6(this$static, data){
  ...
  this$static.currentDefinition = dynamicCast(($location_0[stackIndex] = 'InstanceListView.java:' + '475' , data[0]), 230);
  this$static.cachedInstances = dynamicCast(($location_0[stackIndex] = 'InstanceListView.java:' + '476' , data[1]), 170);
...
function $renderCell_3(listBox, row, column, item){
  ...
  switch (column) {
    case 0:
      $location_0[stackIndex] = 'InstanceListView.java:' + '649' , $setText_6(listBox, row, column, item.currentNodeName);
      break;
    case 1:
      $location_0[stackIndex] = 'InstanceListView.java:' + '652' , $setText_6(listBox, row, column, item.name_0);
      break;
...
function onClick_21(clickEvent){
  ...
  if ($location_0[stackIndex] = 'InstanceListView.java:' + '287' , $getSelection(this.this$0)) {
    ...
    $location_0[stackIndex] = 'InstanceListView.java:' + '314' , $clinit_691();
...
function onResult_1(doIt){
  ...
  if (doIt) {
    ...
    $location_0[stackIndex] = 'InstanceListView.java:' + '299' , $setState_3(selection, ($location_0[stackIndex] = 'ProcessInstanceRef.java:' + '45' , $clinit_956() , ENDED));
    $location_0[stackIndex] = 'InstanceListView.java:' + '300' , $setEndResult(selection, ($location_0[stackIndex] = 'ProcessInstanceRef.java:' + '50' , $clinit_955() , OBSOLETE));
    $location_0[stackIndex] = 'InstanceListView.java:' + '301' , $handleEvent(this.this$1.this$0.controller, ($location_0[stackIndex] = 'InstanceListView.java:' + '302' , $Event(($location_0[stackIndex] = 'InstanceListView.java:' + '302' , new Event_0), ($location_0[stackIndex] = 'StateChangeAction.java:' + '44' , $clinit_1012() , ID_15), selection)));
  }
  $stackDepth_0 = stackIndex - 1;
}
...
function onClick_22(clickEvent){
  ...
  if ($location_0[stackIndex] = 'InstanceListView.java:' + '325' , $getSelection(this.this$0)) {
    ...
    $location_0[stackIndex] = 'InstanceListView.java:' + '358' , $clinit_691();
    $location_0[stackIndex] = 'MessageBox.java:' + '111' , alert_2(($location_0[stackIndex] = 'MessageBox.java:' + '60' , $clinit_700() , ALERT), 'Missing selection', 'Please select an instance');
  }
  $stackDepth_0 = stackIndex - 1;
}
...
function onResult_2(doIt){
  ...
  if (doIt) {
    try {
      ...
      $location_0[stackIndex] = 'InstanceListView.java:' + '339' , $setState_3(selection, ($location_0[stackIndex] = 'ProcessInstanceRef.java:' + '45' , $clinit_956() , ENDED));
      $location_0[stackIndex] = 'InstanceListView.java:' + '341' , $handleEvent(this.this$1.this$0.controller, ($location_0[stackIndex] = 'InstanceListView.java:' + '342' , $Event(($location_0[stackIndex] = 'InstanceListView.java:' + '342' , new Event_0), ($location_0[stackIndex] = 'DeleteInstanceAction.java:' + '42' , $clinit_974() , ID_6), selection)));
    }
     catch ($e0) {
      ...
      if (instanceOf($e0, 8)) {
        ...
        $location_0[stackIndex] = 'MessageBox.java:' + '111' , alert_2(($location_0[stackIndex] = 'MessageBox.java:' + '60' , $clinit_700() , ALERT), 'Warning', ($location_0[stackIndex] = 'InstanceListView.java:' + '349' , e.getMessage()));
      }
       else 
        throw $e0;
    }
...
function onClick_23(clickEvent){
  ...
  if ($location_0[stackIndex] = 'InstanceListView.java:' + '369' , $getSelection(this.this$0)) {
    ...
    $location_0[stackIndex] = 'InstanceListView.java:' + '375' , $clinit_691();
    $location_0[stackIndex] = 'MessageBox.java:' + '111' , alert_2(($location_0[stackIndex] = 'MessageBox.java:' + '60' , $clinit_700() , ALERT), 'Missing selection', 'Please select an instance');
  }
  $stackDepth_0 = stackIndex - 1;
}
...
function onClick_24(clickEvent){
  ...
  if (selectedToken != -1 && ($location_0[stackIndex] = 'DOM.java:' + '760' , $getPropertyString(this.this$0.signalRef.element, 'value')).length > 0) {
    $location_0[stackIndex] = 'InstanceListView.java:' + '579' , $clinit_691();
    ...
    $location_0[stackIndex] = 'InstanceListView.java:' + '584' , $handleEvent(this.this$0.controller, ($location_0[stackIndex] = 'InstanceListView.java:' + '585' , $Event(($location_0[stackIndex] = 'InstanceListView.java:' + '585' , new Event_0), ($location_0[stackIndex] = 'SignalExecutionAction.java:' + '42' , $clinit_1009() , ID_13), ($location_0[stackIndex] = 'InstanceListView.java:' + '586' , $SignalInstanceEvent(($location_0[stackIndex] = 'InstanceListView.java:' + '586' , new SignalInstanceEvent), this.this$0.currentDefinition, $getSelection(this.this$0), dynamicCast($getItem_0(this.this$0.listBoxTokens, selectedToken), 239), ($location_0[stackIndex] = 'DOM.java:' + '760' , $getPropertyString(this.this$0.eventData.element, 'value')), selectedToken)))));
  }
    ...
    for ($location_0[stackIndex] = 'InstanceListView.java:' + '596' , ref$iterator = $AbstractList$IteratorImpl(($location_0[stackIndex] = 'AbstractList.java:' + '278' , new AbstractList$IteratorImpl), this.this$0.tokensToSignal); ref$iterator.i < ($location_0[stackIndex] = 'AbstractList.java:' + '38' , ref$iterator.this$0.size_1());) {
      ref = dynamicCast(($location_0[stackIndex] = 'InstanceListView.java:' + '596' , $next_6(ref$iterator)), 239);
    ...
    $location_0[stackIndex] = 'InstanceListView.java:' + '605' , $handleEvent(this.this$0.controller, ($location_0[stackIndex] = 'InstanceListView.java:' + '606' , $Event(($location_0[stackIndex] = 'InstanceListView.java:' + '606' , new Event_0), ($location_0[stackIndex] = 'SignalExecutionAction.java:' + '42' , $clinit_1009() , ID_13), ($location_0[stackIndex] = 'InstanceListView.java:' + '607' , $SignalInstanceEvent(($location_0[stackIndex] = 'InstanceListView.java:' + '607' , new SignalInstanceEvent), this.this$0.currentDefinition, $getSelection(this.this$0), token, ($location_0[stackIndex] = 'DOM.java:' + '760' , $getPropertyString(this.this$0.eventData.element, 'value')), foundMatch)))));
  }
   else {
    $location_0[stackIndex] = 'InstanceListView.java:' + '610' , $clinit_691();
...
function onClick_25(clickEvent){
  ...
  $handleEvent(this.this$0.controller, ($location_0[stackIndex] = 'InstanceListView.java:' + '626' , $Event(($location_0[stackIndex] = 'InstanceListView.java:' + '626' , new Event_0), ($location_0[stackIndex] = 'UpdateInstancesAction.java:' + '47' , $clinit_1016() , ID_19), this.this$0.currentDefinition)));
  $stackDepth_0 = stackIndex - 1;
}
...
function $clinit_1002(){
  ...
  $location_0[stackIndex] = 'LoadActivityDiagramAction.java:' + '43' , $clinit_1002 = nullMethod;
...
function $LoadActivityDiagramAction(this$static){
  ...
  $location_0[stackIndex] = 'LoadActivityDiagramAction.java:' + '43' , $clinit_1002();
  dynamicCast(($location_0[stackIndex] = 'AbstractRESTAction.java:' + '44' , get_16(Lorg_jboss_bpm_console_client_ApplicationContext_2_classLit)), 224);
  $stackDepth_0 = stackIndex - 1;
  return this$static;
}
...
function getUrl_5(event_0){
  ...
  inst = ($location_0[stackIndex] = 'LoadActivityDiagramAction.java:' + '54' , dynamicCast(event_0, 231));
...
function handleSuccessfulResponse_3(controller, event_0, response){
  ...
  inst = ($location_0[stackIndex] = 'LoadActivityDiagramAction.java:' + '68' , dynamicCast(event_0, 231));
  if (inst.lifecycle.current == ($location_0[stackIndex] = 'ProcessInstanceRef.java:' + '45' , $clinit_956() , ENDED) || response.val$xmlHttpRequest.responseText.length == 0) {
    $location_0[stackIndex] = 'LoadActivityDiagramAction.java:' + '70' , $clinit_691();
    $location_0[stackIndex] = 'MessageBox.java:' + '111' , alert_2(($location_0[stackIndex] = 'MessageBox.java:' + '60' , $clinit_700() , ALERT), 'Info', 'Process is already completed');
    view = ($location_0[stackIndex] = 'LoadActivityDiagramAction.java:' + '72' , dynamicCast(dynamicCast(($location_0[stackIndex] = 'Controller.java:' + '67' , $get_8(controller.views, ($location_0[stackIndex] = 'InstanceListView.java:' + '75' , $clinit_985() , ID_10))), 167), 234));
    $location_0[stackIndex] = 'LoadActivityDiagramAction.java:' + '73' , def = view.currentDefinition;
    $handleEvent(controller, ($location_0[stackIndex] = 'LoadActivityDiagramAction.java:' + '76' , $Event(($location_0[stackIndex] = 'LoadActivityDiagramAction.java:' + '76' , new Event_0), ($location_0[stackIndex] = 'UpdateInstancesAction.java:' + '47' , $clinit_1016() , ID_19), def)));
  }
   else {
    viewData = ($location_0[stackIndex] = 'LoadActivityDiagramAction.java:' + '78' , dynamicCast(dynamicCast(($location_0[stackIndex] = 'Controller.java:' + '67' , $get_8(controller.views, ($location_0[stackIndex] = 'InstanceDetailView.java:' + '58' , $clinit_979() , ID_9))), 167), 235));
    ...
    view = ($location_0[stackIndex] = 'LoadActivityDiagramAction.java:' + '83' , dynamicCast(dynamicCast(($location_0[stackIndex] = 'Controller.java:' + '67' , $get_8(controller.views, ($location_0[stackIndex] = 'ActivityDiagramView.java:' + '43' , $clinit_962() , ID_2))), 167), 240));
...
function handlePostError_1(controller, event_0){
  ...
  view = ($location_0[stackIndex] = 'StateChangeAction.java:' + '86' , dynamicCast(dynamicCast(($location_0[stackIndex] = 'Controller.java:' + '67' , $get_8(controller.views, ($location_0[stackIndex] = 'InstanceListView.java:' + '75' , $clinit_985() , ID_10))), 167), 234));
  $location_0[stackIndex] = 'StateChangeAction.java:' + '87' , def = view.currentDefinition;
  $handleEvent(controller, ($location_0[stackIndex] = 'StateChangeAction.java:' + '90' , $Event(($location_0[stackIndex] = 'StateChangeAction.java:' + '90' , new Event_0), ($location_0[stackIndex] = 'UpdateInstancesAction.java:' + '47' , $clinit_1016() , ID_19), def)));
  $stackDepth_0 = stackIndex - 1;
}
...
function $clinit_1014(){
  ...
  $location_0[stackIndex] = 'UpdateInstanceDataAction.java:' + '41' , $clinit_1014 = nullMethod;
...
function $UpdateInstanceDataAction(this$static){
  ...
  $location_0[stackIndex] = 'UpdateInstanceDataAction.java:' + '41' , $clinit_1014();
  dynamicCast(($location_0[stackIndex] = 'AbstractRESTAction.java:' + '44' , get_16(Lorg_jboss_bpm_console_client_ApplicationContext_2_classLit)), 224);
  $stackDepth_0 = stackIndex - 1;
  return this$static;
}
...
function handleError_2(url, t){
  ...
  $location_0[stackIndex] = 'ConsoleLog.java:' + '41' , $clinit_24();
  $location_0[stackIndex] = 'Log.java:' + '651' , $warn(impl, 'Server reported following warning: ' + message + ' for url ' + url, null);
  $location_0[stackIndex] = 'UpdateInstanceDataAction.java:' + '81' , $clinit_691();
  $location_0[stackIndex] = 'MessageBox.java:' + '111' , alert_2(($location_0[stackIndex] = 'MessageBox.java:' + '60' , $clinit_700() , ALERT), 'Status information', message);
  $stackDepth_0 = stackIndex - 1;
}
...
function handlePostError_2(controller, event_0){
  ...
  view = ($location_0[stackIndex] = 'UpdateInstanceDataAction.java:' + '87' , dynamicCast(dynamicCast(($location_0[stackIndex] = 'Controller.java:' + '67' , $get_8(controller.views, ($location_0[stackIndex] = 'InstanceListView.java:' + '75' , $clinit_985() , ID_10))), 167), 234));
  $location_0[stackIndex] = 'UpdateInstanceDataAction.java:' + '88' , def = view.currentDefinition;
  $handleEvent(controller, ($location_0[stackIndex] = 'UpdateInstanceDataAction.java:' + '91' , $Event(($location_0[stackIndex] = 'UpdateInstanceDataAction.java:' + '91' , new Event_0), ($location_0[stackIndex] = 'UpdateInstancesAction.java:' + '47' , $clinit_1016() , ID_19), def)));
  $stackDepth_0 = stackIndex - 1;
}
...
function handleSuccessfulResponse_9(controller, event_0, response){
  ...
  viewData = ($location_0[stackIndex] = 'UpdateInstanceDataAction.java:' + '64' , dynamicCast(dynamicCast(($location_0[stackIndex] = 'Controller.java:' + '67' , $get_8(controller.views, ($location_0[stackIndex] = 'InstanceDetailView.java:' + '58' , $clinit_979() , ID_9))), 167), 235));
  ...
  $location_0[stackIndex] = 'UpdateInstanceDataAction.java:' + '69' , messageDom = ($location_0[stackIndex] = 'UpdateInstanceDataAction.java:' + '69' , $clinit_495() , ($location_0[stackIndex] = 'XMLParser.java:' + '47' , $parse(impl_1, xml)));
  view = ($location_0[stackIndex] = 'UpdateInstanceDataAction.java:' + '70' , dynamicCast(dynamicCast(($location_0[stackIndex] = 'Controller.java:' + '67' , $get_8(controller.views, ($location_0[stackIndex] = 'InstanceDataView.java:' + '48' , $clinit_976() , ID_8))), 167), 243));
